import { r as registerInstance, a as createEvent, h, i as Host, F as Fragment } from './index-b5cb18eb.js';
import { R as RegisterComponent } from './register-component-8057b2e5.js';
import { a as debug, t as toTitleCase, f as formatFolderName } from './utils-674a951a.js';
...
const NylasListFolders = class {
    ...
    getFolderIcon(folder) {
        switch (folder.name?.toLowerCase()) {
            ...
            case 'trash':
                return h("trash-fill-icon", null);
            default:
                return h("folder-icon", null);
        }
    }
    render() {
        return (h(Host, { key: 'a8d69bd6e13d02c05b067eacf505b4e938876fb5' }, h("div", { key: 'fcae4f615d8c0ea48c401711d368deb68916cd3f', class: "folders" }, this.defaultFolders?.map(folder => (h("sp-button", { onClick: () => this.folderSelectedHandler(folder), class: {
                folder: true,
...
export { NylasListFolders as nylas_list_folders };

//# sourceMappingURL=nylas-list-folders.entry.js.map