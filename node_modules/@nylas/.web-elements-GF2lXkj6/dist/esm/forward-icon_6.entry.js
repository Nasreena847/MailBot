...
import { a as debug, o as htmlToPlainText, q as detectIfMessageIsHTML, r as detectHTMLOrPlainText, s as parsePlainTextToHTML } from './utils-e90d8b26.js';
...
const ForwardIcon = class {
    ...
    render() {
        return (h("svg", { key: 'c8b018ea9d3c7e33125a3cab408be079b8091071', fill: "auto", width: this.width, height: this.height, viewBox: "0 0 1920 1920", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'b1af6cc12e320cc77734d7ad77ac4d5149f7000d', d: "m1246.246 64-90.496 90.496 477.952 477.952h-590.848C467.878 632.448.038 1100.416.038 1675.392v109.056h128v-109.056c0-504.576 410.368-914.944 914.816-914.944h590.848l-477.952 478.08 90.496 90.496 632.448-632.576L1246.246 64Z", "fill-rule": "evenodd" })));
    }
};
...
const NylasSummarizeMessageButton = class {
    ...
    render() {
        return (h(Host, { key: 'ea90a71f09b4b71f83271816680f466c85125368' }, h("sp-theme", { key: '317fbcb6f72b0e3eedbd63e52804b333af260987', scale: "medium", color: "dark" }, h("sp-button", { key: 'dbaa8ee59ab4c449d0e12da8fa6e10a4476cee4a', label: "Summarize email", "icon-only": true, onClickCapture: this.onClick, class: {
                'summarize-button': true,
                'stopped': this.state === 'stopped',
                'loading': this.state === 'loading',
                'playing': this.state === 'playing',
            } }, this.state === 'stopped' && h("play-icon", null), this.state === 'loading' && h("loading-icon", null), this.state === 'playing' && h("stop-icon", null)), h("audio", { key: '7794f0eaad660040bb2bbd7ea25b6590096b9648', ref: r => (this.audioRef = r), autoPlay: true, onPlaying: () => (this.state = 'playing'), onPause: () => (this.state = 'stopped'), onEnded: () => {
                this.state = 'stopped';
...
const NylasViewEmail = class {
    ...
    render() {
        ...
        return (h(Host, { key: '46388e116c6a5a1e57669fc20da75cf8786773eb' }, this.state === 'loading' && h("div", null, "Loading..."), this.state === 'ready' && (h(Fragment, null, this.styles.map(style => (h("style", null, DOMPurify.sanitize(style.innerHTML)))), h("div", { class: 'view-email', part: "view-email", innerHTML: this.sanitizedBody, ref: el => (this.viewEmailElement = el) })))));
    }
    get host() { return getElement(this); }
    static get watchers() { return {
