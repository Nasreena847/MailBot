...
import { i as instance, a as debug } from './utils-674a951a.js';
...
const NylasCancelBookingForm = class {
    ...
    render() {
        return (h(Host, { key: '6f680273959b2726cc68cb465aeacce03447ba8e', part: "ncbf" }, h("div", { key: 'be243375f24e2029af0ad14c990a254c7f005631', class: "nylas-cancel-booking-form", part: "ncbf__card" }, h("div", { key: '5bef53a115c1108a0ff15ed52b773e03456ed249', class: "nylas-cancel-booking-form__calendar-icon", part: "ncbf__icon" }, h("calendar-cancel-icon", { key: 'baa79cd9b1b8fea1019ccacdf0679b702d2f07a2' })), h("h3", { key: '260994a6886a04baccbba07198cb7b55843dcb94', class: "nylas-cancel-booking-form__title", part: "ncbf__title" }, instance.t('cancelBookingTitle')), h("div", { key: '5b551fb4c2f91a043b1a06b64dd635cfb2a6465e', class: "nylas-cancel-booking-form__description", part: "ncbf__description" }, !this.configSettings?.scheduler?.cancellation_policy ? `${instance.t('cancelBookingMessage')}` : this.cancellationPolicy), h("form", { key: '535c7fbc0ccd04b614b0b52e39c183bcc0bd4501', onSubmit: this.handleSubmitCancelBooking }, h("textarea-component", { key: '349fa734e6ca521418f315feca30de5c67c5b4ab', id: "cancel-reason", name: "cancel-reason", required: true, label: instance.t('reasonForCancellation'), class: this.cancellationError ? 'error' : '', part: "ncbf__reason-textarea", defaultValue: this.cancellationReason }), h("div", { key: 'c260628841bb3872a9a1439499c42e494894af9e', class: "footer" }, h("button-component", { key: '1de46efdfe24eaffae44d5a649f9b3ad6a11b3b6', variant: 'destructive', class: "cancel", type: "submit", part: "ncbf__button-cta", disabled: this.isLoading }, instance.t('cancelBookingButton')), !!this.eventInfo && (h("button-component", { variant: 'basic', class: "back", part: "ncbf__button-outline", onClick: this.handleGoBackClicked }, instance.t('goBackButton'))))))));
    }
