...
const ForwardIcon = class {
    ...
    render() {
        return (index.h("svg", { key: 'c8b018ea9d3c7e33125a3cab408be079b8091071', fill: "auto", width: this.width, height: this.height, viewBox: "0 0 1920 1920", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'b1af6cc12e320cc77734d7ad77ac4d5149f7000d', d: "m1246.246 64-90.496 90.496 477.952 477.952h-590.848C467.878 632.448.038 1100.416.038 1675.392v109.056h128v-109.056c0-504.576 410.368-914.944 914.816-914.944h590.848l-477.952 478.08 90.496 90.496 632.448-632.576L1246.246 64Z", "fill-rule": "evenodd" })));
    }
};
...
const NylasComposer = class {
    ...
    async componentDidLoad() {
        ...
        if (!this.editorEl) {
            utils.debug('[connectedCallback] no editor element');
            return;
        }
        if (!this.toolbarEl) {
            utils.debug('[connectedCallback] no toolbar element');
            return;
        }
        ...
        editorEl.addEventListener('mouseup', _ => {
            ...
            utils.debug('messageBodyRect', { messageBodyRect });
            const foundRect = foundElement.getBoundingClientRect();
            utils.debug('foundRect', { foundRect });
    ...
    watchBody(newMessage) {
        ...
        if (newMessage.body) {
            ...
            utils.debug('replyContainer', { replyContainer });
        }
    ...
    render() {
        return (index.h(index.Host, { key: 'e24e688a3965e332b1d14284a0142bd82048449b' }, index.h("sp-theme", { key: '7bd78108aeab6bd84d51002dfecfdfd8658f82df', scale: "medium", color: "dark" }, index.h("div", { key: '0408b3da7f2fa20c80aa57167c32504fba8bd752', class: "editor", contentEditable: true, ref: r => (this.editorEl = r) }, index.h("div", { key: 'a0a78800e4a463cc47dbe74d4b95d633ce58cb0c', class: "toolbar", ref: r => (this.toolbarEl = r), contentEditable: false }, index.h("sp-button", { key: '80af95fbdadd9adfcc6b7cc7cf0c63f705eb8164', quiet: true, onClick: () => document.execCommand('bold') }, index.h("div", { key: 'f9db6a419ad21918d0abc3e45b50c9722b5655ec', slot: "icon" }, index.h("bold-icon", { key: 'a4e8df2a934c404ff435ef0920d3bd69204ecda2' })), index.h("div", { key: '609415df8fccca26ac59095400d7a8c83605156a', slot: "label" }, "Bold")), index.h("sp-button", { key: '4b90d3395738fda4242994134b7625535b21157b', quiet: true, onClick: () => document.execCommand('underline') }, index.h("div", { key: '2cf5470ae2a40175682cd2423035b59d8f2aabe2', slot: "icon" }, index.h("underline-icon", { key: '4d77573ab3628b4956c196be6db4c00cfcce9699' })), index.h("div", { key: '21362c41bcff11414325a38882586013cefef497', slot: "label" }, "Underline")), index.h("sp-button", { key: '8d1bdae9a2d782364c4848118bab933e8ca6c7f5', quiet: true, onClick: () => document.execCommand('italic') }, index.h("div", { key: '743c08e076b633500dd08b569d7496784447c73f', slot: "icon" }, index.h("italic-icon", { key: '0a1ca27562711edf8b7b7221d420fcfdd5110a95' })), index.h("div", { key: '3b1b29a8eb334a59147b9c46eb67064201a44bf8', slot: "label" }, "Italic")))), index.h("div", { key: '901be1e103c0f2b851669d8126d6258091530e81', class: 'buttons' }, index.h("sp-button", { key: 'b6bba4d7ae73f610bd3af6c08a0167ffab3dbc88', onClick: this.sendComposer, class: "send" }, "Send"), index.h("sp-button", { key: '7b68f79eb2fb7a73f3f69863a3cf6fafdcdfb9f1', onClick: this.closeComposer, class: "close" }, "Close")))));
    }
...
const NylasSummarizeMessageButton = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.summarize = index.createEvent(this, "summarize", 7);
            ...
            if (this.state === 'stopped') {
                if (this.message) {
                    ...
                    if (!event.defaultPrevented) {
                        utils.debug(`[nylas-summarize-message-button] Default event not prevented, summarizing message`);
                        if (this.audioRef) {
                            await this.audioRef
                                .play()
    ...
    async componentWillLoad() {
        utils.debug(`[nylas-summarize-message-button] Component will load`);
    }
    async componentDidLoad() {
        utils.debug(`[nylas-summarize-message-button] Component did load`);
    }
        ...
        function onUpdateEnd() {
            if (sourceDone) {
                ...
                mediaSource.removeEventListener('sourceclose', () => {
                    utils.debug(`[nylas-summarize-message-button] Source closed`);
                });
    ...
    render() {
        return (index.h(index.Host, { key: 'ea90a71f09b4b71f83271816680f466c85125368' }, index.h("sp-theme", { key: '317fbcb6f72b0e3eedbd63e52804b333af260987', scale: "medium", color: "dark" }, index.h("sp-button", { key: 'dbaa8ee59ab4c449d0e12da8fa6e10a4476cee4a', label: "Summarize email", "icon-only": true, onClickCapture: this.onClick, class: {
                'summarize-button': true,
                'stopped': this.state === 'stopped',
                'loading': this.state === 'loading',
                'playing': this.state === 'playing',
            } }, this.state === 'stopped' && index.h("play-icon", null), this.state === 'loading' && index.h("loading-icon", null), this.state === 'playing' && index.h("stop-icon", null)), index.h("audio", { key: '7794f0eaad660040bb2bbd7ea25b6590096b9648', ref: r => (this.audioRef = r), autoPlay: true, onPlaying: () => (this.state = 'playing'), onPause: () => (this.state = 'stopped'), onEnded: () => {
                this.state = 'stopped';
                utils.debug(`[nylas-summarize-message-button] Audio ended`);
            } }))));
    }
};
__decorate([
    registerComponent.RegisterComponent({
        ...
        eventToProps: {
            summarize: async (event, nylasConnector) => {
                ...
                const text = utils.htmlToPlainText(message.body || '');
...
function transformElement(element) {
        ...
        if (styleTextContent) {
            ...
            if (backgroundColor) {
                for (const match of backgroundColor) {
                    ...
                    const escapedFullMatch = fullMatch.replace(/[-/\\^$*+?.()|[\]{}]/g, '\\$&');
                    styleTextContent = styleTextContent.replaceAll(escapedFullMatch, fullMatch.replace(color, invertColor(color)));
                    utils.debug('backgroundColor', { fullMatch, replace: fullMatch.replace(color, invertColor(color)), color, invertColor: invertColor(color) });
                }
            }
    ...
    if (element instanceof HTMLElement) {
        ...
        if (color && !backgroundColor) {
            ...
            utils.debug('element', element);
            utils.debug('computedStyle.color', color);
            utils.debug('computedStyle.backgroundColor', backgroundColor);
            utils.debug('invertColor(color)', invertColor(color));
            utils.debug('invertColor(backgroundColor)', invertColor(backgroundColor));
        }
        else if (!color && backgroundColor) {
            element.style.backgroundColor = '';
        }
        if (borderColor) {
            utils.debug('borderColor', borderColor);
...
const NylasViewEmail = class {
    constructor(hostRef) {
        ...
        this.setBody = (body) => {
            ...
            const isHTML = this.message ? utils.detectIfMessageIsHTML(this.message) : utils.detectHTMLOrPlainText(body);
            if (!isHTML) {
                body = `<html><body>${utils.parsePlainTextToHTML(body)}</body></html>`;
            }
            ...
            if (vw <= 768) {
                ...
                if (viewEmailReact && this.viewEmailElement && this.parent) {
                    if (viewEmailReact.width > vw) {
                        ...
                        utils.debug('Parent width:', parentReact?.width, 'Parent height:', parentReact?.height);
                        utils.debug('Parent client width:', parentElement.clientWidth, 'Parent client height:', parentElement.clientHeight);
                        const scaleX = parentReact.width / viewEmailReact.width;
                        const scaleY = parentReact.height / viewEmailReact.height;
                        const scale = Math.min(scaleX, scaleY);
                        utils.debug('Scale:', scale);
    ...
    connectedCallback() { }
    disconnectedCallback() {
        utils.debug(`[nylas-view-email] Component disconnected`);
        this.state = 'loading';
        this.styles = [];
        this.hoistedFontURLs = new Map();
        this.sanitizedBody = '';
    ...
    async componentWillLoad() {
        utils.debug(`[nylas-view-email] component loaded`);
        this.setBody(this.message?.body ?? '');
    }
    async componentDidLoad() {
        utils.debug(`[nylas-view-thread] Component did load`);
        this.handleMobileSize();
    }
    async messageChanged() {
        utils.debug(`[nylas-view-thread] Message changed`, { message: this.message });
        this.setBody(this.message?.body ?? '');
    }
    handleScroll() {
        this.handleMobileSize();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '46388e116c6a5a1e57669fc20da75cf8786773eb' }, this.state === 'loading' && index.h("div", null, "Loading..."), this.state === 'ready' && (index.h(index.Fragment, null, this.styles.map(style => (index.h("style", null, DOMPurify.sanitize(style.innerHTML)))), index.h("div", { class: 'view-email', part: "view-email", innerHTML: this.sanitizedBody, ref: el => (this.viewEmailElement = el) })))));
    }
    get host() { return index.getElement(this); }
    static get watchers() { return {
