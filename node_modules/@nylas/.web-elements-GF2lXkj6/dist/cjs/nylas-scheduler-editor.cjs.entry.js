...
const nylasApiRequest = require('./nylas-api-request-8f73b00d.js');
const utils = require('./utils-0e1c4d88.js');
const schedulerConfigStore = require('./scheduler-config-store-0163f152.js');
const _commonjsHelpers = require('./_commonjsHelpers-9463df90.js');
...
const LoginRequired = ({ authenticationUrl }) => (index.h("div", { class: 'login-required', part: "login-component" },
    index.h("div", { class: 'card' },
        index.h("p", null, "Log into your account to use the Scheduler Editor."),
        index.h("button", { class: "google-button", onClick: async (event) => {
        ...
        index.h("button", { class: "microsoft-button", onClick: async (event) => {
                event.preventDefault();
        ...
        index.h("button", { class: "other-provider-button", onClick: async (event) => {
                event.preventDefault();
        ...
        index.h("small", { class: "disclaimer-text" }, "* You will be redirected to authenticate your account."))));
...
function ExpressFlow({ selectedConfiguration, currentUser, calendars }) {
    ...
    return (index.h(index.Fragment, null,
        ...
        index.h("nylas-booking-calendar-picker", { calendars: calendars, currentUser: currentUser, defaultBookingCalendar: defaultCalendarOption?.id || organizer?.email }),
...
const NylasSchedulerEditor = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e3716df4b6320311046af1b529ee494c9b16c782' }, index.h("div", { key: '1e33292840f2906cfe0f0d4519192851e18d0ce7', class: "scheduler-editor-header", part: "nse__header" }, index.h("h1", { key: '830100ac6a1f5c369a6e665f4fe2ea458bf5b44f', class: "scheduler-editor-title", part: "nse__title" }, index.h("calendar-icon", { key: 'b69dafa07a0af6fae4e1f57be7c98221bc8fc237', width: "18", height: "18" }), "Scheduler Editor"), index.h("button", { key: 'c2e4c17d62f67c8c4011a8f41357481bd17eb883', class: "scheduler-editor-close", title: "logout", onClick: e => this.handleSchedulerConfigCloseClicked(e), part: "nse__close-button" }, index.h("close-icon", { key: '74eb653f9b8fea4a7c3669f7a707a5ebaa18d8d1', width: "18", height: "18" }))), index.h("div", { key: '33273e52377ec5b88672ed66db2a43ceab01b583', class: "scheduler-editor-content", part: "nse__content" }, this.stores?.schedulerConfig?.state.currentUser && this.stores.schedulerConfig.state.action === null && (index.h("div", { class: "list-configurations" }, index.h("nylas-list-configurations", { exportparts: "nlc__create-new-cta" }))), this.stores?.schedulerConfig?.state.currentUser && this.stores.schedulerConfig.state.action === 'create' && (index.h("nylas-editor-tabs", { mode: "composable" }, index.h(ExpressFlow, { currentUser: this.stores?.schedulerConfig?.state.currentUser, calendars: this.stores?.schedulerConfig?.state?.calendars, selectedConfiguration: this.stores?.schedulerConfig?.state?.selectedConfiguration }))), this.stores?.schedulerConfig?.state.currentUser && this.stores.schedulerConfig.state.action === 'edit' && (index.h("nylas-editor-tabs", { key: selectedConfigId, mode: this.mode }, this.mode === 'composable' && index.h("slot", null), this.mode === 'app' && hasSlot && (index.h("div", { style: { display: 'none' }, slot: "custom-page-style-inputs", key: selectedConfigId }, index.h("slot", { name: "custom-page-style-inputs" }))))), !this.stores?.schedulerConfig?.state.currentUser && (index.h("slot", { name: "login-required" }, index.h(LoginRequired, { authenticationUrl: this.authenticationUrl }))))));
    }
