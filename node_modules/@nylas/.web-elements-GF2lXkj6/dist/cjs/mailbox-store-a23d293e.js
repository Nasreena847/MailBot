...
const index_es = require('./index.es-21152a0a.js');
...
class NylasMessagesConnector {
    ...
    async getMessages() {
        ...
        if (index_es.Xr(response)) {
            throw new index_es.Zr(response.error);
        }
    ...
    async selectThread(thread) {
        ...
        if (thread.unread) {
            this.markThreadAsRead(thread).catch(error => {
                utils.debug('Error marking thread as read', error);
            });
        }
    }
...
exports.CreateNylasAuthStore = CreateNylasAuthStore;
exports.CreateNylasMailboxStore = CreateNylasMailboxStore;
exports.HashRouter = HashRouter;
exports.NylasAuthConnector = NylasAuthConnector;
exports.NylasFoldersConnector = NylasFoldersConnector;
exports.NylasMessagesConnector = NylasMessagesConnector;
exports.NylasThreadsConnector = NylasThreadsConnector;

//# sourceMappingURL=mailbox-store-a23d293e.js.map