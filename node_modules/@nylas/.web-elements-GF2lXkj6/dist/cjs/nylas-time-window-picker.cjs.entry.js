...
const TimeInput = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'efbf43a69aaa2bb323ca70eba72dec4245b8e103' }, index.h("div", { key: '0a366760ae64c61e4b61f973f8fe1150f2c4ec33', class: "time-picker", part: "time-picker" }, index.h("input", { key: '21c71cd1390364c13c9e7c72c5cd975df42b9c52', type: "text", name: this.name, id: this.name, part: "time-input", class: {
                'time-input': true,
