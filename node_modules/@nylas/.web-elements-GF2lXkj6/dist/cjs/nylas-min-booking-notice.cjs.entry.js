...
const NylasMinBookingNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b51f14edfe66462ce3822dcd9ea299820dfef96b' }, index.h("div", { key: '578505fefc4132f45ac21d6ab1d59cb409145536', class: "nylas-min-booking-notice", part: "nmbn" }, index.h("label", { key: '5226af32996ae771f65ed4dce017bbba7e26193a' }, "Minimum booking notice", index.h("span", { key: '37dcf44405e2cfe10bc652d35715936f41d78685', class: "label-icon" }, index.h("tooltip-component", { key: '52a11ccbcddb918341c7cad983fb9bdf65b1c86d' }, index.h("info-icon", { key: 'c941288bee95958b40a825944ba2316709f307a1', slot: "tooltip-icon" }), index.h("span", { key: '7d3a9c1f538b1e16c094d78daf4eea1f84084bd7', slot: "tooltip-content" }, "The minimum amount of time in the future that a new booking can be made.")))), showTImePeriodSelector && (index.h("time-period-selector", { id: "min-booking-notice", exportparts: "tps__number-dropdown: nmbn__number-dropdown, tps__number-dropdown-button: nmbn__number-dropdown-button, tps__number-dropdown-content: nmbn__number-dropdown-content, tps__period-dropdown: nmbn__period-dropdown, tps__period-dropdown-button: nmbn__period-dropdown-button, tps__period-dropdown-content: nmbn__period-dropdown-content", timePeriods: ['minute', 'hour', 'day', 'week'], defaultSelectedNumber: this.selectedNumber, defaultSelectedPeriod: this.selectedPeriod })))));
    }
...
//# sourceMappingURL=nylas-min-booking-notice.cjs.entry.js.map