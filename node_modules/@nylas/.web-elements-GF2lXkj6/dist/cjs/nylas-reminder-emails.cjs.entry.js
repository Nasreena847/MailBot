...
const NylasReminderEmails = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ab55690228cfba67a2efeec1e9d899ac254e6830' }, index.h("div", { key: '5f73b959d33a1b9e8bb2d498d4275c52e0db68a9', class: "cards-container" }, this.reminders.map((reminder, index$1) => {
            return (index.h("div", { class: "nylas-reminder-email", part: "nre" }, index.h("div", { class: "header", part: "nre__header" }, index.h("div", null, index.h("h3", null, "Upcoming meeting", organizerName ? ` with ${organizerName} ` : ''), index.h("p", null, "Reminder before event")), this.editingReminderIndex !== index$1 ? (index.h("button-component", { variant: 'basic', key: `edit-${index$1} `, clickHandler: event => {
                    event.preventDefault();
                    this.editingReminderIndex = index$1;
                } }, index.h("edit-icon", { width: "16", height: "16" }), "Edit")) : (index.h("button-component", { variant: 'basic', class: "delete-btn", key: `delete -${index$1} `, clickHandler: event => {
                    event.preventDefault();
                    this.deleteReminder(index$1);
                } }, index.h("trash-icon", { width: "16", height: "16" })))), this.editingReminderIndex === index$1 ? (index.h("div", { class: "nylas-reminder-email__body", part: "nre__body" }, index.h("div", { class: "nylas-reminder-email__section" }, index.h("div", { class: "nylas-reminder-email__row" }, index.h("label", null, "Send confirmation email when", index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, "You and your guests will receive a confirmation immediately after your booking is set up.")))), index.h("nylas-reminder-time", { name: `reminder-time-${index$1}`, eventReminderTimeMinutes: reminder.reminder_minutes, exportparts: "nrt, nrt__input_dropdown: nre__reminder-input_dropdown,\n                          nrt__input_dropdown-input: nre__reminder-input_dropdown-input,\n                          nrt__input_dropdown-content: nre__reminder-input_dropdown-content,\n                          " }))))) : (index.h("div", { class: "nylas-reminder-email__summary", part: "nre__summary" }, index.h("p", null, index.h("span", { class: "summary-icon" }, index.h("person-clipboard-icon", null)), "All host & guests"), index.h("p", null, index.h("span", { class: "summary-icon" }, index.h("clock-icon", null)), this.formatReminderTime(reminder.reminder_minutes), " before the event")))));
        })), index.h("button-component", { key: 'ddae28a87961fba5adb5d277f481eed232fda9e7', class: "create-reminder", variant: 'basic', clickHandler: event => {
                event.preventDefault();
                this.addReminder();
            } }, index.h("plus-icon", { key: 'f04020b8af5545c51af40108cf32aaba5c67ea4c', width: "16", height: "16" }), "New reminder")));
    }
