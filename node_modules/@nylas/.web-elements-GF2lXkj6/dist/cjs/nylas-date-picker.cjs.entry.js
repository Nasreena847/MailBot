...
const NylasDatePicker = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '3e6dd28572687991de4841d639c5bdbd5d2d6e0b', part: "ndp" }, index$1.h("div", { key: 'b8a31231d9e04035c468f9c025bbd3adb4f0dbb2', class: "nylas-date-picker" }, index$1.h("div", { key: 'c25024241ce71fb94bcc485cc32614c820a69fee', class: "title", part: "ndp__title" }, this.configSettings?.name ? (index$1.h("h1", null, this.configSettings?.name)) : (this.configSettings?.organizer?.name && (index$1.h("h1", null, index$1.h("person-icon", null), this.configSettings?.organizer?.name || 'Organizer'))), index$1.h("p", { key: 'f51da2bb7f8b5d6b84ea5a9ea66aef03b9e10e12' }, index$1.h("clock-icon", { key: '42a947b00a14afe7c57c716e37ef4d418e55e337' }), this.eventDuration ? utils.convertMinutesToHoursAndMinutes(this.eventDuration) : `- ${utils.instance.t('time.minutes')}`)), index$1.h("div", { key: 'bb264f745cbe51ece10238e3a2f3fae55d2f1bdb', class: 'header flex-row' }, index$1.h("h2", { key: '16ecbac96e4ede32b8b524a645f96e30d16e2814', part: 'ndp__month-header' }, index$1.h("strong", { key: 'aaf8064ac4ebd41680fb4c147b5a23fc7e5554f2' }, utils.translateMonth(this.month.toLocaleDateString(undefined, { month: 'long' }).toLocaleLowerCase())), "\u00A0", this.month.toLocaleDateString(undefined, { year: 'numeric' })), index$1.h("div", { key: '8d5fdca1f4de5d8b75c89ebf6bc6d964b39b8351', class: 'pagination' }, index$1.h("button", { key: '9a993814c06483337caea097727932aa75e53243', onClick: () => this.changeMonth(-1), class: { 'chevron-left': true, 'button': true }, disabled: !this.selectableDates?.length || this.month <= new Date(), part: "ndp__month-button" }, index$1.h("chevron-icon", { key: 'edd3668dee154cb573cf3ed25e72beb2938cb9d2' })), index$1.h("button", { key: '9452edc29c45e8ff24f76521b94762f128201ba0', onClick: () => this.changeMonth(1), class: { 'chevron-right': true, 'button': true }, disabled: this.disableNextMonthButton, part: "ndp__month-button" }, index$1.h("chevron-icon", { key: '1f27334ee808470e844f8f08c4fd4dfc39376b2d' })))), index$1.h("div", { key: '4173feb8a2661c49d0c898864886db0f90f6a181', class: 'dates' }, [
