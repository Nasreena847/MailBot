...
const NylasListThreads = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd816c7e52e789537b3dacded7568af8edc55187a' }, index.h("div", { key: '4416ef73829c085f716af0114a34c971914d1452', class: 'list-thread', part: "list-thread" }, this.state === 'loading' && new Array(10).fill(0).map((_, i) => index.h("div", { class: "thread loading", style: { animationDelay: `${i * 20}ms` } })), this.state === 'ready' &&
