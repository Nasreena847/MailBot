...
const InputColorPicker = class {
    ...
    render() {
        return (index.h("div", { key: '145dabea01809c210829fc3cdc4882793b38a154', class: "color-picker-container", part: "icp_color-picker", tabindex: "0", onKeyDown: e => this.handleKeyDown(e) }, index.h("input", { key: '4ee61547ce9d051d2066fdcbcb1ebd048a8444cf', type: "color", ref: el => (this.inputRef = el), id: this.name, name: this.name, value: this.selectedColor, tabindex: "-1", onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), onInput: e => this.handleInput(e), onChange: e => this.handleChange(e), onKeyDown: e => this.handleKeyDown(e) }), index.h("label", { key: '9473f60a27db4bb073c740df461ea2f276890ddb', part: "icp_color-picker-button", htmlFor: this.name, class: { labelBtn: true, open: this.isOpen, error: !!this.errorMessage }, "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-label": this.name }, index.h("span", { key: '3e10c11d8dae028ca965da307f06a51c6c71cf40', class: "selected-option", part: "icp_color-picker-button-selected-label" }, this.selectedColor || 'Select a color'), index.h("span", { key: 'bfbe7728225a7e6203189ae4da06fc4abf4f4ec4', class: {
                open: this.isOpen,
                closed: !this.isOpen,
                chevron: true,
            }, "aria-hidden": "true" }, index.h("chevron-icon", { key: '99d0dc5de95436ef6ca79421026debda57c32390', width: "16", height: "16" })), this.errorMessage && index.h("span", { class: "error help-text" }, this.errorMessage))));
    }
