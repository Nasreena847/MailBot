...
const mailboxStore = require('./mailbox-store-f0ea7359.js');
...
const NylasProvider = class {
    ...
    render() {
        return (index.h(index.Host, { key: '671c0ea5bf56f2f4aecda072cc66e54c0d907810' }, index.h("slot", { key: 'db8ea221069d45a5dfd9ee570ab7e8880a4bd6e1' })));
    }
