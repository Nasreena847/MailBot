...
const InputImageUrl = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c8569ab945369f897bc13436ecdee791b5204484' }, index.h("div", { key: '2a48916d7d61bb62cdb2f7e2cf690746c3c08db2', class: "logo-container" }, index.h("div", { key: '39494f8e807bbddd67fbb7148cfac66c00a00b49', class: "input-container" }, index.h("input-component", { key: '1a4a4c588a0e40e44858ea295b2e0467b8be4116', name: this.name, id: this.name, type: "text", required: false, exportparts: "ic_input: iiu__logo-input-textfield", defaultValue: this.imageUrl ?? '' }), this.errorMessage && index.h("span", { class: "error-message" }, this.errorMessage)), this.currentImageUrl && !this.errorMessage && (index.h("div", { class: "logo" }, index.h("img", { src: this.currentImageUrl, alt: "Logo" }))))));
    }
