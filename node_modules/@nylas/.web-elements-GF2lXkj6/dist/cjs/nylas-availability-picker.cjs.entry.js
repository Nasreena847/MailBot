...
const NylasAvailabilityPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3dc91eb1ac8799dd655a98a15483e19e871106e0' }, index.h("div", { key: '9e0ed987cb5d3eca99f929b25aff1703151942c6', class: "nylas-availability-picker", part: "nap" }, !this.hideHeader && (index.h("div", { class: "header", part: "nap__header" }, index.h("h3", null, "Default open hours"), index.h("p", null, "Set when you're regularly available for event bookings.", index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, "This is the default availability for participants who don\u2019t have availability set on the Participants tab."))))), index.h("div", { key: 'db01b76095efb7b3d583ce42166468e429a46ae1', class: "content" }, index.h("div", { key: 'd60e0b06d1a65ea27c7ed7a282852a8596618e26', class: "select-timezone", part: "nap__select-timezone" }, index.h("h4", { key: 'aff3ba9f3d1bb51a1dc8593a9d308620f1521136', class: "sub-header" }, "Select timezone"), selectedTimezoneOption?.label && (index.h("select-dropdown", { name: "timezone", exportparts: "sd_dropdown: nap__timezone-container, sd_dropdown-button: nap__timezone-button, sd_dropdown-content: nap__timezone-dropdown-content", options: timezoneOptions, defaultSelectedOption: selectedTimezoneOption }, index.h("span", { slot: "select-icon" }, index.h("globe-icon", { width: "20", height: "20" }))))), index.h("div", { key: 'b1c0208279b5a9e93ecf0a3f9f627e9f48faced3', class: "availability", part: "nap__availability" }, Object.keys(this.schedule).map(key => {
            const day = key;
