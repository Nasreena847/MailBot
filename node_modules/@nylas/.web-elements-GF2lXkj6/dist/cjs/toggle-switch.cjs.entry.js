...
const ToggleSwitchComponent = class {
    ...
    render() {
        return (index.h("label", { key: 'c23c77986617f95474b950d7e34e0c8fde52de8e', class: "switch", part: "ts_label" }, index.h("input", { key: 'e1d164a9413c00949a1e29f12c45a9bdc9ba04e1', type: "checkbox", part: "ts_input", name: this.name, checked: this.isChecked, onChange: () => this.toggleCheck() }), index.h("div", { key: 'cfa88bfbb93261ffdf1344c4cb78fcfc8b71dd28', class: "slider round", part: "ts_slider" })));
    }
};
