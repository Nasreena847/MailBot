...
const CheckboxComponent = class {
    ...
    render() {
        return (index.h("div", { key: '2e9457e9cc43e9361637d4e7d708d5ed7bcc81e7', class: "checkbox-container" }, index.h("label", { key: '3c67d580d1c99e55651d819d8412164f3f781853' }, index.h("input", { key: '01d2fd66e344ab9465cf1899327f5ee25deb6d8d', type: "checkbox", name: this.name, checked: this.isChecked, onChange: () => this.toggleCheck() }), index.h("span", { key: '67f17754686147fcfdaf20fdf779f4bb2a213e09', class: "checkmark" }), index.h("slot", { key: '4ee5c4d97e1911c0481a7983fd5893be14d27656', name: "label" }, index.h("span", { key: '387fd51b12ae65d1a68436146dd71fcad6a67e88', class: "label" }, this.label))), this.error && index.h("p", { class: "error" }, this.error)));
    }
...
//# sourceMappingURL=checkbox-component_2.cjs.entry.js.map