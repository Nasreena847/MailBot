...
const TextareaComponent = class {
    ...
    render() {
        return (index.h("label", { key: 'fe5c08ffc334bbf3018b5d092cfa3c0dc3493366', part: "tc__label", class: { error: !!this.error } }, index.h("p", { key: '7d572a5c200d968902be56c8915d8da4e27454a7' }, index.h("span", { key: 'ab9b1b67451ed46b4e1d6ccf9403d7cca51b6028', class: "label" }, this.label), this.required && index.h("span", { class: "required" }, "*"), this.tooltip && (index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, this.tooltip)))), index.h("textarea", { key: 'c71b3cc7cac22ce0d153f4c6ac57b7cd7f5732c6', name: this.name, placeholder: this.placeholder, readOnly: this.readOnly, autoFocus: this.autoFocus, value: this.value, maxLength: this.maxLength, onInput: e => this.handleInput(e), class: { error: !!this.error }, part: "tc__textarea" }), this.error && index.h("span", { class: "error help-text" }, this.error)));
    }
};
