...
const NylasEventTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ddbaad83ef3b89e8886159d54d111656d22bb569' }, index.h("div", { key: '14e58026518fbc1b39428ecb349227d08e39649f', class: "nylas-event-title", part: "net" }, index.h("label", { key: '6be82638ef054e754e0a62c899e49457c2683cdb', htmlFor: "title" }, "Event title", index.h("span", { key: '99b30dd44c7e9d699415fd2a19e916e37b84f61f', class: "required" }, "*")), index.h("div", { key: 'bb6f400465244cc57f7b013a26ca1238fa0f3b7b', class: {
                title: true,
                error: this.validationError !== '',
            }, part: "net__title", ref: el => (this.titleRef = el), contentEditable: "true", onInput: e => this.handleChange(e), onKeyDown: event => this.handleInputKeyDown(event) }), this.showTokens && this.filteredTokens?.length > 0 && (index.h("div", { class: "token-options", part: "net__dropdown-content" }, index.h("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-activedescendant": this.ariaActivedescendant }, this.filteredTokens.map(option => (index.h("li", { tabindex: "0", key: option.label, id: option.label, class: { active: this.ariaActivedescendant === option.label }, onClick: e => this.selectOption(e, option), role: "option" }, this.getLabelHTML(option.labelHTML))))))), index.h("span", { key: '3d3769b779354dbd20677ba2a469a283f03ebb51', class: "help-text" }, "Create a dynamic templated event title by typing ", index.h("code", { key: '22a80e53a91ba2acc833b1a18b2c375385b76c88' }, "$"), " and selecting a template item.", index.h("span", { key: '315a5202f520ffb55497870b929042504d4e061b', class: "label-icon" }, index.h("tooltip-component", { key: 'b0d6824ae5774208b9ee452cf81baa93450be186' }, index.h("info-icon", { key: '4d30bdf0f2dcc3e1822684aabf7807729da84efa', slot: "tooltip-icon" }), index.h("span", { key: '06de17977e06f7f4829f617b35cd870553085ad6', slot: "tooltip-content" }, "For example, Interview with ", index.h("code", { key: '602df431370083924e6d90a9562556ffc6e3f9cd' }, '${invitee}'))))), this.validationError != '' && index.h("span", { class: "error-message" }, this.validationError))));
    }
