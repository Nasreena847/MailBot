...
const NylasListFolders = class {
    ...
    getFolderIcon(folder) {
        switch (folder.name?.toLowerCase()) {
            ...
            case 'trash':
                return index.h("trash-fill-icon", null);
            default:
                return index.h("folder-icon", null);
        }
    }
    render() {
        return (index.h(index.Host, { key: 'a8d69bd6e13d02c05b067eacf505b4e938876fb5' }, index.h("div", { key: 'fcae4f615d8c0ea48c401711d368deb68916cd3f', class: "folders" }, this.defaultFolders?.map(folder => (index.h("sp-button", { onClick: () => this.folderSelectedHandler(folder), class: {
                folder: true,
