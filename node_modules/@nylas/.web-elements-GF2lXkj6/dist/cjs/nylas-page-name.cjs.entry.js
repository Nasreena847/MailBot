...
const NylasPageName = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ecc02efdb8a8bdbbb3f22b73bcc6da7f6d8cf51e' }, index.h("div", { key: '68e438d12f257af2dd7ffa2bf618341c40886c1c', class: "nylas-page-name", part: "nces" }, index.h("div", { key: '79bce81e542edd4c3c18d36166ba0415b4350d74', class: "header", part: "nces__header" }, index.h("div", { key: '469c49d9f187e91eac36a72f060b5b5ca2bd81f4' }, index.h("h3", { key: '1e0f14a2e77c379a2ecc50ff78ac74da50c05beb' }, "Page name"), index.h("p", { key: '22c5b83c8fd35ec234493d0d2b714acebd3f65d6' }, "Set the Scheduling Page name.", index.h("tooltip-component", { key: '4ddb31291ff706c4cabfe44ffdbcf03c9bbe6a64' }, index.h("info-icon", { key: '8cef9609071d45a31e9f1af183b806ab836ee126', slot: "tooltip-icon" }), index.h("span", { key: '751a6cfa087a26b7a787523e25b492955daff8c4', slot: "tooltip-content" }, "By default, Scheduling Pages use your user name as the Page name. The Page name is displayed in the top-left corner of the calendar view.")))), this.showToggle && (index.h("div", { class: "drawer-toggle", part: "nces__drawer-toggle--container" }, index.h("span", { class: `chevron ${this.isOpen ? 'open' : 'closed'} `, onClick: () => this.toggleDrawer() }, index.h("chevron-icon", { width: "24", height: "24" }))))), this.isOpen && (index.h("div", { class: "nylas-page-name__body", part: "nces__body" }, index.h("div", { class: "nylas-page-name__section" }, index.h("div", { class: "nylas-page-name__row" }, index.h("div", { class: "input-container" }, index.h("div", { class: "nylas-page-name__input-wrapper" }, isComponentReady && (index.h("input-component", { name: "page-name", id: "page-name", type: "text", required: false, exportparts: "ic_input: npn__input-textfield", defaultValue: this.currentPageName ?? '' })))))))))));
    }
