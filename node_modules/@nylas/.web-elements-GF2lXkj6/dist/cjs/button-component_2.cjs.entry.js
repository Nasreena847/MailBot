...
const ButtonComponent = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '8e535c0a5cb3be758941eee5ac5bf9b1e65b9e42', class: className, disabled: this.disabled, type: "type", onClick: this.clickHandler, onMouseOver: this.mouseOverHandler, onMouseOut: this.mouseOutHandler, onFocus: this.focusHandler, onBlur: this.blurHandler }, !!this.isLoading && index.h("loading-icon", { slot: "icon" }), index.h("slot", { key: 'cc75d33abd248961336b47c5ae558c87d1ddce1e' })));
    }
};
...
const LoadingIcon = class {
    ...
    render() {
        return (index.h("div", { key: '5ff9aa86f4d346ab894e59e1a4b96756a5f38231', class: "wave" }, index.h("div", { key: '35fa4038e2be7d2a18e65ada70f40f2d2e1001e8', class: "dot" }), index.h("div", { key: 'f16983cd2790b6a781cdb71e317046f7fa27c264', class: "dot" }), index.h("div", { key: 'c03e50ae47d23c1caa2c9c5c19f6d1ae274de1b7', class: "dot" })));
    }
};
LoadingIcon.style = LoadingIconStyle0;

exports.button_component = ButtonComponent;
exports.loading_icon = LoadingIcon;

//# sourceMappingURL=button-component_2.cjs.entry.js.map