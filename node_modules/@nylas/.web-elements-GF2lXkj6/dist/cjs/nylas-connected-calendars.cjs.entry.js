...
const NylasConnectedCalendars = class {
    ...
    render() {
        return (index.h(index.Host, { key: '93c9e0b22219deb57d1eb08f1ffa3057c1f11e2d' }, index.h("div", { key: 'fbd05348502ca5f1bf16cdcabe57486afed5ff08', class: "nylas-connected-calendars", part: "npca" }, index.h("div", { key: 'c83d17fa00cca611b100cb17f327af5a4841fec6', class: "header", part: "npca__header" }, index.h("h3", { key: '563228be14edc1cfd8c9cb2c4da74f7384b6824c' }, "Connected Calendars"), index.h("p", { key: 'f9349bbbd8769616744fc125b22f0d50ff340c48' }, "Select the calendars to use for checking your availability.", index.h("tooltip-component", { key: 'b119f309472799d0d7b882cdcf079e0e5fad63ce' }, index.h("info-icon", { key: 'f065051277ec70042dcebc59b0baaf0b7c8a7fc3', slot: "tooltip-icon" }), index.h("span", { key: '3dcad6fcad23ba112d4167fee874a41363ed79ea', slot: "tooltip-content" }, "Check availability across one or more calendars. If you select multiple calendars for a participant, the participant must be available across all of their calendars to be considered available.")))), index.h("div", { key: 'd313e98a65f0dc8a5c8ad12d3d2a301263fe6121', class: "content", part: "npca__content" }, index.h("form", { key: '0e71e357eefb86c6d60e932793a779e7f4d48ead', ref: el => (this.connectedCalendarsFormRef = el) }, Object.keys(this.participantCalendars).map((key, index$1) => {
            const participant = this.selectedCalendars[key];
            const participantCalendars = this.participantCalendars[key];
            if (!participant || !participant.name)
                return;
            return (index.h("div", { class: "participant-container", part: "npca__participant-container", key: `participant-conatiner-${index$1}` }, index.h("div", { class: "participant-title", part: "npca__participant-title" }, index.h("p", null, participant.name, "'s connected calendars"), index.h("div", { class: "participant-toggle", part: "npca__participant-toggle--container" }, index.h("span", { class: `chevron ${participant.isOpen ? 'open' : 'closed'}`, onClick: () => {
