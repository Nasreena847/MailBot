...
const NylasConfirmationEmail = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '45c17e9e7aee29bb1c2f434c547bacc8eb119347' }, index.h("div", { key: '47ea049446b8367af0b37d53a800df7f8f52e1f9', class: "nylas-confirmation-email", part: "nce" }, index.h("div", { key: '3d8af814db748d28f89fb2e4e6bf4cecb07484cc', class: "header", part: "nce__header" }, index.h("div", { key: '76c89e5f36c21588a3b081c0515eecda50a6779d' }, index.h("h3", { key: '241c08c263ac3ebfd50edf55f4bfcf9c7a7e7792' }, this.confirmationEmail?.booking_confirmed?.title ?? `Booking confirmed with ${organizerName ? ` ${organizerName}` : ''}`), index.h("p", { key: '999546d36a35d90b1dc4ccee069dbdf0bf58e433' }, "Booking confirmation email")), this.isConfirmationEmailOpen ? (index.h("div", { class: "confirmation-email-toggle", part: "nce__confirmation-email-toggle--container" }, index.h("span", { class: `chevron ${this.isConfirmationEmailOpen ? 'open' : 'closed'} `, onClick: () => this.toggleConfirmationEmail() }, index.h("chevron-icon", { width: "24", height: "24" })))) : (index.h("button-component", { variant: 'basic', clickHandler: event => {
                event.preventDefault();
                this.toggleConfirmationEmail();
            } }, index.h("edit-icon", { width: "16", height: "16" }), "Edit"))), this.isConfirmationEmailOpen ? (index.h("div", { class: "nylas-confirmation-email__body", part: "nce__body" }, index.h("div", { class: "nylas-confirmation-email__section" }, index.h("div", { class: "nylas-confirmation-email__row" }, index.h("label", null, "Send confirmation email", index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, "You and your guests will receive a confirmation email immediately upon booking.")))), index.h("span", { class: "selected-value" }, "Immediately upon booking")), index.h("div", { class: "nylas-confirmation-email__row" }, index.h("div", { class: "subsection" }, index.h("div", { class: "input-container" }, index.h("label", null, "Company logo URL", index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, "This logo appears in the booking confirmation email. The URL must be publicly accessible. The image will be scaled down to a max size of 200px x 100px.")))), this.confirmationEmail && (index.h("input-image-url", { name: "confirmation-email-logo", exportparts: "iiu__logo-input-textfield: nce__input-image-url", imageUrl: this.confirmationEmail?.logo ?? '' }))))), index.h("div", { class: "nylas-confirmation-email__row full-width-col" }, index.h("div", { class: "subsection" }, index.h("h3", null, "Email message"), index.h("div", { class: "input-container" }, index.h("label", { htmlFor: "title" }, "Custom email title", index.h("span", { class: "label-icon" }, index.h("tooltip-component", null, index.h("info-icon", { slot: "tooltip-icon" }), index.h("span", { slot: "tooltip-content" }, "An email title is a headline within the body of the email. This doesn't change the subject line.")))), index.h("input-component", { name: "confirmation-email-title", maxLength: 60, placeholder: `Booking confirmed ${organizerName ? `with ${organizerName}` : ''}`, defaultValue: this.confirmationEmail?.booking_confirmed?.title ?? '' })), index.h("div", { class: "input-container" }, index.h("textarea-component", { label: "Additional info", name: "confirmation-email-body", id: "confirmation-email-body", placeholder: "Default body", tooltip: "Scheduler adds the content of the box to the email body.", maxLength: 500, defaultValue: this.confirmationEmail?.booking_confirmed?.body ?? '' }))))))) : (index.h("div", { class: "nylas-confirmation-email__summary", part: "nce__summary" }, index.h("p", null, index.h("span", { class: "summary-icon" }, index.h("person-clipboard-icon", null)), "All host & guests"), index.h("p", null, index.h("span", { class: "summary-icon" }, index.h("clock-icon", null)), "Immediately on booking"))))));
    }
