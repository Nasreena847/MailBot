...
const NylasMinCancellationNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b66d9592b00bdbcb61790d80b2f09ea36e2d0a11' }, index.h("div", { key: 'ff7591ebe4ea54db90a0dbf350e523f237cd47cf', class: "nylas-min-cancellation-notice", part: "nmcn" }, index.h("label", { key: '8f1470f500d43e58bc4abd7870965cf5255a91a0' }, "Minimum cancellation notice", index.h("span", { key: 'f484893c1016b2817d880050cd48e25d97de9cd3', class: "label-icon" }, index.h("tooltip-component", { key: '187f651c1b430a63e85df46434c8a8fe626dc9ca' }, index.h("info-icon", { key: '1d8a5cdff1e60ff4bb9a4315c699f760e0b1538b', slot: "tooltip-icon" }), index.h("span", { key: 'd45935b4c6b25e90b1d7cd9950fb2513d1f01296', slot: "tooltip-content" }, "The minimum amount of time required to cancel a booking.")))), showTimePeriodSelector && (index.h("time-period-selector", { id: "min-cancellation-notice", exportparts: "tps__number-dropdown: nmcn__number-dropdown, tps__number-dropdown-button: nmcn__number-dropdown-button, tps__number-dropdown-content: nmcn__number-dropdown-content, tps__period-dropdown: nmcn__period-dropdown, tps__period-dropdown-button: nmcn__period-dropdown-button, tps__period-dropdown-content: nmcn__period-dropdown-content", timePeriods: ['minute', 'hour', 'day', 'week'], defaultSelectedNumber: this.selectedNumber, defaultSelectedPeriod: this.selectedPeriod })))));
    }
