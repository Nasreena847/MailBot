...
const InputDropdown = class {
    ...
    render() {
        return (index.h("div", { key: 'fa0347bf09ec791976c3628837a400ffce06f785', class: "dropdown", part: "id_dropdown" }, index.h("input", { key: 'd18704609aa859f705397ca57a0d491a8f09ed99', type: "text", name: this.name, id: this.name, part: "id_dropdown-input", class: { dropbtn: true, open: this.isOpen }, value: this.inputValue, onClick: (e) => {
                this.toggleDropdown();
                this.shouldAutoScroll = true;
                this.handleClick(e);
