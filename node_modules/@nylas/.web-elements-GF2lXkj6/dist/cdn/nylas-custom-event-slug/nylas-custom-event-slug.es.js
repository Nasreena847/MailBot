...
let ot, Qn, Tt, Su = !1, sn = !1, Ar = !1, me = !1, ui = null, Xn = !1;
const Ze = (n, e = "") => () => {
}, hg = "slot-fb{display:contents}slot-fb[hidden]{display:none}", si = "http://www.w3.org/1999/xlink", oi = {}, gg = "http://www.w3.org/2000/svg", pg = "http://www.w3.org/1999/xhtml", mg = (n) => n != null, Br = (n) => (n = typeof n, n === "object" || n === "function");
function bg(n) {
  var e, t, r;
...
const _ = (n, e, ...t) => {
  ...
  const a = [], l = (d) => {
    for (let f = 0; f < d.length; f++)
      r = d[f], Array.isArray(r) ? l(r) : r != null && typeof r != "boolean" && ((s = typeof n != "function" && !Br(r)) && (r = String(r)), s && o ? a[a.length - 1].$text$ += r : a.push(s ? on(null, r) : r), o = s);
  };
  if (l(t), e) {
...
}, Cu = {}, yg = (n) => n && n.$tag$ === Cu, xg = {
  forEach: (n, e) => n.map(ai).forEach(e),
  map: (n, e) => n.map(ai).map(e).map(vg)
}, ai = (n) => ({
  vattrs: n.$attrs$,
  ...
  if (typeof n.vtag == "function") {
    ...
    return n.vkey && (t.key = n.vkey), n.vname && (t.name = n.vname), _(n.vtag, t, ...n.vchildren || []);
  }
  const e = on(n.vtag, n.vtext);
  return e.$attrs$ = n.vattrs, e.$children$ = n.vchildren, e.$key$ = n.vkey, e.$name$ = n.vname, e;
}, wg = (n) => Vg.map((e) => e(n)).find((e) => !!e), Eg = (n, e) => n != null && !Br(n) ? e & 4 ? n === "false" ? !1 : n === "" || !!n : e & 2 ? parseFloat(n) : e & 1 ? String(n) : n : n, en = (n) => n, tn = (n, e, t) => {
  const r = en(n);
  return {
    emit: (i) => kg(r, e, {
      bubbles: !!(t & 4),
...
}, li = /* @__PURE__ */ new WeakMap(), Tg = (n, e, t) => {
  let r = ln.get(n);
  Zg && t ? (r = r || new CSSStyleSheet(), typeof r == "string" ? r = e : r.replaceSync(e)) : r = e, ln.set(n, r);
}, $g = (n, e, t) => {
  var r;
  const i = Au(e, t), u = ln.get(i);
  if (n = n.nodeType === 11 ? n : $e, u)
    if (typeof u == "string") {
      n = n.head || n;
      let s = li.get(n), o;
      if (s || li.set(n, s = /* @__PURE__ */ new Set()), !s.has(i)) {
        {
          o = $e.createElement("style"), o.innerHTML = u;
          const a = (r = ae.$nonce$) !== null && r !== void 0 ? r : bg($e);
          a != null && o.setAttribute("nonce", a), n.insertBefore(o, n.querySelector("link"));
        }
        e.$flags$ & 4 && (o.innerHTML += hg), s && s.add(i);
      }
    } else n.adoptedStyleSheets.includes(u) || (n.adoptedStyleSheets = [...n.adoptedStyleSheets, u]);
  return i;
}, Sg = (n) => {
  const e = n.$cmpMeta$, t = n.$hostElement$, r = e.$flags$, i = Ze("attachStyles", e.$tagName$), u = $g(t.shadowRoot ? t.shadowRoot : t.getRootNode(), e, n.$modeName$);
  r & 10 && (t["s-sc"] = u, t.classList.add(u + "-h"), r & 2 && t.classList.add(u + "-s")), i();
}, Au = (n, e) => "sc-" + (e && n.$flags$ & 32 ? n.$tagName$ + "-" + e : n.$tagName$), ci = (n, e, t, r, i, u) => {
  if (t !== r) {
    let s = pi(n, e), o = e.toLowerCase();
    if (e === "class") {
      const a = n.classList, l = fi(t), c = fi(r);
      ...
      if (e === "ref")
        ...
        if (e[2] === "-" ? e = e.slice(3) : pi(Cn, o) ? e = o.slice(2) : e = o[2] + e.slice(3), t || r) {
          const a = e.endsWith(Bu);
        ...
        let l = !1;
        o !== (o = o.replace(/^xlink\:?/, "")) && (e = o, l = !0), r == null || r === !1 ? (r !== !1 || n.getAttribute(e) === "") && (l ? n.removeAttributeNS(si, e) : n.removeAttribute(e)) : (!s || u & 4 || i) && !a && (r = r === !0 ? "" : r, l ? n.setAttributeNS(si, e, r) : n.setAttribute(e, r));
      }
  }
}, Cg = /\s/, fi = (n) => n ? n.split(Cg) : [], Bu = "Capture", Ag = new RegExp(Bu + "$"), Iu = (n, e, t, r) => {
  const i = e.$elm$.nodeType === 11 && e.$elm$.host ? e.$elm$.host : e.$elm$, u = n && n.$attrs$ || oi, s = e.$attrs$ || oi;
  for (r in u)
    r in s || ci(i, r, u[r], void 0, t, e.$flags$);
  for (r in s)
    ci(i, r, u[r], s[r], t, e.$flags$);
}, an = (n, e, t, r) => {
  const i = e.$children$[t];
  let u = 0, s, o, a;
  if (Su || (Ar = !0, i.$tag$ === "slot" && (ot && r.classList.add(ot + "-s"), i.$flags$ |= i.$children$ ? (
    ...
    if (me || (me = i.$tag$ === "svg"), s = i.$elm$ = $e.createElementNS(me ? gg : pg, i.$flags$ & 2 ? "slot-fb" : i.$tag$), me && i.$tag$ === "foreignObject" && (me = !1), Iu(null, i, me), mg(ot) && s["s-si"] !== ot && s.classList.add(s["s-si"] = ot), i.$children$)
      for (u = 0; u < i.$children$.length; ++u)
        o = an(n, i, u, s), o && s.appendChild(o);
    i.$tag$ === "svg" ? me = !1 : s.tagName === "foreignObject" && (me = !0);
  }
  return s["s-hn"] = Tt, i.$flags$ & 3 && (s["s-sr"] = !0, s["s-cr"] = Qn, s["s-sn"] = i.$name$ || "", a = n && n.$children$ && n.$children$[t], a && a.$tag$ === i.$tag$ && n.$elm$ && $t(n.$elm$, !1)), s;
}, $t = (n, e) => {
  ae.$flags$ |= 1;
  ...
  for (s.shadowRoot && s.tagName === Tt && (s = s.shadowRoot); i <= u; ++i)
    r[i] && (o = an(null, t, i, n), o && (r[i].$elm$ = o, s.insertBefore(o, Ir(e))));
}, Ou = (n, e, t) => {
  for (let r = e; r <= t; ++r) {
    const i = n[r];
    if (i) {
      const u = i.$elm$;
      _u(i), u && (sn = !0, u["s-ol"] ? u["s-ol"].remove() : $t(u, !0), u.remove());
    }
  }
}, Bg = (n, e, t, r, i = !1) => {
  ...
  for (; u <= l && s <= f; )
    if (c == null)
      ...
      at(c, g, i), c = e[++u], g = r[++s];
    else if (jt(d, b, i))
      at(d, b, i), d = e[--l], b = r[--f];
    else if (jt(c, b, i))
      (c.$tag$ === "slot" || b.$tag$ === "slot") && $t(c.$elm$.parentNode, !1), at(c, b, i), n.insertBefore(c.$elm$, d.$elm$.nextSibling), c = e[++u], b = r[--f];
    else if (jt(d, g, i))
      (c.$tag$ === "slot" || b.$tag$ === "slot") && $t(d.$elm$.parentNode, !1), at(d, g, i), n.insertBefore(d.$elm$, c.$elm$), d = e[--l], g = r[++s];
    else {
      for (o = -1, a = u; a <= l; ++a)
      ...
      for (r = t.length - 1; r >= 0; r--)
        if (e = t[r], !e["s-cn"] && !e["s-nr"] && e["s-hn"] !== i["s-hn"] && !Ye.experimentalSlotFixes)
          if (di(e, u)) {
            ...
            sn = !0, e["s-sn"] = e["s-sn"] || u, s ? (s.$nodeToRelocate$["s-sh"] = i["s-hn"], s.$slotRefNode$ = i) : (e["s-sh"] = i["s-hn"], je.push({
              $slotRefNode$: i,
              $nodeToRelocate$: e
            })), e["s-sr"] && je.map((o) => {
              di(o.$nodeToRelocate$, e["s-sn"]) && (s = je.find((a) => a.$nodeToRelocate$ === e), s && !o.$slotRefNode$ && (o.$slotRefNode$ = s.$slotRefNode$));
            });
...
}, di = (n, e) => n.nodeType === 1 ? n.getAttribute("slot") === null && e === "" || n.getAttribute("slot") === e : n["s-sn"] === e ? !0 : e === "", _u = (n) => {
  n.$attrs$ && n.$attrs$.ref && n.$attrs$.ref(null), n.$children$ && n.$children$.map(_u);
}, Ig = (n, e, t = !1) => {
  var r, i, u, s, o;
  const a = n.$hostElement$, l = n.$cmpMeta$, c = n.$vnode$ || on(null, null), d = yg(e) ? e : _(null, null, e);
  if (Tt = a.tagName, l.$attrsToReflect$ && (d.$attrs$ = d.$attrs$ || {}, l.$attrsToReflect$.map(([f, g]) => d.$attrs$[g] = a[f])), t && d.$attrs$)
    for (const f of Object.keys(d.$attrs$))
      a.hasAttribute(f) && !["key", "ref", "style", "class"].includes(f) && (d.$attrs$[f] = a[f]);
  d.$tag$ = null, d.$flags$ |= 4, n.$vnode$ = d, d.$elm$ = c.$elm$ = a.shadowRoot || a, ot = a["s-sc"], Qn = a["s-cr"], Su = (l.$flags$ & 1) !== 0, sn = !1, at(c, d, t);
  {
    if (ae.$flags$ |= 1, Ar) {
      Nu(d.$elm$);
      for (const f of je) {
      ...
      for (const f of je) {
        ...
        if (b) {
          ...
          let p = b.nextSibling;
          {
            let A = (r = g["s-ol"]) === null || r === void 0 ? void 0 : r.previousSibling;
            for (; A; ) {
  ...
  if (Ye.experimentalScopedSlotChanges && l.$flags$ & 2)
    for (const f of d.$elm$.childNodes)
      f["s-hn"] !== Tt && !f["s-sh"] && (t && f["s-ih"] == null && (f["s-ih"] = (o = f.hidden) !== null && o !== void 0 ? o : !1), f.hidden = !0);
  Qn = void 0;
}, Dg = (n, e) => {
  ...
  try {
    ui = e, e = e.render && e.render(), n.$flags$ &= -17, n.$flags$ |= 2, (Ye.hasRenderFn || Ye.reflect) && (Ye.vdomRender || Ye.reflect) && (Ye.hydrateServerSide || Ig(n, e, r));
  } catch (a) {
    _t(a, n.$hostElement$);
  }
  return ui = null, null;
...
}, Pg = (n, e) => Nt(n).$instanceValues$.get(e), Lg = (n, e, t, r) => {
  const i = Nt(n), u = n, s = i.$instanceValues$.get(e), o = i.$flags$, a = u;
  t = Eg(t, r.$members$[e][0]);
        ...
        ae.jmp(() => {
          ...
          if (this.hasOwnProperty(d))
            ...
            if (i.hasOwnProperty(d) && typeof this[d] == "number" && this[d] == l)
              return;
            if (d == null) {
              const f = Nt(this), g = f == null ? void 0 : f.$flags$;
              if (g && !(g & 8) && g & 128 && l !== a) {
  ...
  if (!(e.$flags$ & 32) && (e.$flags$ |= 32, i = n.constructor, customElements.whenDefined(t.$tagName$).then(() => e.$flags$ |= 128), i.style)) {
    let s = i.style;
    typeof s != "string" && (s = s[e.$modeName$ = wg(n)]);
    const o = Au(t, e.$modeName$);
    if (!ln.has(o)) {
      const a = Ze("registerStyles", t.$tagName$);
      Tg(o, s, !!(t.$flags$ & 1)), a();
    }
  }
  e.$ancestorComponent$, Pu(e, !0);
}, gi = (n) => {
}, jg = (n) => {
  if (!(ae.$flags$ & 1)) {
    const e = Nt(n), t = e.$cmpMeta$, r = Ze("connectedCallback", t.$tagName$);
    e.$flags$ & 1 ? (Lu(n, e, t.$listeners$), e != null && e.$lazyInstance$ ? gi(e.$lazyInstance$) : e != null && e.$onReadyPromise$ && e.$onReadyPromise$.then(() => gi(e.$lazyInstance$))) : (e.$flags$ |= 1, // TODO(STENCIL-854): Remove code related to legacy shadowDomShim field
    t.$flags$ & 12 && qg(n), t.$members$ && Object.entries(t.$members$).map(([i, [u]]) => {
  ...
  return Object.assign(n.prototype, {
    ...
    connectedCallback() {
      jg(this), r && r.call(this);
    },
    disconnectedCallback() {
      Hg(this), i && i.call(this);
    },
    __attachShadow() {
      this.attachShadow({
        mode: "open",
  ...
  }), n.is = t.$tagName$, Fg(n, t);
}, Lu = (n, e, t, r) => {
  t && t.map(([i, u, s]) => {
    const o = zg(n, i), a = Yg(e, s), l = Wg(i);
...
}, zg = (n, e) => e & 4 ? $e : e & 8 ? Cn : e & 16 ? $e.body : n, Wg = (n) => Kg ? {
  passive: (n & 1) !== 0,
  capture: (n & 2) !== 0
} : (n & 2) !== 0, Fu = /* @__PURE__ */ new WeakMap(), Nt = (n) => Fu.get(n), Gg = (n, e) => {
  const t = {
    $flags$: 0,
    $hostElement$: n,
    $cmpMeta$: e,
  ...
  return Lu(n, t, e.$listeners$), Fu.set(n, t);
}, pi = (n, e) => e in n, _t = (n, e) => (0, console.error)(n, e), ln = /* @__PURE__ */ new Map(), Vg = [], Cn = typeof window < "u" ? window : {}, $e = Cn.document || { head: {} }, tt = Cn.HTMLElement || class {
}, ae = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (n) => n(),
  ...
  return n;
})(), Jg = (n) => Promise.resolve(n), Zg = /* @__PURE__ */ (() => {
  try {
  ...
  n.push(t), Xn || (Xn = !0, e && ae.$flags$ & 4 ? Xg(er) : ae.raf(er));
}, bi = (n) => {
...
function np(n) {
  ...
  u = n[o - 2] === "=" ? 2 : n[o - 1] === "=" ? 1 : 0, s = new tp(o * 3 / 4 - u), r = u > 0 ? o - 4 : o;
  var a = 0;
...
function ip(n, e, t) {
  for (var r, i = [], u = e; u < t; u += 3)
    r = (n[u] << 16) + (n[u + 1] << 8) + n[u + 2], i.push(rp(r));
  return i.join("");
}
function xi(n) {
  Dr || ju();
...
var up = {}.toString, Hu = Array.isArray || function(n) {
  return up.call(n) == "[object Array]";
};
/*!
...
function Yu(n, e, t, r) {
  ...
  return typeof ArrayBuffer < "u" && e instanceof ArrayBuffer ? lp(n, e, t, r) : typeof e == "string" ? ap(n, e, t) : cp(n, e);
}
$.from = function(n, e, t) {
  return Yu(null, n, e, t);
};
...
function op(n, e, t, r) {
  return zu(e), e <= 0 ? qe(n, e) : t !== void 0 ? typeof r == "string" ? qe(n, e).fill(t, r) : qe(n, e).fill(t) : qe(n, e);
}
...
function cp(n, e) {
  ...
  if (e) {
    if (typeof ArrayBuffer < "u" && e.buffer instanceof ArrayBuffer || "length" in e)
      return typeof e.length != "number" || Bp(e.length) ? qe(n, 0) : nr(n, e);
...
$.prototype.toString = function() {
  var e = this.length | 0;
  return e === 0 ? "" : arguments.length === 0 ? Ku(this, 0, e) : fp.apply(this, arguments);
};
...
function Vu(n, e, t, r) {
  return Dn(Cp(e), n, t, r);
}
function gp(n, e, t, r) {
  return Vu(n, e, t, r);
}
function pp(n, e, t, r) {
  return Dn(Xu(e), n, t, r);
}
function mp(n, e, t, r) {
  return Dn(Ap(e, n.length - t), n, t, r);
}
...
$.prototype.writeUInt16LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 2, 65535, 0), $.TYPED_ARRAY_SUPPORT ? (this[t] = e & 255, this[t + 1] = e >>> 8) : Bn(this, e, t, !0), t + 2;
};
$.prototype.writeUInt16BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 2, 65535, 0), $.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = e & 255) : Bn(this, e, t, !1), t + 2;
};
function In(n, e, t, r) {
...
$.prototype.writeUInt32LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 4, 4294967295, 0), $.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = e & 255) : In(this, e, t, !0), t + 4;
};
$.prototype.writeUInt32BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 4, 4294967295, 0), $.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = e & 255) : In(this, e, t, !1), t + 4;
};
...
$.prototype.writeInt16LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 2, 32767, -32768), $.TYPED_ARRAY_SUPPORT ? (this[t] = e & 255, this[t + 1] = e >>> 8) : Bn(this, e, t, !0), t + 2;
};
$.prototype.writeInt16BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 2, 32767, -32768), $.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = e & 255) : Bn(this, e, t, !1), t + 2;
};
$.prototype.writeInt32LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 4, 2147483647, -2147483648), $.TYPED_ARRAY_SUPPORT ? (this[t] = e & 255, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : In(this, e, t, !0), t + 4;
};
$.prototype.writeInt32BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ge(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), $.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = e & 255) : In(this, e, t, !1), t + 4;
};
...
function Zu(n, e, t, r, i) {
  return i || Ju(n, e, t, 4), qu(n, e, t, r, 23, 4), t + 4;
}
...
function Qu(n, e, t, r, i) {
  return i || Ju(n, e, t, 8), qu(n, e, t, r, 52, 8), t + 8;
}
...
$.prototype.fill = function(e, t, r, i) {
  ...
  if (typeof e == "number")
    ...
    var o = _e(e) ? e : cn(new $(e, i).toString()), a = o.length;
    for (s = 0; s < r - t; ++s)
      this[s + t] = o[s % a];
  }
  return this;
};
var kp = /[^+\/0-9A-Za-z-_]/g;
function Tp(n) {
  if (n = $p(n).replace(kp, ""), n.length < 2) return "";
  for (; n.length % 4 !== 0; )
    n = n + "=";
  return n;
}
...
function Ip(n) {
  return n != null && (!!n._isBuffer || es(n) || Dp(n));
}
function es(n) {
  return !!n.constructor && typeof n.constructor.isBuffer == "function" && n.constructor.isBuffer(n);
}
function Dp(n) {
  return typeof n.readFloatLE == "function" && typeof n.slice == "function" && es(n.slice(0, 0));
}
...
(function(n, e) {
  (function(t, r) {
    ...
    var t = 1e3, r = 6e4, i = 36e5, u = "millisecond", s = "second", o = "minute", a = "hour", l = "day", c = "week", d = "month", f = "quarter", g = "year", b = "date", T = "Invalid Date", p = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, A = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, O = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(w) {
    ...
    return H.prototype = S, [["$ms", u], ["$s", s], ["$m", o], ["$H", a], ["$W", l], ["$M", d], ["$y", g], ["$D", b]].forEach(function(w) {
      S[w[1]] = function(v) {
...
var Rp = function(n, e, t) {
...
}, Np = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], ts = 1e3 * 60 * 60 * 24, ns = 9999, rs = Qe(1970, 1, 1), _p = [6, 0, 1, 2, 3, 4, 5], Et = function(n) {
  return n % 4 === 0 && n % 100 !== 0 || n % 400 === 0;
}, is = function(n) {
  return n instanceof Date;
}, vt = function(n) {
  return is(n) && !isNaN(n.getTime());
}, ki = function(n) {
  return n.getTimezoneOffset() * 60 * 1e3;
}, Pp = function(n, e) {
  var t = n.getTime() - ki(n), r = e.getTime() - ki(e), i = t - r;
  return Math.round(i / ts);
}, ir = function(n) {
  return Pp(n, rs);
}, us = function(n) {
  return new Date(rs.getTime() + n * ts);
}, Lp = function(n) {
  var e = n.getUTCMonth();
  return e === 1 && Et(n.getUTCFullYear()) ? 29 : Np[e];
}, ft = function(n) {
  return _p[n.getUTCDay()];
}, Ti = function(n, e) {
  var t = Qe(n, e + 1, 1);
  return [ft(t), Lp(t)];
}, ss = function(n, e) {
  ...
  var t = Intl.DateTimeFormat().resolvedOptions().timeZone, r = new Date(Si(n, t)), i = new Date(Si(n, e ?? "UTC")), u = i.getTime() - r.getTime();
...
var Ci = (
  ...
  function() {
    function n(e, t, r, i) {
      if (t === void 0 && (t = Up), r === void 0 && (r = fn), i === void 0 && (i = jp), this.text = [], this.language = r || fn, this.gettext = t, this.dateFormatter = i, this.rrule = e, this.options = e.options, this.origOptions = e.origOptions, this.origOptions.bymonthday) {
...
var Hp = function(n, e) {
  return e === void 0 && (e = fn), new P(os(n, e) || void 0);
}, pt = [
  "count",
  "until",
  "interval",
...
He.IMPLEMENTED = [];
He.IMPLEMENTED[G.HOURLY] = pt;
He.IMPLEMENTED[G.MINUTELY] = pt;
He.IMPLEMENTED[G.DAILY] = ["byhour"].concat(pt);
He.IMPLEMENTED[G.WEEKLY] = pt;
He.IMPLEMENTED[G.MONTHLY] = pt;
He.IMPLEMENTED[G.YEARLY] = ["byweekno", "byyearday"].concat(pt);
var Yp = function(n, e, t, r) {
  return new He(n, e, t, r).toString();
}, zp = He.isFullyConvertible, dn = (
  /** @class */
  function() {
    function n(e, t, r, i) {
  ...
  function(n) {
    ...
    return e.fromDate = function(t) {
      ...
      for (r && (this.hour += Math.floor((23 - this.hour) / t) * t); ; ) {
        this.hour += t;
        var u = qn(this.hour, 24), s = u.div, o = u.mod;
        if (s && (this.hour = o, this.addDaily(s)), Oe(i) || Q(i, this.hour))
          break;
      }
    }, e.prototype.addMinutes = function(t, r, i, u) {
      for (r && (this.minute += Math.floor((1439 - (this.hour * 60 + this.minute)) / t) * t); ; ) {
        this.minute += t;
        var s = qn(this.minute, 60), o = s.div, a = s.mod;
        if (o && (this.minute = a, this.addHours(o, !1, i)), (Oe(i) || Q(i, this.hour)) && (Oe(u) || Q(u, this.minute)))
          break;
      }
      ...
      for (r && (this.second += Math.floor((86399 - (this.hour * 3600 + this.minute * 60 + this.second)) / t) * t); ; ) {
        ...
        if (a && (this.second = l, this.addMinutes(a, !1, i, u)), (Oe(i) || Q(i, this.hour)) && (Oe(u) || Q(u, this.minute)) && (Oe(s) || Q(s, this.second)))
          break;
      }
      ...
      if (!(this.day <= 28)) {
        ...
        if (!(this.day <= t))
          for (; this.day > t; ) {
            if (this.day -= t, ++this.month, this.month === 13 && (this.month = 1, ++this.year, this.year > ns))
              return;
...
function as(n) {
  for (var e = [], t = Object.keys(n), r = 0, i = t; r < i.length; r++) {
    var u = i[r];
    Q(Em, u) || e.push(u), is(n[u]) && !vt(n[u]) && e.push(u);
  }
  if (e.length)
...
function Gp(n) {
  var e = xe(xe({}, Lr), as(n));
  if (te(e.byeaster) && (e.freq = P.YEARLY), !(te(e.freq) && P.FREQUENCIES[e.freq]))
    throw new Error("Invalid frequency: ".concat(e.freq, " ").concat(n.freq));
  if (e.dtstart || (e.dtstart = new Date((/* @__PURE__ */ new Date()).setMilliseconds(0))), te(e.wkst) ? Ie(e.wkst) || (e.wkst = e.wkst.weekday) : e.wkst = P.MO.weekday, te(e.bysetpos)) {
  ...
  return te(e.byhour) ? Ie(e.byhour) && (e.byhour = [e.byhour]) : e.byhour = e.freq < P.HOURLY ? [e.dtstart.getUTCHours()] : null, te(e.byminute) ? Ie(e.byminute) && (e.byminute = [e.byminute]) : e.byminute = e.freq < P.MINUTELY ? [e.dtstart.getUTCMinutes()] : null, te(e.bysecond) ? Ie(e.bysecond) && (e.bysecond = [e.bysecond]) : e.bysecond = e.freq < P.SECONDLY ? [e.dtstart.getUTCSeconds()] : null, { parsedOptions: e };
}
function Vp(n) {
...
var gn = (
  ...
  function() {
    ...
    return Object.defineProperty(n.prototype, "isUTC", {
      ...
      return this.isUTC ? this.date : Fp(this.date, this.tzid);
    }, n;
  }()
);
function ar(n) {
  for (var e = [], t = "", r = Object.keys(n), i = Object.keys(Lr), u = 0; u < r.length; u++)
    if (r[u] !== "tzid" && Q(i, r[u])) {
...
function Qp(n, e) {
  return n ? "DTSTART" + new gn(new Date(n), e).toString() : "";
}
function Xp(n, e) {
...
var em = (
  ...
  function() {
    ...
    return n.prototype._cacheAdd = function(e, t, r) {
      t && (t = t instanceof Date ? ur(t) : $i(t)), e === "all" ? this.all = t : (r._value = t, this[e].push(r));
      ...
      return be(r) ? $i(r) : r instanceof Date ? ur(r) : r;
    }, n;
  }()
), tm = C(C(C(C(C(C(C(C(C(C(C(C(C([], W(1, 31), !0), W(2, 28), !0), W(3, 31), !0), W(4, 30), !0), W(5, 31), !0), W(6, 30), !0), W(7, 31), !0), W(8, 31), !0), W(9, 30), !0), W(10, 31), !0), W(11, 30), !0), W(12, 31), !0), W(1, 7)), nm = C(C(C(C(C(C(C(C(C(C(C(C(C([], W(1, 31), !0), W(2, 29), !0), W(3, 31), !0), W(4, 30), !0), W(5, 31), !0), W(6, 30), !0), W(7, 31), !0), W(8, 31), !0), W(9, 30), !0), W(10, 31), !0), W(11, 30), !0), W(12, 31), !0), W(1, 7)), rm = Pe(1, 29), im = Pe(1, 30), ze = Pe(1, 31), se = Pe(1, 32), um = C(C(C(C(C(C(C(C(C(C(C(C(C([], se, !0), im, !0), se, !0), ze, !0), se, !0), ze, !0), se, !0), se, !0), ze, !0), se, !0), ze, !0), se, !0), se.slice(0, 7)), sm = C(C(C(C(C(C(C(C(C(C(C(C(C([], se, !0), rm, !0), se, !0), ze, !0), se, !0), ze, !0), se, !0), se, !0), ze, !0), se, !0), ze, !0), se, !0), se.slice(0, 7)), om = Pe(-28, 0), am = Pe(-29, 0), We = Pe(-30, 0), oe = Pe(-31, 0), lm = C(C(C(C(C(C(C(C(C(C(C(C(C([], oe, !0), am, !0), oe, !0), We, !0), oe, !0), We, !0), oe, !0), oe, !0), We, !0), oe, !0), We, !0), oe, !0), oe.slice(0, 7)), cm = C(C(C(C(C(C(C(C(C(C(C(C(C([], oe, !0), om, !0), oe, !0), We, !0), oe, !0), We, !0), oe, !0), oe, !0), We, !0), oe, !0), We, !0), oe, !0), oe.slice(0, 7)), fm = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366], dm = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365], Di = function() {
  for (var n = [], e = 0; e < 55; e++)
    n = n.concat(Pe(7));
  return n;
}();
function hm(n, e) {
  var t = Qe(n, 1, 1), r = Et(n) ? 366 : 365, i = Et(n + 1) ? 366 : 365, u = ir(t), s = ft(t), o = xe(xe({ yearlen: r, nextyearlen: i, yearordinal: u, yearweekday: s }, gm(n)), { wnomask: null });
  if (Oe(e.byweekno))
    return o;
  o.wnomask = W(0, r + 7);
  ...
  for (var d = Math.floor(l / 7), f = Ee(l, 7), g = Math.floor(d + f / 4), b = 0; b < e.byweekno.length; b++) {
    ...
    if (T < 0 && (T += g + 1), T > 0 && T <= g) {
      ...
      for (var A = 0; A < 7 && (o.wnomask[p] = 1, p++, o.wdaymask[p] !== e.wkst); A++)
        ;
    }
  }
  if (Q(e.byweekno, 1)) {
  ...
  if (c) {
    ...
    if (Q(e.byweekno, -1))
      ...
      var Y = ft(Qe(n - 1, 1, 1)), D = Ee(7 - Y.valueOf() + e.wkst, 7), F = Et(n - 1) ? 366 : 365, U = void 0;
      D >= 4 ? (D = 0, U = F + Ee(Y - e.wkst, 7)) : U = r - c, O = Math.floor(52 + Ee(U, 7) / 4);
    }
    if (Q(e.byweekno, O))
      for (var p = 0; p < c; p++)
        o.wnomask[p] = 1;
...
function gm(n) {
  var e = Et(n) ? 366 : 365, t = Qe(n, 1, 1), r = ft(t);
  return e === 365 ? {
    mmask: tm,
    mdaymask: sm,
    nmdaymask: cm,
...
function mm(n, e) {
  e === void 0 && (e = 0);
  var t = n % 19, r = Math.floor(n / 100), i = n % 100, u = Math.floor(r / 4), s = r % 4, o = Math.floor((r + 8) / 25), a = Math.floor((r - o + 1) / 3), l = Math.floor(19 * t + r - u - a + 15) % 30, c = Math.floor(i / 4), d = i % 4, f = Math.floor(32 + 2 * s + 2 * c - l - d) % 7, g = Math.floor((t + 11 * l + 22 * f) / 451), b = Math.floor((l + f - 7 * g + 114) / 31), T = (l + f - 7 * g + 114) % 31 + 1, p = Date.UTC(n, b - 1, T + e), A = Date.UTC(n, 0, 1);
  return [Math.ceil((p - A) / (1e3 * 60 * 60 * 24))];
}
var bm = (
  /** @class */
  function() {
    ...
    return n.prototype.rebuild = function(e, t) {
      var r = this.options;
      if (e !== this.lastyear && (this.yearinfo = hm(e, r)), re(r.bynweekday) && (t !== this.lastmonth || e !== this.lastyear)) {
        var i = this.yearinfo, u = i.yearlen, s = i.mrange, o = i.wdaymask;
        this.monthinfo = pm(e, t, u, s, o, r);
      }
      te(r.byeaster) && (this.eastermask = mm(e, r.byeaster));
      ...
      for (var r = this.mrange[t - 1], i = this.mrange[t], u = W(null, this.yearlen), s = r; s < i; s++)
        u[s] = s;
      return [u, r, i];
    }, n.prototype.wdayset = function(e, t, r) {
      for (var i = W(null, this.yearlen + 7), u = ir(Qe(e, t, r)) - this.yearordinal, s = u, o = 0; o < 7 && (i[u] = u, ++u, this.wdaymask[u] !== this.options.wkst); o++)
        ;
      return [i, s, u];
    }, n.prototype.ddayset = function(e, t, r) {
      var i = W(null, this.yearlen), u = ir(Qe(e, t, r)) - this.yearordinal;
      ...
      var u = this.options.bysecond.map(function(s) {
        return new dn(e, t, s, i);
      });
      return St(u), u;
    }, n.prototype.stimeset = function(e, t, r, i) {
      return [new dn(e, t, r, i)];
...
function ym(n, e, t, r, i, u) {
  for (var s = [], o = 0; o < n.length; o++) {
    ...
    var T = e[l], p = us(i.yearordinal + b), A = ss(p, T);
    Q(s, A) || s.push(A);
  }
  return St(s), s;
}
function ls(n, e) {
  ...
  if (o === 0 || i === 0)
    return Le(n);
  var a = Wp.fromDate(t), l = new bm(e);
  l.rebuild(a.year, a.month);
  for (var c = wm(l, a, e); ; ) {
    var d = l.getdayset(r)(a.year, a.month, a.day), f = d[0], g = d[1], b = d[2], T = vm(f, g, b, l, e);
    if (re(s))
      for (var p = ym(s, c, g, b, l, f), A = 0; A < p.length; A++) {
        var O = p[A];
        if (u && O > u)
          return Le(n);
        if (O >= t) {
      ...
      for (var A = g; A < b; A++) {
        var D = f[A];
        if (te(D))
          for (var F = us(l.yearordinal + D), U = 0; U < c.length; U++) {
            var z = c[U], O = ss(F, z);
            if (u && O > u)
              return Le(n);
            if (O >= t) {
    ...
    if (e.interval === 0 || (a.add(e, T), a.year > ns))
      return Le(n);
    Pr(r) || (c = l.gettimeset(r)(a.hour, a.minute, a.second, 0)), l.rebuild(a.year, a.month);
  }
}
function xm(n, e, t) {
  var r = t.bymonth, i = t.byweekno, u = t.byweekday, s = t.byeaster, o = t.bymonthday, a = t.bynmonthday, l = t.byyearday;
  return re(r) && !Q(r, n.mmask[e]) || re(i) && !n.wnomask[e] || re(u) && !Q(u, n.wdaymask[e]) || re(n.nwdaymask) && !n.nwdaymask[e] || s !== null && !Q(n.eastermask, e) || (re(o) || re(a)) && !Q(o, n.mdaymask[e]) && !Q(a, n.nmdaymask[e]) || re(l) && (e < n.yearlen && !Q(l, e + 1) && !Q(l, -n.yearlen + e) || e >= n.yearlen && !Q(l, e + 1 - n.yearlen) && !Q(l, -n.nextyearlen + e - n.yearlen));
}
function Oi(n, e) {
  return new gn(n, e.tzid).rezonedDate();
}
function Le(n) {
  return n.getValue();
}
function vm(n, e, t, r, i) {
  for (var u = !1, s = e; s < t; s++) {
    var o = n[s];
    u = xm(r, o, i), u && (n[o] = null);
  }
  return u;
}
function wm(n, e, t) {
  var r = t.freq, i = t.byhour, u = t.byminute, s = t.bysecond;
  return Pr(r) ? Vp(t) : r >= P.HOURLY && re(i) && !Q(i, e.hour) || r >= P.MINUTELY && re(u) && !Q(u, e.minute) || r >= P.SECONDLY && re(s) && !Q(s, e.second) ? [] : n.gettimeset(r)(e.hour, e.minute, e.second, e.millisecond);
}
var Te = {
  MO: new fe(0),
  TU: new fe(1),
  ...
  function() {
    function n(e, t) {
      e === void 0 && (e = {}), t === void 0 && (t = !1), this._cache = t ? null : new em(), this.origOptions = as(e);
    ...
    return n.parseText = function(e, t) {
      ...
      if (i)
        return this._iter(new Ci("between", u, i));
      var s = this._cacheGet("between", u);
      return s === !1 && (s = this._iter(new lt("between", u)), this._cacheAdd("between", s, u)), s;
...
function km(n, e, t, r, i, u) {
  ...
  for (var l = 0; l < r.length; l++) {
    var c = new gn(r[l], u).rezonedDate();
...
function Tm(n, e) {
  var t = [], r = [], i = [], u = [], s = hn(n), o = s.dtstart, a = s.tzid, l = Bm(n, e.unfold);
    ...
    if (c) {
      ...
      switch (g.toUpperCase()) {
        case "RRULE":
          ...
          break;
        case "RDATE":
          var p = (d = /RDATE(?:;TZID=([^:=]+))?/i.exec(c)) !== null && d !== void 0 ? d : [], A = p[1];
...
function $m(n, e) {
  var t = Tm(n, e), r = t.rrulevals, i = t.rdatevals, u = t.exrulevals, s = t.exdatevals, o = t.dtstart, a = t.tzid, l = e.cache === !1;
  if (e.compatible && (e.forceset = !0, e.unfold = !0), e.forceset || r.length > 1 || i.length || u.length || s.length) {
    ...
    return c.dtstart(o), c.tzid(a || void 0), r.forEach(function(f) {
      c.rrule(new P(Hn(f, o, a), l));
    }), i.forEach(function(f) {
      c.rdate(f);
    }), u.forEach(function(f) {
      c.exrule(new P(Hn(f, o, a), l));
...
function Am(n) {
  var e = Cm(n), t = e.name, r = e.value, i = t.split(";");
  if (!i)
...
var Dm = (
  ...
  function(n) {
    ...
    function e(t) {
      ...
      return r.dtstart = _i.apply(r, ["dtstart"]), r.tzid = _i.apply(r, ["tzid"]), r._rrule = [], r._rdate = [], r._exrule = [], r._exdate = [], r;
    }
    return e.prototype._iter = function(t) {
      return km(t, this._rrule, this._exrule, this._rdate, this._exdate, this.tzid());
...
`).map(function(i) {
      ...
      }), this._rdate.length && t.push(Fi("RDATE", this._rdate, this.tzid())), this._exdate.length && t.push(Fi("EXDATE", this._exdate, this.tzid())), t;
...
class pn {
  ...
  init(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.prefix = t.prefix || "i18next:", this.logger = e || Om, this.options = t, this.debug = t.debug;
  }
  log() {
...
function ji(n, e, t) {
  ...
  let u = e[e.length - 1], s = e.slice(0, e.length - 1), o = kt(n, s, Object);
  for (; o.obj === void 0 && s.length; )
    u = `${s[s.length - 1]}.${u}`, s = s.slice(0, s.length - 1), o = kt(n, s, Object), o && o.obj && typeof o.obj[`${o.k}.${u}`] < "u" && (o.obj = void 0);
  o.obj[`${o.k}.${u}`] = t;
}
function Nm(n, e, t, r) {
  const {
...
function cs(n, e, t) {
  for (const r in e)
    r !== "__proto__" && r !== "constructor" && (r in n ? typeof n[r] == "string" || n[r] instanceof String || typeof e[r] == "string" || e[r] instanceof String ? t && (n[r] = e[r]) : cs(n[r], e[r], t) : n[r] = e[r]);
  return n;
}
function it(n) {
  return n.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
...
const Um = [" ", ",", "?", "!", ";"], jm = new Fm(20);
function qm(n, e, t) {
  e = e || "", t = t || "";
  const r = Um.filter((s) => e.indexOf(s) < 0 && t.indexOf(s) < 0);
  if (r.length === 0) return !0;
  const i = jm.getRegExp(`(${r.map((s) => s === "?" ? "\\?" : s).join("|")})`);
  let u = !i.test(n);
  if (!u) {
    const s = n.indexOf(t);
...
class qi extends Mn {
  ...
  getResource(e, t, r) {
    ...
    return !a && !t && !r && e.indexOf(".") > -1 && (e = o[0], t = o[1], r = o.slice(2).join(".")), a || !s || typeof r != "string" ? a : lr(this.data && this.data[e] && this.data[e][t], r, u);
  }
  addResource(e, t, r, i) {
    ...
    let o = [e, t];
    r && (o = o.concat(s ? r.split(s) : r)), e.indexOf(".") > -1 && (o = e.split("."), i = t, t = o[1]), this.addNamespaces(t), ji(this.data, o, i), u.silent || this.emit("added", e, t, r, i);
  }
  addResources(e, t, r) {
    let i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, t, r, i, u) {
    ...
    s.skipCopy || (r = JSON.parse(JSON.stringify(r))), i ? cs(a, r, u) : a = {
      ...a,
      ...r
    }, ji(this.data, o, a), s.silent || this.emit("added", e, t, r);
  }
...
class yn extends Mn {
  ...
  extractFromKey(e, t) {
    ...
    const s = r && e.indexOf(r) > -1, o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !qm(e, r, i);
    if (s && !o) {
  ...
  translate(e, t, r) {
    ...
    let f = d && d.res;
    const g = d && d.usedKey || s, b = d && d.exactUsedKey || s, T = Object.prototype.toString.apply(f), p = ["[object Number]", "[object Function]", "[object RegExp]"], A = t.joinArrays !== void 0 ? t.joinArrays : this.options.joinArrays, O = !this.i18nFormat || this.i18nFormat.handleAsObject;
    if (O && f && (typeof f != "string" && typeof f != "boolean" && typeof f != "number") && p.indexOf(T) < 0 && !(typeof A == "string" && Array.isArray(f))) {
      ...
      if (u) {
        const D = Array.isArray(f), F = D ? [] : {}, U = D ? b : g;
        for (const z in f)
          if (Object.prototype.hasOwnProperty.call(f, z)) {
            const K = `${U}${u}${z}`;
            F[z] = this.translate(K, {
              ...t,
              joinArrays: !1,
              ns: o
            }), F[z] === K && (F[z] = f[z]);
    ...
    } else if (O && typeof A == "string" && Array.isArray(f))
      f = f.join(A), f && (f = this.extendTranslation(f, e, t, r));
    else {
      let D = !1, F = !1;
      ...
      !this.isValidLookup(f) && z && (D = !0, f = y), this.isValidLookup(f) || (F = !0, f = s);
      const w = (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && F ? void 0 : f, v = z && y !== f && this.options.updateMissing;
      if (F || D || v) {
      ...
      f = this.extendTranslation(f, e, t, d, r), F && f === s && this.options.appendNamespaceToMissingKey && (f = `${a}:${s}`), (F || D) && this.options.parseMissingKeyHandler && (this.options.compatibilityAPI !== "v1" ? f = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${s}` : s, D ? f : void 0) : f = this.options.parseMissingKeyHandler(f));
    }
  ...
  extendTranslation(e, t, r, i, u) {
    ...
    return e != null && a && a.length && r.applyPostProcessor !== !1 && (e = fs.handle(a, e, t, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...i,
  ...
  resolve(e) {
    ...
    return typeof e == "string" && (e = [e]), e.forEach((a) => {
      ...
      d.forEach((p) => {
        this.isValidLookup(r) || (o = p, !Hi[`${T[0]}-${p}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(o) && (Hi[`${T[0]}-${p}`] = !0, this.logger.warn(`key "${i}" for languages "${T.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), T.forEach((A) => {
          if (this.isValidLookup(r)) return;
          s = A;
          const O = [c];
          if (this.i18nFormat && this.i18nFormat.addLookupKeys)
            this.i18nFormat.addLookupKeys(O, c, A, p, t);
          else {
            let D;
            f && (D = this.pluralResolver.getSuffix(A, t.count, t));
            const F = `${this.options.pluralSeparator}zero`, U = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (f && (O.push(c + D), t.ordinal && D.indexOf(U) === 0 && O.push(c + D.replace(U, this.options.pluralSeparator)), g && O.push(c + F)), b) {
              const z = `${c}${this.options.contextSeparator}${t.context}`;
              O.push(z), f && (O.push(z + D), t.ordinal && D.indexOf(U) === 0 && O.push(z + D.replace(U, this.options.pluralSeparator)), g && O.push(z + F));
            }
          }
          let Y;
          for (; Y = O.pop(); )
            this.isValidLookup(r) || (u = Y, r = this.getResource(A, p, Y, t));
        }));
      });
    }), {
      res: r,
...
class Vm {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = t, this.logger = Ne.create("pluralResolver"), (!this.options.compatibilityJSON || Wm.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = Gm();
  }
  addRule(e, t) {
    this.rules[e] = t;
  }
  ...
  getSuffixes(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const r = this.getRule(e, t);
    return r ? this.shouldUseIntlApi() ? r.resolvedOptions().pluralCategories.sort((i, u) => zi[i] - zi[u]).map((i) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${i}`) : r.numbers.map((i) => this.getSuffix(e, i, t)) : [];
  }
  getSuffix(e, t) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  shouldUseIntlApi() {
    return !zm.includes(this.options.compatibilityJSON);
  }
}
function Wi(n, e, t) {
  let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", i = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, u = _m(n, e, t);
  return !u && i && typeof t == "string" && (u = lr(n, t, r), u === void 0 && (u = lr(e, t, r))), u;
}
class Km {
  constructor() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  ...
  init() {
    ...
    this.escape = t !== void 0 ? t : Lm, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = i !== void 0 ? i : !1, this.prefix = u ? it(u) : s || "{{", this.suffix = o ? it(o) : a || "}}", this.formatSeparator = l || ",", this.unescapePrefix = c ? "" : d || "-", this.unescapeSuffix = this.unescapePrefix ? "" : c || "", this.nestingPrefix = f ? it(f) : g || it("$t("), this.nestingSuffix = b ? it(b) : T || it(")"), this.nestingOptionsSeparator = p || ",", this.maxReplaces = A || 1e3, this.alwaysFormat = O !== void 0 ? O : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, t, r, i) {
    ...
    const c = (b) => {
      ...
      const T = b.split(this.formatSeparator), p = T.shift().trim(), A = T.join(this.formatSeparator).trim();
      return this.format(Wi(t, a, p, this.options.keySeparator, this.options.ignoreJSONStructure), A, r, {
        ...i,
        ...t,
        interpolationkey: p
      });
    ...
    return [{
      ...
      for (o = 0; u = b.regex.exec(e); ) {
        ...
        else typeof s != "string" && !this.useRawValueToEscape && (s = Ui(s));
  ...
  nest(e, t) {
    ...
    for (; i = this.nestingRegexp.exec(e); ) {
      ...
      typeof u != "string" && (u = Ui(u)), u || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), u = ""), l && (u = a.reduce((c, d) => this.format(c, d, r.lng, {
        ...r,
...
class Xm extends Mn {
  ...
  loaded(e, t, r) {
    ...
    this.queue.forEach((a) => {
      Nm(a.loaded, [u], s), Qm(a, e), t && a.errors.push(t), a.pendingCount === 0 && !a.done && (Object.keys(a.loaded).forEach((l) => {
        o[l] || (o[l] = {});
        const c = a.loaded[l];
...
class Ct extends Mn {
  constructor() {
    ...
    if (super(), this.options = Vi(e), this.services = {}, this.logger = Ne, this.modules = {
      external: []
    }, eb(this), t && !this.isInitialized && !e.isClone) {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      let c;
      this.modules.formatter ? c = this.modules.formatter : typeof Intl < "u" && (c = Zm);
      const d = new Yi(this.options);
      this.store = new qi(this.options.resources, this.options);
      const f = this.services;
      f.logger = Ne, f.resourceStore = this.store, f.languageUtils = d, f.pluralResolver = new Vm(d, {
        prepend: this.options.pluralSeparator,
        compatibilityJSON: this.options.compatibilityJSON,
        simplifyPluralSuffix: this.options.simplifyPluralSuffix
      }), c && (!this.options.interpolation.format || this.options.interpolation.format === i.interpolation.format) && (f.formatter = u(c), f.formatter.init(f, this.options), this.options.interpolation.format = f.formatter.format.bind(f.formatter)), f.interpolator = new Km(this.options), f.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, f.backendConnector = new Xm(u(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", function(g) {
    ...
    if (this.format = this.options.interpolation.format, r || (r = qt), this.options.fallbackLng && !this.services.languageDetector && !this.options.lng) {
  ...
  loadResources(e) {
    let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : qt;
  ...
  reloadResources(e, t, r) {
    const i = bt();
    return e || (e = this.languages), t || (t = this.options.ns), r || (r = qt), this.services.backendConnector.reload(e, t, (u) => {
      i.resolve(), r(u);
    }), i;
  }
  use(e) {
    ...
    return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && fs.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
  }
  ...
  cloneInstance() {
    ...
    }, r && (u.store = new qi(this.store.data, i), u.services.resourceStore = u.store), u.translator = new yn(u.services, i), u.translator.on("*", function(o) {
...
const ds = Ct.createInstance();
ds.createInstance = Ct.createInstance;
const hs = "No date selected", gs = "Choose another time slot to reschedule your meeting", ps = {
  sunday: "SUN",
  monday: "MON",
  tuesday: "TUE",
  wednesday: "WED",
  ...
  rescheduleBookingButton: Ls,
  rejectBookingButton: Fs,
  confirmBookingButton: Us,
  bookingPendingTitle: js,
  bookingPendingnDescription: qs,
  confirmedEventCardTitle: Hs,
  confirmedEventCardDescription: Ys,
  cancelBookingTitle: zs,
  cancelBookingMessage: Ws,
  reasonForCancellation: Gs,
  goBackButton: Vs,
  bookingCancelledTitle: Ks,
  bookingCancelledMessage: Js,
  closeButton: Zs,
  closingButton: Qs,
  fieldRequired: Xs,
  invalidInputFormat: eo,
  createBookingErrorTitle: to,
  getAvailabilityErrorTitle: no,
  cancelBookingErrorTitle: ro,
  rescheduleBookingErrorTitle: io,
  getUISettingErrorTitle: uo,
  rejectBookingErrorTitle: so,
  confirmBookingErrorTitle: oo,
  ...
  cancelBokingFormError: yo,
  default: tb
}), xo = "Aucune date sélectionnée", vo = "Choisissez un autre créneau horaire pour reprogrammer votre réunion", wo = {
  sunday: "DIM",
  monday: "LUN",
  tuesday: "MAR",
  wednesday: "MER",
  ...
  bookingDateAndTimeHeader: qo,
  cancelBookingButton: Ho,
  rescheduleBookingButton: Yo,
  rejectBookingButton: zo,
  confirmBookingButton: Wo,
  bookingPendingTitle: Go,
  bookingPendingnDescription: Vo,
  ...
  goBackButton: ea,
  bookingCancelledTitle: ta,
  bookingCancelledMessage: na,
  closeButton: ra,
  closingButton: ia,
  fieldRequired: ua,
  invalidInputFormat: sa,
  createBookingErrorTitle: oa,
  getAvailabilityErrorTitle: aa,
  cancelBookingErrorTitle: la,
  rescheduleBookingErrorTitle: ca,
  getUISettingErrorTitle: fa,
  rejectBookingErrorTitle: da,
  confirmBookingErrorTitle: ha,
  genericErrorTitle: ga,
  schedulingComponentErrorTitle: pa,
  sessionIdRequiredErrorMessage: ma,
  publicConfigErrorMessage: ba,
  invalidTimeslotErrorTitle: ya,
  invalidTimeslotErrorMessage: xa,
  cancellationErrorTitle: va,
  cancellationErrorMessage: wa,
  minimumCancellationErrorMessage: Ea,
  cancelBokingFormError: ka
  ...
  cancelBokingFormError: ka,
  default: rb
}), Ta = "No has seleccionado ninguna fecha", $a = "Elige otro horario para reprogramar tu reunión", Sa = {
  sunday: "DOM",
  monday: "LUN",
  tuesday: "MAR",
  wednesday: "MIÉ",
  ...
  bookNowButton: ja,
  bookingConfirmed: qa,
  bookingConfirmedDescription: Ha,
  bookingSent: Ya,
  bookingSentDescription: za,
  bookingRescheduled: Wa,
  bookingDateAndTimeHeader: Ga,
  cancelBookingButton: Va,
  rescheduleBookingButton: Ka,
  rejectBookingButton: Ja,
  confirmBookingButton: Za,
  bookingPendingTitle: Qa,
  bookingPendingnDescription: Xa,
  confirmedEventCardTitle: el,
  confirmedEventCardDescription: tl,
  cancelBookingTitle: nl,
  cancelBookingMessage: rl,
  reasonForCancellation: il,
  goBackButton: ul,
  bookingCancelledTitle: sl,
  bookingCancelledMessage: ol,
  closeButton: al,
  closingButton: ll,
  fieldRequired: cl,
  invalidInputFormat: fl,
  createBookingErrorTitle: dl,
  getAvailabilityErrorTitle: hl,
  cancelBookingErrorTitle: gl,
  rescheduleBookingErrorTitle: pl,
  getUISettingErrorTitle: ml,
  rejectBookingErrorTitle: bl,
  confirmBookingErrorTitle: yl,
  genericErrorTitle: xl,
  schedulingComponentErrorTitle: vl,
  sessionIdRequiredErrorMessage: wl,
  publicConfigErrorMessage: El,
  invalidTimeslotErrorTitle: kl,
  invalidTimeslotErrorMessage: Tl,
  cancellationErrorTitle: $l,
  cancellationErrorMessage: Sl,
  ...
  cancelBokingFormError: Al,
  default: ub
}), Bl = "日付が選択されていません", Il = "別の時間を選択してください", Dl = {
  sunday: "日",
  monday: "月",
  tuesday: "火",
  wednesday: "水",
  ...
  bookNowButton: Wl,
  bookingConfirmed: Gl,
  bookingConfirmedDescription: Vl,
  bookingSent: Kl,
  bookingSentDescription: Jl,
  bookingRescheduled: Zl,
  bookingDateAndTimeHeader: Ql,
  cancelBookingButton: Xl,
  rescheduleBookingButton: ec,
  rejectBookingButton: tc,
  confirmBookingButton: nc,
  bookingPendingTitle: rc,
  bookingPendingnDescription: ic,
  confirmedEventCardTitle: uc,
  confirmedEventCardDescription: sc,
  cancelBookingTitle: oc,
  cancelBookingMessage: ac,
  reasonForCancellation: lc,
  goBackButton: cc,
  bookingCancelledTitle: fc,
  bookingCancelledMessage: dc,
  closeButton: hc,
  closingButton: gc,
  fieldRequired: pc,
  invalidInputFormat: mc,
  createBookingErrorTitle: bc,
  getAvailabilityErrorTitle: yc,
  cancelBookingErrorTitle: xc,
  rescheduleBookingErrorTitle: vc,
  getUISettingErrorTitle: wc,
  rejectBookingErrorTitle: Ec,
  confirmBookingErrorTitle: kc,
  genericErrorTitle: Tc,
  schedulingComponentErrorTitle: $c,
  sessionIdRequiredErrorMessage: Sc,
  ...
  bookingSent: e0,
  bookingSentDescription: t0,
  bookingRescheduled: n0,
  bookingDateAndTimeHeader: r0,
  cancelBookingButton: i0,
  rescheduleBookingButton: u0,
  rejectBookingButton: s0,
  confirmBookingButton: o0,
  bookingPendingTitle: a0,
  bookingPendingnDescription: l0,
  confirmedEventCardTitle: c0,
  confirmedEventCardDescription: f0,
  cancelBookingTitle: d0,
  cancelBookingMessage: h0,
  reasonForCancellation: g0,
  goBackButton: p0,
  bookingCancelledTitle: m0,
  bookingCancelledMessage: b0,
  closeButton: y0,
  closingButton: x0,
  fieldRequired: v0,
  invalidInputFormat: w0,
  createBookingErrorTitle: E0,
  getAvailabilityErrorTitle: k0,
  cancelBookingErrorTitle: T0,
  rescheduleBookingErrorTitle: $0,
  getUISettingErrorTitle: S0,
  rejectBookingErrorTitle: C0,
  confirmBookingErrorTitle: A0,
  ...
  cancelBokingFormError: L0,
  default: lb
}), F0 = "Ingen dag vald", U0 = "Välj en annan tid för att boka om din tid", j0 = {
  sunday: "SÖN",
  monday: "MÅN",
  tuesday: "TIS",
  wednesday: "ONS",
  ...
  bookingSent: sf,
  bookingSentDescription: of,
  bookingRescheduled: af,
  bookingDateAndTimeHeader: lf,
  cancelBookingButton: cf,
  rescheduleBookingButton: ff,
  rejectBookingButton: df,
  confirmBookingButton: hf,
  bookingPendingTitle: gf,
  bookingPendingnDescription: pf,
  confirmedEventCardTitle: mf,
  confirmedEventCardDescription: bf,
  cancelBookingTitle: yf,
  cancelBookingMessage: xf,
  reasonForCancellation: vf,
  goBackButton: wf,
  bookingCancelledTitle: Ef,
  bookingCancelledMessage: kf,
  closeButton: Tf,
  closingButton: $f,
  fieldRequired: Sf,
  ...
  publicConfigErrorMessage: Lf,
  invalidTimeslotErrorTitle: Ff,
  invalidTimeslotErrorMessage: Uf,
  cancellationErrorTitle: jf,
  cancellationErrorMessage: qf,
  minimumCancellationErrorMessage: Hf,
  cancelBokingFormError: Yf
  ...
  cancelBokingFormError: Yf,
  default: fb
}), zf = "请选择日期", Wf = "选择另一个时间段重新安排您的会议", Gf = {
  sunday: "周日",
  monday: "周一",
  tuesday: "周二",
  wednesday: "周三",
  ...
  bookNowButton: ad,
  bookingConfirmed: ld,
  bookingConfirmedDescription: cd,
  bookingSent: fd,
  bookingSentDescription: dd,
  bookingRescheduled: hd,
  bookingDateAndTimeHeader: gd,
  cancelBookingButton: pd,
  rescheduleBookingButton: md,
  rejectBookingButton: bd,
  confirmBookingButton: yd,
  bookingPendingTitle: xd,
  bookingPendingnDescription: vd,
  confirmedEventCardTitle: wd,
  confirmedEventCardDescription: Ed,
  cancelBookingTitle: kd,
  cancelBookingMessage: Td,
  reasonForCancellation: $d,
  goBackButton: Sd,
  bookingCancelledTitle: Cd,
  bookingCancelledMessage: Ad,
  closeButton: Bd,
  closingButton: Id,
  fieldRequired: Dd,
  ...
  rejectBookingErrorTitle: Ld,
  confirmBookingErrorTitle: Fd,
  genericErrorTitle: Ud,
  schedulingComponentErrorTitle: jd,
  sessionIdRequiredErrorMessage: qd,
  publicConfigErrorMessage: Hd,
  invalidTimeslotErrorTitle: Yd,
  invalidTimeslotErrorMessage: zd,
  cancellationErrorTitle: Wd,
  cancellationErrorMessage: Gd,
  minimumCancellationErrorMessage: Vd,
  cancelBokingFormError: Kd
  ...
  cancelBokingFormError: Kd,
  default: hb
}), Jd = "Geen datum geselecteerd", Zd = "Kies een ander tijdslot om je afspraak te verzetten", Qd = {
  sunday: "ZO",
  monday: "MA",
  tuesday: "DI",
  wednesday: "WO",
  ...
  emailPlaceholder: oh,
  guestEmail: ah,
  guestEmailPlaceholder: lh,
  addGuest: ch,
  addAnotherGuest: fh,
  backButton: dh,
  bookNowButton: hh,
  bookingConfirmed: gh,
  bookingConfirmedDescription: ph,
  bookingSent: mh,
  bookingSentDescription: bh,
  bookingRescheduled: yh,
  bookingDateAndTimeHeader: xh,
  cancelBookingButton: vh,
  rescheduleBookingButton: wh,
  rejectBookingButton: Eh,
  confirmBookingButton: kh,
  bookingPendingTitle: Th,
  bookingPendingnDescription: $h,
  confirmedEventCardTitle: Sh,
  ...
  cancellationErrorTitle: Zh,
  cancellationErrorMessage: Qh,
  minimumCancellationErrorMessage: Xh,
  cancelBokingFormError: e1
}, mb = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  noDateSelected: Jd,
  rescheduleTitle: Zd,
  days: Qd,
...
(function(n) {
  ...
  var O = (
    ...
    function() {
      function y(S, w, v) {
        this.decodeTree = S, this.emitCodePoint = w, this.errors = v, this.state = p.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = A.Strict;
      }
  ...
  n.determineBranch = D;
  var F = Y(u.default), U = Y(s.default);
  function z(y, S) {
    return S === void 0 && (S = A.Legacy), F(y, S);
  }
  n.decodeHTML = z;
  function K(y) {
    return F(y, A.Attribute);
  }
...
class t1 {
  ...
  stateBeforeClosingTagName(e) {
    Fe(e) || (e === I.Gt ? this.state = E.Text : (this.state = this.isTagStartChar(e) ? E.InClosingTagName : E.InSpecialComment, this.sectionStart = this.index));
  }
  stateInClosingTagName(e) {
    (e === I.Gt || Fe(e)) && (this.cbs.onclosetag(this.sectionStart, this.index), this.sectionStart = -1, this.state = E.AfterClosingTagName, this.stateAfterClosingTagName(e));
  }
  stateAfterClosingTagName(e) {
    (e === I.Gt || this.fastForwardTo(I.Gt)) && (this.state = E.Text, this.baseState = E.Text, this.sectionStart = this.index + 1);
  }
  stateBeforeAttributeName(e) {
    e === I.Gt ? (this.cbs.onopentagend(this.index), this.isSpecial ? (this.state = E.InSpecialTag, this.sequenceIndex = 0) : this.state = E.Text, this.baseState = this.state, this.sectionStart = this.index + 1) : e === I.Slash ? this.state = E.InSelfClosingTag : Fe(e) || (this.state = E.InAttributeName, this.sectionStart = this.index);
  }
  stateInSelfClosingTag(e) {
    e === I.Gt ? (this.cbs.onselfclosingtag(this.index), this.state = E.Text, this.baseState = E.Text, this.sectionStart = this.index + 1, this.isSpecial = !1) : Fe(e) || (this.state = E.BeforeAttributeName, this.stateBeforeAttributeName(e));
  }
  ...
  stateInHexEntity(e) {
    e === I.Semi ? this.emitNumericEntity(!0) : Ki(e) ? (this.entityResult = this.entityResult * 16 + (e - I.Zero), this.entityExcess++) : yb(e) ? (this.entityResult = this.entityResult * 16 + ((e | 32) - I.LowerA + 10), this.entityExcess++) : (this.allowLegacyEntity() ? this.emitNumericEntity(!1) : this.state = this.baseState, this.index--);
  }
  allowLegacyEntity() {
...
const st = /* @__PURE__ */ new Set([
  ...
  "datalist",
  "textarea"
]), Z = /* @__PURE__ */ new Set(["p"]), Ji = /* @__PURE__ */ new Set(["thead", "tbody"]), Zi = /* @__PURE__ */ new Set(["dd", "dt"]), Qi = /* @__PURE__ */ new Set(["rt", "rp"]), xb = /* @__PURE__ */ new Map([
  ...
  "track",
  "wbr"
]), Xi = /* @__PURE__ */ new Set(["math", "svg"]), eu = /* @__PURE__ */ new Set([
  "mi",
  "mo",
  "mn",
  "ms",
...
class jr {
  ...
  isVoidElement(e) {
    return !this.options.xmlMode && vb.has(e);
  }
  /** @internal */
  onopentagname(e, t) {
    this.endIndex = t;
  ...
  emitOpenTag(e) {
    ...
    const s = !this.options.xmlMode && xb.get(e);
    if (s)
      for (; this.stack.length > 0 && s.has(this.stack[this.stack.length - 1]); ) {
        const o = this.stack.pop();
        (r = (t = this.cbs).onclosetag) === null || r === void 0 || r.call(t, o, !0);
      }
    this.isVoidElement(e) || (this.stack.push(e), Xi.has(e) ? this.foreignContext.push(!0) : eu.has(e) && this.foreignContext.push(!1)), (u = (i = this.cbs).onopentagname) === null || u === void 0 || u.call(i, e), this.cbs.onopentag && (this.attribs = {});
  }
  endOpenTag(e) {
    var t, r;
  ...
  onclosetag(e, t) {
    ...
    if (this.lowerCaseTagNames && (l = l.toLowerCase()), (Xi.has(l) || eu.has(l)) && this.foreignContext.pop(), this.isVoidElement(l))
...
const r1 = V.Root, i1 = V.Text, u1 = V.Directive, s1 = V.Comment, o1 = V.Script, a1 = V.Style, l1 = V.Tag, c1 = V.CDATA, f1 = V.Doctype, Eb = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  get ElementType() {
    return V;
  },
...
function y1(n, e = !1) {
  ...
  if (Xe(n))
    ...
    const r = e ? zn(n.children) : [], i = new dr(r);
    r.forEach((u) => u.parent = i), n["x-mode"] && (i["x-mode"] = n["x-mode"]), t = i;
  } else if (kb(n)) {
    const r = new g1(n.name, n.data);
...
class xn {
   ...
   */
  constructor(e, t, r) {
    this.dom = [], this.root = new dr(this.dom), this.done = !1, this.tagStack = [this.root], this.lastNode = null, this.parser = null, typeof t == "function" && (r = t, t = tu), typeof e == "object" && (t = e, e = void 0), this.callback = e ?? null, this.options = t ?? tu, this.elementCB = r ?? null;
  }
  onparserinit(e) {
    this.parser = e;
  }
  ...
  onopentag(e, t) {
    const r = this.options.xmlMode ? V.Tag : void 0, i = new m1(e, t, void 0, r);
...
const nu = /["&'<>$\x80-\uFFFF]/g, Tb = /* @__PURE__ */ new Map([
  [34, "&quot;"],
  [38, "&amp;"],
  [39, "&apos;"],
  [60, "&lt;"],
...
function x1(n) {
  let e = "", t = 0, r;
  for (; (r = nu.exec(n)) !== null; ) {
    const i = r.index, u = n.charCodeAt(i), s = Tb.get(u);
    s !== void 0 ? (e += n.substring(t, i) + s, t = i + 1) : (e += `${n.substring(t, i)}&#x${$b(n, i).toString(16)};`, t = nu.lastIndex += +((u & 64512) === 55296));
  }
  return e + n.substr(t);
}
function v1(n, e) {
...
const Sb = v1(/["&\u00A0]/g, /* @__PURE__ */ new Map([
  [34, "&quot;"],
  [38, "&amp;"],
  [160, "&nbsp;"]
])), Cb = v1(/[&<>\u00A0]/g, /* @__PURE__ */ new Map([
  [38, "&amp;"],
  [60, "&lt;"],
  [62, "&gt;"],
  [160, "&nbsp;"]
  ...
  "radialGradient",
  "textPath"
].map((n) => [n.toLowerCase(), n])), Bb = new Map([
  "definitionURL",
  "attributeName",
  "attributeType",
  "baseFrequency",
...
function Ob(n, e) {
  ...
  if (!n)
    return;
  const r = ((t = e.encodeEntities) !== null && t !== void 0 ? t : e.decodeEntities) === !1 ? Db : e.xmlMode || e.encodeEntities !== "utf8" ? x1 : Sb;
  return Object.keys(n).map((i) => {
    var u, s;
    const o = (u = n[i]) !== null && u !== void 0 ? u : "";
    return e.xmlMode === "foreign" && (i = (s = Bb.get(i)) !== null && s !== void 0 ? s : i), !e.emptyAttrs && !e.xmlMode && o === "" ? i : `${i}="${r(o)}"`;
  }).join(" ");
}
...
function _b(n, e) {
  ...
  return i && (r += ` ${i}`), n.children.length === 0 && (e.xmlMode ? (
    ...
    e.selfClosingTags && ru.has(n.name)
  )) ? (e.xmlMode || (r += " "), r += "/>") : (r += ">", n.children.length > 0 && (r += zr(n.children, e)), (e.xmlMode || !ru.has(n.name)) && (r += `</${n.name}>`)), r;
}
function Pb(n) {
  return `<${n.data}>`;
}
function Lb(n, e) {
  var t;
  let r = n.data || "";
  return ((t = e.encodeEntities) !== null && t !== void 0 ? t : e.decodeEntities) !== !1 && !(!e.xmlMode && n.parent && Ib.has(n.parent.name)) && (r = e.xmlMode || e.encodeEntities !== "utf8" ? x1(r) : Cb(r)), r;
}
function Fb(n) {
...
function jb(n, e) {
  return Ve(n) ? n.children.map((t) => w1(t, e)).join("") : "";
}
function nn(n) {
...
function Nn(n, e, t = !0, r = 1 / 0) {
  return T1(n, Array.isArray(e) ? e : [e], t, r);
}
function T1(n, e, t, r) {
  const i = [], u = [e], s = [0];
  for (; ; ) {
...
function Wr(n, e, t = !0) {
  ...
  for (let i = 0; i < e.length && !r; i++) {
    const u = e[i];
    if (ye(u))
      n(u) ? r = u : t && u.children.length > 0 && (r = Wr(n, u.children, !0));
    else continue;
  }
  return r;
}
function $1(n, e) {
  return e.some((t) => ye(t) && (n(t) || $1(n, t.children)));
}
function e2(n, e) {
  const t = [], r = [e], i = [0];
  for (; ; ) {
...
function C1(n) {
  const e = Object.keys(n).map((t) => {
    const r = n[t];
    return Object.prototype.hasOwnProperty.call(wn, t) ? wn[t](r) : S1(t, r);
  });
  return e.length === 0 ? null : e.reduce(t2);
}
function n2(n, e) {
  const t = C1(n);
  return t ? t(e) : !0;
}
function r2(n, e, t, r = 1 / 0) {
  const i = C1(n);
  return i ? Nn(i, e, t, r) : [];
}
function i2(n, e, t = !0) {
  return Array.isArray(e) || (e = [e]), Wr(S1("id", n), e, t);
}
function mt(n, e, t = !0, r = 1 / 0) {
  return Nn(wn.tag_name(n), e, t, r);
}
function u2(n, e, t = !0, r = 1 / 0) {
...
function Gr(n) {
  const e = En(d2, n);
  return e ? e.name === "feed" ? a2(e) : l2(e) : null;
}
function a2(n) {
  var e;
  const t = n.children, r = {
    type: "atom",
    items: mt("entry", t).map((s) => {
      var o;
      const { children: a } = s, l = { media: B1(a) };
...
function l2(n) {
  ...
  const r = (t = (e = En("channel", n.children)) === null || e === void 0 ? void 0 : e.children) !== null && t !== void 0 ? t : [], i = {
    ...
    id: "",
    items: mt("item", n.children).map((s) => {
      const { children: o } = s, a = { media: B1(o) };
...
const h2 = /* @__PURE__ */ Object.freeze({
  ...
  getElementsByTagType: u2,
  removeSubsets: s2,
  get DocumentPosition() {
    return we;
  },
  compareDocumentPosition: A1,
  uniqueSort: o2,
  getFeed: Gr
});
function I1(n, e) {
...
const b2 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  parseDocument: I1,
  parseDOM: D1,
  createDomStream: g2,
...
function v2(n) {
  var e, t;
  return iu(n) === !1 ? !1 : (e = n.constructor, e === void 0 ? !0 : (t = e.prototype, !(iu(t) === !1 || t.hasOwnProperty("isPrototypeOf") === !1)));
}
const w2 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  isPlainObject: v2
}), E2 = /* @__PURE__ */ On(w2);
var k2 = function(e) {
...
var S2 = typeof Symbol == "function" && Symbol.for, C2 = S2 ? Symbol.for("react.element") : 60103;
function A2(n) {
  return n.$$typeof === C2;
}
function B2(n) {
...
function At(n, e) {
  return e.clone !== !1 && e.isMergeableObject(n) ? dt(B2(n), n, e) : n;
}
function I2(n, e, t) {
...
function uu(n) {
  return Object.keys(n).concat(O2(n));
}
function O1(n, e) {
  try {
    return e in n;
...
` || // new line
      ...
      function r(D) {
        var F, U = D.exec(e.substring(p));
        if (U)
          return F = U[0], p += F.length, F;
      }
      for (var i = e.length, u = /^[ \t\n\r\u000c]+/, s = /^[, \t\n\r\u000c]+/, o = /^[^ \t\n\r\u000c]+/, a = /[,]+$/, l = /^\d+$/, c = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, d, f, g, b, T, p = 0, A = []; ; ) {
        if (r(s), p >= i)
          return A;
      ...
      function Y() {
        ...
        for (K = 0; K < f.length; K++)
          L = f[K], y = L[L.length - 1], S = L.substring(0, L.length - 1), w = parseInt(S, 10), v = parseFloat(S), l.test(S) && y === "w" ? ((F || U) && (D = !0), w === 0 ? D = !0 : F = w) : c.test(S) && y === "x" ? ((F || U || z) && (D = !0), v < 0 ? D = !0 : U = v) : l.test(S) && y === "h" ? ((z || U) && (D = !0), w === 0 ? D = !0 : z = w) : D = !0;
        D ? console && console.log && console.log("Invalid srcset descriptor found in '" + e + "' at '" + L + "'.") : (H.url = d, F && (H.w = F), U && (H.d = U), z && (H.h = z), A.push(H));
      }
    };
  });
})(M1);
...
class Bt extends Error {
  ...
  showSourceCode(e) {
    ...
    let t = this.source;
    e == null && (e = ou.isColorSupported), au && e && (t = au(t));
    let r = t.split(/\r?\n/), i = Math.max(this.line - 3, 0), u = Math.min(this.line + 2, r.length), s = String(u).length, o, a;
    if (e) {
      let { bold: l, red: c, gray: d } = ou.createColors(!0);
      o = (f) => l(c(f)), a = (f) => d(f);
    } else
      o = a = (l) => l;
...
class gr {
  ...
  raw(e, t, r) {
    ...
    return typeof i > "u" && (i = lu[r]), s.rawCache[r] = i, i;
  }
  rawSemicolon(e) {
    let t;
    return e.walk((r) => {
...
var _n = pr;
pr.default = pr;
let { isClean: Yt, my: j2 } = Lt, q2 = Kr, H2 = N1, Y2 = _n;
function mr(n, e) {
  let t = new n.constructor();
  for (let r in n) {
    if (!Object.prototype.hasOwnProperty.call(n, r) || r === "proxyCache") continue;
    let i = n[r], u = typeof i;
    r === "parent" && u === "object" ? e && (t[r] = e) : r === "source" ? t[r] = i : Array.isArray(i) ? t[r] = i.map((s) => mr(s, t)) : (u === "object" && i !== null && (i = mr(i)), t[r] = i);
  }
  return t;
}
class br {
  constructor(e = {}) {
    this.raws = {}, this[Yt] = !1, this[j2] = !0;
    for (let t in e)
      if (t === "nodes") {
        this.nodes = [];
        for (let r of e[t])
...
var Ln = yr;
yr.default = yr;
let W2 = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", G2 = (n, e = 21) => (t = e) => {
  let r = "", i = t;
  for (; i--; )
...
let { SourceMapConsumer: cu, SourceMapGenerator: fu } = Ce, { existsSync: Z2, readFileSync: Q2 } = Ce, { dirname: Wn, join: X2 } = Ce;
function ey(n) {
...
class xr {
  ...
  consumer() {
    return this.consumerCache || (this.consumerCache = new cu(this.text)), this.consumerCache;
  }
  withContent() {
  ...
  loadMap(e, t) {
    ...
    if (t) {
      ...
      if (typeof t == "function") {
        ...
        if (t instanceof cu)
          return fu.fromSourceMap(t).toString();
        if (t instanceof fu)
          return t.toString();
        if (this.isMap(t))
      ...
      if (this.annotation) {
        ...
        return e && (r = X2(Wn(e), r)), this.loadFile(r);
      }
    }
  }
  isMap(e) {
...
var _1 = xr;
xr.default = xr;
let { SourceMapConsumer: ty, SourceMapGenerator: ny } = Ce, { fileURLToPath: du, pathToFileURL: zt } = Ce, { resolve: vr, isAbsolute: wr } = Ce, { nanoid: ry } = J2, Gn = Ce, hu = Kr, iy = _1, Vn = Symbol("fromOffsetCache"), uy = !!(ty && ny), gu = !!(vr && wr);
class kn {
  constructor(e, t = {}) {
    if (e === null || typeof e > "u" || typeof e == "object" && !e.toString)
      throw new Error(`PostCSS received ${e} instead of CSS string`);
    if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = !0, this.css = this.css.slice(1)) : this.hasBOM = !1, t.from && (!gu || /^\w+:\/\//.test(t.from) || wr(t.from) ? this.file = t.from : this.file = vr(t.from)), gu && uy) {
      let r = new iy(this.css, t);
      if (r.text) {
        this.map = r;
    ...
    this.file || (this.id = "<input css " + ry(6) + ">"), this.map && (this.map.file = this.from);
  }
  fromOffset(e) {
    let t, r;
    if (this[Vn])
...
`);
  ...
  error(e, t, r, i = {}) {
    ...
    return a ? u = new hu(
      ...
      this.file,
      i.plugin
    ), u.input = { line: t, column: r, endLine: s, endColumn: o, source: this.css }, this.file && (zt && (u.input.url = zt(this.file).toString()), u.input.file = this.file), u;
  }
  origin(e, t, r, i) {
    ...
    let a;
    wr(s.source) ? a = zt(s.source) : a = new URL(
      s.source,
      this.map.consumer().sourceRoot || zt(this.map.mapFile)
    );
    let l = {
      url: a.toString(),
      line: s.line,
...
let { SourceMapConsumer: P1, SourceMapGenerator: rn } = Ce, { dirname: un, resolve: L1, relative: F1, sep: U1 } = Ce, { pathToFileURL: pu } = Ce, sy = Fn, oy = !!(P1 && rn), ay = !!(un && L1 && F1 && U1);
class ly {
  constructor(e, t, r, i) {
  ...
  previous() {
    if (!this.previousMaps)
      if (this.previousMaps = [], this.root)
        ...
        let e = new sy(this.css, this.opts);
  ...
  applyPrevMaps() {
    for (let e of this.previous()) {
      let t = this.toUrl(this.path(e.file)), r = e.root || un(e.file), i;
      this.mapOpts.sourcesContent === !1 ? (i = new P1(e.text), i.sourcesContent && (i.sourcesContent = i.sourcesContent.map(() => null))) : i = e.consumer(), this.map.applySourceMap(i, t, this.toUrl(this.path(r)));
    }
  }
  isAnnotation() {
...
`), this.css += t + "/*# sourceMappingURL=" + e + " */";
  ...
  path(e) {
    ...
    let t = this.opts.to ? un(this.opts.to) : ".";
    return typeof this.mapOpts.annotation == "string" && (t = un(L1(t, this.mapOpts.annotation))), e = F1(t, e), e;
  }
  toUrl(e) {
    return U1 === "\\" && (e = e.replace(/\\/g, "/")), encodeURI(e).replace(/[#?]/g, encodeURIComponent);
  }
  toFileUrl(e) {
    if (pu)
...
`), t = o.length - s) : t += o.length, a && l !== "start") {
  ...
  generate() {
    if (this.clearAnnotation(), ay && oy && this.isMap())
...
var Un = Er;
Er.default = Er;
let { isClean: q1, my: H1 } = Lt, Y1 = Ln, z1 = Un, fy = Pn, W1, Jr, Zr, G1;
function V1(n) {
  return n.map((e) => (e.nodes && (e.nodes = V1(e.nodes)), delete e.source, e));
}
function K1(n) {
  if (n[q1] = !1, n.proxyOf.nodes)
...
class Se extends fy {
  ...
  normalize(e, t) {
    if (typeof e == "string")
      ...
      typeof e.value != "string" && (e.value = String(e.value)), e = [new Y1(e)];
    } else if (e.selector)
      e = [new Jr(e)];
    else if (e.name)
      e = [new Zr(e)];
    ...
    return e.map((i) => (i[H1] || Se.rebuild(i), i = i.proxyOf, i.parent && i.parent.removeChild(i), i[q1] && K1(i), typeof i.raws.before > "u" && t && typeof t.raws.before < "u" && (i.raws.before = t.raws.before.replace(/\S/g, "")), i.parent = this.proxyOf, i));
  }
  getProxyProcessor() {
    return {
      set(e, t, r) {
...
Se.default = Se;
Se.rebuild = (n) => {
  n.type === "atrule" ? Object.setPrototypeOf(n, Zr.prototype) : n.type === "rule" ? Object.setPrototypeOf(n, Jr.prototype) : n.type === "decl" ? Object.setPrototypeOf(n, Y1.prototype) : n.type === "comment" ? Object.setPrototypeOf(n, z1.prototype) : n.type === "root" && Object.setPrototypeOf(n, G1.prototype), n[H1] = !0, n.nodes && n.nodes.forEach((e) => {
    Se.rebuild(e);
  });
};
let dy = nt, J1, Z1;
class It extends dy {
  ...
  toResult(e = {}) {
    return new J1(new Z1(), this, e).stringify();
  }
}
...
var Xr = Tr;
Tr.default = Tr;
const Kn = 39, mu = 34, Wt = 92, bu = 47, Gt = 10, yt = 32, Vt = 12, Kt = 9, Jt = 13, gy = 91, py = 93, my = 40, by = 41, yy = 123, xy = 125, vy = 59, wy = 42, Ey = 58, ky = 64, Zt = /[\t\n\f\r "#'()/;[\\\]{}]/g, Qt = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, Ty = /.[\n"'(/\\]/, yu = /[\da-f]/i;
var $y = function(e, t = {}) {
  let r = e.css.valueOf(), i = t.ignoreErrors, u, s, o, a, l, c, d, f, g, b, T = r.length, p = 0, A = [], O = [];
  function Y() {
    return p;
  }
  function D(K) {
  ...
  function U(K) {
    ...
    switch (u = r.charCodeAt(p), u) {
      ...
      case Vt: {
        ...
        while (u === yt || u === Gt || u === Kt || u === Jt || u === Vt);
      ...
      case my: {
        if (f = A.length ? A.pop()[1] : "", g = r.charCodeAt(p + 1), f === "url" && g !== Kn && g !== mu && g !== yt && g !== Gt && g !== Kt && g !== Vt && g !== Jt) {
          s = p;
          do {
            if (c = !1, s = r.indexOf(")", s + 1), s === -1)
              if (i || H) {
                ...
                D("bracket");
            for (d = s; r.charCodeAt(d - 1) === Wt; )
              d -= 1, c = !c;
          } while (c);
          b = ["brackets", r.slice(p, s + 1), p, s], p = s;
        } else
          s = r.indexOf(")", p + 1), a = r.slice(p, s + 1), s === -1 || Ty.test(a) ? b = ["(", "(", p] : (b = ["brackets", a, p, s], p = s);
        break;
      }
      case Kn:
      case mu: {
      ...
      case ky: {
        Zt.lastIndex = p + 1, Zt.test(r), Zt.lastIndex === 0 ? s = r.length - 1 : s = Zt.lastIndex - 2, b = ["at-word", r.slice(p, s + 1), p, s], p = s;
        break;
      }
      case Wt: {
        for (s = p, l = !0; r.charCodeAt(s + 1) === Wt; )
          s += 1, l = !l;
        if (u = r.charCodeAt(s + 1), l && u !== bu && u !== yt && u !== Gt && u !== Kt && u !== Jt && u !== Vt && (s += 1, yu.test(r.charAt(s)))) {
          for (; yu.test(r.charAt(s + 1)); )
            s += 1;
          r.charCodeAt(s + 1) === yt && (s += 1);
        }
        b = ["word", r.slice(p, s + 1), p, s], p = s;
        break;
      }
      default: {
        u === bu && r.charCodeAt(p + 1) === wy ? (s = r.indexOf("*/", p + 2) + 1, s === 0 && (i || H ? s = r.length : D("comment")), b = ["comment", r.slice(p, s + 1), p, s], p = s) : (Qt.lastIndex = p + 1, Qt.test(r), Qt.lastIndex === 0 ? s = r.length - 1 : s = Qt.lastIndex - 2, b = ["word", r.slice(p, s + 1), p, s], A.push(b), p = s);
        break;
      }
    }
    return p++, b;
...
class ht extends eg {
  ...
  toResult(e = {}) {
    return new tg(new ng(), this, e).stringify();
  }
}
...
$n.default = $n;
ig.registerRule($n);
let Cy = Ln, Ay = $y, By = Un, Iy = ei, Dy = Ft, xu = ti;
const vu = {
  empty: !0,
  space: !0
};
...
class My {
  ...
  raw(e, t, r, i) {
    ...
    for (let f = 0; f < o; f += 1)
      u = r[f], s = u[0], s === "space" && f === o - 1 && !i ? l = !1 : s === "comment" ? (d = r[f - 1] ? r[f - 1][0] : "empty", c = r[f + 1] ? r[f + 1][0] : "empty", !vu[d] && !vu[c] ? a.slice(-1) === "," ? l = !1 : a += u[1] : l = !1) : a += u[1];
    if (!l) {
...
Sn.default = Sn;
Ny.registerParse(Sn);
let { isClean: Be, my: Ly } = Lt, Fy = j1, Uy = _n, jy = nt, qy = Qr, wu = Xr, Hy = ni, Yy = Ft;
const zy = {
  document: "Document",
  root: "Root",
  atrule: "AtRule",
...
function Eu(n) {
  let e;
  return n.type === "document" ? e = ["Document", gt, "DocumentExit"] : n.type === "root" ? e = ["Root", gt, "RootExit"] : e = ug(n), {
    node: n,
    events: e,
    eventIndex: 0,
    visitors: [],
...
class Ke {
  constructor(e, t, r) {
    ...
    if (typeof t == "object" && t !== null && (t.type === "root" || t.type === "document"))
      i = $r(t);
    else if (t instanceof Ke || t instanceof wu)
    ...
    this.result = new wu(e, i, r), this.helpers = { ...Sr, result: this.result, postcss: Sr }, this.plugins = this.processor.plugins.map((u) => typeof u == "object" && u.prepare ? { ...u, ...u.prepare(this.result) } : u);
  }
  ...
  stringify() {
    ...
    let i = new Fy(t, this.result.root, this.result.opts).generate();
...
qy.registerLazyResult(Ke);
let Vy = j1, Ky = _n, Jy = ni;
const Zy = Xr;
class Cr {
  constructor(e, t, r) {
    t = t.toString(), this.stringified = !1, this._processor = e, this._css = t, this._opts = r, this._map = void 0;
    let i, u = Ky;
    this.result = new Zy(this._processor, i, this._opts), this.result.css = t;
    let s = this;
...
class Ot {
  ...
  process(e, t = {}) {
    return this.plugins.length === 0 && typeof t.parser > "u" && typeof t.stringifier > "u" && typeof t.syntax > "u" ? new Xy(this, e, t) : new e3(this, e, t);
  }
  normalize(e) {
    let t = [];
    for (let r of e)
...
function Mt(n, e) {
  ...
  if (t) {
    e = [];
    for (let i of t) {
      let u = { ...i, __proto__: a3.prototype };
      u.map && (u.map = {
        ...u.map,
        __proto__: u3.prototype
      }), e.push(u);
    }
  }
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`
    ), su.env.LANG && su.env.LANG.startsWith("cn") && console.warn(
...
J.fromJSON = m3;
J.list = w3;
J.comment = (n) => new lg(n);
J.atRule = (n) => new cg(n);
J.decl = (n) => new og(n);
J.rule = (n) => new fg(n);
J.root = (n) => new dg(n);
J.document = (n) => new ag(n);
J.CssSyntaxError = d3;
J.Declaration = og;
J.Container = g3;
J.Processor = ri;
...
`);
  ...
  e.allowedAttributes && (a = {}, l = {}, wt(e.allowedAttributes, function(h, x) {
    ...
    h.forEach(function(k) {
      typeof k == "string" && k.indexOf("*") >= 0 ? m.push(ku(k).replace(/\\\*/g, ".*")) : a[x].push(k);
  ...
  wt(e.allowedClasses, function(h, x) {
    if (a && (Ue(a, x) || (a[x] = []), a[x].push("class")), c[x] = h, Array.isArray(h)) {
      ...
      c[x] = [], f[x] = [], h.forEach(function(k) {
        typeof k == "string" && k.indexOf("*") >= 0 ? m.push(ku(k).replace(/\\\*/g, ".*")) : k instanceof RegExp ? f[x].push(k) : c[x].push(k);
  ...
  const U = new T3.Parser({
        ...
        if (ee) {
          ...
          if (h === "iframe" && R === "src") {
            ...
            try {
              const j = L(N);
              if (j.isRelativeUrl)
                q = Ue(e, "allowIframeRelativeUrls") ? e.allowIframeRelativeUrls : !e.allowedIframeHostnames && !e.allowedIframeDomains;
    ...
    ontext: function(h) {
      ...
      if (x && (m = x.tag, h = x.innerText !== void 0 ? x.innerText : h), e.disallowedTagsMode === "completelyDiscard" && !s(m))
        ...
        const k = K(h, !1);
        e.textFilter && !F ? r += e.textFilter(k, m) : F || (r += k);
      }
      if (p.length) {
        const k = p[p.length - 1];
        k.text += h;
  ...
  function w(h) {
    return function(x, m) {
      return Ue(h, m.prop) && h[m.prop].some(function(B) {
...
function F3(n) {
  return (e, t) => {
    ...
    if (!i) {
      Xt(`[${r}] componentWillLoad lifecycle method in ${r} missing. Required for RegisterComponent decorator.`);
      return;
    }
    const u = e.connectedCallback;
    if (!u) {
      Xt(`[${r}] connectedCallback lifecycle method in ${r} missing. Required for RegisterComponent decorator.`);
      return;
    }
    const s = e.disconnectedCallback;
    if (!s) {
      Xt(`[${r}] disconnectedCallback lifecycle method in ${r} missing. Required for RegisterComponent decorator.`);
      return;
    }
    if (n.storeToProps && n.stateToProps) {
      ...
      if (c.length > 0) {
        Xt(`[${r}] Overlapping prop keys detected in ${r} for storeToProps and stateToProps. Make sure to only define them once. Overlapping keys: ${c.join(", ")}`);
        return;
      }
    }
    ...
    n.eventToProps && Object.keys(n.eventToProps).forEach((a) => {
      ...
      const a = u == null ? void 0 : u.call(this), l = en(this);
      ...
      const a = i == null ? void 0 : i.call(this), l = en(this), c = {
        element: l,
        ...n,
        eventToProps: o
      }, d = P3(e, c, n.registrationEventName);
      return l.dispatchEvent(d) && ce(`[${r}] Component ${r} successfully fired registration event`), a;
    }, e.disconnectedCallback = function() {
      const a = s == null ? void 0 : s.call(this), l = en(this), c = {
        element: l,
        ...n,
        eventToProps: o
      }, d = L3(e, c, n.unregistrationEventName);
      return l.dispatchEvent(d) && ce(`[${r}] Component ${r} successfully fired unregistration event`), a;
    });
  };
}
const U3 = ".sc-checkmark-icon-h{display:flex}", j3 = U3, q3 = et(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "18", this.height = "14";
  }
  render() {
    return _("svg", { key: "e8ee67dad2ae6438b3358babc1350245ec04de72", width: this.width, height: this.height, viewBox: "0 0 18 14", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, _("path", { key: "de655451a6d3d50b7b6ba66c5267842ff3385b89", d: "M1.53033 7.46967C1.23744 7.17678 0.762563 7.17678 0.46967 7.46967C0.176777 7.76256 0.176777 8.23744 0.46967 8.53033L4.96967 13.0303C5.26256 13.3232 5.73744 13.3232 6.03033 13.0303L17.0303 2.03033C17.3232 1.73744 17.3232 1.26256 17.0303 0.96967C16.7374 0.676777 16.2626 0.676777 15.9697 0.96967L5.5 11.4393L1.53033 7.46967Z", fill: "#293056" }));
  }
  static get style() {
    return j3;
  }
...
const Y3 = ".sc-chevron-icon-h{display:flex}", z3 = Y3, W3 = et(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "24", this.height = "24";
  }
  render() {
    return _("svg", { key: "90d483478e14f04ab2793f5c922ccb87a8b1f1cc", xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none" }, _("path", { key: "b50664e82487982f62f962fd7e6586d2a68e42e9", fill: "currentColor", d: "M15.53 4.22a.75.75 0 0 1 0 1.06L8.81 12l6.72 6.72a.75.75 0 1 1-1.06 1.06l-7.25-7.25a.75.75 0 0 1 0-1.06l7.25-7.25a.75.75 0 0 1 1.06 0Z" }));
  }
  static get style() {
    return z3;
  }
...
const n6 = ':host{display:block;height:auto;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif;width:100%}label{display:flex;color:var(--nylas-base-800, #293056);font-size:14px;font-style:normal;font-weight:400;line-height:150%;flex-direction:column;gap:4px;font-family:var(--nylas-font-family);font-size:16px;color:var(--nylas-base-800)}label.error{color:var(--nylas-error)}label span.required{color:var(--nylas-error);padding:0 0.25rem}label p{margin:0}label .error{color:var(--nylas-error)}.input_wrapper{display:flex;align-items:center;gap:1rem}input[type=text],input[type=email]{display:flex;height:48px;padding-left:16px;align-items:center;gap:8px;align-self:stretch;border-radius:var(--nylas-border-radius-2x);border:1px solid var(--nylas-base-300);background:var(--nylas-base-0);width:-webkit-fill-available;color:var(--nylas-base-900);font-size:16px;font-style:normal;font-weight:400;line-height:150%;width:-moz-available;width:-webkit-fill-available}input[type=text]:focus,input[type=email]:focus{outline-color:var(--nylas-primary)}input[type=text].error,input[type=email].error{border-radius:var(--nylas-border-radius-2x);font-weight:600;border-color:var(--nylas-error);border-width:2px}input[type=text].error::placeholder,input[type=email].error::placeholder{font-weight:400}input[type=text]::placeholder,input[type=email]::placeholder{color:var(--nylas-base-300)}', r6 = n6, i6 = {
  ...
  render() {
    return _("label", { key: "207cb06847b7a045c4917180affc535169b55596", part: "ic__label", class: { error: !!this.error } }, this.label && _("p", null, _("span", { class: "label" }, this.label), this.required && _("span", { class: "required" }, "*")), _("div", { key: "8da4d52acd543376116d9851df43eb54b3e3fec1", part: "ic__input_wrapper", class: "input_wrapper" }, _("input", { key: "541168da152c81e01dfa0263f8c1f0b6e73e09f2", type: "text", name: this.name, part: "ic__input", readOnly: this.readOnly, autoFocus: this.autoFocus, value: this.value, maxLength: this.maxLength, placeholder: this.placeholder, class: { error: !!this.error }, onInput: (e) => this.handleInput(e), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), _("slot", { key: "9e4ccbf52802dc59bda1d6b738c45026b8b78bd4", name: "additional-input" })), this.error && _("span", { class: "error help-text" }, this.error));
  }
  get el() {
    return this;
  }
...
const a6 = '.tooltip-container{position:relative;display:flex;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif}.tooltip-content{visibility:hidden;background-color:var(--nylas-base-800);color:var(--nylas-base-0);text-align:left;border-radius:6px;padding:5px 0;position:absolute;z-index:1;opacity:0;transition:opacity 0.3s;padding:0.5rem 1rem;max-width:200px;width:max-content}.tooltip-content.top{bottom:0;left:0;margin-bottom:1.25rem;transform:translateX(-50%)}.tooltip-content.right{top:50%;left:0%;margin-left:1.25rem;transform:translateY(-50%)}.tooltip-content.bottom{top:0;left:0;margin-top:1.25rem;transform:translateX(-50%)}.tooltip-content.left{top:50%;right:0%;margin-right:1.25rem;transform:translateY(-50%)}.tooltip-container:hover .tooltip-content,.tooltip-container:focus-within .tooltip-content{visibility:visible;opacity:1}.tooltip-content::after{content:"";position:absolute;top:-0.75rem;left:50%;transform:rotate(180deg);border-width:6px;border-style:solid;border-color:black transparent transparent transparent}.tooltip-content.top::after{top:100%;left:50%;transform:rotate(0deg)}.tooltip-content.bottom::after{top:-0.75rem;left:50%;transform:rotate(180deg)}.tooltip-content.left::after{top:47.5%;left:100%;transform:rotate(270deg)}.tooltip-content.right::after{top:47.5%;left:-0.75rem;transform:rotate(90deg)}', l6 = a6, c6 = et(class extends tt {
  ...
  render() {
    return _("div", { key: "39014243f733656bf550b9141eabd5c13e3c43d9", class: "tooltip-container", part: "tc__container" }, _("span", { key: "8b331b143065287a337e26a4680b3744ca8e2bc7", class: "info-icon", tabindex: "0", onFocus: this.showTooltip.bind(this), onBlur: this.hideTooltip.bind(this) }, _("slot", { key: "cf584033435cee5ca7143f5ee5fb983e3e9ab550", name: "tooltip-icon" }, "i")), _("span", { key: "409b87ee03bc5aa39fcaf965eca18d03f0ef1a44", class: `tooltip-content ${this.position}`, part: "tc__content" }, _("slot", { key: "00f5fa51bcf2cd31fac498f94a97ac67d5b7de3f", name: "tooltip-content" }, "This is a help text.")));
  }
  get el() {
    return this;
  }
  ...
  ["tooltip-component"].forEach((e) => {
    switch (e) {
      case "tooltip-component":
        customElements.get(e) || customElements.define(e, c6);
        break;
    }
  });
}
...
const ii = et(class extends tt {
  ...
  componentDidLoad() {
    ce("nylas-custom-event-slug", "componentDidLoad"), this.selectedConfiguration ? this.selectedConfigurationChangedHandler(this.selectedConfiguration) : this.urlSlug = this.defaultUrlSlug || "";
  }
  componentWillUpdate() {
  ...
  async nylasFormInputChangeHandler(e) {
    ...
    this.internals.setValidity({}), t === "event-slug" && (this.urlSlug = r, this.internals.setFormValue(JSON.stringify(r), this.name), this.valueChanged.emit({ value: JSON.stringify(r), name: this.name }));
  }
  ...
  async nylasFormInputBlurHandler() {
    ...
    /^[A-Za-z0-9-]*$/.test(this.urlSlug) || (this.internals.setValidity({ customError: !0 }, "Invalid slug: Only letters, numbers, and hyphens are allowed."), this.slugErrorMessage = "Invalid slug: Only letters, numbers, and hyphens are allowed.");
  }
  ...
  ["nylas-custom-event-slug", "checkmark-icon", "chevron-icon", "copy-icon", "info-icon", "input-component", "tooltip-component"].forEach((e) => {
    switch (e) {
      ...
      case "checkmark-icon":
        ...
        break;
      case "chevron-icon":
        customElements.get(e) || G3();
        break;
      case "copy-icon":
        customElements.get(e) || Z3();
        break;
      case "info-icon":
        customElements.get(e) || t6();
        break;
      case "input-component":
        customElements.get(e) || o6();
        break;
      case "tooltip-component":
...
const k6 = ii, T6 = p6;
export {
  k6 as NylasCustomEventSlug,
  T6 as defineCustomElement
};
