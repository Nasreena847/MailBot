...
const H = (e, t, ...n) => {
...
}, Ue = /\s/, J = (e) => e ? e.split(Ue) : [], ie = "Capture", He = new RegExp(ie + "$"), ce = (e, t, n, s) => {
  ...
  let c = 0, o = 0, r = 0, i = 0, u = t.length - 1, f = t[0], $ = t[u], d = s.length - 1, a = s[0], p = s[d], y, g;
  for (; c <= u && o <= d; )
    if (f == null)
      f = t[++c];
    else if ($ == null)
      ...
      (f.$tag$ === "slot" || p.$tag$ === "slot") && A(f.$elm$.parentNode, !1), E(f, p, l), e.insertBefore(f.$elm$, $.$elm$.nextSibling), f = t[++c], p = s[--d];
    else if (F($, a, l))
  ...
  var s, l, c, o, r;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || P(null, null), $ = xe(t) ? t : H(null, null, t);
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), B = /* @__PURE__ */ new Map(), tt = [], w = typeof window < "u" ? window : {}, S = w.document || { head: {} }, st = w.HTMLElement || class {
}, h = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, ct = (e) => lt().then(e), rt = /* @__PURE__ */ it(ye, !0), $t = ".sc-envelope-icon-h{display:flex}", at = $t, ve = Ke(class extends st {
  constructor() {
