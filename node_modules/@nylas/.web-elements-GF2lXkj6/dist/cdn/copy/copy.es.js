...
let L, D, _, le = !1, F = !1, W = !1, v = !1, I = null, M = !1;
const x = (e, t = "") => () => {
...
const U = (e, t, ...n) => {
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = x("attachStyles", t.$tagName$), c = Re(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
...
}, He = /\s/, J = (e) => e ? e.split(He) : [], ie = "Capture", Fe = new RegExp(ie + "$"), ce = (e, t, n, s) => {
  ...
  if (le || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? Se : me, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ce(null, l, v), ke(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const c = l.$elm$;
      ue(l), c && (F = !0, c["s-ol"] ? c["s-ol"].remove() : A(c, !0), c.remove());
    }
  }
}, Ue = (e, t, n, s, l = !1) => {
  ...
  for (; c <= u && o <= d; )
    if (f == null)
      ...
      r >= 0 ? (g = t[r], g.$tag$ !== a.$tag$ ? y = j(t && t[o], n, r, e) : (E(g, a, l), t[r] = void 0, y = g.$elm$), a = s[++o]) : (y = j(t && t[o], n, o, e), a = s[++o]), y && ae(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  c > u ? re(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && $e(t, c, u);
}, H = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, q = (e) => e && e["s-ol"] || e, ae = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, E = (e, t, n = !1) => {
  const s = t.$elm$ = e.$elm$, l = e.$children$, c = t.$children$, o = t.$tag$, r = t.$text$;
  let i;
  r === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || ce(e, t, v), l !== null && c !== null ? Ue(s, l, t, c, n) : c !== null ? (e.$text$ !== null && (s.textContent = ""), re(s, null, t, c, 0, c.length - 1)) : l !== null && $e(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = r : e.$text$ !== r && (s.data = r);
}, fe = (e) => {
...
}, he = (e, t) => (e.$flags$ |= 16, je(e, e.$ancestorComponent$), ct(() => we(e, t))), we = (e, t) => {
  const n = e.$hostElement$, s = x("scheduleUpdate", e.$cmpMeta$.$tagName$), l = n;
  let c;
  return t ? c = C(l, "componentWillLoad") : c = C(l, "componentWillUpdate"), c = V(c, () => C(l, "componentWillRender")), s(), V(c, () => De(e, l, t));
