...
let L, D, _, lt = !1, U = !1, W = !1, v = !1, G = null, H = !1;
const T = (t, e = "") => () => {
}, vt = "slot-fb{display:contents}slot-fb[hidden]{display:none}", Z = "http://www.w3.org/1999/xlink", I = {}, Ct = "http://www.w3.org/2000/svg", St = "http://www.w3.org/1999/xhtml", mt = (t) => t != null, z = (t) => (t = typeof t, t === "object" || t === "function");
function kt(t) {
  var e, n, s;
...
const M = (t, e, ...n) => {
...
}, bt = {}, Tt = (t) => t && t.$tag$ === bt, Lt = {
  forEach: (t, e) => t.map(Q).forEach(e),
  map: (t, e) => t.map(Q).map(e).map(xt)
}, Q = (t) => ({
  vattrs: t.$attrs$,
...
}, Et = (t) => te.map((e) => e(t)).find((e) => !!e), _t = (t, e) => t != null && !z(t) ? e & 4 ? t === "false" ? !1 : t === "" || !!t : e & 2 ? parseFloat(t) : e & 1 ? String(t) : t : t, X = /* @__PURE__ */ new WeakMap(), At = (t, e, n) => {
  let s = w.get(t);
      ...
      if (o || X.set(t, o = /* @__PURE__ */ new Set()), !o.has(l)) {
        {
          ...
          const i = (s = p.$nonce$) !== null && s !== void 0 ? s : kt(C);
  ...
  const e = t.$cmpMeta$, n = t.$hostElement$, s = e.$flags$, l = T("attachStyles", e.$tagName$), r = Rt(n.shadowRoot ? n.shadowRoot : n.getRootNode(), e, t.$modeName$);
...
}, Ft = /\s/, J = (t) => t ? t.split(Ft) : [], it = "Capture", Ut = new RegExp(it + "$"), rt = (t, e, n, s) => {
  ...
  if (lt || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = C.createElementNS(v ? Ct : St, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), rt(null, l, v), mt(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || rt(t, e, v), l !== null && r !== null ? Mt(s, l, e, r, n) : r !== null ? (t.$text$ !== null && (s.textContent = ""), ct(s, null, e, r, 0, r.length - 1)) : l !== null && $t(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : t.$text$ !== c && (s.data = c);
}, ft = (t) => {
  ...
  var s, l, r, o, c;
  const i = t.$hostElement$, u = t.$cmpMeta$, f = t.$vnode$ || P(null, null), $ = Tt(e) ? e : M(null, null, e);
...
}, ht = (t, e) => (t.$flags$ |= 16, jt(t, t.$ancestorComponent$), re(() => wt(t, e))), wt = (t, e) => {
  const n = t.$hostElement$, s = T("scheduleUpdate", t.$cmpMeta$.$tagName$), l = n;
  let r;
  return e ? r = E(l, "componentWillLoad") : r = E(l, "componentWillUpdate"), r = V(r, () => E(l, "componentWillRender")), s(), V(r, () => Dt(t, l, e));
  ...
  if (!(p.$flags$ & 1)) {
    ...
    n.$flags$ & 12 && It(t), n.$members$ && Object.entries(n.$members$).map(([l, [r]]) => {
...
}, Jt = (t, e) => e & 4 ? C : e & 8 ? B : e & 16 ? C.body : t, Yt = (t) => se ? {
  passive: (t & 1) !== 0,
  capture: (t & 2) !== 0
...
}, et = (t, e) => e in t, O = (t, e) => (0, console.error)(t, e), w = /* @__PURE__ */ new Map(), te = [], B = typeof window < "u" ? window : {}, C = B.document || { head: {} }, ee = B.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (t) => t(),
...
}, ie = (t) => ne().then(t), re = /* @__PURE__ */ oe(yt, !0), ce = ".sc-translate-icon-h{display:flex}", $e = ce, ae = Xt(class extends ee {
  constructor() {
