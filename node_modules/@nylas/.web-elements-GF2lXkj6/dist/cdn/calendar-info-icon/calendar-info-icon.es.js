...
let x, B, _, le = !1, F = !1, W = !1, v = !1, q = null, D = !1;
const C = (e, t = "") => () => {
...
const M = (e, t, ...n) => {
...
}, Fe = /\s/, J = (e) => e ? e.split(Fe) : [], ie = "Capture", Me = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  if (le || (W = !0, l.$tag$ === "slot" && (x && s.classList.add(x + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : ke, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), Te(x) && o["s-si"] !== x && o.classList.add(o["s-si"] = x), l.$children$)
  ...
  for (o.shadowRoot && o.tagName === _ && (o = o.shadowRoot); l <= r; ++l)
    s[l] && (c = P(null, n, l, e), c && (s[l].$elm$ = c, o.insertBefore(c, I(t))));
}, $e = (e, t, n) => {
  for (let s = t; s <= n; ++s) {
    const l = e[s];
    if (l) {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = P(t && t[o], n, c, e) : (L(g, a, l), t[c] = void 0, y = g.$elm$), a = s[++o]) : (y = P(t && t[o], n, o, e), a = s[++o]), y && ae(f.$elm$).insertBefore(y, I(f.$elm$));
    }
  r > u ? ce(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && $e(t, r, u);
}, H = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, I = (e) => e && e["s-ol"] || e, ae = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, L = (e, t, n = !1) => {
  ...
  try {
    q = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || Pe(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return q = null, null;
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-calendar-info-icon-h{display:flex}", at = $t, ve = Ke(class extends st {
  constructor() {
