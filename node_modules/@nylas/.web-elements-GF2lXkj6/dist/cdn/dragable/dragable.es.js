...
let C, B, _, le = !1, F = !1, W = !1, v = !1, Z = null, H = !1;
const x = (e, t = "") => () => {
...
const M = (e, t, ...n) => {
  ...
  const i = [], u = (a) => {
    for (let d = 0; d < a.length; d++)
      s = a[d], Array.isArray(s) ? u(s) : s != null && typeof s != "boolean" && ((o = typeof e != "function" && !z(s)) && (s = String(s)), o && c ? i[i.length - 1].$text$ += s : i.push(o ? U(null, s) : s), c = o);
  };
  if (u(n), t) {
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = x("attachStyles", t.$tagName$), r = Re(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
...
}, De = /\s/, J = (e) => e ? e.split(De) : [], ie = "Capture", Fe = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  let r = 0, o, c, i;
  if (le || (W = !0, l.$tag$ === "slot" && (C && s.classList.add(C + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? Se : me, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), ke(C) && o["s-si"] !== C && o.classList.add(o["s-si"] = C), l.$children$)
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== _ && l["s-ol"] && ($e(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && A(l, t);
  }
  g.$flags$ &= -2;
}, ce = (e, t, n, s, l, r) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (p = t[c], p.$tag$ !== $.$tag$ ? y = P(t && t[o], n, c, e) : (L(p, $, l), t[c] = void 0, y = p.$elm$), $ = s[++o]) : (y = P(t && t[o], n, o, e), $ = s[++o]), y && $e(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  r > u ? ce(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && ae(t, r, u);
}, D = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, q = (e) => e && e["s-ol"] || e, $e = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, L = (e, t, n = !1) => {
  const s = t.$elm$ = e.$elm$, l = e.$children$, r = t.$children$, o = t.$tag$, c = t.$text$;
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || re(e, t, v), l !== null && r !== null ? Me(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), ce(s, null, t, r, 0, r.length - 1)) : l !== null && ae(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, fe = (e) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || U(null, null), a = xe(t) ? t : M(null, null, t);
  ...
  a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = f.$elm$ = i.shadowRoot || i, C = i["s-sc"], B = i["s-cr"], le = (u.$flags$ & 1) !== 0, F = !1, L(f, a, n);
  {
    if (g.$flags$ |= 1, W) {
      de(a.$elm$);
      for (const d of m) {
  ...
  try {
    Z = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (b.hasRenderFn || b.reflect) && (b.vdomRender || b.reflect) && (b.hydrateServerSide || Ue(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return Z = null, null;
  ...
  e.push(n), H || (H = !0, t && g.$flags$ & 4 ? it(N) : g.raf(N));
}, ne = (e) => {
