...
let L, P, A, oe = !1, H = !1, W = !1, v = !1, I = null, D = !1;
const x = (e, t = "") => () => {
...
const F = (e, t, ...n) => {
  ...
  const i = [], u = ($) => {
    for (let d = 0; d < $.length; d++)
      s = $[d], Array.isArray(s) ? u(s) : s != null && typeof s != "boolean" && ((l = typeof e != "function" && !z(s)) && (s = String(s)), l && c ? i[i.length - 1].$text$ += s : i.push(l ? U(null, s) : s), c = l);
  };
  if (u(n), t) {
...
}, Be = /\s/, Y = (e) => e ? e.split(Be) : [], ie = "Capture", He = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  return l["s-hn"] = A, o.$flags$ & 3 && (l["s-sr"] = !0, l["s-cr"] = P, l["s-sn"] = o.$name$ || "", i = e && e.$children$ && e.$children$[n], i && i.$tag$ === o.$tag$ && e.$elm$ && R(e.$elm$, !1)), l;
}, R = (e, t) => {
  p.$flags$ |= 1;
  const n = e.childNodes;
  for (let s = n.length - 1; s >= 0; s--) {
    const o = n[s];
    o["s-hn"] !== A && o["s-ol"] && (ae(o).insertBefore(o, q(o)), o["s-ol"].remove(), o["s-ol"] = void 0, o["s-sh"] = void 0, W = !0), t && R(o, t);
  }
  p.$flags$ &= -2;
}, ce = (e, t, n, s, o, r) => {
  ...
  for (; r <= u && l <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = j(t && t[l], n, c, e) : (E(g, a, o), t[c] = void 0, y = g.$elm$), a = s[++l]) : (y = j(t && t[l], n, l, e), a = s[++l]), y && ae(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  r > u ? ce(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, l, d) : l > d && $e(t, r, u);
}, B = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, q = (e) => e && e["s-ol"] || e, ae = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, E = (e, t, n = !1) => {
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, L = i["s-sc"], P = i["s-cr"], oe = (u.$flags$ & 1) !== 0, H = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      de($.$elm$);
      for (const d of k) {
  ...
  let r;
  return t ? r = _(o, "componentWillLoad") : r = _(o, "componentWillUpdate"), r = V(r, () => _(o, "componentWillRender")), s(), V(r, () => Pe(e, o, t));
}, V = (e, t) => Me(e) ? e.then(t) : t(), Me = (e) => e instanceof Promise || e && e.then && typeof e.then == "function", Pe = async (e, t, n) => {
...
}, Ye = (e, t) => t & 4 ? S : t & 8 ? M : t & 16 ? S.body : e, Ze = (e) => st ? {
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), et = [], M = typeof window < "u" ? window : {}, S = M.document || { head: {} }, tt = M.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ lt(ye, !0), ct = ".sc-bold-icon-h{display:flex}", $t = ct, at = Ke(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "15", this.height = "15";
  }
  render() {
    return F("svg", { key: "93ec49e234ab8841098d7024f4000f2047a950fd", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, F("path", { key: "1713de8140949f52a489b05f2ab92cc2b09b49ec", d: "M6 4V20M9.5 4H15.5C17.7091 4 19.5 5.79086 19.5 8C19.5 10.2091 17.7091 12 15.5 12H9.5H16.5C18.7091 12 20.5 13.7909 20.5 16C20.5 18.2091 18.7091 20 16.5 20H9.5M9.5 4V20M9.5 4H4M9.5 20H4", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }));
  }
  static get style() {
    return $t;
  }
