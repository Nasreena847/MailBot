...
const b = (e, t = "") => () => {
}, Se = "slot-fb{display:contents}slot-fb[hidden]{display:none}", Z = "http://www.w3.org/1999/xlink", Q = {}, me = "http://www.w3.org/2000/svg", ke = "http://www.w3.org/1999/xhtml", Le = (e) => e != null, z = (e) => (e = typeof e, e === "object" || e === "function");
function Te(e) {
  var t, n, s;
...
const U = (e, t, ...n) => {
  ...
  if (le || (W = !0, l.$tag$ === "slot" && (x && s.classList.add(x + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : ke, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), Le(x) && o["s-si"] !== x && o.classList.add(o["s-si"] = x), l.$children$)
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || M(null, null), $ = xe(t) ? t : U(null, null, t);
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), j = /* @__PURE__ */ new Map(), tt = [], w = typeof window < "u" ? window : {}, S = w.document || { head: {} }, st = w.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-trash-icon-h{display:flex}", at = $t, ve = Ke(class extends st {
  constructor() {
