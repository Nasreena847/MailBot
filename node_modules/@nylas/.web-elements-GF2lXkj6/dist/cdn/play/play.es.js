...
}, te = (e, t) => t in e, P = (e, t) => (0, console.error)(e, t), B = /* @__PURE__ */ new Map(), et = [], D = typeof window < "u" ? window : {}, S = D.document || { head: {} }, tt = D.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ ot(ye, !0), ct = ".sc-play-icon-h{display:flex}", $t = ct, at = Ke(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "15", this.height = "15";
  }
  render() {
    return U("svg", { key: "03aeffce3f9f6d60a15e334e51d4b8473724937a", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "auto", xmlns: "http://www.w3.org/2000/svg" }, U("path", { key: "b150b7c852caa549be48caaf60e46bc442b15960", d: "M21 12L3 21V3L21 12Z", stroke: "auto", "stroke-width": "1.5", "stroke-linecap": "round", "stroke-linejoin": "round" }));
  }
  static get style() {
    return $t;
  }
