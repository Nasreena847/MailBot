...
const p = (e, t, ...n) => {
...
}, _e = (e) => tt.map((t) => t(e)).find((t) => !!t), He = (e, t) => e != null && !W(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, X = /* @__PURE__ */ new WeakMap(), Ae = (e, t, n) => {
  let s = F.get(e);
...
}, Oe = /\s/, J = (e) => e ? e.split(Oe) : [], ce = "Capture", Be = new RegExp(ce + "$"), ie = (e, t, n, s) => {
  ...
  if (le || (N = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = k.createElementNS(v ? ke : Se, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ie(null, l, v), me(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  for (; i <= u && o <= d; )
    if ($ == null)
      ...
      ($.$tag$ === "slot" || h.$tag$ === "slot") && A($.$elm$.parentNode, !1), E($, h, l), e.insertBefore($.$elm$, r.$elm$.nextSibling), $ = t[++i], h = s[--d];
    else if (O(r, f, l))
      ($.$tag$ === "slot" || h.$tag$ === "slot") && A(r.$elm$.parentNode, !1), E(r, f, l), e.insertBefore(r.$elm$, $.$elm$), r = t[--u], f = s[++o];
    else {
      for (a = -1, c = i; c <= u; ++c)
      ...
      a >= 0 ? (y = t[a], y.$tag$ !== f.$tag$ ? b = w(t && t[o], n, a, e) : (E(y, f, l), t[a] = void 0, b = y.$elm$), f = s[++o]) : (b = w(t && t[o], n, o, e), f = s[++o]), b && fe($.$elm$).insertBefore(b, z($.$elm$));
    }
  i > u ? ae(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && re(t, i, u);
}, O = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, z = (e) => e && e["s-ol"] || e, fe = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, E = (e, t, n = !1) => {
  const s = t.$elm$ = e.$elm$, l = e.$children$, i = t.$children$, o = t.$tag$, a = t.$text$;
  let c;
  a === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || ie(e, t, v), l !== null && i !== null ? Ue(s, l, t, i, n) : i !== null ? (e.$text$ !== null && (s.textContent = ""), ae(s, null, t, i, 0, i.length - 1)) : l !== null && re(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (c = s["s-cr"]) ? c.parentNode.textContent = a : e.$text$ !== a && (s.data = a);
}, $e = (e) => {
  ...
  var s, l, i, o, a;
  const c = e.$hostElement$, u = e.$cmpMeta$, $ = e.$vnode$ || U(null, null), r = xe(t) ? t : p(null, null, t);
  ...
  r.$tag$ = null, r.$flags$ |= 4, e.$vnode$ = r, r.$elm$ = $.$elm$ = c.shadowRoot || c, L = c["s-sc"], D = c["s-cr"], le = (u.$flags$ & 1) !== 0, B = !1, E($, r, n);
  {
    if (g.$flags$ |= 1, N) {
      de(r.$elm$);
      for (const d of S) {
...
}, pe = (e, t) => (e.$flags$ |= 16, Fe(e, e.$ancestorComponent$), at(() => Pe(e, t))), Pe = (e, t) => {
  const n = e.$hostElement$, s = x("scheduleUpdate", e.$cmpMeta$.$tagName$), l = n;
  let i;
  return t ? i = _(l, "componentWillLoad") : i = _(l, "componentWillUpdate"), i = V(i, () => _(l, "componentWillRender")), s(), V(i, () => je(e, l, t));
  ...
  try {
    q = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (C.hasRenderFn || C.reflect) && (C.vdomRender || C.reflect) && (C.hydrateServerSide || we(e, t, s));
  } catch (c) {
    R(c, e.$hostElement$);
  }
  return q = null, null;
  ...
  n && n.map(([l, i, o]) => {
    const a = Ye(e, l), c = Je(t, o), u = Ve(l);
  ...
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
} : (e & 2) !== 0, ge = /* @__PURE__ */ new WeakMap(), M = (e) => ge.get(e), et = (e, t) => {
  const n = {
    $flags$: 0,
    $hostElement$: e,
    $cmpMeta$: t,
...
}, it = (e) => lt().then(e), at = /* @__PURE__ */ ct(ye, !0), rt = ".sc-microsoft-teams-icon-h{display:flex}", ft = rt, be = Ke(class extends st {
  constructor() {
