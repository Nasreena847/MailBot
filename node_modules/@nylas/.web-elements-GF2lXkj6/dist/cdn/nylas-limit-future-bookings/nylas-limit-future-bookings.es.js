...
let He, vr, ot, Oi = !1, Lt = !1, Wr = !1, ie = !1, vn = null, xr = !1;
const Ne = (n, e = "") => () => {
}, jh = "slot-fb{display:contents}slot-fb[hidden]{display:none}", xn = "http://www.w3.org/1999/xlink", wn = {}, Yh = "http://www.w3.org/2000/svg", qh = "http://www.w3.org/1999/xhtml", Hh = (n) => n != null, Gr = (n) => (n = typeof n, n === "object" || n === "function");
function zh(n) {
  var e, t, r;
...
const R = (n, e, ...t) => {
  ...
  forEach: (n, e) => n.map(kn).forEach(e),
  map: (n, e) => n.map(kn).map(e).map(Kh)
}, kn = (n) => ({
  vattrs: n.$attrs$,
  ...
  if (n = n.nodeType === 11 ? n : fe, u)
    if (typeof u == "string") {
      n = n.head || n;
      let o = En.get(n), s;
      if (o || En.set(n, o = /* @__PURE__ */ new Set()), !o.has(i)) {
        {
          s = fe.createElement("style"), s.innerHTML = u;
          const a = (r = ee.$nonce$) !== null && r !== void 0 ? r : zh(fe);
          a != null && s.setAttribute("nonce", a), n.insertBefore(s, n.querySelector("link"));
        }
        e.$flags$ & 4 && (s.innerHTML += jh), o && o.add(i);
      }
...
}, Ri = (n, e) => "sc-" + (e && n.$flags$ & 32 ? n.$tagName$ + "-" + e : n.$tagName$), $n = (n, e, t, r, i, u) => {
  if (t !== r) {
    let o = An(n, e), s = e.toLowerCase();
    if (e === "class") {
      const a = n.classList, l = Tn(t), c = Tn(r);
      ...
      if (e === "ref")
        ...
        if (e[2] === "-" ? e = e.slice(3) : An(Xt, s) ? e = s.slice(2) : e = s[2] + e.slice(3), t || r) {
          const a = e.endsWith(Mi);
          e = e.replace(r1, ""), t && ee.rel(n, e, t, a), r && ee.ael(n, e, r, a);
        }
      } else {
        const a = Gr(r);
        if ((o || a && r !== null) && !i)
        ...
        let l = !1;
        s !== (s = s.replace(/^xlink\:?/, "")) && (e = s, l = !0), r == null || r === !1 ? (r !== !1 || n.getAttribute(e) === "") && (l ? n.removeAttributeNS(xn, e) : n.removeAttribute(e)) : (!o || u & 4 || i) && !a && (r = r === !0 ? "" : r, l ? n.setAttributeNS(xn, e, r) : n.setAttribute(e, r));
      }
  }
}, t1 = /\s/, Tn = (n) => n ? n.split(t1) : [], Mi = "Capture", r1 = new RegExp(Mi + "$"), Pi = (n, e, t, r) => {
  const i = e.$elm$.nodeType === 11 && e.$elm$.host ? e.$elm$.host : e.$elm$, u = n && n.$attrs$ || wn, o = e.$attrs$ || wn;
  for (r in u)
  ...
  let u = 0, o, s, a;
  if (Oi || (Wr = !0, i.$tag$ === "slot" && (He && r.classList.add(He + "-s"), i.$flags$ |= i.$children$ ? (
    ...
    if (ie || (ie = i.$tag$ === "svg"), o = i.$elm$ = fe.createElementNS(ie ? Yh : qh, i.$flags$ & 2 ? "slot-fb" : i.$tag$), ie && i.$tag$ === "foreignObject" && (ie = !1), Pi(null, i, ie), Hh(He) && o["s-si"] !== He && o.classList.add(o["s-si"] = He), i.$children$)
  ...
  let u = 0, o = 0, s = 0, a = 0, l = e.length - 1, c = e[0], f = e[l], d = r.length - 1, h = r[0], g = r[d], w, p;
  for (; u <= l && o <= d; )
    if (c == null)
      c = e[++u];
    else if (f == null)
  ...
  let a;
  s === null ? (ie = o === "svg" ? !0 : o === "foreignObject" ? !1 : ie, o === "slot" || Pi(n, e, ie), i !== null && u !== null ? n1(r, i, e, u, t) : u !== null ? (n.$text$ !== null && (r.textContent = ""), Ii(r, null, e, u, 0, u.length - 1)) : i !== null && Li(i, 0, i.length - 1), ie && o === "svg" && (ie = !1)) : (a = r["s-cr"]) ? a.parentNode.textContent = s : n.$text$ !== s && (r.data = s);
}, _i = (n) => {
        ...
        if (e = t[r], !e["s-cn"] && !e["s-nr"] && e["s-hn"] !== i["s-hn"] && !Oe.experimentalSlotFixes)
          if (Sn(e, u)) {
            ...
            Lt = !0, e["s-sn"] = e["s-sn"] || u, o ? (o.$nodeToRelocate$["s-sh"] = i["s-hn"], o.$slotRefNode$ = i) : (e["s-sh"] = i["s-hn"], Te.push({
              ...
              Sn(s.$nodeToRelocate$, e["s-sn"]) && (o = Te.find((a) => a.$nodeToRelocate$ === e), o && !s.$slotRefNode$ && (s.$slotRefNode$ = o.$slotRefNode$));
            });
...
}, Sn = (n, e) => n.nodeType === 1 ? n.getAttribute("slot") === null && e === "" || n.getAttribute("slot") === e : n["s-sn"] === e ? !0 : e === "", Fi = (n) => {
  ...
  f.$tag$ = null, f.$flags$ |= 4, n.$vnode$ = f, f.$elm$ = c.$elm$ = a.shadowRoot || a, He = a["s-sc"], vr = a["s-cr"], Oi = (l.$flags$ & 1) !== 0, Lt = !1, ze(c, f, t);
  {
    if (ee.$flags$ |= 1, Wr) {
      Ui(f.$elm$);
      for (const d of Te) {
      ...
      for (const d of Te) {
        const h = d.$nodeToRelocate$, g = d.$slotRefNode$;
        if (g) {
          ...
          (!p && w !== h.parentNode || h.nextSibling !== p) && h !== p && (!h["s-hn"] && h["s-ol"] && (h["s-hn"] = h["s-ol"].parentNode.nodeName), w.insertBefore(h, p), h.nodeType === 1 && (h.hidden = (u = h["s-ih"]) !== null && u !== void 0 ? u : !1));
        } else
...
}, ji = (n, e) => (n.$flags$ |= 16, u1(n, n.$ancestorComponent$), C1(() => o1(n, e))), o1 = (n, e) => {
  const t = n.$hostElement$, r = Ne("scheduleUpdate", n.$cmpMeta$.$tagName$), i = t;
  let u;
  return e ? u = Ge(i, "componentWillLoad") : u = Ge(i, "componentWillUpdate"), u = Bn(u, () => Ge(i, "componentWillRender")), r(), Bn(u, () => a1(n, i, e));
}, Bn = (n, e) => s1(n) ? n.then(e) : e(), s1 = (n) => n instanceof Promise || n && n.then && typeof n.then == "function", a1 = async (n, e, t) => {
  const r = n.$hostElement$, i = Ne("update", n.$cmpMeta$.$tagName$);
  r["s-rc"], t && e1(n);
  const u = Ne("render", n.$cmpMeta$.$tagName$);
  l1(n, e, r, t), u(), i(), c1(n);
}, l1 = (n, e, t, r) => {
  try {
  ...
  return Object.assign(n.prototype, {
    ...
    connectedCallback() {
      g1(this), r && r.call(this);
    },
    disconnectedCallback() {
      b1(this), i && i.call(this);
    },
    __attachShadow() {
      this.attachShadow({
        mode: "open",
  ...
  }), n.is = t.$tagName$, h1(n, t);
}, Yi = (n, e, t, r) => {
  t && t.map(([i, u, o]) => {
    const s = v1(n, i), a = y1(e, o), l = x1(i);
  ...
  passive: (n & 1) !== 0,
  capture: (n & 2) !== 0
} : (n & 2) !== 0, qi = /* @__PURE__ */ new WeakMap(), mt = (n) => qi.get(n), w1 = (n, e) => {
  const t = {
    $flags$: 0,
    $hostElement$: n,
    $cmpMeta$: e,
  ...
  return Yi(n, t, e.$listeners$), qi.set(n, t);
}, An = (n, e) => e in n, bt = (n, e) => (0, console.error)(n, e), Ut = /* @__PURE__ */ new Map(), k1 = [], Xt = typeof window < "u" ? window : {}, fe = Xt.document || { head: {} }, Ie = Xt.HTMLElement || class {
}, ee = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (n) => n(),
  ...
  return n;
})(), $1 = (n) => Promise.resolve(n), T1 = /* @__PURE__ */ (() => {
  try {
  ...
  n.push(t), xr || (xr = !0, e && ee.$flags$ & 4 ? B1(wr) : ee.raf(wr));
}, Dn = (n) => {
  ...
  Dn(On), Dn(Hi), (xr = On.length > 0) && ee.raf(wr);
}, B1 = (n) => $1().then(n), C1 = /* @__PURE__ */ S1(Hi, !0), Rn = typeof global < "u" ? global : typeof self < "u" ? self : typeof window < "u" ? window : {};
...
function O1(n) {
  ...
  u = n[s - 2] === "=" ? 2 : n[s - 1] === "=" ? 1 : 0, o = new A1(s * 3 / 4 - u), r = u > 0 ? s - 4 : s;
  var a = 0;
...
function er(n, e, t, r, i) {
  ...
  for (f += d, u = h & (1 << -c) - 1, h >>= -c, c += s; c > 0; u = u * 256 + n[e + f], f += d, c -= 8)
    ;
  for (o = u & (1 << -c) - 1, u >>= -c, c += r; c > 0; o = o * 256 + n[e + f], f += d, c -= 8)
    ;
  if (u === 0)
    u = 1 - l;
  else {
...
function Wi(n, e, t, r, i, u) {
  var o, s, a, l = u * 8 - i - 1, c = (1 << l) - 1, f = c >> 1, d = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = r ? 0 : u - 1, g = r ? 1 : -1, w = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, o = c) : (o = Math.floor(Math.log(e) / Math.LN2), e * (a = Math.pow(2, -o)) < 1 && (o--, a *= 2), o + f >= 1 ? e += d / a : e += d * Math.pow(2, 1 - f), e * a >= 2 && (o++, a /= 2), o + f >= c ? (s = 0, o = c) : o + f >= 1 ? (s = (e * a - 1) * Math.pow(2, i), o = o + f) : (s = e * Math.pow(2, f - 1) * Math.pow(2, i), o = 0)); i >= 8; n[t + h] = s & 255, h += g, s /= 256, i -= 8)
    ;
  for (o = o << i | s, l += i; l > 0; n[t + h] = o & 255, h += g, o /= 256, l -= 8)
    ;
  n[t + h - g] |= w * 128;
}
var M1 = {}.toString, Gi = Array.isArray || function(n) {
  return M1.call(n) == "[object Array]";
};
/*!
...
function Ki(n, e, t, r) {
  ...
  return typeof ArrayBuffer < "u" && e instanceof ArrayBuffer ? N1(n, e, t, r) : typeof e == "string" ? L1(n, e, t) : _1(n, e);
}
...
function _1(n, e) {
  ...
  if (e) {
    if (typeof ArrayBuffer < "u" && e.buffer instanceof ArrayBuffer || "length" in e)
      return typeof e.length != "number" || np(e.length) ? Se(n, 0) : Er(n, e);
    if (e.type === "Buffer" && Gi(e.data))
      return Er(n, e.data);
  }
...
x.prototype.toString = function() {
  var e = this.length | 0;
  return e === 0 ? "" : arguments.length === 0 ? Xi(this, 0, e) : U1.apply(this, arguments);
};
...
x.prototype.compare = function(e, t, r, i, u) {
  ...
  for (var o = u - i, s = r - t, a = Math.min(o, s), l = this.slice(i, u), c = e.slice(t, r), f = 0; f < a; ++f)
    if (l[f] !== c[f]) {
      o = l[f], s = c[f];
      break;
    }
...
function Zi(n, e, t, r, i) {
  ...
  if (typeof e == "string" && (e = x.from(e, r)), we(e))
    return e.length === 0 ? -1 : Pn(n, e, t, r, i);
  if (typeof e == "number")
    return e = e & 255, x.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(n, e, t) : Uint8Array.prototype.lastIndexOf.call(n, e, t) : Pn(n, [e], t, r, i);
...
x.prototype.indexOf = function(e, t, r) {
  return Zi(this, e, t, r, !0);
};
x.prototype.lastIndexOf = function(e, t, r) {
  return Zi(this, e, t, r, !1);
};
function F1(n, e, t, r) {
  t = Number(t) || 0;
  var i = n.length - t;
...
function q1(n, e, t, r) {
  return nr(nu(e), n, t, r);
}
function H1(n, e, t, r) {
  return nr(rp(e, n.length - t), n, t, r);
}
    ...
    if (i + s <= t) {
      ...
      switch (s) {
        ...
        case 3:
          ...
          break;
        case 4:
          a = n[i + 1], l = n[i + 2], c = n[i + 3], (a & 192) === 128 && (l & 192) === 128 && (c & 192) === 128 && (f = (u & 15) << 18 | (a & 63) << 12 | (l & 63) << 6 | c & 63, f > 65535 && f < 1114112 && (o = f));
      }
    }
...
function eu(n, e, t, r, i, u) {
  if (t + r > n.length) throw new RangeError("Index out of range");
  if (t < 0) throw new RangeError("Index out of range");
}
function tu(n, e, t, r, i) {
  return i || eu(n, e, t, 4), Wi(n, e, t, r, 23, 4), t + 4;
}
x.prototype.writeFloatLE = function(e, t, r) {
  return tu(this, e, t, !0, r);
};
x.prototype.writeFloatBE = function(e, t, r) {
  return tu(this, e, t, !1, r);
};
function ru(n, e, t, r, i) {
  return i || eu(n, e, t, 8), Wi(n, e, t, r, 52, 8), t + 8;
}
...
function Q1(n) {
  if (n = X1(n).replace(Z1, ""), n.length < 2) return "";
  for (; n.length % 4 !== 0; )
    n = n + "=";
  return n;
}
...
function ip(n) {
  return n != null && (!!n._isBuffer || iu(n) || up(n));
}
function iu(n) {
  return !!n.constructor && typeof n.constructor.isBuffer == "function" && n.constructor.isBuffer(n);
}
function up(n) {
  return typeof n.readFloatLE == "function" && typeof n.slice == "function" && iu(n.slice(0, 0));
}
...
(function(n, e) {
  (function(t, r) {
    ...
    var t = 1e3, r = 6e4, i = 36e5, u = "millisecond", o = "second", s = "minute", a = "hour", l = "day", c = "week", f = "month", d = "quarter", h = "year", g = "date", w = "Invalid Date", p = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, T = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, O = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(v) {
      ...
      var B = 12 * (y.year() - b.year()) + (y.month() - b.month()), k = b.clone().add(B, f), S = y - k < 0, C = b.clone().add(B + (S ? -1 : 1), f);
      return +(-(B + (y - k) / (S ? k - C : C - k)) || 0);
    }, a: function(v) {
      return v < 0 ? Math.ceil(v) || 0 : Math.floor(v);
    }, p: function(v) {
      return { M: f, y: h, w: c, d: l, D: g, h: a, m: s, s: o, ms: u, Q: d }[v] || String(v || "").toLowerCase().replace(/s$/, "");
    }, u: function(v) {
      return v === void 0;
    } }, L = "en", P = {};
    P[L] = O;
      ...
      return b.parse = function(y) {
        this.$d = function(B) {
          ...
          if (typeof k == "string" && !/Z$/i.test(k)) {
            var C = k.match(p);
            if (C) {
              var I = C[2] - 1 || 0, H = (C[7] || "0").substring(0, 3);
              return S ? new Date(Date.UTC(C[1], I, C[3] || 1, C[4] || 0, C[5] || 0, C[6] || 0, H)) : new Date(C[1], I, C[3] || 1, C[4] || 0, C[5] || 0, C[6] || 0, H);
            }
          }
          return new Date(k);
        ...
        return N(y) < this.startOf(B);
      }, b.isBefore = function(y, B) {
        return this.endOf(B) < N(y);
      }, b.$g = function(y, B, k) {
        return M.u(y) ? this[B] : this.set(k, y);
      }, b.unix = function() {
        return Math.floor(this.valueOf() / 1e3);
      }, b.valueOf = function() {
        return this.$d.getTime();
      }, b.startOf = function(y, B) {
        var k = this, S = !!M.u(B) || B, C = M.p(y), I = function(Fe, re) {
          var Ae = M.w(k.$u ? Date.UTC(k.$y, re, Fe) : new Date(k.$y, re, Fe), k);
          return S ? Ae : Ae.endOf(l);
        }, H = function(Fe, re) {
          return M.w(k.toDate()[Fe].apply(k.toDate("s"), (S ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(re)), k);
        ...
        var k, S = M.p(y), C = "set" + (this.$u ? "UTC" : ""), I = (k = {}, k[l] = C + "Date", k[g] = C + "Date", k[f] = C + "Month", k[h] = C + "FullYear", k[a] = C + "Hours", k[s] = C + "Minutes", k[o] = C + "Seconds", k[u] = C + "Milliseconds", k)[S], H = S === l ? this.$D + (B - this.$W) : B;
        if (S === f || S === h) {
          var G = this.clone().set(g, 1);
          G.$d[I](H), G.init(), this.$d = G.set(g, Math.min(this.$D, G.daysInMonth())).$d;
        } else I && this.$d[I](H);
        ...
        var k, S = this;
        y = Number(y);
        var C = M.p(B), I = function(Z) {
          var Ce = N(S);
          return M.w(Ce.date(Ce.date() + Math.round(Z * y)), S);
        };
        if (C === f) return this.set(f, this.$M + y);
        if (C === h) return this.set(h, this.$y + y);
        if (C === l) return I(1);
        if (C === c) return I(7);
        var H = (k = {}, k[s] = r, k[a] = i, k[o] = t, k)[C] || 1, G = this.$d.getTime() + y * H;
        return M.w(G, this);
        ...
        var S = y || "YYYY-MM-DDTHH:mm:ssZ", C = M.z(this), I = this.$H, H = this.$m, G = this.$M, Z = k.weekdays, Ce = k.months, Ee = function(re, Ae, cr, xt) {
          return re && (re[Ae] || re(B, S)) || cr[Ae].slice(0, xt);
        }, Qe = function(re) {
          return M.s(I % 12 || 12, re, "0");
        }, Xe = k.meridiem || function(re, Ae, cr) {
          var xt = re < 12 ? "AM" : "PM";
          return cr ? xt.toLowerCase() : xt;
        }, Fe = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: G + 1, MM: M.s(G + 1, 2, "0"), MMM: Ee(k.monthsShort, G, Ce, 3), MMMM: Ee(Ce, G), D: this.$D, DD: M.s(this.$D, 2, "0"), d: String(this.$W), dd: Ee(k.weekdaysMin, this.$W, Z, 2), ddd: Ee(k.weekdaysShort, this.$W, Z, 3), dddd: Z[this.$W], H: String(I), HH: M.s(I, 2, "0"), h: Qe(1), hh: Qe(2), a: Xe(I, H, !0), A: Xe(I, H, !1), m: String(H), mm: M.s(H, 2, "0"), s: String(this.$s), ss: M.s(this.$s, 2, "0"), SSS: M.s(this.$ms, 3, "0"), Z: C };
        ...
        var S, C = M.p(B), I = N(y), H = (I.utcOffset() - this.utcOffset()) * r, G = this - I, Z = M.m(this, I);
        return Z = (S = {}, S[h] = Z / 12, S[f] = Z, S[d] = Z / 3, S[c] = (G - H) / 6048e5, S[l] = (G - H) / 864e5, S[a] = G / i, S[s] = G / r, S[o] = G / t, S)[C] || G, k ? Z : M.a(Z);
    ...
    }, N.locale = W, N.isDayjs = F, N.unix = function(v) {
      return N(1e3 * v);
...
var ap = function(n, e, t) {
  ...
  return lu(n) && !isNaN(n.getTime());
}, Nn = function(n) {
  return n.getTimezoneOffset() * 60 * 1e3;
}, dp = function(n, e) {
  var t = n.getTime() - Nn(n), r = e.getTime() - Nn(e), i = t - r;
  return Math.round(i / ou);
}, Tr = function(n) {
  return dp(n, au);
}, cu = function(n) {
  return new Date(au.getTime() + n * ou);
}, fp = function(n) {
  var e = n.getUTCMonth();
  return e === 1 && it(n.getUTCFullYear()) ? 29 : lp[e];
}, Ke = function(n) {
  ...
  var t = Intl.DateTimeFormat().resolvedOptions().timeZone, r = new Date(Fn(n, t)), i = new Date(Fn(n, e ?? "UTC")), u = i.getTime() - r.getTime();
  ...
  function() {
    ...
    return n.isFullyConvertible = function(e) {
      ...
      for (var r in e.origOptions) {
        if (Yn(["dtstart", "wkst", "freq"], r))
          return !0;
        if (!Yn(n.IMPLEMENTED[e.options.freq], r))
          return !1;
      }
      return t;
...
function fu(n, e) {
  ...
  function u() {
    var d = r.accept("on"), h = r.accept("the");
    if (d || h)
      do {
        var g = l(), w = a(), p = s();
        if (g)
          w ? (r.nextSymbol(), t.byweekday || (t.byweekday = []), t.byweekday.push(D[w].nth(g))) : (t.bymonthday || (t.bymonthday = []), t.bymonthday.push(g), r.accept("day(s)"));
        else if (w)
          r.nextSymbol(), t.byweekday || (t.byweekday = []), t.byweekday.push(D[w]);
  ...
  function(n) {
    ...
    return e.fromDate = function(t) {
      ...
      if (this.month += t, this.month > 12) {
        var r = Math.floor(this.month / 12), i = ae(this.month, 12);
      ...
      if (!(this.day <= 28)) {
        var t = _n(this.year, this.month - 1)[1];
        if (!(this.day <= t))
          for (; this.day > t; ) {
            if (this.day -= t, ++this.month, this.month === 13 && (this.month = 1, ++this.year, this.year > su))
              return;
            t = _n(this.year, this.month - 1)[1];
          }
      }
...
function wp(n) {
  ...
  if (K(e.bymonth) && !ue(e.bymonth) && (e.bymonth = [e.bymonth]), K(e.byyearday) && !ue(e.byyearday) && be(e.byyearday) && (e.byyearday = [e.byyearday]), !K(e.bymonthday))
  ...
  if (K(e.byweekno) && !ue(e.byweekno) && (e.byweekno = [e.byweekno]), !K(e.byweekday))
    e.bynweekday = null;
...
function Tp(n) {
  ...
  return e.map(function(t) {
    ...
    var i = Number(r[1]), u = r[2], o = ce[u].weekday;
    return new te(o, i);
  });
}
var Ht = (
...
function Ar(n) {
      ...
      if (!(!K(s) || ue(s) && !s.length)) {
        switch (o) {
          ...
          case "WKST":
            ...
            break;
          case "BYWEEKDAY":
            o = "BYDAY", a = sp(s).map(function(h) {
              return h instanceof te ? h : ue(h) ? new te(h[0], h[1]) : new te(h);
            }).toString();
            break;
          case "DTSTART":
            t = Sp(s, n.tzid);
  ...
  var f = e.map(function(h) {
    var g = h[0], w = h[1];
    return "".concat(g, "=").concat(w.toString());
  }).join(";"), d = "";
...
var Cp = (
  ...
  function() {
    ...
    return n.prototype._cacheAdd = function(e, t, r) {
      ...
      return ue(r) ? Un(r) : r instanceof Date ? Sr(r) : r;
    }, n;
  }()
), Ap = $($($($($($($($($($($($($([], _(1, 31), !0), _(2, 28), !0), _(3, 31), !0), _(4, 30), !0), _(5, 31), !0), _(6, 30), !0), _(7, 31), !0), _(8, 31), !0), _(9, 30), !0), _(10, 31), !0), _(11, 30), !0), _(12, 31), !0), _(1, 7)), Op = $($($($($($($($($($($($($([], _(1, 31), !0), _(2, 29), !0), _(3, 31), !0), _(4, 30), !0), _(5, 31), !0), _(6, 30), !0), _(7, 31), !0), _(8, 31), !0), _(9, 30), !0), _(10, 31), !0), _(11, 30), !0), _(12, 31), !0), _(1, 7)), Dp = ke(1, 29), Rp = ke(1, 30), De = ke(1, 31), Q = ke(1, 32), Mp = $($($($($($($($($($($($($([], Q, !0), Rp, !0), Q, !0), De, !0), Q, !0), De, !0), Q, !0), Q, !0), De, !0), Q, !0), De, !0), Q, !0), Q.slice(0, 7)), Pp = $($($($($($($($($($($($($([], Q, !0), Dp, !0), Q, !0), De, !0), Q, !0), De, !0), Q, !0), Q, !0), De, !0), Q, !0), De, !0), Q, !0), Q.slice(0, 7)), Ip = ke(-28, 0), Lp = ke(-29, 0), Re = ke(-30, 0), X = ke(-31, 0), Np = $($($($($($($($($($($($($([], X, !0), Lp, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X.slice(0, 7)), _p = $($($($($($($($($($($($($([], X, !0), Ip, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X.slice(0, 7)), Up = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366], Fp = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365], zn = function() {
  for (var n = [], e = 0; e < 55; e++)
    n = n.concat(ke(7));
  return n;
}();
function jp(n, e) {
  var t = _e(n, 1, 1), r = it(n) ? 366 : 365, i = it(n + 1) ? 366 : 365, u = Tr(t), o = Ke(t), s = oe(oe({ yearlen: r, nextyearlen: i, yearordinal: u, yearweekday: o }, Yp(n)), { wnomask: null });
  if (ye(e.byweekno))
    return s;
  s.wnomask = _(0, r + 7);
  var a, l, c = a = ae(7 - o + e.wkst, 7);
  c >= 4 ? (c = 0, l = s.yearlen + ae(o - e.wkst, 7)) : l = r - c;
  for (var f = Math.floor(l / 7), d = ae(l, 7), h = Math.floor(f + d / 4), g = 0; g < e.byweekno.length; g++) {
    var w = e.byweekno[g];
    if (w < 0 && (w += h + 1), w > 0 && w <= h) {
      var p = void 0;
      w > 1 ? (p = c + (w - 1) * 7, c !== a && (p -= 7 - a)) : p = c;
  ...
  if (c) {
    ...
    if (Y(e.byweekno, -1))
      ...
      var q = Ke(_e(n - 1, 1, 1)), A = ae(7 - q.valueOf() + e.wkst, 7), L = it(n - 1) ? 366 : 365, P = void 0;
      A >= 4 ? (A = 0, P = L + ae(q - e.wkst, 7)) : P = r - c, O = Math.floor(52 + ae(P, 7) / 4);
    }
    if (Y(e.byweekno, O))
      for (var p = 0; p < c; p++)
        s.wnomask[p] = 1;
...
function Yp(n) {
  var e = it(n) ? 366 : 365, t = _e(n, 1, 1), r = Ke(t);
  return e === 365 ? {
    mmask: Ap,
    mdaymask: Pp,
    nmdaymask: _p,
...
function qp(n, e, t, r, i, u) {
  ...
  for (var a = 0; a < s.length; a++)
    for (var l = s[a], c = l[0], f = l[1] - 1, d = 0; d < u.bynweekday.length; d++) {
      var h = void 0, g = u.bynweekday[d], w = g[0], p = g[1];
      p < 0 ? (h = f + (p + 1) * 7, h -= ae(i[h] - w, 7)) : (h = c + (p - 1) * 7, h += ae(7 - i[h] + w, 7)), c <= h && h <= f && (o.nwdaymask[h] = 1);
    }
  return o;
}
function Hp(n, e) {
  e === void 0 && (e = 0);
  var t = n % 19, r = Math.floor(n / 100), i = n % 100, u = Math.floor(r / 4), o = r % 4, s = Math.floor((r + 8) / 25), a = Math.floor((r - s + 1) / 3), l = Math.floor(19 * t + r - u - a + 15) % 30, c = Math.floor(i / 4), f = i % 4, d = Math.floor(32 + 2 * o + 2 * c - l - f) % 7, h = Math.floor((t + 11 * l + 22 * d) / 451), g = Math.floor((l + d - 7 * h + 114) / 31), w = (l + d - 7 * h + 114) % 31 + 1, p = Date.UTC(n, g - 1, w + e), T = Date.UTC(n, 0, 1);
...
var zp = (
  ...
  function() {
    ...
    return n.prototype.rebuild = function(e, t) {
      ...
      K(r.byeaster) && (this.eastermask = Hp(e, r.byeaster));
      ...
      for (var i = _(null, this.yearlen + 7), u = Tr(_e(e, t, r)) - this.yearordinal, o = u, s = 0; s < 7 && (i[u] = u, ++u, this.wdaymask[u] !== this.options.wkst); s++)
        ;
      return [i, o, u];
    }, n.prototype.ddayset = function(e, t, r) {
      var i = _(null, this.yearlen), u = Tr(_e(e, t, r)) - this.yearordinal;
  ...
  for (var c = Jp(l, a, e); ; ) {
    ...
    if (J(o))
      ...
      for (var T = h; T < g; T++) {
        var A = d[T];
        if (K(A))
          for (var L = cu(l.yearordinal + A), P = 0; P < c.length; P++) {
            var F = c[P], O = du(L, F);
            if (u && O > u)
              return $e(n);
            if (O >= t) {
    ...
    if (e.interval === 0 || (a.add(e, w), a.year > su))
      return $e(n);
...
var ce = {
  ...
  function() {
    function n(e, t) {
      e === void 0 && (e = {}), t === void 0 && (t = !1), this._cache = t ? null : new Cp(), this.origOptions = hu(e);
      var r = wp(e).parsedOptions;
      this.options = r;
    }
    return n.parseText = function(e, t) {
      ...
      if (e)
        return this._iter(new jn("all", {}, e));
      ...
      if (i)
        return this._iter(new jn("between", u, i));
...
function Zp(n, e, t, r, i, u) {
  var o = {}, s = n.accept;
  function a(d, h) {
    t.forEach(function(g) {
      g.between(d, h, !0).forEach(function(w) {
        o[Number(w)] = !0;
      });
    });
  }
  i.forEach(function(d) {
    ...
    var h = Number(d);
    return isNaN(h) ? s.call(this, d) : !o[h] && (a(new Date(h - 1), new Date(h + 1)), !o[h]) ? (o[h] = !0, s.call(this, d)) : !0;
...
function Qp(n, e) {
  var t = [], r = [], i = [], u = [], o = qt(n), s = o.dtstart, a = o.tzid, l = ng(n, e.unfold);
  return l.forEach(function(c) {
    var f;
    if (c) {
      var d = rg(c), h = d.name, g = d.parms, w = d.value;
...
function Xp(n, e) {
  var t = Qp(n, e), r = t.rrulevals, i = t.rdatevals, u = t.exrulevals, o = t.exdatevals, s = t.dtstart, a = t.tzid, l = e.cache === !1;
...
function Kn(n, e) {
  return e === void 0 && (e = {}), Xp(n, eg(e));
}
function fr(n, e, t) {
  return oe(oe({}, n), { dtstart: e, tzid: t });
}
function eg(n) {
  var e = [], t = Object.keys(n), r = Object.keys(Gn);
...
function rg(n) {
  var e = tg(n), t = e.name, r = e.value, i = t.split(";");
  if (!i)
...
`).map(function(i) {
      ...
      }), this._rdate.length && t.push(Xn("RDATE", this._rdate, this.tzid())), this._exdate.length && t.push(Xn("EXDATE", this._exdate, this.tzid())), t;
...
class zt {
  ...
  init(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.prefix = t.prefix || "i18next:", this.logger = e || og, this.options = t, this.debug = t.debug;
  }
  log() {
...
function ut(n, e, t) {
  function r(s) {
    return s && s.indexOf("###") > -1 ? s.replace(ag, ".") : s;
  }
  function i() {
...
function gu(n, e, t) {
  for (const r in e)
    r !== "__proto__" && r !== "constructor" && (r in n ? typeof n[r] == "string" || n[r] instanceof String || typeof e[r] == "string" || e[r] instanceof String ? t && (n[r] = e[r]) : gu(n[r], e[r], t) : n[r] = e[r]);
  return n;
}
function Ye(n) {
  return n.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
...
function fg(n) {
  return typeof n == "string" ? n.replace(/[&<>"'\/]/g, (e) => dg[e]) : n;
}
class hg {
  constructor(e) {
...
const pg = [" ", ",", "?", "!", ";"], gg = new hg(20);
function mg(n, e, t) {
  e = e || "", t = t || "";
  const r = pg.filter((o) => e.indexOf(o) < 0 && t.indexOf(o) < 0);
  if (r.length === 0) return !0;
  const i = gg.getRegExp(`(${r.map((o) => o === "?" ? "\\?" : o).join("|")})`);
  let u = !i.test(n);
  if (!u) {
    const o = n.indexOf(t);
...
class ri extends ir {
  ...
  addResource(e, t, r, i) {
    ...
    let s = [e, t];
    r && (s = s.concat(o ? r.split(o) : r)), e.indexOf(".") > -1 && (s = e.split("."), i = t, t = s[1]), this.addNamespaces(t), ti(this.data, s, i), u.silent || this.emit("added", e, t, r, i);
  }
  addResources(e, t, r) {
    let i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, t, r, i, u) {
    ...
    o.skipCopy || (r = JSON.parse(JSON.stringify(r))), i ? gu(a, r, u) : a = {
      ...a,
      ...r
    }, ti(this.data, s, a), o.silent || this.emit("added", e, t, r);
  }
...
class Kt extends ir {
  ...
  extractFromKey(e, t) {
    ...
    const o = r && e.indexOf(r) > -1, s = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !mg(e, r, i);
    if (o && !s) {
  ...
  translate(e, t, r) {
    ...
    let d = f && f.res;
    const h = f && f.usedKey || o, g = f && f.exactUsedKey || o, w = Object.prototype.toString.apply(d), p = ["[object Number]", "[object Function]", "[object RegExp]"], T = t.joinArrays !== void 0 ? t.joinArrays : this.options.joinArrays, O = !this.i18nFormat || this.i18nFormat.handleAsObject;
    if (O && d && (typeof d != "string" && typeof d != "boolean" && typeof d != "number") && p.indexOf(w) < 0 && !(typeof T == "string" && Array.isArray(d))) {
      if (!t.returnObjects && !this.options.returnObjects) {
        this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
        const A = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(h, d, {
          ...t,
          ns: s
      ...
      if (u) {
        const A = Array.isArray(d), L = A ? [] : {}, P = A ? g : h;
        for (const F in d)
    ...
    } else if (O && typeof T == "string" && Array.isArray(d))
      d = d.join(T), d && (d = this.extendTranslation(d, e, t, r));
    else {
      let A = !1, L = !1;
      const P = t.count !== void 0 && typeof t.count != "string", F = Kt.hasDefaultValue(t), W = P ? this.pluralResolver.getSuffix(l, t.count, t) : "", N = t.ordinal && P ? this.pluralResolver.getSuffix(l, t.count, {
        ordinal: !1
      }) : "", M = P && !t.ordinal && t.count === 0 && this.pluralResolver.shouldUseIntlApi(), m = M && t[`defaultValue${this.options.pluralSeparator}zero`] || t[`defaultValue${W}`] || t[`defaultValue${N}`] || t.defaultValue;
      !this.isValidLookup(d) && F && (A = !0, d = m), this.isValidLookup(d) || (L = !0, d = o);
      const v = (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && L ? void 0 : d, b = F && m !== d && this.options.updateMissing;
      if (L || A || b) {
        ...
        const k = (S, C, I) => {
          const H = F && I !== d ? I : v;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(S, a, C, H, b, t) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(S, a, C, H, b, t), this.emit("missingKey", S, a, C, d);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && P ? y.forEach((S) => {
          const C = this.pluralResolver.getSuffixes(S, t);
          M && t[`defaultValue${this.options.pluralSeparator}zero`] && C.indexOf(`${this.options.pluralSeparator}zero`) < 0 && C.push(`${this.options.pluralSeparator}zero`), C.forEach((I) => {
            k([S], o + I, t[`defaultValue${I}`] || m);
          });
        }) : k(y, o, m));
      }
      d = this.extendTranslation(d, e, t, f, r), L && d === o && this.options.appendNamespaceToMissingKey && (d = `${a}:${o}`), (L || A) && this.options.parseMissingKeyHandler && (this.options.compatibilityAPI !== "v1" ? d = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${o}` : o, A ? d : void 0) : d = this.options.parseMissingKeyHandler(d));
    }
  ...
  extendTranslation(e, t, r, i, u) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse)
      ...
      !r.lng && this.options.compatibilityAPI !== "v1" && i && i.res && (r.lng = i.usedLng), r.nest !== !1 && (e = this.interpolator.nest(e, function() {
        for (var d = arguments.length, h = new Array(d), g = 0; g < d; g++)
          h[g] = arguments[g];
    ...
    return e != null && a && a.length && r.applyPostProcessor !== !1 && (e = mu.handle(a, e, t, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...i,
  ...
  resolve(e) {
    ...
    return typeof e == "string" && (e = [e]), e.forEach((a) => {
      ...
      const d = t.count !== void 0 && typeof t.count != "string", h = d && !t.ordinal && t.count === 0 && this.pluralResolver.shouldUseIntlApi(), g = t.context !== void 0 && (typeof t.context == "string" || typeof t.context == "number") && t.context !== "", w = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
      f.forEach((p) => {
        this.isValidLookup(r) || (s = p, !ni[`${w[0]}-${p}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(s) && (ni[`${w[0]}-${p}`] = !0, this.logger.warn(`key "${i}" for languages "${w.join(", ")}" won't get resolved as namespace "${s}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), w.forEach((T) => {
          if (this.isValidLookup(r)) return;
          o = T;
          const O = [c];
          if (this.i18nFormat && this.i18nFormat.addLookupKeys)
            ...
            let A;
            d && (A = this.pluralResolver.getSuffix(T, t.count, t));
            const L = `${this.options.pluralSeparator}zero`, P = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (d && (O.push(c + A), t.ordinal && A.indexOf(P) === 0 && O.push(c + A.replace(P, this.options.pluralSeparator)), h && O.push(c + L)), g) {
              const F = `${c}${this.options.contextSeparator}${t.context}`;
              O.push(F), d && (O.push(F + A), t.ordinal && A.indexOf(P) === 0 && O.push(F + A.replace(P, this.options.pluralSeparator)), h && O.push(F + L));
            }
          }
          let q;
          for (; q = O.pop(); )
...
class kg {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = t, this.logger = xe.create("pluralResolver"), (!this.options.compatibilityJSON || xg.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = wg();
  }
  addRule(e, t) {
    this.rules[e] = t;
  }
  ...
  getSuffixes(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const r = this.getRule(e, t);
    return r ? this.shouldUseIntlApi() ? r.resolvedOptions().pluralCategories.sort((i, u) => ui[i] - ui[u]).map((i) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${i}`) : r.numbers.map((i) => this.getSuffix(e, i, t)) : [];
  }
  getSuffix(e, t) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
...
class Eg {
  ...
  init() {
    ...
    this.escape = t !== void 0 ? t : fg, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = i !== void 0 ? i : !1, this.prefix = u ? Ye(u) : o || "{{", this.suffix = s ? Ye(s) : a || "}}", this.formatSeparator = l || ",", this.unescapePrefix = c ? "" : f || "-", this.unescapeSuffix = this.unescapePrefix ? "" : c || "", this.nestingPrefix = d ? Ye(d) : h || Ye("$t("), this.nestingSuffix = g ? Ye(g) : w || Ye(")"), this.nestingOptionsSeparator = p || ",", this.maxReplaces = T || 1e3, this.alwaysFormat = O !== void 0 ? O : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, t, r, i) {
    ...
    const c = (g) => {
      if (g.indexOf(this.formatSeparator) < 0) {
        const O = oi(t, a, g, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(oi(t, a, p, this.options.keySeparator, this.options.ignoreJSONStructure), T, r, {
        ...i,
        ...t,
        interpolationkey: p
      });
    ...
    return [{
      ...
      for (s = 0; u = g.regex.exec(e); ) {
        ...
        if (e = e.replace(u[0], p), d ? (g.regex.lastIndex += o.length, g.regex.lastIndex -= u[0].length) : g.regex.lastIndex = 0, s++, s >= this.maxReplaces)
          break;
      }
    }), e;
  }
  nest(e, t) {
    ...
    function s(a, l) {
      ...
      let d = `{${f[1]}`;
      a = f[0], d = this.interpolate(d, o);
      const h = d.match(/'/g), g = d.match(/"/g);
      (h && h.length % 2 === 0 && !g || g.length % 2 !== 0) && (d = d.replace(/'/g, '"'));
      try {
        o = JSON.parse(d), l && (o = {
          ...l,
          ...o
        ...
        return this.logger.warn(`failed parsing options string in nesting for key ${a}`, w), `${a}${c}${d}`;
      }
    ...
    for (; i = this.nestingRegexp.exec(e); ) {
      ...
      typeof u != "string" && (u = ei(u)), u || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), u = ""), l && (u = a.reduce((c, f) => this.format(c, f, r.lng, {
        ...r,
...
class Bg extends ir {
  ...
  queueLoad(e, t, r, i) {
    ...
    return e.forEach((l) => {
      ...
      t.forEach((f) => {
        const d = `${l}|${f}`;
        !r.reload && this.store.hasResourceBundle(l, f) ? this.state[d] = 2 : this.state[d] < 0 || (this.state[d] === 1 ? o[d] === void 0 && (o[d] = !0) : (this.state[d] = 1, c = !1, o[d] === void 0 && (o[d] = !0), u[d] === void 0 && (u[d] = !0), a[f] === void 0 && (a[f] = !0)));
      }), c || (s[l] = !0);
  ...
  loaded(e, t, r) {
    ...
    this.queue.forEach((a) => {
      lg(a.loaded, [u], o), Sg(a, e), t && a.errors.push(t), a.pendingCount === 0 && !a.done && (Object.keys(a.loaded).forEach((l) => {
        s[l] || (s[l] = {});
        const c = a.loaded[l];
    ...
    if (!(r == null || r === "")) {
      if (this.backend && this.backend.create) {
        ...
        if (l.length < 6)
          try {
            let c;
            l.length === 5 ? c = l(e, t, r, i, a) : c = l(e, t, r, i), c && typeof c.then == "function" ? c.then((f) => s(null, f)).catch(s) : s(null, c);
          } catch (c) {
            s(c);
          }
        else
...
class ct extends ir {
  constructor() {
    ...
    if (super(), this.options = ai(e), this.services = {}, this.logger = xe, this.modules = {
      external: []
    }, Cg(this), t && !this.isInitialized && !e.isClone) {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      let c;
      this.modules.formatter ? c = this.modules.formatter : typeof Intl < "u" && (c = Tg);
      const f = new ii(this.options);
      this.store = new ri(this.options.resources, this.options);
      const d = this.services;
      d.logger = xe, d.resourceStore = this.store, d.languageUtils = f, d.pluralResolver = new kg(f, {
        prepend: this.options.pluralSeparator,
        compatibilityJSON: this.options.compatibilityJSON,
        simplifyPluralSuffix: this.options.simplifyPluralSuffix
      }), c && (!this.options.interpolation.format || this.options.interpolation.format === i.interpolation.format) && (d.formatter = u(c), d.formatter.init(d, this.options), this.options.interpolation.format = d.formatter.format.bind(d.formatter)), d.interpolator = new Eg(this.options), d.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, d.backendConnector = new Bg(u(this.modules.backend), d.resourceStore, d, this.options), d.backendConnector.on("*", function(h) {
  ...
  use(e) {
    ...
    return e.type === "backend" && (this.modules.backend = e), (e.type === "logger" || e.log && e.warn && e.error) && (this.modules.logger = e), e.type === "languageDetector" && (this.modules.languageDetector = e), e.type === "i18nFormat" && (this.modules.i18nFormat = e), e.type === "postProcessor" && mu.addPostProcessor(e), e.type === "formatter" && (this.modules.formatter = e), e.type === "3rdParty" && this.modules.external.push(e), this;
  }
    ...
    const u = function(o, s) {
      ...
      if (typeof s != "object") {
        for (var l = arguments.length, c = new Array(l > 2 ? l - 2 : 0), f = 2; f < l; f++)
          c[f - 2] = arguments[f];
        a = i.options.overloadTranslationOptionHandler([o, s].concat(c));
      } else
        a = {
          ...s
        };
      ...
      let h;
      return a.keyPrefix && Array.isArray(o) ? h = o.map((g) => `${a.keyPrefix}${d}${g}`) : h = a.keyPrefix ? `${a.keyPrefix}${d}${o}` : o, i.t(h, a);
    };
  ...
  dir(e) {
    ...
    const t = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], r = this.services && this.services.languageUtils || new ii(si());
...
const yu = "No date selected", vu = "Choose another time slot to reschedule your meeting", xu = {
  ...
  bookNowButton: Iu,
  bookingConfirmed: Lu,
  bookingConfirmedDescription: Nu,
  bookingSent: _u,
  bookingSentDescription: Uu,
  bookingRescheduled: Fu,
  bookingDateAndTimeHeader: ju,
  cancelBookingButton: Yu,
  rescheduleBookingButton: qu,
  rejectBookingButton: Hu,
  confirmBookingButton: zu,
  ...
  goBackButton: Xu,
  bookingCancelledTitle: eo,
  bookingCancelledMessage: to,
  closeButton: ro,
  closingButton: no,
  fieldRequired: io,
  invalidInputFormat: uo,
  createBookingErrorTitle: oo,
  getAvailabilityErrorTitle: so,
  cancelBookingErrorTitle: ao,
  rescheduleBookingErrorTitle: lo,
  getUISettingErrorTitle: co,
  rejectBookingErrorTitle: fo,
  confirmBookingErrorTitle: ho,
  genericErrorTitle: po,
  schedulingComponentErrorTitle: go,
  sessionIdRequiredErrorMessage: mo,
  publicConfigErrorMessage: bo,
  invalidTimeslotErrorTitle: yo,
  invalidTimeslotErrorMessage: vo,
  ...
  cancelBokingFormError: Eo,
  default: Ag
}), $o = "Aucune date sélectionnée", To = "Choisissez un autre créneau horaire pour reprogrammer votre réunion", So = {
  sunday: "DIM",
  monday: "LUN",
  tuesday: "MAR",
  wednesday: "MER",
  ...
  confirmedEventCardTitle: es,
  confirmedEventCardDescription: ts,
  cancelBookingTitle: rs,
  cancelBookingMessage: ns,
  reasonForCancellation: is,
  goBackButton: us,
  bookingCancelledTitle: os,
  bookingCancelledMessage: ss,
  closeButton: as,
  closingButton: ls,
  fieldRequired: cs,
  invalidInputFormat: ds,
  createBookingErrorTitle: fs,
  getAvailabilityErrorTitle: hs,
  cancelBookingErrorTitle: ps,
  rescheduleBookingErrorTitle: gs,
  getUISettingErrorTitle: ms,
  rejectBookingErrorTitle: bs,
  confirmBookingErrorTitle: ys,
  genericErrorTitle: vs,
  schedulingComponentErrorTitle: xs,
  sessionIdRequiredErrorMessage: ws,
  publicConfigErrorMessage: ks,
  invalidTimeslotErrorTitle: Es,
  invalidTimeslotErrorMessage: $s,
  cancellationErrorTitle: Ts,
  cancellationErrorMessage: Ss,
  ...
  cancelBokingFormError: Cs,
  default: Dg
}), As = "No has seleccionado ninguna fecha", Os = "Elige otro horario para reprogramar tu reunión", Ds = {
  sunday: "DOM",
  monday: "LUN",
  tuesday: "MAR",
  wednesday: "MIÉ",
  ...
  rescheduleBookingButton: ea,
  rejectBookingButton: ta,
  confirmBookingButton: ra,
  bookingPendingTitle: na,
  bookingPendingnDescription: ia,
  confirmedEventCardTitle: ua,
  confirmedEventCardDescription: oa,
  cancelBookingTitle: sa,
  cancelBookingMessage: aa,
  reasonForCancellation: la,
  goBackButton: ca,
  bookingCancelledTitle: da,
  bookingCancelledMessage: fa,
  closeButton: ha,
  closingButton: pa,
  fieldRequired: ga,
  invalidInputFormat: ma,
  createBookingErrorTitle: ba,
  getAvailabilityErrorTitle: ya,
  cancelBookingErrorTitle: va,
  rescheduleBookingErrorTitle: xa,
  getUISettingErrorTitle: wa,
  rejectBookingErrorTitle: ka,
  confirmBookingErrorTitle: Ea,
  genericErrorTitle: $a,
  schedulingComponentErrorTitle: Ta,
  sessionIdRequiredErrorMessage: Sa,
  publicConfigErrorMessage: Ba,
  invalidTimeslotErrorTitle: Ca,
  invalidTimeslotErrorMessage: Aa,
  cancellationErrorTitle: Oa,
  ...
  cancelBokingFormError: Ma,
  default: Mg
}), Pa = "日付が選択されていません", Ia = "別の時間を選択してください", La = {
  sunday: "日",
  monday: "月",
  tuesday: "火",
  wednesday: "水",
  ...
  november: "11月",
  december: "12月"
}, Ua = "次", Fa = "{{date}}", ja = "{{time}}", Ya = "名前", qa = "名前を入力してください", Ha = "メールアドレス", za = "メールアドレスを入力してください", Wa = "ゲストのメールアドレス", Ga = "ゲストのメールアドレスを入力してください", Ka = "ゲストを追加", Ja = "他のゲストを追加", Va = "戻る", Za = "今すぐ予約", Qa = "予約が確認されました", Xa = "間もなくメールで確認が届きます。", el = "予約が送信されました", tl = "予約が確認され次第、メールをお送りします。", rl = "予約が再予定されました", nl = "予約の日付と時間", il = "予約をキャンセル", ul = "再調整", ol = "予約を拒否", sl = "予約を確認", al = "予約保留中", ll = "以下で予約を管理します。招待者にはリクエストステータスを知らせるメールが届きます。", cl = "予約が正常に確認されました", dl = "確認メールが送信されました", fl = "予約をキャンセルしますか？", hl = "現在の時間枠は他の人に利用可能になります。", pl = "キャンセルの理由", gl = "戻る", ml = "予約が正常にキャンセルされました", bl = "キャンセルメールが送信されました", yl = "閉じる", vl = "閉じる", xl = "{{field}} は必須です.", wl = "{{field}} の形式が無効です.", kl = "予約作成", El = "空き状況を取得", $l = "予約をキャンセル", Tl = "予約の再スケジュール", Sl = "UI設定を取得", Bl = "予約を拒否", Cl = "予約を確認", Al = "何かがうまくいかなかった...", Ol = "スケジューリングコンポーネントエラー", Dl = "プライベート構成には 'sessionId' が必要です。", Rl = "公開設定を使用する場合は、configurationId または 'slug' と 'clientId' の組み合わせを渡します。", Ml = "無効な時間帯！", Pl = "選択された時間帯は無効です", Il = "キャンセルエラー", Ll = "キャンセルの理由を入力してください。", Nl = "イベントの{{minCancellationNotice}}分前には予約をキャンセルできません", _l = "予約キャンセルフォームエラー", Ig = {
  noDateSelected: Pa,
  rescheduleTitle: Ia,
  days: La,
  time: Na,
  ...
  bookingSent: el,
  bookingSentDescription: tl,
  bookingRescheduled: rl,
  bookingDateAndTimeHeader: nl,
  cancelBookingButton: il,
  rescheduleBookingButton: ul,
  rejectBookingButton: ol,
  confirmBookingButton: sl,
  bookingPendingTitle: al,
  bookingPendingnDescription: ll,
  confirmedEventCardTitle: cl,
  confirmedEventCardDescription: dl,
  cancelBookingTitle: fl,
  cancelBookingMessage: hl,
  reasonForCancellation: pl,
  goBackButton: gl,
  bookingCancelledTitle: ml,
  bookingCancelledMessage: bl,
  closeButton: yl,
  closingButton: vl,
  fieldRequired: xl,
  invalidInputFormat: wl,
  createBookingErrorTitle: kl,
  getAvailabilityErrorTitle: El,
  cancelBookingErrorTitle: $l,
  rescheduleBookingErrorTitle: Tl,
  getUISettingErrorTitle: Sl,
  rejectBookingErrorTitle: Bl,
  confirmBookingErrorTitle: Cl,
  genericErrorTitle: Al,
  schedulingComponentErrorTitle: Ol,
  sessionIdRequiredErrorMessage: Dl,
  publicConfigErrorMessage: Rl,
  invalidTimeslotErrorTitle: Ml,
  invalidTimeslotErrorMessage: Pl,
  cancellationErrorTitle: Il,
  cancellationErrorMessage: Ll,
  minimumCancellationErrorMessage: Nl,
  cancelBokingFormError: _l
  ...
  cancelBokingFormError: _l,
  default: Ig
}), Ul = "Kein Datum ausgewählt", Fl = "Wählen Sie einen anderen Zeitpunkt, um Ihr Meeting neu zu planen", jl = {
  sunday: "SO",
  monday: "MO",
  tuesday: "DI",
  wednesday: "MI",
  ...
  bookNowButton: rc,
  bookingConfirmed: nc,
  bookingConfirmedDescription: ic,
  bookingSent: uc,
  bookingSentDescription: oc,
  bookingRescheduled: sc,
  bookingDateAndTimeHeader: ac,
  cancelBookingButton: lc,
  rescheduleBookingButton: cc,
  rejectBookingButton: dc,
  confirmBookingButton: fc,
  bookingPendingTitle: hc,
  bookingPendingnDescription: pc,
  confirmedEventCardTitle: gc,
  confirmedEventCardDescription: mc,
  cancelBookingTitle: bc,
  cancelBookingMessage: yc,
  reasonForCancellation: vc,
  goBackButton: xc,
  ...
  closingButton: $c,
  fieldRequired: Tc,
  invalidInputFormat: Sc,
  createBookingErrorTitle: Bc,
  getAvailabilityErrorTitle: Cc,
  cancelBookingErrorTitle: Ac,
  rescheduleBookingErrorTitle: Oc,
  getUISettingErrorTitle: Dc,
  rejectBookingErrorTitle: Rc,
  confirmBookingErrorTitle: Mc,
  genericErrorTitle: Pc,
  schedulingComponentErrorTitle: Ic,
  sessionIdRequiredErrorMessage: Lc,
  publicConfigErrorMessage: Nc,
  invalidTimeslotErrorTitle: _c,
  invalidTimeslotErrorMessage: Uc,
  cancellationErrorTitle: Fc,
  cancellationErrorMessage: jc,
  minimumCancellationErrorMessage: Yc,
  ...
  cancelBokingFormError: qc,
  default: Ng
}), Hc = "Ingen dag vald", zc = "Välj en annan tid för att boka om din tid", Wc = {
  sunday: "SÖN",
  monday: "MÅN",
  tuesday: "TIS",
  wednesday: "ONS",
  ...
  bookingSent: c0,
  bookingSentDescription: d0,
  bookingRescheduled: f0,
  bookingDateAndTimeHeader: h0,
  cancelBookingButton: p0,
  rescheduleBookingButton: g0,
  rejectBookingButton: m0,
  confirmBookingButton: b0,
  bookingPendingTitle: y0,
  bookingPendingnDescription: v0,
  confirmedEventCardTitle: x0,
  confirmedEventCardDescription: w0,
  cancelBookingTitle: k0,
  ...
  rescheduleBookingErrorTitle: I0,
  getUISettingErrorTitle: L0,
  rejectBookingErrorTitle: N0,
  confirmBookingErrorTitle: _0,
  ...
  invalidTimeslotErrorMessage: H0,
  ...
  november: "十一月",
  december: "十二月"
}, ed = "下一个", td = "{{date}}", rd = "{{time}}", nd = "姓名", id = "输入你的名字", ud = "电子邮件", od = "输入你的电子邮件", sd = "客人的电子邮件", ad = "输入客人的电子邮件", ld = "添加客人", cd = "添加另一个客人", dd = "返回", fd = "立即预订", hd = "预订已确认", pd = "您将很快收到一封确认电子邮件。", gd = "预订已发送", md = "预订确认后，您将收到一封电子邮件。", bd = "预订已重新安排", yd = "预订日期和时间", vd = "取消预订", xd = "重新安排", wd = "拒绝预订", kd = "确认预订", Ed = "预订待处理", $d = "在下方管理您的预订。受邀者将收到一封电子邮件，通知他们请求状态。", Td = "您的预订已成功确认", Sd = "确认邮件已发送至", Bd = "取消预订？", Cd = "您当前的时间段将对其他人开放。", Ad = "取消原因", Od = "返回", Dd = "您的预订已成功取消", Rd = "取消邮件已发送至", Md = "关闭", Pd = "关闭", Id = "{{field}} 是必需的.", Ld = "{{field}} 格式无效.", Nd = "创建预订", _d = "获取可用性", Ud = "取消预订", Fd = "重新安排预订", jd = "获取UI设置", Yd = "拒绝预订", qd = "确认预订", Hd = "出了点问题...", zd = "调度组件错误", Wd = "私有配置需要 'sessionId'。", Gd = "如果使用公共配置，请传递 configurationId 或 'slug' 和 'clientId' 的组合。", Kd = "无效的时间段！", Jd = "所选时间段无效", Vd = "取消错误", Zd = "请提供取消的原因。", Qd = "您不能在活动开始前的{{minCancellationNotice}}分钟内取消预订", Xd = "取消预订表单错误", jg = {
  noDateSelected: J0,
  rescheduleTitle: V0,
  days: Z0,
  time: Q0,
  ...
  bookingSent: gd,
  bookingSentDescription: md,
  bookingRescheduled: bd,
  bookingDateAndTimeHeader: yd,
  cancelBookingButton: vd,
  rescheduleBookingButton: xd,
  rejectBookingButton: wd,
  confirmBookingButton: kd,
  bookingPendingTitle: Ed,
  bookingPendingnDescription: $d,
  confirmedEventCardTitle: Td,
  confirmedEventCardDescription: Sd,
  cancelBookingTitle: Bd,
  cancelBookingMessage: Cd,
  reasonForCancellation: Ad,
  goBackButton: Od,
  bookingCancelledTitle: Dd,
  bookingCancelledMessage: Rd,
  closeButton: Md,
  closingButton: Pd,
  fieldRequired: Id,
  invalidInputFormat: Ld,
  createBookingErrorTitle: Nd,
  getAvailabilityErrorTitle: _d,
  cancelBookingErrorTitle: Ud,
  rescheduleBookingErrorTitle: Fd,
  getUISettingErrorTitle: jd,
  rejectBookingErrorTitle: Yd,
  confirmBookingErrorTitle: qd,
  genericErrorTitle: Hd,
  schedulingComponentErrorTitle: zd,
  ...
  cancelBokingFormError: Xd,
  default: jg
}), ef = "Geen datum geselecteerd", tf = "Kies een ander tijdslot om je afspraak te verzetten", rf = {
  sunday: "ZO",
  monday: "MA",
  tuesday: "DI",
  wednesday: "WO",
  ...
  emailPlaceholder: ff,
  guestEmail: hf,
  guestEmailPlaceholder: pf,
  addGuest: gf,
  addAnotherGuest: mf,
  backButton: bf,
  bookNowButton: yf,
  bookingConfirmed: vf,
  bookingConfirmedDescription: xf,
  bookingSent: wf,
  bookingSentDescription: kf,
  bookingRescheduled: Ef,
  bookingDateAndTimeHeader: $f,
  cancelBookingButton: Tf,
  rescheduleBookingButton: Sf,
  rejectBookingButton: Bf,
  confirmBookingButton: Cf,
  bookingPendingTitle: Af,
  bookingPendingnDescription: Of,
  confirmedEventCardTitle: Df,
  confirmedEventCardDescription: Rf,
  cancelBookingTitle: Mf,
  cancelBookingMessage: Pf,
  reasonForCancellation: If,
  goBackButton: Lf,
  bookingCancelledTitle: Nf,
  bookingCancelledMessage: _f,
  closeButton: Uf,
  closingButton: Ff,
  fieldRequired: jf,
  invalidInputFormat: Yf,
  createBookingErrorTitle: qf,
  getAvailabilityErrorTitle: Hf,
  cancelBookingErrorTitle: zf,
  ...
  publicConfigErrorMessage: eh,
  invalidTimeslotErrorMessage: th,
  cancellationErrorTitle: rh,
  cancellationErrorMessage: nh,
  minimumCancellationErrorMessage: ih,
  cancelBokingFormError: uh
...
(function(n) {
  var e = le && le.__createBinding || (Object.create ? function(m, E, v, b) {
    b === void 0 && (b = v);
  ...
  }), t = le && le.__setModuleDefault || (Object.create ? function(m, E) {
    ...
    return t(E, m), E;
  }, i = le && le.__importDefault || function(m) {
  ...
  function g(m) {
    return m >= l.UPPER_A && m <= l.UPPER_Z || m >= l.LOWER_A && m <= l.LOWER_Z || d(m);
  }
  function w(m) {
  ...
  var O = (
    ...
    function() {
      ...
      return m.prototype.startEntity = function(E) {
        ...
        return v >= E.length ? -1 : (E.charCodeAt(v) | c) === l.LOWER_X ? (this.state = p.NumericHex, this.consumed += 1, this.stateNumericHex(E, v + 1)) : (this.state = p.NumericDecimal, this.stateNumericDecimal(E, v));
        ...
        for (var b = this.decodeTree, y = b[this.treeIndex], B = (y & f.VALUE_LENGTH) >> 14; v < E.length; v++, this.excess++) {
          ...
          if (this.treeIndex = A(b, y, this.treeIndex + Math.max(1, B), k), this.treeIndex < 0)
            ...
            w(k)) ? 0 : this.emitNotTerminatedNamedEntity();
          if (y = b[this.treeIndex], B = (y & f.VALUE_LENGTH) >> 14, B !== 0) {
            if (k === l.SEMI)
        ...
        var E, v = this, b = v.result, y = v.decodeTree, B = (y[b] & f.VALUE_LENGTH) >> 14;
  ...
  function A(m, E, v, b) {
    var y = (E & f.BRANCH_LENGTH) >> 7, B = E & f.JUMP_TABLE;
    if (y === 0)
      return B !== 0 && b === B ? v : -1;
    if (B) {
      var k = b - B;
...
` || // new line
      ...
      function r(A) {
        var L, P = A.exec(e.substring(p));
        if (P)
          return L = P[0], p += L.length, L;
      }
      for (var i = e.length, u = /^[ \t\n\r\u000c]+/, o = /^[, \t\n\r\u000c]+/, s = /^[^ \t\n\r\u000c]+/, a = /[,]+$/, l = /^\d+$/, c = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, f, d, h, g, w, p = 0, T = []; ; ) {
        if (r(o), p >= i)
          return T;
        f = r(s), d = [], f.slice(-1) === "," ? (f = f.replace(a, ""), q()) : O();
      }
      function O() {
        for (r(u), h = "", g = "in descriptor"; ; ) {
          if (w = e.charAt(p), g === "in descriptor")
            ...
            if (w === ")")
              h = h + w, g = "in descriptor";
            else if (w === "") {
              d.push(h), q();
              return;
            } else
              h = h + w;
          else if (g === "after descriptor" && !t(w))
            if (w === "") {
              q();
              return;
            } else
      ...
      function q() {
        var A = !1, L, P, F, W, N = {}, M, m, E, v, b;
        for (W = 0; W < d.length; W++)
          M = d[W], m = M[M.length - 1], E = M.substring(0, M.length - 1), v = parseInt(E, 10), b = parseFloat(E), l.test(E) && m === "w" ? ((L || P) && (A = !0), v === 0 ? A = !0 : L = v) : c.test(E) && m === "x" ? ((L || P || F) && (A = !0), b < 0 ? A = !0 : P = b) : l.test(E) && m === "h" ? ((F || P) && (A = !0), v === 0 ? A = !0 : F = v) : A = !0;
        A ? console && console.log && console.log("Invalid srcset descriptor found in '" + e + "' at '" + M + "'.") : (N.url = f, L && (N.w = L), P && (N.d = P), F && (N.h = F), T.push(N));
      }
    };
  });
})(Wg);
var hi = le.process, on = { exports: {} }, z = String, oh = function() {
...
on.exports = oh();
on.exports.createColors = oh;
const Gg = {}, Kg = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: Gg
}), ge = /* @__PURE__ */ uu(Kg);
...
class dt extends Error {
  ...
  showSourceCode(e) {
    ...
    let t = this.source;
    e == null && (e = pi.isColorSupported), gi && e && (t = gi(t));
    let r = t.split(/\r?\n/), i = Math.max(this.line - 3, 0), u = Math.min(this.line + 2, r.length), o = String(u).length, s, a;
    if (e) {
      let { bold: l, red: c, gray: f } = pi.createColors(!0);
      s = (d) => l(c(d)), a = (d) => f(d);
    } else
      s = a = (l) => l;
    return r.slice(i, u).map((l, c) => {
      ...
      if (f === this.line) {
        let h = a(d.replace(/\d/g, " ")) + l.slice(0, this.column - 1).replace(/[^\t]/g, " ");
        return s(">") + a(d) + l + `
 ` + h + s("^");
      }
      return " " + a(d) + l;
...
class Rr {
  ...
  raw(e, t, r) {
    ...
    return typeof i > "u" && (i = mi[r]), o.rawCache[r] = i, i;
  }
  rawSemicolon(e) {
    let t;
    return e.walk((r) => {
...
var sr = Lr;
Lr.default = Lr;
let rm = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", nm = (n, e = 21) => (t = e) => {
  let r = "", i = t;
  for (; i--; )
  ...
  let e = "", t = n;
  for (; t--; )
    e += rm[Math.random() * 64 | 0];
  return e;
};
const um = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  nanoid: im,
  customAlphabet: nm
}), om = /* @__PURE__ */ uu(um);
let { SourceMapConsumer: bi, SourceMapGenerator: yi } = ge, { existsSync: sm, readFileSync: am } = ge, { dirname: pr, join: lm } = ge;
function cm(n) {
...
class Nr {
  ...
  consumer() {
    return this.consumerCache || (this.consumerCache = new bi(this.text)), this.consumerCache;
  }
  withContent() {
  ...
  decodeInline(e) {
    ...
    if (t.test(e) || r.test(e))
      return cm(e.substr(RegExp.lastMatch.length));
    let o = e.match(/data:application\/json;([^,]+),/)[1];
    throw new Error("Unsupported source map encoding " + o);
  }
  loadFile(e) {
    if (this.root = pr(e), sm(e))
      return this.mapFile = e, am(e, "utf-8").toString().trim();
  }
  loadMap(e, t) {
    if (t === !1) return !1;
    if (t) {
      ...
      if (typeof t == "function") {
        ...
        if (t instanceof bi)
          return yi.fromSourceMap(t).toString();
        if (t instanceof yi)
          return t.toString();
        if (this.isMap(t))
      ...
      if (this.annotation) {
        ...
        return e && (r = lm(pr(e), r)), this.loadFile(r);
      }
    }
  }
  isMap(e) {
...
class Jt {
  constructor(e, t = {}) {
    ...
    if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = !0, this.css = this.css.slice(1)) : this.hasBOM = !1, t.from && (!wi || /^\w+:\/\//.test(t.from) || Ur(t.from) ? this.file = t.from : this.file = _r(t.from)), wi && gm) {
      let r = new pm(this.css, t);
      if (r.text) {
        this.map = r;
    ...
    this.file || (this.id = "<input css " + hm(6) + ">"), this.map && (this.map.file = this.from);
  }
  fromOffset(e) {
    let t, r;
    if (this[mr])
...
let { SourceMapConsumer: lh, SourceMapGenerator: Pt } = ge, { dirname: It, resolve: ch, relative: dh, sep: fh } = ge, { pathToFileURL: ki } = ge, mm = ar, bm = !!(lh && Pt), ym = !!(It && ch && dh && fh);
class vm {
  constructor(e, t, r, i) {
  ...
  previous() {
    if (!this.previousMaps)
      if (this.previousMaps = [], this.root)
        ...
        let e = new mm(this.css, this.opts);
...
`), t = s.length - o) : t += s.length, a && l !== "start") {
  ...
  generate() {
    if (this.clearAnnotation(), ym && bm && this.isMap())
...
class pe extends wm {
  ...
  normalize(e, t) {
    if (typeof e == "string")
      ...
      typeof e.value != "string" && (e.value = String(e.value)), e = [new mh(e)];
    } else if (e.selector)
      e = [new an(e)];
    else if (e.name)
      e = [new ln(e)];
    ...
    return e.map((i) => (i[gh] || pe.rebuild(i), i = i.proxyOf, i.parent && i.parent.removeChild(i), i[ph] && wh(i), typeof i.raws.before > "u" && t && typeof t.raws.before < "u" && (i.raws.before = t.raws.before.replace(/\S/g, "")), i.parent = this.proxyOf, i));
  }
  getProxyProcessor() {
    return {
      set(e, t, r) {
...
pe.default = pe;
pe.rebuild = (n) => {
  n.type === "atrule" ? Object.setPrototypeOf(n, ln.prototype) : n.type === "rule" ? Object.setPrototypeOf(n, an.prototype) : n.type === "decl" ? Object.setPrototypeOf(n, mh.prototype) : n.type === "comment" ? Object.setPrototypeOf(n, bh.prototype) : n.type === "root" && Object.setPrototypeOf(n, vh.prototype), n[gh] = !0, n.nodes && n.nodes.forEach((e) => {
    pe.rebuild(e);
  });
};
let km = Ue, kh, Eh;
    ...
    switch (u = r.charCodeAt(p), u) {
      ...
      case Sm: {
        if (d = T.length ? T.pop()[1] : "", h = r.charCodeAt(p + 1), d === "url" && h !== br && h !== Ei && h !== tt && h !== St && h !== Ct && h !== Bt && h !== At) {
          ...
          o = r.indexOf(")", p + 1), a = r.slice(p, o + 1), o === -1 || Pm.test(a) ? g = ["(", "(", p] : (g = ["brackets", a, p, o], p = o);
        break;
      }
      case br:
      case Ei: {
...
let ht = {
  split(n, e, t) {
    ...
    for (let c of n)
      l ? l = !1 : c === "\\" ? l = !0 : s ? c === a && (s = !1) : c === '"' || c === "'" ? (s = !0, a = c) : c === "(" ? o += 1 : c === ")" ? o > 0 && (o -= 1) : o === 0 && e.includes(c) && (u = !0), u ? (i !== "" && r.push(i.trim()), i = "", u = !1) : i += c;
...
Zt.default = Zt;
Oh.registerRule(Zt);
let Nm = sr, _m = Im, Um = lr, Fm = fn, jm = vt, Si = hn;
const Bi = {
  empty: !0,
  space: !0
};
...
class qm {
  constructor(e) {
    this.input = e, this.root = new jm(), this.current = this.root, this.spaces = "", this.semicolon = !1, this.customProperty = !1, this.createTokenizer(), this.root.source = { input: e, start: { offset: 0, line: 1, column: 1 } };
  }
  createTokenizer() {
    this.tokenizer = _m(this.input);
  }
  parse() {
    let e;
  ...
  raw(e, t, r, i) {
    let u, o, s = r.length, a = "", l = !0, c, f;
    for (let d = 0; d < s; d += 1)
      u = r[d], o = u[0], o === "space" && d === s - 1 && !i ? l = !1 : o === "comment" ? (f = r[d - 1] ? r[d - 1][0] : "empty", c = r[d + 1] ? r[d + 1][0] : "empty", !Bi[f] && !Bi[c] ? a.slice(-1) === "," ? l = !1 : a += u[1] : l = !1) : a += u[1];
    if (!l) {
      let d = r.reduce((h, g) => h + g[1], "");
...
class Me {
  constructor(e, t, r) {
    ...
    if (typeof t == "object" && t !== null && (t.type === "root" || t.type === "document"))
      i = qr(t);
    else if (t instanceof Me || t instanceof Ci)
    ...
    this.result = new Ci(e, i, r), this.helpers = { ...Hr, result: this.result, postcss: Hr }, this.plugins = this.processor.plugins.map((u) => typeof u == "object" && u.prepare ? { ...u, ...u.prepare(this.result) } : u);
  }
...
class pt {
  ...
  process(e, t = {}) {
    return this.plugins.length === 0 && typeof t.parser > "u" && typeof t.stringifier > "u" && typeof t.syntax > "u" ? new lb(this, e, t) : new cb(this, e, t);
  }
  normalize(e) {
    let t = [];
    for (let r of e)
...
function gt(n, e) {
  ...
  if (t) {
    e = [];
    for (let i of t) {
      let u = { ...i, __proto__: yb.prototype };
      u.map && (u.map = {
        ...u.map,
...
var wb = gt;
gt.default = gt;
let kb = sn, Mh = sr, Eb = Rh, $b = Ue, gn = hb, Tb = ur, Sb = wb, Ph = cn, Bb = $h, Ih = lr, Lh = fn, Cb = dn, Ab = ar, Ob = pn, Db = Ah, Nh = hn, _h = vt, Rb = or;
function j(...n) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`
    ), hi.env.LANG && hi.env.LANG.startsWith("cn") && console.warn(
...
j.fromJSON = Sb;
j.list = Db;
j.comment = (n) => new Ih(n);
j.atRule = (n) => new Lh(n);
j.decl = (n) => new Mh(n);
j.rule = (n) => new Nh(n);
j.root = (n) => new _h(n);
j.document = (n) => new Ph(n);
j.CssSyntaxError = kb;
j.Declaration = Mh;
j.Container = $b;
j.Processor = gn;
...
function Pb(n, e, t = "unregisterComponent") {
  return new CustomEvent(t, {
    bubbles: !0,
    composed: !0,
    detail: e
  ...
  return (e, t) => {
    ...
    n.eventToProps && Object.keys(n.eventToProps).forEach((a) => {
      ...
      const a = o == null ? void 0 : o.call(this), l = Mt(this), c = {
        ...
        ...n,
        eventToProps: s
      }, f = Pb(e, c, n.unregistrationEventName);
      return l.dispatchEvent(f) && de(`[${r}] Component ${r} successfully fired unregistration event`), a;
    });
  };
}
const Lb = ".sc-chevron-icon-h{display:flex}", Nb = Lb, _b = Pe(class extends Ie {
  constructor() {
    super(), this.__registerHost(), this.width = "24", this.height = "24";
  }
  render() {
    return R("svg", { key: "90d483478e14f04ab2793f5c922ccb87a8b1f1cc", xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none" }, R("path", { key: "b50664e82487982f62f962fd7e6586d2a68e42e9", fill: "currentColor", d: "M15.53 4.22a.75.75 0 0 1 0 1.06L8.81 12l6.72 6.72a.75.75 0 1 1-1.06 1.06l-7.25-7.25a.75.75 0 0 1 0-1.06l7.25-7.25a.75.75 0 0 1 1.06 0Z" }));
  }
  static get style() {
    return Nb;
  }
...
const qb = ':host{display:block;position:relative;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif}@media screen and (max-width: 768px){:host{position:unset}}.dropdown{display:inline-block}.dropbtn{color:var(--nylas-base-800);padding:10px;font-size:1rem;font-family:var(--nylas-font-family);cursor:pointer;display:flex;gap:0.5rem;background:transparent;border:none;border-radius:var(--nylas-border-radius-2x);width:50px;padding:14px 16px;border-radius:var(--nylas-border-radius-2x)}.dropbtn.focus{background:transparent}.dropbtn:hover,.dropbtn:active{outline:1px solid var(--nylas-primary)}.dropbtn:active{outline:2px solid var(--nylas-primary)}.dropbtn span.chevron{display:flex;align-self:center}.dropbtn span.open{transform:rotate(90deg)}.dropbtn span.closed{transform:rotate(270deg)}.dropbtn span.selected-option{text-overflow:ellipsis;overflow:hidden;white-space:nowrap;max-width:144px;font-size:14px;line-height:20px}@media screen and (max-width: 768px){.dropbtn span.selected-option{max-width:124px;font-size:16px}}.dropdown-content{display:block;margin-top:0.5rem;background-color:var(--nylas-base-0);max-width:306px;width:max-content;max-height:336px;overflow:auto;z-index:1;border-radius:4px;position:absolute;box-shadow:0px 4px 6px -2px rgba(0, 0, 0, 0.05);box-shadow:0px 10px 15px -3px rgba(0, 0, 0, 0.1)}@media screen and (max-width: 768px){.dropdown-content{right:0;width:325px;max-width:unset}}.search-box{border-bottom:1px solid var(--nylas-base-200);padding:10px;position:sticky;top:0;background:var(--nylas-base-0)}.search-box .icon{position:absolute;top:1.25rem;left:1.25rem;color:var(--nylas-base-300)}.dropdown-content ul{padding:0;list-style-type:none;color:var(--nylas-base-900);max-height:336px}.dropdown-content ul li{padding:16px, 12px, 16px, 12px;color:black;padding:12px 16px;text-decoration:none;display:block;font-family:inherit;font-size:14px;font-weight:400;line-height:20px;letter-spacing:0px;text-align:left;cursor:pointer}.dropdown-content ul li:hover,.dropdown-content ul li:focus{background-color:var(--nylas-base-100)}.dropdown-content .selected{background-color:#e7e7e7}input[type=text]{width:-webkit-fill-available;padding:inherit;border:1px solid #ccc;border-radius:4px;position:sticky;background:no-repeat scroll 7px 7px;padding-left:30px;background-size:16px 16px}', Hb = qb, zb = Pe(class extends Ie {
  ...
  getFilteredOptions(e) {
    return this.filterable ? e.filter((t) => {
      var r, i, u, o;
      return ((i = t == null ? void 0 : t.value) == null ? void 0 : i.toString().toLowerCase().includes((r = this.typedValue) == null ? void 0 : r.toLowerCase())) || ((o = t == null ? void 0 : t.label) == null ? void 0 : o.toLowerCase().includes((u = this.typedValue) == null ? void 0 : u.toLowerCase()));
    }) : e;
  }
  toggleDropdown() {
  ...
  handleOnInput(e) {
    ...
    this.typedValue = t;
    const r = this.options.findIndex((i) => i.label.toLowerCase().includes(t.toLowerCase()));
    r > -1 && this.scrollToViewWithinParent(r), this.inputOptionChanged.emit({
      value: t,
      name: this.name
    });
  }
  scrollToViewWithinParent(e) {
    var s;
    const t = this.options[e], r = (s = this.el.shadowRoot) == null ? void 0 : s.getElementById(t.value.toString()), i = this.optionsRef;
    if (this.ariaActivedescendant = t.value.toString(), !r || !i)
      return;
    const u = r.getBoundingClientRect(), o = i.getBoundingClientRect();
    u.top < o.top ? i.scrollTop -= o.top - u.top : u.bottom > o.bottom && (i.scrollTop += u.bottom - o.bottom);
  }
  ...
  handleClick(e) {
    if (this.isOpen) {
      const t = e.target.value, r = this.options.findIndex((i) => i.label.toLowerCase().includes(t.toLowerCase()));
      r > -1 && setTimeout(() => {
        this.scrollToViewWithinParent(r);
      }, 10);
    }
  }
  handleListboxKeydown(e) {
    var i, u;
    const t = this.filteredOptions, r = t.findIndex((o) => o.value === this.ariaActivedescendant);
    if (e.key === "ArrowDown" || e.key === "Tab" && !e.shiftKey) {
      if (e.preventDefault(), r === t.length - 1) {
        this.ariaActivedescendant = "", (i = this.inputRef) == null || i.focus();
        return;
      }
      const o = r + 1 < t.length ? r + 1 : 0;
      this.ariaActivedescendant = t[o].value, this.focusOption(o);
    } else if (e.key === "ArrowUp" || e.key === "Tab" && e.shiftKey) {
      if (e.preventDefault(), r === 0) {
        this.ariaActivedescendant = "", (u = this.inputRef) == null || u.focus();
        return;
      }
      const o = r - 1 >= 0 ? r - 1 : t.length - 1;
      this.ariaActivedescendant = t[o].value, this.focusOption(o);
  ...
  render() {
    return R("div", { key: "fa0347bf09ec791976c3628837a400ffce06f785", class: "dropdown", part: "id_dropdown" }, R("input", { key: "d18704609aa859f705397ca57a0d491a8f09ed99", type: "text", name: this.name, id: this.name, part: "id_dropdown-input", class: { dropbtn: !0, open: this.isOpen }, value: this.inputValue, onClick: (e) => {
...
function Uh() {
  ...
  ["input-dropdown"].forEach((e) => {
    switch (e) {
      case "input-dropdown":
        customElements.get(e) || customElements.define(e, zb);
        break;
    }
  });
}
const Wb = ".sc-search-icon-h{display:flex}", Gb = Wb, Kb = Pe(class extends Ie {
  constructor() {
    super(), this.__registerHost(), this.width = "15", this.height = "15";
  }
  render() {
    return R("svg", { key: "bed5da3f7b1b6d9737b4289b2123ed11a0ce3298", width: this.width, height: this.height, fill: "none", xmlns: "http://www.w3.org/2000/svg" }, R("path", { key: "c43ccee98412d9f980018c737e15ce43d0f5c2be", fill: "currentColor", d: "M5.5 0C8.53757 0 11 2.46243 11 5.5C11 6.83879 10.5217 8.06586 9.72656 9.01962L13.8536 13.1464C14.0488 13.3417 14.0488 13.6583 13.8536 13.8536C13.68 14.0271 13.4106 14.0464 13.2157 13.9114L13.1464 13.8536L9.01962 9.72656C8.06586 10.5217 6.83879 11 5.5 11C2.46243 11 0 8.53757 0 5.5C0 2.46243 2.46243 0 5.5 0ZM5.5 1C3.01472 1 1 3.01472 1 5.5C1 7.98528 3.01472 10 5.5 10C7.98528 10 10 7.98528 10 5.5C10 3.01472 7.98528 1 5.5 1Z" }));
  }
  static get style() {
    return Gb;
  }
...
const Jb = ':host{display:block;position:relative;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif;width:100%}@media screen and (max-width: 768px){:host{position:unset}}label{display:flex;color:var(--nylas-base-800, #293056);font-size:14px;font-style:normal;font-weight:400;line-height:150%;flex-direction:column;gap:4px;font-family:var(--nylas-font-family);font-size:16px;color:var(--nylas-base-800)}label.error{color:var(--nylas-error)}label span.required{color:var(--nylas-error);padding:0 0.25rem}label p{margin:0}label .error{color:var(--nylas-error)}.dropdown{display:inline-block;width:inherit}.dropbtn{color:var(--nylas-base-800);padding:14px;font-size:1rem;font-family:var(--nylas-font-family);cursor:pointer;display:flex;justify-content:space-between;gap:0.5rem;background:transparent;border:1px solid var(--nylas-base-300);border-radius:var(--nylas-border-radius-2x)}.dropbtn.error{border:1px solid var(--nylas-error)}.dropbtn.focus{background:transparent}.dropbtn:hover,.dropbtn:active{outline:1px solid var(--nylas-primary)}.dropbtn:active{outline:2px solid var(--nylas-primary)}.dropbtn span.chevron{display:flex;align-self:center}.dropbtn span.open{transform:rotate(90deg)}.dropbtn span.closed{transform:rotate(270deg)}.dropbtn span.selected-option{text-overflow:ellipsis;overflow:hidden;white-space:nowrap;max-width:144px;font-size:14px;line-height:20px}@media screen and (max-width: 768px){.dropbtn span.selected-option{max-width:124px;font-size:16px}}.dropdown-content{display:block;margin-top:0.5rem;background-color:var(--nylas-base-0);width:100%;max-height:336px;overflow:auto;z-index:1;border-radius:4px;position:absolute;box-shadow:0px 4px 6px -2px rgba(0, 0, 0, 0.05);box-shadow:0px 10px 15px -3px rgba(0, 0, 0, 0.1)}@media screen and (max-width: 768px){.dropdown-content{right:0;width:325px;max-width:unset}}.search-box{border-bottom:1px solid var(--nylas-base-200);padding:10px;position:sticky;top:0;background:var(--nylas-base-0)}.search-box .icon{position:absolute;top:1.25rem;left:1.25rem;color:var(--nylas-base-300)}.dropdown-content ul{padding:0;list-style-type:none;color:var(--nylas-base-900);max-height:336px}.dropdown-content ul li{padding:16px, 12px, 16px, 12px;color:black;padding:12px 16px;text-decoration:none;display:block;font-family:inherit;font-size:14px;font-weight:400;line-height:20px;letter-spacing:0px;text-align:left;cursor:pointer}.dropdown-content ul li:hover,.dropdown-content ul li:focus{background-color:var(--nylas-base-100)}.dropdown-content .selected{background-color:#e7e7e7}input[type=text]{width:-webkit-fill-available;padding:inherit;border:1px solid #ccc;border-radius:4px;position:sticky;background:no-repeat scroll 7px 7px;padding-left:30px;background-size:16px 16px}', Vb = Jb, Zb = Pe(class extends Ie {
  ...
  render() {
    ...
    return R("div", { key: "4b724d892194708b2dcd0ed74c8e23486ba2b4f7", class: "dropdown", part: "sd_dropdown" }, R("label", { key: "06d33f4f5daa7c09eed054505989210e35c2beb5", part: "sd_dropdown_label", class: { error: !!this.errorMessage } }, this.label && R("p", null, R("span", { class: "label" }, this.label), this.required && R("span", { class: "required" }, "*")), R("button", { key: "8e5952f7e2a1279670304e82f329da3e8e60522a", part: "sd_dropdown-button", class: { dropbtn: !0, open: this.isOpen, error: !!this.errorMessage }, onClick: () => this.toggleDropdown(), "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? "true" : "false", "aria-label": this.name, onKeyDown: (t) => this.handleSelectButtonKeyDown(t) }, R("slot", { key: "aece407da3b35858b9ec1248d09447706b3120cc", name: "select-icon", "aria-hidden": "true" }), R("span", { key: "55aae4a92f862c81533635999fb60693705cb12b", class: "selected-option", part: "sd_dropdown-button-selected-label" }, e), this.withChevron && R("span", { class: {
      ...
      closed: !this.isOpen,
      chevron: !0
    }, "aria-hidden": "true" }, R("chevron-icon", { width: "16", height: "16" }))), this.errorMessage && R("span", { class: "error help-text" }, this.errorMessage)), this.isOpen ? R("div", { class: "dropdown-content", part: "sd_dropdown-content" }, this.withSearch && R("div", { class: { "search-box": !0, open: this.isOpen } }, R("search-icon", { width: "15", height: "15", class: "icon" }), R("input", { type: "text", role: "combobox", placeholder: "Search", value: this.searchValue, ref: (t) => this.inputRef = t, onInput: (t) => this.filterOptions(t), onKeyDown: (t) => this.handleComboboxKeyDown(t) })), R("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-activedescendant": this.ariaActivedescendant, onKeyDown: (t) => this.handleListboxKeydown(t) }, this.filteredOptions.map((t) => t.value.toString() ? R("li", { tabindex: "0", key: t.value, id: t.value, onClick: () => this.selectOption(t), role: "option" }, t.labelHTML ? R("div", { part: "sd_dropdown-labelhtml" }, t.labelHTML) : t.label) : null))) : null);
  }
  get el() {
    return this;
  }
...
const Qb = ".time-period-selector.sc-time-period-selector{display:grid;gap:0.5rem;grid-template-columns:auto 1fr}.time-period-selector.sc-time-period-selector select-dropdown.sc-time-period-selector,.time-period-selector.sc-time-period-selector input-dropdown.sc-time-period-selector{border:1px solid var(--nylas-base-200);border-radius:var(--nylas-border-radius-2x)}.time-period-selector.sc-time-period-selector select-dropdown.sc-time-period-selector{width:116px}.time-period-selector.sc-time-period-selector input-dropdown.sc-time-period-selector{width:84px;display:flex;align-items:center}.time-period-selector.sc-time-period-selector select-dropdown#time-period.sc-time-period-selector::part(sd_dropdown-button){width:100%}.time-period-selector.sc-time-period-selector input-dropdown.sc-time-period-selector::part(id_dropdown){width:inherit;height:100%}.time-period-selector.sc-time-period-selector input-dropdown#time-number.sc-time-period-selector::part(id_dropdown-input){border:none;border-radius:var(--nylas-border-radius-2x)}.time-period-selector.sc-time-period-selector input-dropdown.sc-time-period-selector::part(id_dropdown-input){padding:17px;gap:1rem}.time-period-selector.sc-time-period-selector input-dropdown.sc-time-period-selector::part(id_dropdown-content){width:100%;max-height:200px}.time-period-selector.sc-time-period-selector select-dropdown.sc-time-period-selector::part(sd_dropdown){width:inherit}.time-period-selector.sc-time-period-selector select-dropdown.sc-time-period-selector::part(sd_dropdown-button){padding:1rem;gap:1rem;justify-content:space-between}.time-period-selector.sc-time-period-selector select-dropdown.sc-time-period-selector::part(sd_dropdown-content){width:100%;max-height:200px}", Xb = Qb, e2 = {
  ...
  componentDidLoad() {
    ...
    const e = e2[this.selectedPeriod] ?? this.selectedPeriod, t = this.calculateOptions(e);
    this.numberOptions = t.map((r) => ({
      label: r.toString(),
      value: r.toString()
    }));
  }
  calculateOptions(e) {
    switch (e) {
      case "hour":
        return Array.from({ length: 23 }, (t, r) => r + 1);
      case "minute":
        return Array.from({ length: 13 }, (t, r) => r * 5);
      case "day":
        return Array.from({ length: 30 }, (t, r) => r + 1);
      case "week":
        return Array.from({ length: 4 }, (t, r) => r + 1);
      case "month":
        return Array.from({ length: 12 }, (t, r) => r + 1);
      default:
        return [];
    }
  }
  inputOptionChangedHandler(e) {
    ...
    r === "time-number" && (this.selectedNumber = t ? parseInt(t) : this.defaultSelectedNumber);
    const i = {
      number: this.selectedNumber,
      period: this.selectedPeriod
    };
    this.timePeriodChanged.emit(i);
  }
  nylasFormDropdownChangedHandler(e) {
    de("time-period-selector", "nylasFormDropdownChangedHandler", e.detail);
    const { value: t, name: r } = e.detail;
    r === "time-period" ? (this.selectedPeriod = t, this.updateNumberOptionsAndSelectedNumber(t)) : r === "time-number" && (this.selectedNumber = parseInt(t));
    const i = {
      number: this.selectedNumber,
      period: this.selectedPeriod
    };
...
const n2 = '.tooltip-container{position:relative;display:flex;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif}.tooltip-content{visibility:hidden;background-color:var(--nylas-base-800);color:var(--nylas-base-0);text-align:left;border-radius:6px;padding:5px 0;position:absolute;z-index:1;opacity:0;transition:opacity 0.3s;padding:0.5rem 1rem;max-width:200px;width:max-content}.tooltip-content.top{bottom:0;left:0;margin-bottom:1.25rem;transform:translateX(-50%)}.tooltip-content.right{top:50%;left:0%;margin-left:1.25rem;transform:translateY(-50%)}.tooltip-content.bottom{top:0;left:0;margin-top:1.25rem;transform:translateX(-50%)}.tooltip-content.left{top:50%;right:0%;margin-right:1.25rem;transform:translateY(-50%)}.tooltip-container:hover .tooltip-content,.tooltip-container:focus-within .tooltip-content{visibility:visible;opacity:1}.tooltip-content::after{content:"";position:absolute;top:-0.75rem;left:50%;transform:rotate(180deg);border-width:6px;border-style:solid;border-color:black transparent transparent transparent}.tooltip-content.top::after{top:100%;left:50%;transform:rotate(0deg)}.tooltip-content.bottom::after{top:-0.75rem;left:50%;transform:rotate(180deg)}.tooltip-content.left::after{top:47.5%;left:100%;transform:rotate(270deg)}.tooltip-content.right::after{top:47.5%;left:-0.75rem;transform:rotate(90deg)}', i2 = n2, u2 = Pe(class extends Ie {
  ...
  render() {
    return R("div", { key: "39014243f733656bf550b9141eabd5c13e3c43d9", class: "tooltip-container", part: "tc__container" }, R("span", { key: "8b331b143065287a337e26a4680b3744ca8e2bc7", class: "info-icon", tabindex: "0", onFocus: this.showTooltip.bind(this), onBlur: this.hideTooltip.bind(this) }, R("slot", { key: "cf584033435cee5ca7143f5ee5fb983e3e9ab550", name: "tooltip-icon" }, "i")), R("span", { key: "409b87ee03bc5aa39fcaf965eca18d03f0ef1a44", class: `tooltip-content ${this.position}`, part: "tc__content" }, R("slot", { key: "00f5fa51bcf2cd31fac498f94a97ac67d5b7de3f", name: "tooltip-content" }, "This is a help text.")));
  }
  get el() {
    return this;
  }
...
const yn = Pe(class extends Ie {
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.valueChanged = st(this, "valueChanged", 7), this.internals = this.attachInternals(), this.selectedConfiguration = void 0, this.availableDaysInFuture = void 0, this.name = "limit-future-bookings", this.selectedNumber = void 0, this.selectedPeriod = void 0;
  }
  ...
  selectedConfigurationChangedHandler(e) {
    var r;
    const t = ((r = e == null ? void 0 : e.scheduler) == null ? void 0 : r.available_days_in_future) || this.availableDaysInFuture || 1;
  ...
  timePeriodChangedHandler(e) {
    const { number: t, period: r } = e.detail;
    let i;
    r === "day" ? i = t : r === "week" ? i = t * 7 : i = t * 30, this.valueChanged.emit({ value: i, name: "availableDaysInFuture" }), typeof this.internals.setFormValue == "function" && this.internals.setFormValue(i.toString(), this.name);
  }
  updateNumberAndPeriodFromDays(e) {
    let t, r;
    e >= 30 && e % 30 === 0 ? (t = e / 30, r = "month") : e >= 7 && e % 7 === 0 ? (t = e / 7, r = "week") : (t = e, r = "day"), this.selectedNumber = t, this.selectedPeriod = r;
  }
  render() {
    const e = typeof this.selectedNumber == "number" && typeof this.selectedPeriod == "string";
    return R(Di, { key: "cfdcf00204e70323e9d85fa2fac4ff6e969fe4d2" }, R("div", { key: "47f30c99bb64a716afb4815a3a94c60bf0e00013", class: "nylas-limit-future-bookings", part: "nlfb" }, R("label", { key: "3163cb22a01a10b19d290b156fcbe643aa1e5988" }, "Limit future bookings", R("span", { key: "1107193982975970afd5462570973719bb3f6993", class: "label-icon" }, R("tooltip-component", { key: "00cfba9876189179aac11d30110e063711d6ff15" }, R("info-icon", { key: "07ee779935ae241fdd3b8b4733e8686cbea66ba7", slot: "tooltip-icon" }), R("span", { key: "09883971191c905c9c67de0634653dc6d28497b6", slot: "tooltip-content" }, "The limit on how far in the future bookings can be made.")))), e && R("time-period-selector", { id: "limit-future-bookings", timePeriods: ["day", "week", "month"], exportparts: "tps__number-dropdown: nlfb__number-dropdown, tps__number-dropdown-button: nlfb__number-dropdown-button, tps__number-dropdown-content: nlfb__number-dropdown-content, tps__period-dropdown: nlfb__period-dropdown, tps__period-dropdown-button: nlfb__period-dropdown-button, tps__period-dropdown-content: nlfb__period-dropdown-content", defaultSelectedNumber: this.selectedNumber, defaultSelectedPeriod: this.selectedPeriod })));
  }
  ...
  ["nylas-limit-future-bookings", "chevron-icon", "info-icon", "input-dropdown", "search-icon", "select-dropdown", "time-period-selector", "tooltip-component"].forEach((e) => {
    switch (e) {
      ...
      case "select-dropdown":
        ...
        break;
      case "time-period-selector":
        customElements.get(e) || r2();
        break;
      case "tooltip-component":
        customElements.get(e) || o2();
        break;
    }
  });
}
const v2 = yn, x2 = c2;
export {
  v2 as NylasLimitFutureBookings,
  x2 as defineCustomElement
};
