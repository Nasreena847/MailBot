...
const P = (e, t, ...n) => {
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== _ && l["s-ol"] && (ae(l).insertBefore(l, I(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && A(l, t);
  }
  p.$flags$ &= -2;
}, ce = (e, t, n, s, l, r) => {
  let o = e["s-cr"] && e["s-cr"].parentNode || e, c;
  for (o.shadowRoot && o.tagName === _ && (o = o.shadowRoot); l <= r; ++l)
    s[l] && (c = M(null, n, l, e), c && (s[l].$elm$ = c, o.insertBefore(c, I(t))));
}, $e = (e, t, n) => {
  for (let s = t; s <= n; ++s) {
    const l = e[s];
    if (l) {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = M(t && t[o], n, c, e) : (E(g, a, l), t[c] = void 0, y = g.$elm$), a = s[++o]) : (y = M(t && t[o], n, o, e), a = s[++o]), y && ae(f.$elm$).insertBefore(y, I(f.$elm$));
    }
...
}, he = (e, t) => (e.$flags$ |= 16, Me(e, e.$ancestorComponent$), rt(() => we(e, t))), we = (e, t) => {
  ...
  try {
    q = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || je(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return q = null, null;
...
}, Je = (e, t) => t & 4 ? S : t & 8 ? B : t & 16 ? S.body : e, Ye = (e) => st ? {
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), et = [], B = typeof window < "u" ? window : {}, S = B.document || { head: {} }, tt = B.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ ot(ye, !0), ct = ".sc-info-icon-h{display:flex}", $t = ct, at = Ge(class extends tt {
  constructor() {
