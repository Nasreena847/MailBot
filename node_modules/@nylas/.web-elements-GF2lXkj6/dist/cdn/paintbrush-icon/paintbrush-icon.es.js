...
const F = (e, t, ...n) => {
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = x("attachStyles", t.$tagName$), r = He(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
  ...
  if (le || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? me : ke, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), be(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
...
}, he = (e, t) => (e.$flags$ |= 16, Be(e, e.$ancestorComponent$), ct(() => we(e, t))), we = (e, t) => {
...
}, te = (e, t) => t in e, H = (e, t) => (0, console.error)(e, t), B = /* @__PURE__ */ new Map(), tt = [], w = typeof window < "u" ? window : {}, S = w.document || { head: {} }, st = w.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-paintbrush-icon-h{display:flex}", at = $t, ve = Ke(class extends st {
  constructor() {
