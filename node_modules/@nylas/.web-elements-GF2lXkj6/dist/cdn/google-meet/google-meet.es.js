...
let E, j, R, le = !1, H = !1, W = !1, S = !1, Z = null, B = !1;
const x = (e, t = "") => () => {
}, ve = "slot-fb{display:contents}slot-fb[hidden]{display:none}", G = "http://www.w3.org/1999/xlink", I = {}, Se = "http://www.w3.org/2000/svg", be = "http://www.w3.org/1999/xhtml", ke = (e) => e != null, z = (e) => (e = typeof e, e === "object" || e === "function");
function me(e) {
  var t, n, s;
...
const v = (e, t, ...n) => {
...
}, _e = (e) => et.map((t) => t(e)).find((t) => !!t), Ae = (e, t) => e != null && !z(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, X = /* @__PURE__ */ new WeakMap(), Re = (e, t, n) => {
  let s = w.get(e);
  lt && n ? (s = s || new CSSStyleSheet(), typeof s == "string" ? s = t : s.replaceSync(t)) : s = t, w.set(e, s);
}, Ce = (e, t, n) => {
  var s;
  const l = oe(t, n), c = w.get(l);
      ...
      if (o || X.set(e, o = /* @__PURE__ */ new Set()), !o.has(l)) {
        {
          ...
          const i = (s = p.$nonce$) !== null && s !== void 0 ? s : me(b);
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = x("attachStyles", t.$tagName$), c = Ce(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
  s & 10 && (n["s-sc"] = c, n.classList.add(c + "-h"), s & 2 && n.classList.add(c + "-s")), l();
}, oe = (e, t) => "sc-" + (t && e.$flags$ & 32 ? e.$tagName$ + "-" + t : e.$tagName$), K = (e, t, n, s, l, c) => {
  if (n !== s) {
...
}, Me = /\s/, J = (e) => e ? e.split(Me) : [], ie = "Capture", Fe = new RegExp(ie + "$"), ce = (e, t, n, s) => {
  ...
  let c = 0, o, r, i;
  if (le || (W = !0, l.$tag$ === "slot" && (E && s.classList.add(E + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (S || (S = l.$tag$ === "svg"), o = l.$elm$ = b.createElementNS(S ? Se : be, l.$flags$ & 2 ? "slot-fb" : l.$tag$), S && l.$tag$ === "foreignObject" && (S = !1), ce(null, l, S), ke(E) && o["s-si"] !== E && o.classList.add(o["s-si"] = E), l.$children$)
      for (c = 0; c < l.$children$.length; ++c)
        r = U(e, l, c, o), r && o.appendChild(r);
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== R && l["s-ol"] && ($e(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && C(l, t);
  }
  p.$flags$ &= -2;
}, re = (e, t, n, s, l, c) => {
  let o = e["s-cr"] && e["s-cr"].parentNode || e, r;
  for (o.shadowRoot && o.tagName === R && (o = o.shadowRoot); l <= c; ++l)
    s[l] && (r = U(null, n, l, e), r && (s[l].$elm$ = r, o.insertBefore(r, q(t))));
}, ae = (e, t, n) => {
  for (let s = t; s <= n; ++s) {
    const l = e[s];
    if (l) {
      const c = l.$elm$;
      ue(l), c && (H = !0, c["s-ol"] ? c["s-ol"].remove() : C(c, !0), c.remove());
    }
  }
}, He = (e, t, n, s, l = !1) => {
  ...
  for (; c <= u && o <= d; )
    if (f == null)
      ...
      r >= 0 ? (g = t[r], g.$tag$ !== $.$tag$ ? y = U(t && t[o], n, r, e) : (_(g, $, l), t[r] = void 0, y = g.$elm$), $ = s[++o]) : (y = U(t && t[o], n, o, e), $ = s[++o]), y && $e(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  c > u ? re(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && ae(t, c, u);
}, F = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, q = (e) => e && e["s-ol"] || e, $e = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, _ = (e, t, n = !1) => {
  const s = t.$elm$ = e.$elm$, l = e.$children$, c = t.$children$, o = t.$tag$, r = t.$text$;
  let i;
  r === null ? (S = o === "svg" ? !0 : o === "foreignObject" ? !1 : S, o === "slot" || ce(e, t, S), l !== null && c !== null ? He(s, l, t, c, n) : c !== null ? (e.$text$ !== null && (s.textContent = ""), re(s, null, t, c, 0, c.length - 1)) : l !== null && ae(l, 0, l.length - 1), S && o === "svg" && (S = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = r : e.$text$ !== r && (s.data = r);
}, fe = (e) => {
  ...
  var s, l, c, o, r;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || P(null, null), a = Te(t) ? t : v(null, null, t);
  ...
  a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = f.$elm$ = i.shadowRoot || i, E = i["s-sc"], j = i["s-cr"], le = (u.$flags$ & 1) !== 0, H = !1, _(f, a, n);
  {
    if (p.$flags$ |= 1, W) {
      de(a.$elm$);
      for (const d of k) {
    ...
    H && fe(a.$elm$), p.$flags$ &= -2, k.length = 0;
  }
...
}, he = (e, t) => (e.$flags$ |= 16, Ue(e, e.$ancestorComponent$), ct(() => we(e, t))), we = (e, t) => {
  const n = e.$hostElement$, s = x("scheduleUpdate", e.$cmpMeta$.$tagName$), l = n;
  let c;
  return t ? c = A(l, "componentWillLoad") : c = A(l, "componentWillUpdate"), c = V(c, () => A(l, "componentWillRender")), s(), V(c, () => je(e, l, t));
...
}, We = (e, t) => O(e).$instanceValues$.get(t), ze = (e, t, n, s) => {
  ...
  if (!(p.$flags$ & 1)) {
    ...
    n.$flags$ & 12 && Ie(e), n.$members$ && Object.entries(n.$members$).map(([l, [c]]) => {
  ...
  n && n.map(([l, c, o]) => {
    const r = Je(e, l), i = Ke(t, o), u = Ye(l);
...
}, te = (e, t) => t in e, M = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), et = [], D = typeof window < "u" ? window : {}, b = D.document || { head: {} }, tt = D.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
  ...
  e.push(n), B || (B = !0, t && p.$flags$ & 4 ? it(N) : p.raf(N));
}, ne = (e) => {
  ...
  ne(se), ne(ye), (B = se.length > 0) && p.raf(N);
}, it = (e) => nt().then(e), ct = /* @__PURE__ */ ot(ye, !0), rt = ".sc-google-meet-icon-h{display:flex}", at = rt, $t = Xe(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "20", this.height = "20";
  }
  render() {
    return v("svg", { key: "0aa498e61ebce2d78f63c403477b8d0a96bdfeee", width: this.width, height: this.height, fill: "none", xmlns: "http://www.w3.org/2000/svg" }, v("g", { key: "8eccb2471e9b06ad96a831ae9fa0eba4e08a35b6", "clip-path": "url(#clip0_22_6251)" }, v("path", { key: "1d17ce009fca759d96661753ef0189a377dce539", d: "M11.3145 10.1036L13.2642 12.3321L15.8859 14.0076L16.343 10.1173L15.8859 6.31384L13.2139 7.78584L11.3145 10.1036Z", fill: "#00832D" }), v("path", { key: "3039bd6dfe965f2cd4426a9c5ed79c73bd72610a", d: "M0 13.6464V16.9607C0 17.7184 0.613714 18.3321 1.37143 18.3321H4.68571L5.37143 15.827L4.68571 13.6464L2.41143 12.9607L0 13.6464Z", fill: "#0066DA" }), v("path", { key: "f1d875b0d02f12605c2cb6aff6cad72a4fcc3814", d: "M4.68571 1.875L0 6.56071L2.41143 7.24643L4.68571 6.56071L5.36 4.40986L4.68571 1.875Z", fill: "#E94235" }), v("path", { key: "d6ae2d7d2c4ff0f16b0ff44b10b677527eb828ba", d: "M4.68571 6.56067H0V13.6464H4.68571V6.56067Z", fill: "#2684FC" }), v("path", { key: "4038bb56f14f8e3e0c341311d42c87be42654b4f", d: "M18.8798 3.85895L15.8855 6.31381V14.0075L18.8935 16.4738C19.3438 16.8258 20.0021 16.5047 20.0021 15.9321V4.38923C20.0021 3.80981 19.329 3.49209 18.8798 3.85895ZM11.3141 10.1035V13.6464H4.68555V18.3321H14.5141C15.2718 18.3321 15.8855 17.7184 15.8855 16.9607V14.0075L11.3141 10.1035Z", fill: "#00AC47" }), v("path", { key: "97552d1ad3a93113020c952639c09e78d0fb44eb", d: "M14.5141 1.875H4.68555V6.56071H11.3141V10.1036L15.8855 6.31614V3.24643C15.8855 2.48871 15.2718 1.875 14.5141 1.875Z", fill: "#FFBA00" })), v("defs", { key: "f65426e4705030b50f2a11f2b80c21e554b78b7f" }, v("clipPath", { key: "babd1df94171d7415934ce92cf1cc221def81c48", id: "clip0_22_6251" }, v("rect", { key: "d4c2b22875d26ace18561ba9c3bbf1e1b196864c", width: "20", height: "20", fill: "white" }))));
  }
  static get style() {
    return at;
  }
