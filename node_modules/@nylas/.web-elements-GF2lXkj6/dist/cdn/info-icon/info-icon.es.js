...
let L, D, _, oe = !1, U = !1, W = !1, v = !1, q = null, H = !1;
const x = (e, t = "") => () => {
...
const P = (e, t, ...n) => {
...
}, Ue = /\s/, J = (e) => e ? e.split(Ue) : [], ie = "Capture", Pe = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  if (oe || (W = !0, o.$tag$ === "slot" && (L && s.classList.add(L + "-s"), o.$flags$ |= o.$children$ ? (
    ...
    if (v || (v = o.$tag$ === "svg"), l = o.$elm$ = S.createElementNS(v ? me : ke, o.$flags$ & 2 ? "slot-fb" : o.$tag$), v && o.$tag$ === "foreignObject" && (v = !1), re(null, o, v), Te(L) && l["s-si"] !== L && l.classList.add(l["s-si"] = L), o.$children$)
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const o = n[s];
    o["s-hn"] !== _ && o["s-ol"] && (ae(o).insertBefore(o, I(o)), o["s-ol"].remove(), o["s-ol"] = void 0, o["s-sh"] = void 0, W = !0), t && A(o, t);
  }
  p.$flags$ &= -2;
}, ce = (e, t, n, s, o, r) => {
  let l = e["s-cr"] && e["s-cr"].parentNode || e, c;
  for (l.shadowRoot && l.tagName === _ && (l = l.shadowRoot); o <= r; ++o)
    s[o] && (c = M(null, n, o, e), c && (s[o].$elm$ = c, l.insertBefore(c, I(t))));
}, $e = (e, t, n) => {
  for (let s = t; s <= n; ++s) {
    const o = e[s];
    if (o) {
  ...
  for (; r <= u && l <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = M(t && t[l], n, c, e) : (E(g, a, o), t[c] = void 0, y = g.$elm$), a = s[++l]) : (y = M(t && t[l], n, l, e), a = s[++l]), y && ae(f.$elm$).insertBefore(y, I(f.$elm$));
    }
  ...
  try {
    q = t, t = t.render && t.render(), e.$flags$ &= -17, e.$flags$ |= 2, (T.hasRenderFn || T.reflect) && (T.vdomRender || T.reflect) && (T.hydrateServerSide || Me(e, t, s));
  } catch (i) {
    O(i, e.$hostElement$);
  }
  return q = null, null;
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), tt = [], B = typeof window < "u" ? window : {}, S = B.document || { head: {} }, st = B.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => ot().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-info-icon-h{display:flex}", at = $t, ve = Ke(class extends st {
  constructor() {
