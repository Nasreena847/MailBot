...
const U = (e, t, ...n) => {
  ...
  let s = M.get(e);
  ot && n ? (s = s || new CSSStyleSheet(), typeof s == "string" ? s = t : s.replaceSync(t)) : s = t, M.set(e, s);
}, Oe = (e, t, n) => {
  var s;
...
}, He = /\s/, J = (e) => e ? e.split(He) : [], ie = "Capture", Ue = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || re(e, t, v), l !== null && r !== null ? Pe(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), ce(s, null, t, r, 0, r.length - 1)) : l !== null && ae(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, fe = (e) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || P(null, null), a = xe(t) ? t : U(null, null, t);
...
}, he = (e, t) => (e.$flags$ |= 16, Me(e, e.$ancestorComponent$), ct(() => we(e, t))), we = (e, t) => {
  ...
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
} : (e & 2) !== 0, pe = /* @__PURE__ */ new WeakMap(), R = (e) => pe.get(e), et = (e, t) => {
  const n = {
    $flags$: 0,
    $hostElement$: e,
    $cmpMeta$: t,
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), M = /* @__PURE__ */ new Map(), tt = [], w = typeof window < "u" ? window : {}, S = w.document || { head: {} }, st = w.HTMLElement || class {
}, g = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ye, !0), at = ".sc-calendar-agenda-fill-icon-h{display:flex}", $t = at, ve = Ke(class extends st {
  constructor() {
