...
const U = (e, t, ...n) => {
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const c = l.$elm$;
      ue(l), c && (F = !0, c["s-ol"] ? c["s-ol"].remove() : R(c, !0), c.remove());
    }
  }
}, je = (e, t, n, s, l = !1) => {
  ...
  var s, l, c, o, r;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || j(null, null), $ = Le(t) ? t : U(null, null, t);
...
}, ct = (e) => lt().then(e), rt = /* @__PURE__ */ it(ye, !0), $t = ".sc-people-icon-h{display:flex}", at = $t, ve = Ke(class extends st {
  constructor() {
