...
let L, H, C, le = !1, U = !1, W = !1, v = !1, I = null, M = !1;
const x = (e, t = "") => () => {
...
const P = (e, t, ...n) => {
  ...
  if (le || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? ke : me, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), ce(null, l, v), be(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
...
}, ct = (e) => lt().then(e), rt = /* @__PURE__ */ it(ye, !0), $t = ".sc-checkmark-circle-icon-h{display:flex}", at = $t, ve = Ke(class extends st {
  constructor() {
