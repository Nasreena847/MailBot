...
let x, D, C, le = !1, U = !1, W = !1, v = !1, I = null, M = !1;
const L = (e, t = "") => () => {
...
const H = (e, t, ...n) => {
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== C && l["s-ol"] && (ae(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && A(l, t);
  }
  h.$flags$ &= -2;
}, ce = (e, t, n, s, l, r) => {
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || re(e, t, v), l !== null && r !== null ? He(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), ce(s, null, t, r, 0, r.length - 1)) : l !== null && $e(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, fe = (e) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || P(null, null), $ = Le(t) ? t : H(null, null, t);
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], D = i["s-cr"], le = (u.$flags$ & 1) !== 0, U = !1, E(f, $, n);
  {
    if (h.$flags$ |= 1, W) {
      de($.$elm$);
      for (const d of m) {
...
}, pe = (e, t) => (e.$flags$ |= 16, je(e, e.$ancestorComponent$), rt(() => Be(e, t))), Be = (e, t) => {
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), B = /* @__PURE__ */ new Map(), et = [], w = typeof window < "u" ? window : {}, S = w.document || { head: {} }, tt = w.HTMLElement || class {
}, h = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ ot(ye, !0), ct = ".sc-envelope-icon-h{display:flex}", $t = ct, at = Ge(class extends tt {
  constructor() {
