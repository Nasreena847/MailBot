...
let L, H, A, oe = !1, U = !1, W = !1, v = !1, I = null, M = !1;
const x = (e, t = "") => () => {
...
const P = (e, t, ...n) => {
...
}, Ue = /\s/, Y = (e) => e ? e.split(Ue) : [], ie = "Capture", Pe = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (o) {
      const r = o.$elm$;
      ue(o), r && (U = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, je = (e, t, n, s, o = !1) => {
  ...
  for (; r <= u && l <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = w(t && t[l], n, c, e) : (E(g, a, o), t[c] = void 0, y = g.$elm$), a = s[++l]) : (y = w(t && t[l], n, l, e), a = s[++l]), y && ae(f.$elm$).insertBefore(y, q(f.$elm$));
    }
...
}, rt = (e) => ot().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-chevron-icon-h{display:flex}", at = $t, ve = Je(class extends st {
  constructor() {
