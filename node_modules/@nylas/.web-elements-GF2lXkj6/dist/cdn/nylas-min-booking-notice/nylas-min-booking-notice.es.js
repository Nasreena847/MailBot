...
}, t1 = /\s/, Tn = (n) => n ? n.split(t1) : [], Mi = "Capture", r1 = new RegExp(Mi + "$"), Ii = (n, e, t, r) => {
...
function Zi(n, e, t, r, i) {
  ...
  if (typeof e == "string" && (e = x.from(e, r)), we(e))
    return e.length === 0 ? -1 : In(n, e, t, r, i);
  if (typeof e == "number")
    return e = e & 255, x.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(n, e, t) : Uint8Array.prototype.lastIndexOf.call(n, e, t) : In(n, [e], t, r, i);
  ...
  (function(t, r) {
    ...
    var m = function() {
      ...
      return b.parse = function(y) {
        ...
        var k = this, S = !!M.u(B) || B, C = M.p(y), P = function(Fe, re) {
        ...
        var k, S = M.p(y), C = "set" + (this.$u ? "UTC" : ""), P = (k = {}, k[l] = C + "Date", k[g] = C + "Date", k[f] = C + "Month", k[h] = C + "FullYear", k[a] = C + "Hours", k[s] = C + "Minutes", k[o] = C + "Seconds", k[u] = C + "Milliseconds", k)[S], q = S === l ? this.$D + (B - this.$W) : B;
        if (S === f || S === h) {
          var G = this.clone().set(g, 1);
          G.$d[P](q), G.init(), this.$d = G.set(g, Math.min(this.$D, G.daysInMonth())).$d;
        } else P && this.$d[P](q);
        ...
        if (C === l) return P(1);
        if (C === c) return P(7);
        var q = (k = {}, k[s] = r, k[a] = i, k[o] = t, k)[C] || 1, G = this.$d.getTime() + y * q;
        return M.w(G, this);
        ...
        var S, C = M.p(B), P = N(y), q = (P.utcOffset() - this.utcOffset()) * r, G = this - P, Z = M.m(this, P);
        return Z = (S = {}, S[h] = Z / 12, S[f] = Z, S[d] = Z / 3, S[c] = (G - q) / 6048e5, S[l] = (G - q) / 864e5, S[a] = G / i, S[s] = G / r, S[o] = G / t, S)[C] || G, k ? Z : M.a(Z);
...
function jp(n, e) {
  ...
  if (c) {
    ...
    if (Y(e.byweekno, -1))
      ...
      var H = Ke(_e(n - 1, 1, 1)), A = ae(7 - H.valueOf() + e.wkst, 7), L = it(n - 1) ? 366 : 365, I = void 0;
      A >= 4 ? (A = 0, I = L + ae(H - e.wkst, 7)) : I = r - c, O = Math.floor(52 + ae(I, 7) / 4);
    }
    if (Y(e.byweekno, O))
      for (var p = 0; p < c; p++)
        s.wnomask[p] = 1;
...
var zp = (
  ...
  function() {
    ...
    return n.prototype.rebuild = function(e, t) {
      ...
      K(r.byeaster) && (this.eastermask = qp(e, r.byeaster));
  ...
  for (var c = Jp(l, a, e); ; ) {
    ...
    if (J(o))
      ...
      for (var T = h; T < g; T++) {
        var A = d[T];
        if (K(A))
          for (var L = cu(l.yearordinal + A), I = 0; I < c.length; I++) {
            var F = c[I], O = du(L, F);
            if (u && O > u)
              return $e(n);
            if (O >= t) {
...
class Kt extends ir {
  ...
  translate(e, t, r) {
    ...
    if (O && d && (typeof d != "string" && typeof d != "boolean" && typeof d != "number") && p.indexOf(w) < 0 && !(typeof T == "string" && Array.isArray(d))) {
      ...
      if (u) {
        const A = Array.isArray(d), L = A ? [] : {}, I = A ? g : h;
        for (const F in d)
      ...
      if (L || A || b) {
        ...
        const k = (S, C, P) => {
          const q = F && P !== d ? P : v;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(S, a, C, q, b, t) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(S, a, C, q, b, t), this.emit("missingKey", S, a, C, d);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && I ? y.forEach((S) => {
          const C = this.pluralResolver.getSuffixes(S, t);
          M && t[`defaultValue${this.options.pluralSeparator}zero`] && C.indexOf(`${this.options.pluralSeparator}zero`) < 0 && C.push(`${this.options.pluralSeparator}zero`), C.forEach((P) => {
      ...
      f.forEach((p) => {
        this.isValidLookup(r) || (s = p, !ni[`${w[0]}-${p}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(s) && (ni[`${w[0]}-${p}`] = !0, this.logger.warn(`key "${i}" for languages "${w.join(", ")}" won't get resolved as namespace "${s}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), w.forEach((T) => {
          ...
          if (this.i18nFormat && this.i18nFormat.addLookupKeys)
            ...
            const L = `${this.options.pluralSeparator}zero`, I = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (d && (O.push(c + A), t.ordinal && A.indexOf(I) === 0 && O.push(c + A.replace(I, this.options.pluralSeparator)), h && O.push(c + L)), g) {
              const F = `${c}${this.options.contextSeparator}${t.context}`;
              O.push(F), d && (O.push(F + A), t.ordinal && A.indexOf(I) === 0 && O.push(F + A.replace(I, this.options.pluralSeparator)), h && O.push(F + L));
            }
          }
          let H;
          for (; H = O.pop(); )
            this.isValidLookup(r) || (u = H, r = this.getResource(T, p, H, t));
        }));
      });
    }), {
      res: r,
...
const yu = "No date selected", vu = "Choose another time slot to reschedule your meeting", xu = {
  ...
  bookNowButton: jo,
  bookingConfirmed: Yo,
  bookingConfirmedDescription: Ho,
  bookingSent: qo,
  ...
  cancelBokingFormError: Ma,
  default: Mg
}), Ia = "日付が選択されていません", Pa = "別の時間を選択してください", La = {
  sunday: "日",
  monday: "月",
  tuesday: "火",
  wednesday: "水",
  ...
  schedulingComponentErrorTitle: Pc,
  ...
  cancelBokingFormError: Hc,
  default: Ng
}), qc = "Ingen dag vald", zc = "Välj en annan tid för att boka om din tid", Wc = {
  sunday: "SÖN",
  monday: "MÅN",
  tuesday: "TIS",
  wednesday: "ONS",
  ...
  rescheduleBookingErrorTitle: P0,
  ...
  invalidTimeslotErrorMessage: q0,
  ...
  createBookingErrorTitle: Hf,
  getAvailabilityErrorTitle: qf,
...
(function(n) {
  ...
  n.determineBranch = A;
  var L = H(u.default), I = H(o.default);
  function F(m, E) {
...
` || // new line
      ...
      function r(A) {
        var L, I = A.exec(e.substring(p));
        if (I)
          return L = I[0], p += L.length, L;
      }
      for (var i = e.length, u = /^[ \t\n\r\u000c]+/, o = /^[, \t\n\r\u000c]+/, s = /^[^ \t\n\r\u000c]+/, a = /[,]+$/, l = /^\d+$/, c = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, f, d, h, g, w, p = 0, T = []; ; ) {
        if (r(o), p >= i)
          return T;
        f = r(s), d = [], f.slice(-1) === "," ? (f = f.replace(a, ""), H()) : O();
      }
      function O() {
      ...
      function H() {
        var A = !1, L, I, F, W, N = {}, M, m, E, v, b;
        for (W = 0; W < d.length; W++)
          M = d[W], m = M[M.length - 1], E = M.substring(0, M.length - 1), v = parseInt(E, 10), b = parseFloat(E), l.test(E) && m === "w" ? ((L || I) && (A = !0), v === 0 ? A = !0 : L = v) : c.test(E) && m === "x" ? ((L || I || F) && (A = !0), b < 0 ? A = !0 : I = b) : l.test(E) && m === "h" ? ((F || I) && (A = !0), v === 0 ? A = !0 : F = v) : A = !0;
        A ? console && console.log && console.log("Invalid srcset descriptor found in '" + e + "' at '" + M + "'.") : (N.url = f, L && (N.w = L), I && (N.d = I), F && (N.h = F), T.push(N));
      }
    };
  });
})(Wg);
    ...
    switch (u = r.charCodeAt(p), u) {
      ...
      case Sm: {
        if (d = T.length ? T.pop()[1] : "", h = r.charCodeAt(p + 1), d === "url" && h !== br && h !== Ei && h !== tt && h !== St && h !== Ct && h !== Bt && h !== At) {
          ...
          o = r.indexOf(")", p + 1), a = r.slice(p, o + 1), o === -1 || Im.test(a) ? g = ["(", "(", p] : (g = ["brackets", a, p, o], p = o);
        break;
      }
      case br:
      case Ei: {
...
class Me {
  constructor(e, t, r) {
    ...
    this.result = new Ci(e, i, r), this.helpers = { ...qr, result: this.result, postcss: qr }, this.plugins = this.processor.plugins.map((u) => typeof u == "object" && u.prepare ? { ...u, ...u.prepare(this.result) } : u);
  }
...
j.fromJSON = Sb;
j.list = Db;
j.comment = (n) => new Ph(n);
j.atRule = (n) => new Lh(n);
j.decl = (n) => new Mh(n);
j.rule = (n) => new Nh(n);
j.root = (n) => new _h(n);
j.document = (n) => new Ih(n);
j.CssSyntaxError = kb;
j.Declaration = Mh;
j.Container = $b;
j.Processor = gn;
...
function Ib(n, e, t = "unregisterComponent") {
  return new CustomEvent(t, {
    bubbles: !0,
    composed: !0,
    detail: e
  ...
  return (e, t) => {
    ...
    n.eventToProps && Object.keys(n.eventToProps).forEach((a) => {
      ...
      const a = o == null ? void 0 : o.call(this), l = Mt(this), c = {
        ...
        ...n,
        eventToProps: s
      }, f = Ib(e, c, n.unregistrationEventName);
      return l.dispatchEvent(f) && de(`[${r}] Component ${r} successfully fired unregistration event`), a;
    });
  };
}
const Lb = ".sc-chevron-icon-h{display:flex}", Nb = Lb, _b = Ie(class extends Pe {
  constructor() {
...
const Ub = ".sc-info-icon-h{display:flex}", Fb = Ub, jb = Ie(class extends Pe {
  constructor() {
...
const Wb = ".sc-search-icon-h{display:flex}", Gb = Wb, Kb = Ie(class extends Pe {
  constructor() {
...
const yn = Ie(class extends Pe {
  ...
  selectedConfigurationChangedHandler(e) {
    var r;
    const t = ((r = e == null ? void 0 : e.scheduler) == null ? void 0 : r.min_booking_notice) || this.minBookingNotice || 1;
  ...
  timePeriodChangedHandler(e) {
    ...
    let i;
    const u = 60, o = u * 24, s = o * 7, a = o * 30;
    r === "minute" ? i = t : r === "hour" ? i = t * u : r === "day" ? i = t * o : r === "week" ? i = t * s : r === "month" ? i = t * a : i = 0, this.valueChanged.emit({ value: i, name: "minBookingNotice" }), typeof this.internals.setFormValue == "function" && this.internals.setFormValue(i.toString(), this.name);
  }
  ...
  render() {
    ...
    return R(Di, { key: "b51f14edfe66462ce3822dcd9ea299820dfef96b" }, R("div", { key: "578505fefc4132f45ac21d6ab1d59cb409145536", class: "nylas-min-booking-notice", part: "nmbn" }, R("label", { key: "5226af32996ae771f65ed4dce017bbba7e26193a" }, "Minimum booking notice", R("span", { key: "37dcf44405e2cfe10bc652d35715936f41d78685", class: "label-icon" }, R("tooltip-component", { key: "52a11ccbcddb918341c7cad983fb9bdf65b1c86d" }, R("info-icon", { key: "c941288bee95958b40a825944ba2316709f307a1", slot: "tooltip-icon" }), R("span", { key: "7d3a9c1f538b1e16c094d78daf4eea1f84084bd7", slot: "tooltip-content" }, "The minimum amount of time in the future that a new booking can be made.")))), e && R("time-period-selector", { id: "min-booking-notice", exportparts: "tps__number-dropdown: nmbn__number-dropdown, tps__number-dropdown-button: nmbn__number-dropdown-button, tps__number-dropdown-content: nmbn__number-dropdown-content, tps__period-dropdown: nmbn__period-dropdown, tps__period-dropdown-button: nmbn__period-dropdown-button, tps__period-dropdown-content: nmbn__period-dropdown-content", timePeriods: ["minute", "hour", "day", "week"], defaultSelectedNumber: this.selectedNumber, defaultSelectedPeriod: this.selectedPeriod })));
  }
