...
const P = (e, t, ...n) => {
...
}, Ae = (e) => et.map((t) => t(e)).find((t) => !!t), _e = (e, t) => e != null && !z(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, G = /* @__PURE__ */ new WeakMap(), Re = (e, t, n) => {
  let s = B.get(e);
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== _ && l["s-ol"] && (ae(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && R(l, t);
  }
  p.$flags$ &= -2;
}, ce = (e, t, n, s, l, r) => {
  ...
  let r;
  return t ? r = A(l, "componentWillLoad") : r = A(l, "componentWillUpdate"), r = V(r, () => A(l, "componentWillRender")), s(), V(r, () => Me(e, l, t));
...
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ ot(ye, !0), ct = ".sc-add-circle-icon-h{display:flex}", $t = ct, at = Ge(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "24", this.height = "25";
  }
  render() {
    return P("svg", { key: "9b8f05e545513c4c1c04aaeb303c60d51e8263f4", width: this.width, height: this.height, fill: "none", xmlns: "http://www.w3.org/2000/svg" }, P("path", { key: "80bd0f3a26f863b80196b8ff3831223db307701d", d: "M12 2.5c5.523 0 10 4.477 10 10s-4.477 10-10 10-10-4.477-10-10 4.477-10 10-10ZM12 4a8.5 8.5 0 1 0 0 17 8.5 8.5 0 0 0 0-17Zm0 3.5a.75.75 0 0 1 .75.75v3.5h3.5a.75.75 0 0 1 0 1.5h-3.5v3.5a.75.75 0 0 1-1.5 0v-3.5h-3.5a.75.75 0 0 1 0-1.5h3.5v-3.5A.75.75 0 0 1 12 7.5Z", fill: "currentColor" }));
  }
  static get style() {
    return $t;
  }
