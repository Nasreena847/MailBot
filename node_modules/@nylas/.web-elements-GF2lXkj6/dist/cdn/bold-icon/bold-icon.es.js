...
const F = (e, t, ...n) => {
...
}, He = /\s/, Y = (e) => e ? e.split(He) : [], ie = "Capture", Fe = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  if (oe || (W = !0, o.$tag$ === "slot" && (L && s.classList.add(L + "-s"), o.$flags$ |= o.$children$ ? (
    ...
    if (v || (v = o.$tag$ === "svg"), l = o.$elm$ = S.createElementNS(v ? ke : me, o.$flags$ & 2 ? "slot-fb" : o.$tag$), v && o.$tag$ === "foreignObject" && (v = !1), re(null, o, v), be(L) && l["s-si"] !== L && l.classList.add(l["s-si"] = L), o.$children$)
...
}, he = (e, t) => (e.$flags$ |= 16, we(e, e.$ancestorComponent$), ct(() => Me(e, t))), Me = (e, t) => {
  const n = e.$hostElement$, s = x("scheduleUpdate", e.$cmpMeta$.$tagName$), o = n;
  let r;
  return t ? r = _(o, "componentWillLoad") : r = _(o, "componentWillUpdate"), r = V(r, () => _(o, "componentWillRender")), s(), V(r, () => De(e, o, t));
...
}, Ze = (e, t) => t & 4 ? S : t & 8 ? M : t & 16 ? S.body : e, Ve = (e) => nt ? {
  passive: (e & 1) !== 0,
  capture: (e & 2) !== 0
} : (e & 2) !== 0, ge = /* @__PURE__ */ new WeakMap(), C = (e) => ge.get(e), et = (e, t) => {
  const n = {
    $flags$: 0,
    $hostElement$: e,
    $cmpMeta$: t,
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), tt = [], M = typeof window < "u" ? window : {}, S = M.document || { head: {} }, st = M.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => ot().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-bold-icon-h{display:flex}", at = $t, ve = Je(class extends st {
  constructor() {
