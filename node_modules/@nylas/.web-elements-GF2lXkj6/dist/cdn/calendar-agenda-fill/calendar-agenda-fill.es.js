...
let x, B, A, le = !1, H = !1, W = !1, v = !1, I = null, D = !1;
const b = (e, t = "") => () => {
...
const U = (e, t, ...n) => {
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(w, c) ? t = c.slice(2) : t = c[2] + t.slice(3), n || s) {
          ...
          t = t.replace(He, ""), n && g.rel(e, t, n, i), s && g.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, Fe = /\s/, J = (e) => e ? e.split(Fe) : [], ie = "Capture", He = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      ue(l), r && (H = !0, r["s-ol"] ? r["s-ol"].remove() : _(r, !0), r.remove());
    }
  }
}, Ue = (e, t, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (p = t[c], p.$tag$ !== $.$tag$ ? y = j(t && t[o], n, c, e) : (C(p, $, l), t[c] = void 0, y = p.$elm$), $ = s[++o]) : (y = j(t && t[o], n, o, e), $ = s[++o]), y && $e(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  r > u ? ce(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && ae(t, r, u);
}, F = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, q = (e) => e && e["s-ol"] || e, $e = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, C = (e, t, n = !1) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || P(null, null), a = be(t) ? t : U(null, null, t);
  ...
  a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], B = i["s-cr"], le = (u.$flags$ & 1) !== 0, H = !1, C(f, a, n);
  {
    if (g.$flags$ |= 1, W) {
      de(a.$elm$);
      for (const d of m) {
    ...
    H && fe(a.$elm$), g.$flags$ &= -2, m.length = 0;
  }
...
}, he = (e, t) => (e.$flags$ |= 16, je(e, e.$ancestorComponent$), rt(() => Me(e, t))), Me = (e, t) => {
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), M = /* @__PURE__ */ new Map(), et = [], w = typeof window < "u" ? window : {}, S = w.document || { head: {} }, tt = w.HTMLElement || class {
}, g = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
