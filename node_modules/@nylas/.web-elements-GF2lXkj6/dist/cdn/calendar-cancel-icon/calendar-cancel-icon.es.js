...
const P = (e, t, ...n) => {
...
}, _e = (e) => tt.map((t) => t(e)).find((t) => !!t), Ce = (e, t) => e != null && !z(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, G = /* @__PURE__ */ new WeakMap(), Re = (e, t, n) => {
  let s = B.get(e);
...
}, Ue = /\s/, J = (e) => e ? e.split(Ue) : [], ie = "Capture", Pe = new RegExp(ie + "$"), ce = (e, t, n, s) => {
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== _ && l["s-ol"] && ($e(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && C(l, t);
  }
  p.$flags$ &= -2;
}, re = (e, t, n, s, l, c) => {
  ...
  for (; c <= u && o <= d; )
    if (f == null)
      ...
      r >= 0 ? (g = t[r], g.$tag$ !== $.$tag$ ? y = w(t && t[o], n, r, e) : (E(g, $, l), t[r] = void 0, y = g.$elm$), $ = s[++o]) : (y = w(t && t[o], n, o, e), $ = s[++o]), y && $e(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  c > u ? re(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && ae(t, c, u);
}, F = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, q = (e) => e && e["s-ol"] || e, $e = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, E = (e, t, n = !1) => {
  const s = t.$elm$ = e.$elm$, l = e.$children$, c = t.$children$, o = t.$tag$, r = t.$text$;
  let i;
  r === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || ce(e, t, v), l !== null && c !== null ? je(s, l, t, c, n) : c !== null ? (e.$text$ !== null && (s.textContent = ""), re(s, null, t, c, 0, c.length - 1)) : l !== null && ae(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = r : e.$text$ !== r && (s.data = r);
}, fe = (e) => {
  ...
  var s, l, c, o, r;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || j(null, null), a = xe(t) ? t : P(null, null, t);
  ...
  a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], H = i["s-cr"], le = (u.$flags$ & 1) !== 0, U = !1, E(f, a, n);
  {
    if (p.$flags$ |= 1, W) {
      de(a.$elm$);
      for (const d of m) {
    ...
    U && fe(a.$elm$), p.$flags$ &= -2, m.length = 0;
  }
