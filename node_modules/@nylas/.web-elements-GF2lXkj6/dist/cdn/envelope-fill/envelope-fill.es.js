...
const P = (e, t, ...n) => {
  ...
  const t = e.$cmpMeta$, n = e.$hostElement$, s = t.$flags$, l = L("attachStyles", t.$tagName$), r = Ce(n.shadowRoot ? n.shadowRoot : n.getRootNode(), t, e.$modeName$);
  ...
  for (o.shadowRoot && o.tagName === A && (o = o.shadowRoot); l <= r; ++l)
    s[l] && (c = B(null, n, l, e), c && (s[l].$elm$ = c, o.insertBefore(c, q(t))));
}, $e = (e, t, n) => {
  for (let s = t; s <= n; ++s) {
    const l = e[s];
    if (l) {
      const r = l.$elm$;
      ue(l), r && (U = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, Pe = (e, t, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== a.$tag$ ? y = B(t && t[o], n, c, e) : (E(g, a, l), t[c] = void 0, y = g.$elm$), a = s[++o]) : (y = B(t && t[o], n, o, e), a = s[++o]), y && ae(f.$elm$).insertBefore(y, q(f.$elm$));
    }
...
}, pe = (e, t) => (e.$flags$ |= 16, Be(e, e.$ancestorComponent$), rt(() => we(e, t))), we = (e, t) => {
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), et = [], D = typeof window < "u" ? window : {}, S = D.document || { head: {} }, tt = D.HTMLElement || class {
}, h = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
  ...
  e.push(n), M || (M = !0, t && h.$flags$ & 4 ? it(N) : h.raf(N));
}, ne = (e) => {
  ...
  ne(se), ne(ye), (M = se.length > 0) && h.raf(N);
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ ot(ye, !0), ct = ".sc-envelope-fill-icon-h{display:flex}", $t = ct, at = Ke(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "16", this.height = "13";
  }
  render() {
    return P("svg", { key: "e3078018e435f423d3a3e83a1f045dbf5b3b9c74", width: "16", height: "13", viewBox: "0 0 16 13", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, P("path", { key: "4a734103e5239969819a847c37b559ca3949f183", d: "M16.0001 3.373V10.5C16.0001 11.8807 14.8808 13 13.5001 13H2.50008C1.11937 13 0 11.8807 0 10.5V3.373L7.74657 7.93097C7.90304 8.02301 8.09711 8.02301 8.25359 7.93097L16.0001 3.373ZM13.5001 0C14.7871 0 15.847 0.972604 15.9849 2.22293L8.00008 6.91991L0.0152595 2.22293C0.153116 0.972604 1.21302 0 2.50008 0H13.5001Z", fill: "currentColor" }));
  }
  static get style() {
    return $t;
  }
