...
const U = (e, t, ...n) => {
...
}, Ae = (e) => tt.map((t) => t(e)).find((t) => !!t), Re = (e, t) => e != null && !z(e) ? t & 4 ? e === "false" ? !1 : e === "" || !!e : t & 2 ? parseFloat(e) : t & 1 ? String(e) : e : e, K = /* @__PURE__ */ new WeakMap(), Oe = (e, t, n) => {
  let s = B.get(e);
  ...
  if (le || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? ke : me, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), be(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
...
}, te = (e, t) => t in e, P = (e, t) => (0, console.error)(e, t), B = /* @__PURE__ */ new Map(), tt = [], D = typeof window < "u" ? window : {}, S = D.document || { head: {} }, st = D.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-play-icon-h{display:flex}", at = $t, ve = Je(class extends st {
  constructor() {
