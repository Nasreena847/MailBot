...
let qe, xr, ot, Di = !1, It = !1, Gr = !1, ue = !1, kn = null, kr = !1;
const Ie = (n, e = "") => () => {
}, qh = "slot-fb{display:contents}slot-fb[hidden]{display:none}", wn = "http://www.w3.org/1999/xlink", En = {}, zh = "http://www.w3.org/2000/svg", Wh = "http://www.w3.org/1999/xhtml", Gh = (n) => n != null, Kr = (n) => (n = typeof n, n === "object" || n === "function");
function Kh(n) {
  var e, t, r;
...
const B = (n, e, ...t) => {
  ...
  const a = [], l = (f) => {
    for (let c = 0; c < f.length; c++)
      r = f[c], Array.isArray(r) ? l(r) : r != null && typeof r != "boolean" && ((o = typeof n != "function" && !Kr(r)) && (r = String(r)), o && s ? a[a.length - 1].$text$ += r : a.push(o ? Lt(null, r) : r), s = o);
  };
  if (l(t), e) {
...
}, Qt = {}, Vh = (n) => n && n.$tag$ === Qt, Jh = {
  forEach: (n, e) => n.map($n).forEach(e),
  map: (n, e) => n.map($n).map(e).map(Zh)
}, $n = (n) => ({
  vattrs: n.$attrs$,
  ...
  if (typeof n.vtag == "function") {
    ...
    return n.vkey && (t.key = n.vkey), n.vname && (t.name = n.vname), B(n.vtag, t, ...n.vchildren || []);
  }
  const e = Lt(n.vtag, n.vtext);
  return e.$attrs$ = n.vattrs, e.$children$ = n.vchildren, e.$key$ = n.vkey, e.$name$ = n.vname, e;
}, Qh = (n) => T1.map((e) => e(n)).find((e) => !!e), Xh = (n, e) => n != null && !Kr(n) ? e & 4 ? n === "false" ? !1 : n === "" || !!n : e & 2 ? parseFloat(n) : e & 1 ? String(n) : n : n, Dt = (n) => n, Vr = (n, e, t) => {
  const r = Dt(n);
  return {
    emit: (i) => e1(r, e, {
      bubbles: !!(t & 4),
...
}, Tn = /* @__PURE__ */ new WeakMap(), t1 = (n, e, t) => {
  let r = _t.get(n);
  B1 && t ? (r = r || new CSSStyleSheet(), typeof r == "string" ? r = e : r.replaceSync(e)) : r = e, _t.set(n, r);
}, r1 = (n, e, t) => {
  var r;
  const i = Mi(e, t), u = _t.get(i);
  if (n = n.nodeType === 11 ? n : fe, u)
    if (typeof u == "string") {
      n = n.head || n;
      let o = Tn.get(n), s;
      if (o || Tn.set(n, o = /* @__PURE__ */ new Set()), !o.has(i)) {
        {
          s = fe.createElement("style"), s.innerHTML = u;
          const a = (r = te.$nonce$) !== null && r !== void 0 ? r : Kh(fe);
          a != null && s.setAttribute("nonce", a), n.insertBefore(s, n.querySelector("link"));
        }
        e.$flags$ & 4 && (s.innerHTML += qh), o && o.add(i);
      }
    } else n.adoptedStyleSheets.includes(u) || (n.adoptedStyleSheets = [...n.adoptedStyleSheets, u]);
  return i;
}, n1 = (n) => {
  const e = n.$cmpMeta$, t = n.$hostElement$, r = e.$flags$, i = Ie("attachStyles", e.$tagName$), u = r1(t.shadowRoot ? t.shadowRoot : t.getRootNode(), e, n.$modeName$);
  r & 10 && (t["s-sc"] = u, t.classList.add(u + "-h"), r & 2 && t.classList.add(u + "-s")), i();
}, Mi = (n, e) => "sc-" + (e && n.$flags$ & 32 ? n.$tagName$ + "-" + e : n.$tagName$), Sn = (n, e, t, r, i, u) => {
  if (t !== r) {
    let o = Rn(n, e), s = e.toLowerCase();
    if (e === "class") {
      const a = n.classList, l = Cn(t), d = Cn(r);
      ...
      if (e === "ref")
        ...
        if (e[2] === "-" ? e = e.slice(3) : Rn(Xt, s) ? e = s.slice(2) : e = s[2] + e.slice(3), t || r) {
          const a = e.endsWith(Pi);
          e = e.replace(u1, ""), t && te.rel(n, e, t, a), r && te.ael(n, e, r, a);
        }
      } else {
        const a = Kr(r);
        if ((o || a && r !== null) && !i)
        ...
        let l = !1;
        s !== (s = s.replace(/^xlink\:?/, "")) && (e = s, l = !0), r == null || r === !1 ? (r !== !1 || n.getAttribute(e) === "") && (l ? n.removeAttributeNS(wn, e) : n.removeAttribute(e)) : (!o || u & 4 || i) && !a && (r = r === !0 ? "" : r, l ? n.setAttributeNS(wn, e, r) : n.setAttribute(e, r));
      }
  }
}, i1 = /\s/, Cn = (n) => n ? n.split(i1) : [], Pi = "Capture", u1 = new RegExp(Pi + "$"), Ii = (n, e, t, r) => {
  const i = e.$elm$.nodeType === 11 && e.$elm$.host ? e.$elm$.host : e.$elm$, u = n && n.$attrs$ || En, o = e.$attrs$ || En;
  for (r in u)
    r in o || Sn(i, r, u[r], void 0, t, e.$flags$);
  for (r in o)
    Sn(i, r, u[r], o[r], t, e.$flags$);
}, Nt = (n, e, t, r) => {
  const i = e.$children$[t];
  let u = 0, o, s, a;
  if (Di || (Gr = !0, i.$tag$ === "slot" && (qe && r.classList.add(qe + "-s"), i.$flags$ |= i.$children$ ? (
    ...
    o = i.$elm$ = fe.createTextNode(i.$text$);
  else if (i.$flags$ & 1)
    o = i.$elm$ = fe.createTextNode("");
  else {
    if (ue || (ue = i.$tag$ === "svg"), o = i.$elm$ = fe.createElementNS(ue ? zh : Wh, i.$flags$ & 2 ? "slot-fb" : i.$tag$), ue && i.$tag$ === "foreignObject" && (ue = !1), Ii(null, i, ue), Gh(qe) && o["s-si"] !== qe && o.classList.add(o["s-si"] = qe), i.$children$)
  ...
  for (let r = t.length - 1; r >= 0; r--) {
    const i = t[r];
    i["s-hn"] !== ot && i["s-ol"] && (_i(i).insertBefore(i, Jr(i)), i["s-ol"].remove(), i["s-ol"] = void 0, i["s-sh"] = void 0, Gr = !0), e && st(i, e);
  }
  te.$flags$ &= -2;
}, Li = (n, e, t, r, i, u) => {
  let o = n["s-cr"] && n["s-cr"].parentNode || n, s;
  for (o.shadowRoot && o.tagName === ot && (o = o.shadowRoot); i <= u; ++i)
    r[i] && (s = Nt(null, t, i, n), s && (r[i].$elm$ = s, o.insertBefore(s, Jr(e))));
}, Ni = (n, e, t) => {
  for (let r = e; r <= t; ++r) {
    const i = n[r];
    if (i) {
      const u = i.$elm$;
      ji(i), u && (It = !0, u["s-ol"] ? u["s-ol"].remove() : st(u, !0), u.remove());
    }
  }
}, o1 = (n, e, t, r, i = !1) => {
  let u = 0, o = 0, s = 0, a = 0, l = e.length - 1, d = e[0], f = e[l], c = r.length - 1, h = r[0], g = r[c], k, p;
  for (; u <= l && o <= c; )
    if (d == null)
      d = e[++u];
    else if (f == null)
      ...
      ze(d, h, i), d = e[++u], h = r[++o];
    else if (xt(f, g, i))
      ze(f, g, i), f = e[--l], g = r[--c];
    else if (xt(d, g, i))
      (d.$tag$ === "slot" || g.$tag$ === "slot") && st(d.$elm$.parentNode, !1), ze(d, g, i), n.insertBefore(d.$elm$, f.$elm$.nextSibling), d = e[++u], g = r[--c];
    else if (xt(f, h, i))
      (d.$tag$ === "slot" || g.$tag$ === "slot") && st(f.$elm$.parentNode, !1), ze(f, h, i), n.insertBefore(f.$elm$, d.$elm$), f = e[--l], h = r[++o];
    else {
      for (s = -1, a = u; a <= l; ++a)
      ...
      s >= 0 ? (p = e[s], p.$tag$ !== h.$tag$ ? k = Nt(e && e[o], t, s, n) : (ze(p, h, i), e[s] = void 0, k = p.$elm$), h = r[++o]) : (k = Nt(e && e[o], t, o, n), h = r[++o]), k && _i(d.$elm$).insertBefore(k, Jr(d.$elm$));
    }
  u > l ? Li(n, r[c + 1] == null ? null : r[c + 1].$elm$, t, r, o, c) : o > c && Ni(e, u, l);
}, xt = (n, e, t = !1) => n.$tag$ === e.$tag$ ? n.$tag$ === "slot" ? n.$name$ === e.$name$ : t ? !0 : n.$key$ === e.$key$ : !1, Jr = (n) => n && n["s-ol"] || n, _i = (n) => (n["s-ol"] ? n["s-ol"] : n).parentNode, ze = (n, e, t = !1) => {
  const r = e.$elm$ = n.$elm$, i = n.$children$, u = e.$children$, o = e.$tag$, s = e.$text$;
  let a;
  s === null ? (ue = o === "svg" ? !0 : o === "foreignObject" ? !1 : ue, o === "slot" || Ii(n, e, ue), i !== null && u !== null ? o1(r, i, e, u, t) : u !== null ? (n.$text$ !== null && (r.textContent = ""), Li(r, null, e, u, 0, u.length - 1)) : i !== null && Ni(i, 0, i.length - 1), ue && o === "svg" && (ue = !1)) : (a = r["s-cr"]) ? a.parentNode.textContent = s : n.$text$ !== s && (r.data = s);
}, Ui = (n) => {
        ...
        if (e = t[r], !e["s-cn"] && !e["s-nr"] && e["s-hn"] !== i["s-hn"] && !Oe.experimentalSlotFixes)
          if (Bn(e, u)) {
            ...
            It = !0, e["s-sn"] = e["s-sn"] || u, o ? (o.$nodeToRelocate$["s-sh"] = i["s-hn"], o.$slotRefNode$ = i) : (e["s-sh"] = i["s-hn"], Te.push({
              ...
              Bn(s.$nodeToRelocate$, e["s-sn"]) && (o = Te.find((a) => a.$nodeToRelocate$ === e), o && !s.$slotRefNode$ && (s.$slotRefNode$ = o.$slotRefNode$));
            });
...
}, Bn = (n, e) => n.nodeType === 1 ? n.getAttribute("slot") === null && e === "" || n.getAttribute("slot") === e : n["s-sn"] === e ? !0 : e === "", ji = (n) => {
  n.$attrs$ && n.$attrs$.ref && n.$attrs$.ref(null), n.$children$ && n.$children$.map(ji);
}, s1 = (n, e, t = !1) => {
  var r, i, u, o, s;
  const a = n.$hostElement$, l = n.$cmpMeta$, d = n.$vnode$ || Lt(null, null), f = Vh(e) ? e : B(null, null, e);
  if (ot = a.tagName, l.$attrsToReflect$ && (f.$attrs$ = f.$attrs$ || {}, l.$attrsToReflect$.map(([c, h]) => f.$attrs$[h] = a[c])), t && f.$attrs$)
    for (const c of Object.keys(f.$attrs$))
      a.hasAttribute(c) && !["key", "ref", "style", "class"].includes(c) && (f.$attrs$[c] = a[c]);
  f.$tag$ = null, f.$flags$ |= 4, n.$vnode$ = f, f.$elm$ = d.$elm$ = a.shadowRoot || a, qe = a["s-sc"], xr = a["s-cr"], Di = (l.$flags$ & 1) !== 0, It = !1, ze(d, f, t);
  {
    if (te.$flags$ |= 1, Gr) {
      Fi(f.$elm$);
      for (const c of Te) {
        ...
        if (!h["s-ol"]) {
          const g = fe.createTextNode("");
          g["s-nr"] = h, h.parentNode.insertBefore(h["s-ol"] = g, h);
        }
      }
      for (const c of Te) {
        const h = c.$nodeToRelocate$, g = c.$slotRefNode$;
        if (g) {
          ...
          let p = g.nextSibling;
          {
            ...
            for (; T; ) {
              let A = (i = T["s-nr"]) !== null && i !== void 0 ? i : null;
              if (A && A["s-sn"] === h["s-sn"] && k === A.parentNode && (A = A.nextSibling, !A || !A["s-nr"])) {
                p = A;
                break;
              }
              T = T.previousSibling;
          ...
          (!p && k !== h.parentNode || h.nextSibling !== p) && h !== p && (!h["s-hn"] && h["s-ol"] && (h["s-hn"] = h["s-ol"].parentNode.nodeName), k.insertBefore(h, p), h.nodeType === 1 && (h.hidden = (u = h["s-ih"]) !== null && u !== void 0 ? u : !1));
        } else
          h.nodeType === 1 && (t && (h["s-ih"] = (o = h.hidden) !== null && o !== void 0 ? o : !1), h.hidden = !0);
      }
    }
    It && Ui(f.$elm$), te.$flags$ &= -2, Te.length = 0;
  }
...
}, Yi = (n, e) => (n.$flags$ |= 16, a1(n, n.$ancestorComponent$), R1(() => l1(n, e))), l1 = (n, e) => {
  const t = n.$hostElement$, r = Ie("scheduleUpdate", n.$cmpMeta$.$tagName$), i = t;
  let u;
  return e ? u = Ge(i, "componentWillLoad") : u = Ge(i, "componentWillUpdate"), u = An(u, () => Ge(i, "componentWillRender")), r(), An(u, () => d1(n, i, e));
}, An = (n, e) => c1(n) ? n.then(e) : e(), c1 = (n) => n instanceof Promise || n && n.then && typeof n.then == "function", d1 = async (n, e, t) => {
  ...
  try {
    kn = e, e = e.render && e.render(), n.$flags$ &= -17, n.$flags$ |= 2, (Oe.hasRenderFn || Oe.reflect) && (Oe.vdomRender || Oe.reflect) && (Oe.hydrateServerSide || s1(n, e, r));
  } catch (a) {
    mt(a, n.$hostElement$);
  }
  return kn = null, null;
...
}, p1 = (n, e) => gt(n).$instanceValues$.get(e), g1 = (n, e, t, r) => {
  const i = gt(n), u = n, o = i.$instanceValues$.get(e), s = i.$flags$, a = u;
  t = Xh(t, r.$members$[e][0]);
        ...
        te.jmp(() => {
          ...
          if (this.hasOwnProperty(f))
            ...
            if (f == null) {
              ...
              if (h && !(h & 8) && h & 128 && l !== a) {
                const k = this, p = (d = e.$watchers$) === null || d === void 0 ? void 0 : d[s];
                p == null || p.forEach((T) => {
  ...
  if (!(e.$flags$ & 32) && (e.$flags$ |= 32, i = n.constructor, customElements.whenDefined(t.$tagName$).then(() => e.$flags$ |= 128), i.style)) {
    let o = i.style;
    typeof o != "string" && (o = o[e.$modeName$ = Qh(n)]);
  ...
  if (!(te.$flags$ & 1)) {
    ...
    e.$flags$ & 1 ? (Hi(n, e, t.$listeners$), e != null && e.$lazyInstance$ ? On(e.$lazyInstance$) : e != null && e.$onReadyPromise$ && e.$onReadyPromise$.then(() => On(e.$lazyInstance$))) : (e.$flags$ |= 1, // TODO(STENCIL-854): Remove code related to legacy shadowDomShim field
    t.$flags$ & 12 && v1(n), t.$members$ && Object.entries(t.$members$).map(([i, [u]]) => {
  ...
  return Object.assign(n.prototype, {
    ...
    connectedCallback() {
      y1(this), r && r.call(this);
    },
    disconnectedCallback() {
      x1(this), i && i.call(this);
    },
    __attachShadow() {
      this.attachShadow({
        mode: "open",
  ...
  }), n.is = t.$tagName$, m1(n, t);
}, Hi = (n, e, t, r) => {
  t && t.map(([i, u, o]) => {
    const s = w1(n, i), a = k1(e, o), l = E1(i);
...
}, w1 = (n, e) => e & 4 ? fe : e & 8 ? Xt : e & 16 ? fe.body : n, E1 = (n) => S1 ? {
  passive: (n & 1) !== 0,
  capture: (n & 2) !== 0
} : (n & 2) !== 0, qi = /* @__PURE__ */ new WeakMap(), gt = (n) => qi.get(n), $1 = (n, e) => {
  const t = {
    $flags$: 0,
    $hostElement$: n,
    $cmpMeta$: e,
  ...
  return Hi(n, t, e.$listeners$), qi.set(n, t);
}, Rn = (n, e) => e in n, mt = (n, e) => (0, console.error)(n, e), _t = /* @__PURE__ */ new Map(), T1 = [], Xt = typeof window < "u" ? window : {}, fe = Xt.document || { head: {} }, _e = Xt.HTMLElement || class {
}, te = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (n) => n(),
  ...
  return n;
})(), C1 = (n) => Promise.resolve(n), B1 = /* @__PURE__ */ (() => {
  try {
  ...
  n.push(t), kr || (kr = !0, e && te.$flags$ & 4 ? O1(wr) : te.raf(wr));
}, Mn = (n) => {
  ...
  Mn(Dn), Mn(zi), (kr = Dn.length > 0) && te.raf(wr);
}, O1 = (n) => C1().then(n), R1 = /* @__PURE__ */ A1(zi, !0), Pn = typeof global < "u" ? global : typeof self < "u" ? self : typeof window < "u" ? window : {};
var ve = [], ae = [], D1 = typeof Uint8Array < "u" ? Uint8Array : Array, Zr = !1;
function Wi() {
  Zr = !0;
...
function M1(n) {
  ...
  u = n[s - 2] === "=" ? 2 : n[s - 1] === "=" ? 1 : 0, o = new D1(s * 3 / 4 - u), r = u > 0 ? s - 4 : s;
  var a = 0;
  for (e = 0, t = 0; e < r; e += 4, t += 3)
    i = ae[n.charCodeAt(e)] << 18 | ae[n.charCodeAt(e + 1)] << 12 | ae[n.charCodeAt(e + 2)] << 6 | ae[n.charCodeAt(e + 3)], o[a++] = i >> 16 & 255, o[a++] = i >> 8 & 255, o[a++] = i & 255;
  return u === 2 ? (i = ae[n.charCodeAt(e)] << 2 | ae[n.charCodeAt(e + 1)] >> 4, o[a++] = i & 255) : u === 1 && (i = ae[n.charCodeAt(e)] << 10 | ae[n.charCodeAt(e + 1)] << 4 | ae[n.charCodeAt(e + 2)] >> 2, o[a++] = i >> 8 & 255, o[a++] = i & 255), o;
}
function P1(n) {
...
function I1(n, e, t) {
  for (var r, i = [], u = e; u < t; u += 3)
    r = (n[u] << 16) + (n[u + 1] << 8) + n[u + 2], i.push(P1(r));
  return i.join("");
}
function In(n) {
  Zr || Wi();
  for (var e, t = n.length, r = t % 3, i = "", u = [], o = 16383, s = 0, a = t - r; s < a; s += o)
    u.push(I1(n, s, s + o > a ? a : s + o));
...
function Gi(n, e, t, r, i, u) {
  var o, s, a, l = u * 8 - i - 1, d = (1 << l) - 1, f = d >> 1, c = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = r ? 0 : u - 1, g = r ? 1 : -1, k = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, o = d) : (o = Math.floor(Math.log(e) / Math.LN2), e * (a = Math.pow(2, -o)) < 1 && (o--, a *= 2), o + f >= 1 ? e += c / a : e += c * Math.pow(2, 1 - f), e * a >= 2 && (o++, a /= 2), o + f >= d ? (s = 0, o = d) : o + f >= 1 ? (s = (e * a - 1) * Math.pow(2, i), o = o + f) : (s = e * Math.pow(2, f - 1) * Math.pow(2, i), o = 0)); i >= 8; n[t + h] = s & 255, h += g, s /= 256, i -= 8)
    ;
  for (o = o << i | s, l += i; l > 0; n[t + h] = o & 255, h += g, o /= 256, l -= 8)
    ;
  n[t + h - g] |= k * 128;
}
var L1 = {}.toString, Ki = Array.isArray || function(n) {
 ...
 */
var N1 = 50;
x.TYPED_ARRAY_SUPPORT = Pn.TYPED_ARRAY_SUPPORT !== void 0 ? Pn.TYPED_ARRAY_SUPPORT : !0;
function Er() {
...
function Vi(n, e, t, r) {
  ...
  return typeof ArrayBuffer < "u" && e instanceof ArrayBuffer ? F1(n, e, t, r) : typeof e == "string" ? U1(n, e, t) : j1(n, e);
}
x.from = function(n, e, t) {
  return Vi(null, n, e, t);
};
...
x.alloc = function(n, e, t) {
  return _1(null, n, e, t);
};
function Qr(n, e) {
  if (Ji(e), n = Se(n, e < 0 ? 0 : Xr(e) | 0), !x.TYPED_ARRAY_SUPPORT)
    for (var t = 0; t < e; ++t)
      n[t] = 0;
  return n;
}
...
function $r(n, e) {
  var t = e.length < 0 ? 0 : Xr(e.length) | 0;
  n = Se(n, t);
  for (var r = 0; r < t; r += 1)
    n[r] = e[r] & 255;
  return n;
...
function j1(n, e) {
  ...
  if (e) {
    if (typeof ArrayBuffer < "u" && e.buffer instanceof ArrayBuffer || "length" in e)
      return typeof e.length != "number" || op(e.length) ? Se(n, 0) : $r(n, e);
    if (e.type === "Buffer" && Ki(e.data))
      return $r(n, e.data);
  }
...
x.compare = function(e, t) {
  ...
  if (e === t) return 0;
  for (var r = e.length, i = t.length, u = 0, o = Math.min(r, i); u < o; ++u)
    if (e[u] !== t[u]) {
      r = e[u], i = t[u];
      break;
    }
...
x.prototype.toString = function() {
  var e = this.length | 0;
  return e === 0 ? "" : arguments.length === 0 ? eu(this, 0, e) : Y1.apply(this, arguments);
};
...
x.prototype.compare = function(e, t, r, i, u) {
  if (!ke(e))
...
function Qi(n, e, t, r, i) {
  ...
  if (typeof e == "string" && (e = x.from(e, r)), ke(e))
    return e.length === 0 ? -1 : Ln(n, e, t, r, i);
  if (typeof e == "number")
    return e = e & 255, x.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(n, e, t) : Uint8Array.prototype.lastIndexOf.call(n, e, t) : Ln(n, [e], t, r, i);
...
function Ln(n, e, t, r, i) {
  ...
  function a(h, g) {
    return u === 1 ? h[g] : h.readUInt16BE(g * u);
  }
  var l;
  if (i) {
    var d = -1;
...
x.prototype.indexOf = function(e, t, r) {
  return Qi(this, e, t, r, !0);
};
x.prototype.lastIndexOf = function(e, t, r) {
  return Qi(this, e, t, r, !1);
};
function H1(n, e, t, r) {
  t = Number(t) || 0;
  var i = n.length - t;
...
function Xi(n, e, t, r) {
  return nr(ip(e), n, t, r);
}
function z1(n, e, t, r) {
  return Xi(n, e, t, r);
}
function W1(n, e, t, r) {
  return nr(iu(e), n, t, r);
}
function G1(n, e, t, r) {
  return nr(up(e, n.length - t), n, t, r);
}
x.prototype.write = function(e, t, r, i) {
  ...
  for (var o = !1; ; )
    switch (i) {
      ...
      case "utf8":
      case "utf-8":
        return q1(this, e, t, r);
      case "ascii":
        return Xi(this, e, t, r);
      case "latin1":
      case "binary":
        return z1(this, e, t, r);
      case "base64":
        return W1(this, e, t, r);
      case "ucs2":
      case "ucs-2":
      case "utf16le":
      case "utf-16le":
...
function K1(n, e, t) {
  return e === 0 && t === n.length ? In(n) : In(n.slice(e, t));
}
function eu(n, e, t) {
...
x.prototype.slice = function(e, t) {
  ...
  if (x.TYPED_ARRAY_SUPPORT)
    i = this.subarray(e, t), i.__proto__ = x.prototype;
  else {
    var u = t - e;
    i = new x(u, void 0);
    for (var o = 0; o < u; ++o)
...
x.prototype.readUIntLE = function(e, t, r) {
  e = e | 0, t = t | 0, r || Z(e, t, this.length);
...
x.prototype.readFloatLE = function(e, t) {
  return t || Z(e, 4, this.length), er(this, e, !0, 23, 4);
};
x.prototype.readFloatBE = function(e, t) {
  return t || Z(e, 4, this.length), er(this, e, !1, 23, 4);
};
x.prototype.readDoubleLE = function(e, t) {
  return t || Z(e, 8, this.length), er(this, e, !0, 52, 8);
};
x.prototype.readDoubleBE = function(e, t) {
  return t || Z(e, 8, this.length), er(this, e, !1, 52, 8);
};
...
x.prototype.writeUIntLE = function(e, t, r, i) {
...
x.prototype.writeUInt16LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 2, 65535, 0), x.TYPED_ARRAY_SUPPORT ? (this[t] = e & 255, this[t + 1] = e >>> 8) : tr(this, e, t, !0), t + 2;
};
x.prototype.writeUInt16BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 2, 65535, 0), x.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = e & 255) : tr(this, e, t, !1), t + 2;
};
function rr(n, e, t, r) {
...
x.prototype.writeUInt32LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 4, 4294967295, 0), x.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = e & 255) : rr(this, e, t, !0), t + 4;
};
x.prototype.writeUInt32BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 4, 4294967295, 0), x.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = e & 255) : rr(this, e, t, !1), t + 4;
};
...
x.prototype.writeInt16LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 2, 32767, -32768), x.TYPED_ARRAY_SUPPORT ? (this[t] = e & 255, this[t + 1] = e >>> 8) : tr(this, e, t, !0), t + 2;
};
x.prototype.writeInt16BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 2, 32767, -32768), x.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = e & 255) : tr(this, e, t, !1), t + 2;
};
x.prototype.writeInt32LE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 4, 2147483647, -2147483648), x.TYPED_ARRAY_SUPPORT ? (this[t] = e & 255, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : rr(this, e, t, !0), t + 4;
};
x.prototype.writeInt32BE = function(e, t, r) {
  return e = +e, t = t | 0, r || ie(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), x.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = e & 255) : rr(this, e, t, !1), t + 4;
};
function tu(n, e, t, r, i, u) {
  if (t + r > n.length) throw new RangeError("Index out of range");
  if (t < 0) throw new RangeError("Index out of range");
}
function ru(n, e, t, r, i) {
  return i || tu(n, e, t, 4), Gi(n, e, t, r, 23, 4), t + 4;
}
...
function nu(n, e, t, r, i) {
  return i || tu(n, e, t, 8), Gi(n, e, t, r, 52, 8), t + 8;
}
x.prototype.writeDoubleLE = function(e, t, r) {
  return nu(this, e, t, !0, r);
};
x.prototype.writeDoubleBE = function(e, t, r) {
  return nu(this, e, t, !1, r);
};
x.prototype.copy = function(e, t, r, i) {
...
x.prototype.fill = function(e, t, r, i) {
  if (typeof e == "string") {
  ...
  if (typeof e == "number")
    ...
    var s = ke(e) ? e : Ut(new x(e, i).toString()), a = s.length;
    for (o = 0; o < r - t; ++o)
      this[o + t] = s[o % a];
  }
  return this;
...
function tp(n) {
  if (n = rp(n).replace(ep, ""), n.length < 2) return "";
  for (; n.length % 4 !== 0; )
    n = n + "=";
  return n;
}
...
function up(n, e) {
  for (var t, r, i, u = [], o = 0; o < n.length && !((e -= 2) < 0); ++o)
    t = n.charCodeAt(o), r = t >> 8, i = t % 256, u.push(i), u.push(r);
  return u;
}
function iu(n) {
  return M1(tp(n));
...
function sp(n) {
  return n != null && (!!n._isBuffer || uu(n) || ap(n));
}
function uu(n) {
  return !!n.constructor && typeof n.constructor.isBuffer == "function" && n.constructor.isBuffer(n);
}
function ap(n) {
  return typeof n.readFloatLE == "function" && typeof n.slice == "function" && uu(n.slice(0, 0));
}
...
(function(n, e) {
  (function(t, r) {
    ...
    var t = 1e3, r = 6e4, i = 36e5, u = "millisecond", o = "second", s = "minute", a = "hour", l = "day", d = "week", f = "month", c = "quarter", h = "year", g = "date", k = "Invalid Date", p = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, T = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, A = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(v) {
      var b = ["th", "st", "nd", "rd"], y = v % 100;
      return "[" + v + (b[(y - 20) % 10] || b[y] || b[0]) + "]";
    } }, j = function(v, b, y) {
      var C = String(v);
      return !C || C.length >= b ? v : "" + Array(b + 1 - C.length).join(y) + v;
    }, R = { s: j, z: function(v) {
      var b = -v.utcOffset(), y = Math.abs(b), C = Math.floor(y / 60), w = y % 60;
      return (b <= 0 ? "+" : "-") + j(C, 2, "0") + ":" + j(w, 2, "0");
    }, m: function v(b, y) {
      if (b.date() < y.date()) return -v(y, b);
      var C = 12 * (y.year() - b.year()) + (y.month() - b.month()), w = b.clone().add(C, f), S = y - w < 0, O = b.clone().add(C + (S ? -1 : 1), f);
      return +(-(C + (y - w) / (S ? w - O : O - w)) || 0);
    }, a: function(v) {
      return v < 0 ? Math.ceil(v) || 0 : Math.floor(v);
    }, p: function(v) {
      return { M: f, y: h, w: d, d: l, D: g, h: a, m: s, s: o, ms: u, Q: c }[v] || String(v || "").toLowerCase().replace(/s$/, "");
    }, u: function(v) {
      return v === void 0;
    } }, L = "en", P = {};
    P[L] = A;
      ...
      return b.parse = function(y) {
        this.$d = function(C) {
          ...
          if (typeof w == "string" && !/Z$/i.test(w)) {
            var O = w.match(p);
            if (O) {
              var I = O[2] - 1 || 0, q = (O[7] || "0").substring(0, 3);
              return S ? new Date(Date.UTC(O[1], I, O[3] || 1, O[4] || 0, O[5] || 0, O[6] || 0, q)) : new Date(O[1], I, O[3] || 1, O[4] || 0, O[5] || 0, O[6] || 0, q);
            }
          }
          return new Date(w);
        ...
        return N(y) < this.startOf(C);
      }, b.isBefore = function(y, C) {
        return this.endOf(C) < N(y);
      }, b.$g = function(y, C, w) {
        ...
        var w = this, S = !!M.u(C) || C, O = M.p(y), I = function(Fe, ne) {
          var Ae = M.w(w.$u ? Date.UTC(w.$y, ne, Fe) : new Date(w.$y, ne, Fe), w);
          return S ? Ae : Ae.endOf(l);
        }, q = function(Fe, ne) {
          return M.w(w.toDate()[Fe].apply(w.toDate("s"), (S ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(ne)), w);
        }, K = this.$W, Q = this.$M, Be = this.$D, Ee = "set" + (this.$u ? "UTC" : "");
        switch (O) {
          case h:
          ...
          case d:
            var Qe = this.$locale().weekStart || 0, Xe = (K < Qe ? K + 7 : K) - Qe;
            return I(S ? Be - Xe : Be + (6 - Xe), Q);
          case l:
          case g:
            return q(Ee + "Hours", 0);
          case a:
        ...
        var w, S = M.p(y), O = "set" + (this.$u ? "UTC" : ""), I = (w = {}, w[l] = O + "Date", w[g] = O + "Date", w[f] = O + "Month", w[h] = O + "FullYear", w[a] = O + "Hours", w[s] = O + "Minutes", w[o] = O + "Seconds", w[u] = O + "Milliseconds", w)[S], q = S === l ? this.$D + (C - this.$W) : C;
        if (S === f || S === h) {
          var K = this.clone().set(g, 1);
          K.$d[I](q), K.init(), this.$d = K.set(g, Math.min(this.$D, K.daysInMonth())).$d;
        } else I && this.$d[I](q);
        ...
        var w, S = this;
        y = Number(y);
        var O = M.p(C), I = function(Q) {
          var Be = N(S);
          return M.w(Be.date(Be.date() + Math.round(Q * y)), S);
        };
        if (O === f) return this.set(f, this.$M + y);
        if (O === h) return this.set(h, this.$y + y);
        if (O === l) return I(1);
        if (O === d) return I(7);
        var q = (w = {}, w[s] = r, w[a] = i, w[o] = t, w)[O] || 1, K = this.$d.getTime() + y * q;
        return M.w(K, this);
        ...
        var S = y || "YYYY-MM-DDTHH:mm:ssZ", O = M.z(this), I = this.$H, q = this.$m, K = this.$M, Q = w.weekdays, Be = w.months, Ee = function(ne, Ae, cr, vt) {
          return ne && (ne[Ae] || ne(C, S)) || cr[Ae].slice(0, vt);
        }, Qe = function(ne) {
          return M.s(I % 12 || 12, ne, "0");
        }, Xe = w.meridiem || function(ne, Ae, cr) {
          var vt = ne < 12 ? "AM" : "PM";
          return cr ? vt.toLowerCase() : vt;
        }, Fe = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: K + 1, MM: M.s(K + 1, 2, "0"), MMM: Ee(w.monthsShort, K, Be, 3), MMMM: Ee(Be, K), D: this.$D, DD: M.s(this.$D, 2, "0"), d: String(this.$W), dd: Ee(w.weekdaysMin, this.$W, Q, 2), ddd: Ee(w.weekdaysShort, this.$W, Q, 3), dddd: Q[this.$W], H: String(I), HH: M.s(I, 2, "0"), h: Qe(1), hh: Qe(2), a: Xe(I, q, !0), A: Xe(I, q, !1), m: String(q), mm: M.s(q, 2, "0"), s: String(this.$s), ss: M.s(this.$s, 2, "0"), SSS: M.s(this.$ms, 3, "0"), Z: O };
        return S.replace(T, function(ne, Ae) {
          return Ae || Fe[ne] || O.replace(":", "");
        });
      }, b.utcOffset = function() {
        return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
      }, b.diff = function(y, C, w) {
        var S, O = M.p(C), I = N(y), q = (I.utcOffset() - this.utcOffset()) * r, K = this - I, Q = M.m(this, I);
        return Q = (S = {}, S[h] = Q / 12, S[f] = Q, S[c] = Q / 3, S[d] = (K - q) / 6048e5, S[l] = (K - q) / 864e5, S[a] = K / i, S[s] = K / r, S[o] = K / t, S)[O] || K, w ? Q : M.a(Q);
    ...
    return N.prototype = E, [["$ms", u], ["$s", o], ["$m", s], ["$H", a], ["$W", l], ["$M", f], ["$y", h], ["$D", g]].forEach(function(v) {
      E[v[1]] = function(b) {
        return this.$g(b, v[0], v[1]);
      };
    }), N.extend = function(v, b) {
      return v.$i || (v(b, m, N), v.$i = !0), N;
    }, N.locale = G, N.isDayjs = F, N.unix = function(v) {
      return N(1e3 * v);
    }, N.en = P[L], N.Ls = P, N.p = {}, N;
  });
})(lp);
var Tr = [
  "MO",
...
function je(n, e, t) {
  t === void 0 && (t = " ");
  var r = String(n);
  return e = e >> 0, r.length > e ? String(r) : (e = e - r.length, e > t.length && (t += _(t, e / t.length)), t.slice(0, e) + String(r));
}
var dp = function(n, e, t) {
...
}, Le = function(n, e, t, r, i, u) {
  return r === void 0 && (r = 0), i === void 0 && (i = 0), u === void 0 && (u = 0), new Date(Date.UTC(n, e - 1, t, r, i, u));
}, fp = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], su = 1e3 * 60 * 60 * 24, au = 9999, lu = Le(1970, 1, 1), hp = [6, 0, 1, 2, 3, 4, 5], it = function(n) {
  return n % 4 === 0 && n % 100 !== 0 || n % 400 === 0;
}, cu = function(n) {
  return n instanceof Date;
}, nt = function(n) {
  return cu(n) && !isNaN(n.getTime());
}, Un = function(n) {
  return n.getTimezoneOffset() * 60 * 1e3;
}, pp = function(n, e) {
  var t = n.getTime() - Un(n), r = e.getTime() - Un(e), i = t - r;
  return Math.round(i / su);
}, Sr = function(n) {
  return pp(n, lu);
}, du = function(n) {
  return new Date(lu.getTime() + n * su);
}, gp = function(n) {
  var e = n.getUTCMonth();
  return e === 1 && it(n.getUTCFullYear()) ? 29 : fp[e];
}, Ke = function(n) {
  return hp[n.getUTCDay()];
}, Fn = function(n, e) {
  var t = Le(n, e + 1, 1);
  return [Ke(t), gp(t)];
}, fu = function(n, e) {
  ...
  var t = Intl.DateTimeFormat().resolvedOptions().timeZone, r = new Date(Yn(n, t)), i = new Date(Yn(n, e ?? "UTC")), u = i.getTime() - r.getTime();
...
var Hn = (
  ...
  function() {
    function n(e, t, r, i) {
      if (t === void 0 && (t = bp), r === void 0 && (r = Ft), i === void 0 && (i = yp), this.text = [], this.language = r || Ft, this.gettext = t, this.dateFormatter = i, this.rrule = e, this.options = e.options, this.origOptions = e.origOptions, this.origOptions.bymonthday) {
      ...
      if (V(this.origOptions.byweekday)) {
        var s = oe(this.origOptions.byweekday) ? this.origOptions.byweekday : [this.origOptions.byweekday], a = String(s);
        this.byweekday = {
    ...
    return n.isFullyConvertible = function(e) {
      ...
      for (var r in e.origOptions) {
        if (qn(["dtstart", "wkst", "freq"], r))
          return !0;
        if (!qn(n.IMPLEMENTED[e.options.freq], r))
          return !1;
      }
      return t;
...
function hu(n, e) {
  ...
  function i() {
    ...
    if (c && (t.interval = parseInt(c[0], 10)), r.isDone())
      throw new Error("Unexpected end");
    switch (r.symbol) {
      case "day(s)":
        t.freq = D.DAILY, r.nextSymbol() && (o(), f());
        break;
      case "weekday(s)":
        t.freq = D.WEEKLY, t.byweekday = [D.MO, D.TU, D.WE, D.TH, D.FR], r.nextSymbol(), f();
        break;
      case "week(s)":
        t.freq = D.WEEKLY, r.nextSymbol() && (u(), f());
        break;
      case "hour(s)":
        t.freq = D.HOURLY, r.nextSymbol() && (u(), f());
        break;
      case "minute(s)":
        t.freq = D.MINUTELY, r.nextSymbol() && (u(), f());
        break;
      case "month(s)":
        t.freq = D.MONTHLY, r.nextSymbol() && (u(), f());
        break;
      case "year(s)":
        t.freq = D.YEARLY, r.nextSymbol() && (u(), f());
        break;
      case "monday":
      case "tuesday":
      case "wednesday":
      ...
      case "sunday":
        ...
        for (; r.accept("comma"); ) {
          ...
          t.byweekday.push(D[g]), r.nextSymbol();
        }
        d(), f();
        break;
      case "january":
  ...
  function u() {
    ...
    if (c || h)
      do {
        var g = l(), k = a(), p = s();
        if (g)
          k ? (r.nextSymbol(), t.byweekday || (t.byweekday = []), t.byweekday.push(D[k].nth(g))) : (t.bymonthday || (t.bymonthday = []), t.bymonthday.push(g), r.accept("day(s)"));
        else if (k)
  ...
  function l() {
    switch (r.symbol) {
      ...
      case "nth":
        var c = parseInt(r.value[1], 10);
        if (c < -366 || c > 366)
          throw new Error("Nth out of range: " + c);
        return r.nextSymbol(), r.accept("last") ? -c : c;
      default:
        return !1;
    }
  }
  function d() {
    ...
    var c = l();
    if (c)
      for (t.bymonthday = [c], r.nextSymbol(); r.accept("comma"); ) {
        if (c = l(), !c)
          throw new Error("Unexpected symbol " + r.symbol + "; expected monthday");
        t.bymonthday.push(c), r.nextSymbol();
      }
  }
  function f() {
    if (r.symbol === "until") {
      var c = Date.parse(r.text);
      if (!c)
...
var xp = function(n, e) {
  return e === void 0 && (e = Ft), new D(hu(n, e) || void 0);
}, Ze = [
  "count",
  "until",
  "interval",
...
Ce.IMPLEMENTED = [];
Ce.IMPLEMENTED[U.HOURLY] = Ze;
Ce.IMPLEMENTED[U.MINUTELY] = Ze;
Ce.IMPLEMENTED[U.DAILY] = ["byhour"].concat(Ze);
Ce.IMPLEMENTED[U.WEEKLY] = Ze;
Ce.IMPLEMENTED[U.MONTHLY] = Ze;
Ce.IMPLEMENTED[U.YEARLY] = ["byweekno", "byyearday"].concat(Ze);
var kp = function(n, e, t, r) {
  return new Ce(n, e, t, r).toString();
}, wp = Ce.isFullyConvertible, jt = (
  /** @class */
  function() {
    function n(e, t, r, i) {
  ...
  function(n) {
    ...
    return e.fromDate = function(t) {
      ...
      if (this.month += t, this.month > 12) {
        var r = Math.floor(this.month / 12), i = le(this.month, 12);
      ...
      if (!(this.day <= 28)) {
        var t = Fn(this.year, this.month - 1)[1];
        if (!(this.day <= t))
          for (; this.day > t; ) {
            if (this.day -= t, ++this.month, this.month === 13 && (this.month = 1, ++this.year, this.year > au))
              return;
            t = Fn(this.year, this.month - 1)[1];
          }
      }
...
function pu(n) {
  for (var e = [], t = Object.keys(n), r = 0, i = t; r < i.length; r++) {
    var u = i[r];
    H(Xp, u) || e.push(u), cu(n[u]) && !nt(n[u]) && e.push(u);
  }
  if (e.length)
...
function $p(n) {
  var e = se(se({}, un), pu(n));
  if (V(e.byeaster) && (e.freq = D.YEARLY), !(V(e.freq) && D.FREQUENCIES[e.freq]))
    throw new Error("Invalid frequency: ".concat(e.freq, " ").concat(n.freq));
  if (e.dtstart || (e.dtstart = new Date((/* @__PURE__ */ new Date()).setMilliseconds(0))), V(e.wkst) ? be(e.wkst) || (e.wkst = e.wkst.weekday) : e.wkst = D.MO.weekday, V(e.bysetpos)) {
  ...
  if (!(e.byweekno || J(e.byweekno) || J(e.byyearday) || e.bymonthday || J(e.bymonthday) || V(e.byweekday) || V(e.byeaster)))
    switch (e.freq) {
      case D.YEARLY:
  ...
  if (V(e.bymonth) && !oe(e.bymonth) && (e.bymonth = [e.bymonth]), V(e.byyearday) && !oe(e.byyearday) && be(e.byyearday) && (e.byyearday = [e.byyearday]), !V(e.bymonthday))
  ...
  return V(e.byhour) ? be(e.byhour) && (e.byhour = [e.byhour]) : e.byhour = e.freq < D.HOURLY ? [e.dtstart.getUTCHours()] : null, V(e.byminute) ? be(e.byminute) && (e.byminute = [e.byminute]) : e.byminute = e.freq < D.MINUTELY ? [e.dtstart.getUTCMinutes()] : null, V(e.bysecond) ? be(e.bysecond) && (e.bysecond = [e.bysecond]) : e.bysecond = e.freq < D.SECONDLY ? [e.dtstart.getUTCSeconds()] : null, { parsedOptions: e };
}
function Tp(n) {
...
function Yt(n) {
  ...
  if (!t)
    return e;
  var r = t[1], i = t[2];
  return r && (e.tzid = r), e.dtstart = tn(i), e;
}
function Sp(n) {
...
function Bp(n) {
  ...
  return e.map(function(t) {
    ...
    var i = Number(r[1]), u = r[2], o = de[u].weekday;
    return new re(o, i);
  });
}
var Ht = (
  ...
  function() {
    ...
    return Object.defineProperty(n.prototype, "isUTC", {
      ...
      var e = en(this.date.getTime(), this.isUTC);
      return this.isUTC ? ":".concat(e) : ";TZID=".concat(this.tzid, ":").concat(e);
    }, n.prototype.getTime = function() {
      return this.date.getTime();
    }, n.prototype.rezonedDate = function() {
      return this.isUTC ? this.date : mp(this.date, this.tzid);
    }, n;
  }()
);
function Or(n) {
  for (var e = [], t = "", r = Object.keys(n), i = Object.keys(un), u = 0; u < r.length; u++)
    if (r[u] !== "tzid" && H(i, r[u])) {
      ...
      if (!(!V(s) || oe(s) && !s.length)) {
        switch (o) {
          ...
          case "WKST":
            ...
            break;
          case "BYWEEKDAY":
            o = "BYDAY", a = cp(s).map(function(h) {
              return h instanceof re ? h : oe(h) ? new re(h[0], h[1]) : new re(h);
            }).toString();
            break;
          case "DTSTART":
            t = Ap(s, n.tzid);
  ...
  var f = e.map(function(h) {
    var g = h[0], k = h[1];
    return "".concat(g, "=").concat(k.toString());
  }).join(";"), c = "";
...
var Rp = (
  ...
  function() {
    ...
    return n.prototype._cacheAdd = function(e, t, r) {
      t && (t = t instanceof Date ? Cr(t) : jn(t)), e === "all" ? this.all = t : (r._value = t, this[e].push(r));
    }, n.prototype._cacheGet = function(e, t) {
      var r = !1, i = t ? Object.keys(t) : [], u = function(d) {
      ...
      return oe(r) ? jn(r) : r instanceof Date ? Cr(r) : r;
    }, n;
  }()
), Dp = $($($($($($($($($($($($($([], _(1, 31), !0), _(2, 28), !0), _(3, 31), !0), _(4, 30), !0), _(5, 31), !0), _(6, 30), !0), _(7, 31), !0), _(8, 31), !0), _(9, 30), !0), _(10, 31), !0), _(11, 30), !0), _(12, 31), !0), _(1, 7)), Mp = $($($($($($($($($($($($($([], _(1, 31), !0), _(2, 29), !0), _(3, 31), !0), _(4, 30), !0), _(5, 31), !0), _(6, 30), !0), _(7, 31), !0), _(8, 31), !0), _(9, 30), !0), _(10, 31), !0), _(11, 30), !0), _(12, 31), !0), _(1, 7)), Pp = we(1, 29), Ip = we(1, 30), Re = we(1, 31), X = we(1, 32), Lp = $($($($($($($($($($($($($([], X, !0), Ip, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X.slice(0, 7)), Np = $($($($($($($($($($($($($([], X, !0), Pp, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X, !0), Re, !0), X, !0), Re, !0), X, !0), X.slice(0, 7)), _p = we(-28, 0), Up = we(-29, 0), De = we(-30, 0), ee = we(-31, 0), Fp = $($($($($($($($($($($($($([], ee, !0), Up, !0), ee, !0), De, !0), ee, !0), De, !0), ee, !0), ee, !0), De, !0), ee, !0), De, !0), ee, !0), ee.slice(0, 7)), jp = $($($($($($($($($($($($($([], ee, !0), _p, !0), ee, !0), De, !0), ee, !0), De, !0), ee, !0), ee, !0), De, !0), ee, !0), De, !0), ee, !0), ee.slice(0, 7)), Yp = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366], Hp = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365], Gn = function() {
  for (var n = [], e = 0; e < 55; e++)
    n = n.concat(we(7));
  return n;
}();
function qp(n, e) {
  var t = Le(n, 1, 1), r = it(n) ? 366 : 365, i = it(n + 1) ? 366 : 365, u = Sr(t), o = Ke(t), s = se(se({ yearlen: r, nextyearlen: i, yearordinal: u, yearweekday: o }, zp(n)), { wnomask: null });
  if (ye(e.byweekno))
    return s;
  s.wnomask = _(0, r + 7);
  var a, l, d = a = le(7 - o + e.wkst, 7);
  d >= 4 ? (d = 0, l = s.yearlen + le(o - e.wkst, 7)) : l = r - d;
  for (var f = Math.floor(l / 7), c = le(l, 7), h = Math.floor(f + c / 4), g = 0; g < e.byweekno.length; g++) {
    var k = e.byweekno[g];
    if (k < 0 && (k += h + 1), k > 0 && k <= h) {
      var p = void 0;
      k > 1 ? (p = d + (k - 1) * 7, d !== a && (p -= 7 - a)) : p = d;
      for (var T = 0; T < 7 && (s.wnomask[p] = 1, p++, s.wdaymask[p] !== e.wkst); T++)
        ;
    }
  }
  if (H(e.byweekno, 1)) {
    var p = d + h * 7;
    if (d !== a && (p -= 7 - a), p < r)
      for (var g = 0; g < 7 && (s.wnomask[p] = 1, p += 1, s.wdaymask[p] !== e.wkst); g++)
        ;
  }
  if (d) {
    var A = void 0;
    if (H(e.byweekno, -1))
      ...
      var j = Ke(Le(n - 1, 1, 1)), R = le(7 - j.valueOf() + e.wkst, 7), L = it(n - 1) ? 366 : 365, P = void 0;
      R >= 4 ? (R = 0, P = L + le(j - e.wkst, 7)) : P = r - d, A = Math.floor(52 + le(P, 7) / 4);
    }
    if (H(e.byweekno, A))
      for (var p = 0; p < d; p++)
        s.wnomask[p] = 1;
...
function zp(n) {
  var e = it(n) ? 366 : 365, t = Le(n, 1, 1), r = Ke(t);
  return e === 365 ? {
    mmask: Dp,
    mdaymask: Np,
    nmdaymask: jp,
...
function Wp(n, e, t, r, i, u) {
  ...
  else u.freq === D.MONTHLY && (s = [r.slice(e - 1, e + 1)]);
  if (ye(s))
    return o;
  o.nwdaymask = _(0, t);
  for (var a = 0; a < s.length; a++)
    for (var l = s[a], d = l[0], f = l[1] - 1, c = 0; c < u.bynweekday.length; c++) {
      var h = void 0, g = u.bynweekday[c], k = g[0], p = g[1];
      p < 0 ? (h = f + (p + 1) * 7, h -= le(i[h] - k, 7)) : (h = d + (p - 1) * 7, h += le(7 - i[h] + k, 7)), d <= h && h <= f && (o.nwdaymask[h] = 1);
    }
  return o;
}
function Gp(n, e) {
  e === void 0 && (e = 0);
  var t = n % 19, r = Math.floor(n / 100), i = n % 100, u = Math.floor(r / 4), o = r % 4, s = Math.floor((r + 8) / 25), a = Math.floor((r - s + 1) / 3), l = Math.floor(19 * t + r - u - a + 15) % 30, d = Math.floor(i / 4), f = i % 4, c = Math.floor(32 + 2 * o + 2 * d - l - f) % 7, h = Math.floor((t + 11 * l + 22 * c) / 451), g = Math.floor((l + c - 7 * h + 114) / 31), k = (l + c - 7 * h + 114) % 31 + 1, p = Date.UTC(n, g - 1, k + e), T = Date.UTC(n, 0, 1);
  return [Math.ceil((p - T) / (1e3 * 60 * 60 * 24))];
}
var Kp = (
  /** @class */
  function() {
    ...
    return n.prototype.rebuild = function(e, t) {
      var r = this.options;
      if (e !== this.lastyear && (this.yearinfo = qp(e, r)), J(r.bynweekday) && (t !== this.lastmonth || e !== this.lastyear)) {
        var i = this.yearinfo, u = i.yearlen, o = i.mrange, s = i.wdaymask;
        this.monthinfo = Wp(e, t, u, o, s, r);
      }
      V(r.byeaster) && (this.eastermask = Gp(e, r.byeaster));
      ...
      for (var r = this.mrange[t - 1], i = this.mrange[t], u = _(null, this.yearlen), o = r; o < i; o++)
        u[o] = o;
      return [u, r, i];
    }, n.prototype.wdayset = function(e, t, r) {
      for (var i = _(null, this.yearlen + 7), u = Sr(Le(e, t, r)) - this.yearordinal, o = u, s = 0; s < 7 && (i[u] = u, ++u, this.wdaymask[u] !== this.options.wkst); s++)
        ;
      return [i, o, u];
    }, n.prototype.ddayset = function(e, t, r) {
      var i = _(null, this.yearlen), u = Sr(Le(e, t, r)) - this.yearordinal;
...
function Vp(n, e, t, r, i, u) {
  for (var o = [], s = 0; s < n.length; s++) {
    ...
    d < 0 ? (a = Math.floor(d / e.length), l = le(d, e.length)) : (a = Math.floor((d - 1) / e.length), l = le(d - 1, e.length));
    for (var f = [], c = t; c < r; c++) {
      var h = u[c];
      V(h) && f.push(h);
    }
    var g = void 0;
    a < 0 ? g = f.slice(a)[0] : g = f[a];
    var k = e[l], p = du(i.yearordinal + g), T = fu(p, k);
    H(o, T) || o.push(T);
  }
  return at(o), o;
}
function gu(n, e) {
  ...
  if (s === 0 || i === 0)
    return $e(n);
  var a = Ep.fromDate(t), l = new Kp(e);
  l.rebuild(a.year, a.month);
  for (var d = Qp(l, a, e); ; ) {
    var f = l.getdayset(r)(a.year, a.month, a.day), c = f[0], h = f[1], g = f[2], k = Zp(c, h, g, l, e);
    if (J(o))
      for (var p = Vp(o, d, h, g, l, c), T = 0; T < p.length; T++) {
        var A = p[T];
        if (u && A > u)
          return $e(n);
        if (A >= t) {
      ...
      for (var T = h; T < g; T++) {
        var R = c[T];
        if (V(R))
          for (var L = du(l.yearordinal + R), P = 0; P < d.length; P++) {
            var F = d[P], A = fu(L, F);
            if (u && A > u)
              return $e(n);
            if (A >= t) {
    ...
    if (e.interval === 0 || (a.add(e, k), a.year > au))
      return $e(n);
    nn(r) || (d = l.gettimeset(r)(a.hour, a.minute, a.second, 0)), l.rebuild(a.year, a.month);
  }
}
function Jp(n, e, t) {
  var r = t.bymonth, i = t.byweekno, u = t.byweekday, o = t.byeaster, s = t.bymonthday, a = t.bynmonthday, l = t.byyearday;
  return J(r) && !H(r, n.mmask[e]) || J(i) && !n.wnomask[e] || J(u) && !H(u, n.wdaymask[e]) || J(n.nwdaymask) && !n.nwdaymask[e] || o !== null && !H(n.eastermask, e) || (J(s) || J(a)) && !H(s, n.mdaymask[e]) && !H(a, n.nmdaymask[e]) || J(l) && (e < n.yearlen && !H(l, e + 1) && !H(l, -n.yearlen + e) || e >= n.yearlen && !H(l, e + 1 - n.yearlen) && !H(l, -n.nextyearlen + e - n.yearlen));
}
function Kn(n, e) {
...
function Zp(n, e, t, r, i) {
  for (var u = !1, o = e; o < t; o++) {
    var s = n[o];
    u = Jp(r, s, i), u && (n[s] = null);
  }
  return u;
}
function Qp(n, e, t) {
  var r = t.freq, i = t.byhour, u = t.byminute, o = t.bysecond;
  return nn(r) ? Tp(t) : r >= D.HOURLY && J(i) && !H(i, e.hour) || r >= D.MINUTELY && J(u) && !H(u, e.minute) || r >= D.SECONDLY && J(o) && !H(o, e.second) ? [] : n.gettimeset(r)(e.hour, e.minute, e.second, e.millisecond);
}
var de = {
  MO: new re(0),
  TU: new re(1),
  ...
  function() {
    function n(e, t) {
      e === void 0 && (e = {}), t === void 0 && (t = !1), this._cache = t ? null : new Rp(), this.origOptions = pu(e);
      var r = $p(e).parsedOptions;
      this.options = r;
    }
    return n.parseText = function(e, t) {
      ...
      if (i)
        return this._iter(new Hn("between", u, i));
      ...
      "MINUTELY",
      "SECONDLY"
    ], n.YEARLY = U.YEARLY, n.MONTHLY = U.MONTHLY, n.WEEKLY = U.WEEKLY, n.DAILY = U.DAILY, n.HOURLY = U.HOURLY, n.MINUTELY = U.MINUTELY, n.SECONDLY = U.SECONDLY, n.MO = de.MO, n.TU = de.TU, n.WE = de.WE, n.TH = de.TH, n.FR = de.FR, n.SA = de.SA, n.SU = de.SU, n.parseString = Ar, n.optionsToString = Or, n;
  }()
);
function eg(n, e, t, r, i, u) {
  var o = {}, s = n.accept;
  function a(c, h) {
    t.forEach(function(g) {
      g.between(c, h, !0).forEach(function(k) {
        o[Number(k)] = !0;
      });
    });
  }
  i.forEach(function(c) {
    var h = new Ht(c, u).rezonedDate();
    o[Number(h)] = !0;
  }), n.accept = function(c) {
    var h = Number(c);
  ...
  for (var l = 0; l < r.length; l++) {
    var d = new Ht(r[l], u).rezonedDate();
...
function tg(n, e) {
  var t = [], r = [], i = [], u = [], o = Yt(n), s = o.dtstart, a = o.tzid, l = og(n, e.unfold);
  return l.forEach(function(d) {
    var f;
    if (d) {
      var c = ug(d), h = c.name, g = c.parms, k = c.value;
      switch (h.toUpperCase()) {
        case "RRULE":
          ...
          break;
        case "RDATE":
          var p = (f = /RDATE(?:;TZID=([^:=]+))?/i.exec(d)) !== null && f !== void 0 ? f : [], T = p[1];
          T && !a && (a = T), r = r.concat(Zn(k, g));
          break;
        case "EXRULE":
          if (g.length)
...
function rg(n, e) {
  var t = tg(n, e), r = t.rrulevals, i = t.rdatevals, u = t.exrulevals, o = t.exdatevals, s = t.dtstart, a = t.tzid, l = e.cache === !1;
  if (e.compatible && (e.forceset = !0, e.unfold = !0), e.forceset || r.length > 1 || i.length || u.length || o.length) {
    ...
    return d.dtstart(s), d.tzid(a || void 0), r.forEach(function(c) {
      d.rrule(new D(fr(c, s, a), l));
    }), i.forEach(function(c) {
      d.rdate(c);
    }), u.forEach(function(c) {
      d.exrule(new D(fr(c, s, a), l));
...
function Jn(n, e) {
  return e === void 0 && (e = {}), rg(n, ng(e));
}
function fr(n, e, t) {
  return se(se({}, n), { dtstart: e, tzid: t });
}
function ng(n) {
  var e = [], t = Object.keys(n), r = Object.keys(Vn);
...
function ug(n) {
  var e = ig(n), t = e.name, r = e.value, i = t.split(";");
  if (!i)
...
function Zn(n, e) {
  return sg(e), n.split(",").map(function(t) {
    return tn(t);
  });
}
function Qn(n) {
...
var ag = (
  ...
  function(n) {
    ...
    function e(t) {
      ...
      return r.dtstart = Qn.apply(r, ["dtstart"]), r.tzid = Qn.apply(r, ["tzid"]), r._rrule = [], r._rdate = [], r._exrule = [], r._exdate = [], r;
    }
    return e.prototype._iter = function(t) {
      return eg(t, this._rrule, this._exrule, this._rdate, this._exdate, this.tzid());
      ...
      var t = [];
      return !this._rrule.length && this._dtstart && (t = t.concat(Or({ dtstart: this._dtstart }))), this._rrule.forEach(function(r) {
...
`).map(function(i) {
      ...
      }), this._rdate.length && t.push(ti("RDATE", this._rdate, this.tzid())), this._exdate.length && t.push(ti("EXDATE", this._exdate, this.tzid())), t;
...
class qt {
  ...
  init(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.prefix = t.prefix || "i18next:", this.logger = e || lg, this.options = t, this.debug = t.debug;
  }
  log() {
...
function ut(n, e, t) {
  function r(s) {
    return s && s.indexOf("###") > -1 ? s.replace(dg, ".") : s;
  }
  function i() {
...
function ni(n, e, t) {
  ...
  let u = e[e.length - 1], o = e.slice(0, e.length - 1), s = ut(n, o, Object);
  for (; s.obj === void 0 && o.length; )
    u = `${o[o.length - 1]}.${u}`, o = o.slice(0, o.length - 1), s = ut(n, o, Object), s && s.obj && typeof s.obj[`${s.k}.${u}`] < "u" && (s.obj = void 0);
  s.obj[`${s.k}.${u}`] = t;
}
function fg(n, e, t, r) {
  const {
...
function mu(n, e, t) {
  for (const r in e)
    r !== "__proto__" && r !== "constructor" && (r in n ? typeof n[r] == "string" || n[r] instanceof String || typeof e[r] == "string" || e[r] instanceof String ? t && (n[r] = e[r]) : mu(n[r], e[r], t) : n[r] = e[r]);
  return n;
}
function Ye(n) {
  return n.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
...
function gg(n) {
  return typeof n == "string" ? n.replace(/[&<>"'\/]/g, (e) => pg[e]) : n;
}
class mg {
  constructor(e) {
...
const bg = [" ", ",", "?", "!", ";"], yg = new mg(20);
function vg(n, e, t) {
  e = e || "", t = t || "";
  const r = bg.filter((o) => e.indexOf(o) < 0 && t.indexOf(o) < 0);
  if (r.length === 0) return !0;
  const i = yg.getRegExp(`(${r.map((o) => o === "?" ? "\\?" : o).join("|")})`);
  let u = !i.test(n);
  if (!u) {
    const o = n.indexOf(t);
    o > 0 && !i.test(n.substring(0, o)) && (u = !0);
  }
  return u;
}
function Rr(n, e) {
...
class ii extends ir {
  ...
  addResource(e, t, r, i) {
    ...
    let s = [e, t];
    r && (s = s.concat(o ? r.split(o) : r)), e.indexOf(".") > -1 && (s = e.split("."), i = t, t = s[1]), this.addNamespaces(t), ni(this.data, s, i), u.silent || this.emit("added", e, t, r, i);
  }
  addResources(e, t, r) {
    let i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, t, r, i, u) {
    ...
    o.skipCopy || (r = JSON.parse(JSON.stringify(r))), i ? mu(a, r, u) : a = {
      ...a,
      ...r
    }, ni(this.data, s, a), o.silent || this.emit("added", e, t, r);
  }
...
class Gt extends ir {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    super(), cg(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = xe.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, t) {
    ...
    const o = r && e.indexOf(r) > -1, s = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !vg(e, r, i);
    if (o && !s) {
  ...
  translate(e, t, r) {
    ...
    let c = f && f.res;
    const h = f && f.usedKey || o, g = f && f.exactUsedKey || o, k = Object.prototype.toString.apply(c), p = ["[object Number]", "[object Function]", "[object RegExp]"], T = t.joinArrays !== void 0 ? t.joinArrays : this.options.joinArrays, A = !this.i18nFormat || this.i18nFormat.handleAsObject;
    if (A && c && (typeof c != "string" && typeof c != "boolean" && typeof c != "number") && p.indexOf(k) < 0 && !(typeof T == "string" && Array.isArray(c))) {
      if (!t.returnObjects && !this.options.returnObjects) {
        this.options.returnedObjectHandler || this.logger.warn("accessing an object - but returnObjects options is not enabled!");
        const R = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(h, c, {
          ...t,
          ns: s
        }) : `key '${o} (${this.language})' returned an object instead of string.`;
        return i ? (f.res = R, f.usedParams = this.getUsedParamsDetails(t), f) : R;
      }
      if (u) {
        const R = Array.isArray(c), L = R ? [] : {}, P = R ? g : h;
        for (const F in c)
          if (Object.prototype.hasOwnProperty.call(c, F)) {
            const G = `${P}${u}${F}`;
            L[F] = this.translate(G, {
              ...t,
              joinArrays: !1,
              ns: s
            }), L[F] === G && (L[F] = c[F]);
    ...
    } else if (A && typeof T == "string" && Array.isArray(c))
      c = c.join(T), c && (c = this.extendTranslation(c, e, t, r));
    else {
      let R = !1, L = !1;
      const P = t.count !== void 0 && typeof t.count != "string", F = Gt.hasDefaultValue(t), G = P ? this.pluralResolver.getSuffix(l, t.count, t) : "", N = t.ordinal && P ? this.pluralResolver.getSuffix(l, t.count, {
        ordinal: !1
      }) : "", M = P && !t.ordinal && t.count === 0 && this.pluralResolver.shouldUseIntlApi(), m = M && t[`defaultValue${this.options.pluralSeparator}zero`] || t[`defaultValue${G}`] || t[`defaultValue${N}`] || t.defaultValue;
      !this.isValidLookup(c) && F && (R = !0, c = m), this.isValidLookup(c) || (L = !0, c = o);
      const v = (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && L ? void 0 : c, b = F && m !== c && this.options.updateMissing;
      if (L || R || b) {
        if (this.logger.log(b ? "updateKey" : "missingKey", l, a, o, b ? m : c), u) {
        ...
        const w = (S, O, I) => {
          const q = F && I !== c ? I : v;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(S, a, O, q, b, t) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(S, a, O, q, b, t), this.emit("missingKey", S, a, O, c);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && P ? y.forEach((S) => {
          const O = this.pluralResolver.getSuffixes(S, t);
          M && t[`defaultValue${this.options.pluralSeparator}zero`] && O.indexOf(`${this.options.pluralSeparator}zero`) < 0 && O.push(`${this.options.pluralSeparator}zero`), O.forEach((I) => {
            w([S], o + I, t[`defaultValue${I}`] || m);
          });
        }) : w(y, o, m));
      }
      c = this.extendTranslation(c, e, t, f, r), L && c === o && this.options.appendNamespaceToMissingKey && (c = `${a}:${o}`), (L || R) && this.options.parseMissingKeyHandler && (this.options.compatibilityAPI !== "v1" ? c = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${o}` : o, R ? c : void 0) : c = this.options.parseMissingKeyHandler(c));
    }
  ...
  resolve(e) {
    ...
    return typeof e == "string" && (e = [e]), e.forEach((a) => {
      ...
      const c = t.count !== void 0 && typeof t.count != "string", h = c && !t.ordinal && t.count === 0 && this.pluralResolver.shouldUseIntlApi(), g = t.context !== void 0 && (typeof t.context == "string" || typeof t.context == "number") && t.context !== "", k = t.lngs ? t.lngs : this.languageUtils.toResolveHierarchy(t.lng || this.language, t.fallbackLng);
      f.forEach((p) => {
        this.isValidLookup(r) || (s = p, !ui[`${k[0]}-${p}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(s) && (ui[`${k[0]}-${p}`] = !0, this.logger.warn(`key "${i}" for languages "${k.join(", ")}" won't get resolved as namespace "${s}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), k.forEach((T) => {
          if (this.isValidLookup(r)) return;
          o = T;
          const A = [d];
          if (this.i18nFormat && this.i18nFormat.addLookupKeys)
            this.i18nFormat.addLookupKeys(A, d, T, p, t);
          else {
            let R;
            c && (R = this.pluralResolver.getSuffix(T, t.count, t));
            const L = `${this.options.pluralSeparator}zero`, P = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (c && (A.push(d + R), t.ordinal && R.indexOf(P) === 0 && A.push(d + R.replace(P, this.options.pluralSeparator)), h && A.push(d + L)), g) {
              const F = `${d}${this.options.contextSeparator}${t.context}`;
              A.push(F), c && (A.push(F + R), t.ordinal && R.indexOf(P) === 0 && A.push(F + R.replace(P, this.options.pluralSeparator)), h && A.push(F + L));
            }
          }
          let j;
          for (; j = A.pop(); )
            this.isValidLookup(r) || (u = j, r = this.getResource(T, p, j, t));
        }));
      });
    }), {
      res: r,
...
class Tg {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    this.languageUtils = e, this.options = t, this.logger = xe.create("pluralResolver"), (!this.options.compatibilityJSON || Eg.includes(this.options.compatibilityJSON)) && (typeof Intl > "u" || !Intl.PluralRules) && (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = $g();
  }
  addRule(e, t) {
    this.rules[e] = t;
  }
  ...
  getSuffixes(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const r = this.getRule(e, t);
    return r ? this.shouldUseIntlApi() ? r.resolvedOptions().pluralCategories.sort((i, u) => si[i] - si[u]).map((i) => `${this.options.prepend}${t.ordinal ? `ordinal${this.options.prepend}` : ""}${i}`) : r.numbers.map((i) => this.getSuffix(e, i, t)) : [];
  }
  getSuffix(e, t) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  shouldUseIntlApi() {
    return !wg.includes(this.options.compatibilityJSON);
  }
}
function ai(n, e, t) {
  let r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", i = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, u = hg(n, e, t);
...
class Sg {
  ...
  init() {
    ...
    this.escape = t !== void 0 ? t : gg, this.escapeValue = r !== void 0 ? r : !0, this.useRawValueToEscape = i !== void 0 ? i : !1, this.prefix = u ? Ye(u) : o || "{{", this.suffix = s ? Ye(s) : a || "}}", this.formatSeparator = l || ",", this.unescapePrefix = d ? "" : f || "-", this.unescapeSuffix = this.unescapePrefix ? "" : d || "", this.nestingPrefix = c ? Ye(c) : h || Ye("$t("), this.nestingSuffix = g ? Ye(g) : k || Ye(")"), this.nestingOptionsSeparator = p || ",", this.maxReplaces = T || 1e3, this.alwaysFormat = A !== void 0 ? A : !1, this.resetRegExp();
  }
  reset() {
  ...
  interpolate(e, t, r, i) {
    ...
    const d = (g) => {
      if (g.indexOf(this.formatSeparator) < 0) {
        const A = ai(t, a, g, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(ai(t, a, p, this.options.keySeparator, this.options.ignoreJSONStructure), T, r, {
        ...i,
        ...t,
        interpolationkey: p
      });
    ...
    return [{
      ...
      for (s = 0; u = g.regex.exec(e); ) {
        ...
        else typeof o != "string" && !this.useRawValueToEscape && (o = ri(o));
        const p = g.safeValue(o);
        if (e = e.replace(u[0], p), c ? (g.regex.lastIndex += o.length, g.regex.lastIndex -= u[0].length) : g.regex.lastIndex = 0, s++, s >= this.maxReplaces)
          break;
      }
    }), e;
  }
  nest(e, t) {
    ...
    function s(a, l) {
      ...
      (h && h.length % 2 === 0 && !g || g.length % 2 !== 0) && (c = c.replace(/'/g, '"'));
      try {
        o = JSON.parse(c), l && (o = {
          ...l,
          ...o
        ...
        return this.logger.warn(`failed parsing options string in nesting for key ${a}`, k), `${a}${d}${c}`;
      }
    ...
    for (; i = this.nestingRegexp.exec(e); ) {
      ...
      typeof u != "string" && (u = ri(u)), u || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), u = ""), l && (u = a.reduce((d, f) => this.format(d, f, r.lng, {
        ...r,
...
class Og extends ir {
  ...
  loaded(e, t, r) {
    const i = e.split("|"), u = i[0], o = i[1];
    t && this.emit("failedLoading", u, o, t), r && this.store.addResourceBundle(u, o, r, void 0, void 0, {
      skipCopy: !0
    }), this.state[e] = t ? -1 : 2;
    const s = {};
    this.queue.forEach((a) => {
      fg(a.loaded, [u], o), Ag(a, e), t && a.errors.push(t), a.pendingCount === 0 && !a.done && (Object.keys(a.loaded).forEach((l) => {
        s[l] || (s[l] = {});
        const d = a.loaded[l];
  ...
  read(e, t, r) {
    ...
    const s = (l, d) => {
      ...
      if (l && d && i < this.maxRetries) {
        setTimeout(() => {
          this.read.call(this, e, t, r, i + 1, u * 2, o);
        }, u);
        return;
      }
      o(l, d);
...
class lt extends ir {
  constructor() {
    ...
    if (super(), this.options = ci(e), this.services = {}, this.logger = xe, this.modules = {
      external: []
    }, Rg(this), t && !this.isInitialized && !e.isClone) {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      let d;
      this.modules.formatter ? d = this.modules.formatter : typeof Intl < "u" && (d = Bg);
      const f = new oi(this.options);
      this.store = new ii(this.options.resources, this.options);
      const c = this.services;
      c.logger = xe, c.resourceStore = this.store, c.languageUtils = f, c.pluralResolver = new Tg(f, {
        prepend: this.options.pluralSeparator,
        compatibilityJSON: this.options.compatibilityJSON,
        simplifyPluralSuffix: this.options.simplifyPluralSuffix
      }), d && (!this.options.interpolation.format || this.options.interpolation.format === i.interpolation.format) && (c.formatter = u(d), c.formatter.init(c, this.options), this.options.interpolation.format = c.formatter.format.bind(c.formatter)), c.interpolator = new Sg(this.options), c.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, c.backendConnector = new Og(u(this.modules.backend), c.resourceStore, c, this.options), c.backendConnector.on("*", function(h) {
        for (var g = arguments.length, k = new Array(g > 1 ? g - 1 : 0), p = 1; p < g; p++)
          k[p - 1] = arguments[p];
        e.emit(h, ...k);
  ...
  getFixedT(e, t, r) {
    ...
    const u = function(o, s) {
      ...
      let h;
      return a.keyPrefix && Array.isArray(o) ? h = o.map((g) => `${a.keyPrefix}${c}${g}`) : h = a.keyPrefix ? `${a.keyPrefix}${c}${o}` : o, i.t(h, a);
    };
  ...
  dir(e) {
    ...
    const t = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], r = this.services && this.services.languageUtils || new oi(li());
  ...
  cloneInstance() {
    ...
    }, r && (u.store = new ii(this.store.data, i), u.services.resourceStore = u.store), u.translator = new Gt(u.services, i), u.translator.on("*", function(s) {
...
const yu = lt.createInstance();
yu.createInstance = lt.createInstance;
const vu = "No date selected", xu = "Choose another time slot to reschedule your meeting", ku = {
  sunday: "SUN",
  monday: "MON",
  tuesday: "TUE",
  wednesday: "WED",
  ...
  november: "November",
  december: "December"
}, $u = "Next", Tu = "{{date}}", Su = "{{time}}", Cu = "Name", Bu = "Enter your name", Au = "Email", Ou = "Enter your email", Ru = "Guest email", Du = "Enter guest email", Mu = "Add guest", Pu = "Add another guest", Iu = "Back", Lu = "Book now", Nu = "Booking confirmed", _u = "You'll receive an email confirmation soon.", Uu = "Booking sent", Fu = "You will receive an email once the booking is confirmed.", ju = "Booking rescheduled", Yu = "Booking date and time", Hu = "Cancel booking", qu = "Reschedule", zu = "Reject booking", Wu = "Confirm booking", Gu = "Booking pending", Ku = "Manage your booking below. The invitee will receive an email informing them of the request status.", Vu = "Your booking has been confirmed successfully", Ju = "A confirmation email has been sent to", Zu = "Cancel booking?", Qu = "Your current timeslot will become available to others.", Xu = "Reason for cancellation", eo = "Go back", to = "Your booking has been cancelled successfully", ro = "A cancellation email has been sent to", no = "Close", io = "Closing", uo = "{{field}} is required.", oo = "{{field}} has invalid format.", so = "Create Booking", ao = "Get Availability", lo = "Cancel Booking", co = "Reschedule Booking", fo = "Get UI Settings", ho = "Reject Booking", po = "Confirm Booking", go = "Something went wrong...", mo = "Scheduling Component Error", bo = "'sessionId' is required for private configs.", yo = "If using public config either pass a configurationId or a combination of 'slug' and 'clientId'.", vo = "Invalid timeslot!", xo = "The selected timeslot is invalid", ko = "Cancellation Error", wo = "Please provide a reason for cancellation.", Eo = "You cannot cancel the booking within {{minCancellationNotice}} minutes of the event", $o = "Cancel booking form error", Dg = {
  noDateSelected: vu,
  rescheduleTitle: xu,
  days: ku,
  time: wu,
  ...
  bookNowButton: Lu,
  bookingConfirmed: Nu,
  bookingConfirmedDescription: _u,
  bookingSent: Uu,
  bookingSentDescription: Fu,
  bookingRescheduled: ju,
  bookingDateAndTimeHeader: Yu,
  cancelBookingButton: Hu,
  rescheduleBookingButton: qu,
  rejectBookingButton: zu,
  confirmBookingButton: Wu,
  bookingPendingTitle: Gu,
  bookingPendingnDescription: Ku,
  confirmedEventCardTitle: Vu,
  confirmedEventCardDescription: Ju,
  cancelBookingTitle: Zu,
  cancelBookingMessage: Qu,
  ...
  cancelBokingFormError: $o,
  default: Dg
}), To = "Aucune date sélectionnée", So = "Choisissez un autre créneau horaire pour reprogrammer votre réunion", Co = {
  sunday: "DIM",
  monday: "LUN",
  tuesday: "MAR",
  wednesday: "MER",
  ...
  november: "Novembre",
  december: "Décembre"
}, Oo = "Procéder", Ro = "{{date}}", Do = "{{time}}", Mo = "Name", Po = "Entrez votre nom", Io = "E-mail", Lo = "Entrer votre E-mail", No = "E-mail invité", _o = "Entrez l'adresse e-mail de l'invité", Uo = "Ajouter un invité", Fo = "Ajouter un autre invité", jo = "Retour", Yo = "Réservez maintenant", Ho = "Réservation confirmée", qo = "Vous recevrez bientôt un e-mail de confirmation.", zo = "Réservation envoyée", Wo = "Vous recevrez un e-mail une fois la réservation confirmée.", Go = "Réservation reprogrammée", Ko = "Date et heure de la réservation", Vo = "Annuler la réservation", Jo = "Replanifier", Zo = "Refuser la réservation", Qo = "Confirmer la réservation", Xo = "Réservation en attente", es = "Gérez votre réservation ci-dessous. L'invité recevra un e-mail l'informant du statut de la demande.", ts = "Votre réservation a été confirmée avec succès", rs = "Un e-mail de confirmation a été envoyé à", ns = "Annuler la réservation?", is = "Votre créneau horaire actuel sera disponible pour les autres.", us = "Raison de l'annulation", os = "Retourner", ss = "Votre réservation a été annulée avec succès", as = "Un e-mail d'annulation a été envoyé à", ls = "Fermer", cs = "Fermeture", ds = "{{field}} est requis.", fs = "{{field}} a un format invalide.", hs = "Créer une Réservation", ps = "Obtenir la Disponibilité", gs = "Annuler la Réservation", ms = "Reprogrammer la Réservation", bs = "Obtenir les Paramètres UI", ys = "Refuser la Réservation", vs = "Confirmer la Réservation", xs = "Quelque chose a mal tourné...", ks = "Erreur du composant de planification", ws = "'sessionId' est requis pour les configurations privées.", Es = "Si vous utilisez une configuration publique, passez soit un configurationId, soit une combinaison de 'slug' et 'clientId'.", $s = "Créneau horaire invalide !", Ts = "Le créneau horaire sélectionné est invalide", Ss = "Erreur d'annulation", Cs = "Veuillez fournir une raison pour l'annulation.", Bs = "Vous ne pouvez pas annuler la réservation dans les {{minCancellationNotice}} minutes avant l'événement", As = "Erreur de formulaire d'annulation de réservation", Pg = {
  noDateSelected: To,
  rescheduleTitle: So,
  days: Co,
  time: Bo,
  ...
  emailPlaceholder: Lo,
  guestEmail: No,
  guestEmailPlaceholder: _o,
  addGuest: Uo,
  addAnotherGuest: Fo,
  backButton: jo,
  bookNowButton: Yo,
  bookingConfirmed: Ho,
  bookingConfirmedDescription: qo,
  bookingSent: zo,
  bookingSentDescription: Wo,
  bookingRescheduled: Go,
  bookingDateAndTimeHeader: Ko,
  cancelBookingButton: Vo,
  rescheduleBookingButton: Jo,
  rejectBookingButton: Zo,
  confirmBookingButton: Qo,
  bookingPendingTitle: Xo,
  bookingPendingnDescription: es,
  confirmedEventCardTitle: ts,
  confirmedEventCardDescription: rs,
  cancelBookingTitle: ns,
  cancelBookingMessage: is,
  reasonForCancellation: us,
  goBackButton: os,
  bookingCancelledTitle: ss,
  bookingCancelledMessage: as,
  closeButton: ls,
  closingButton: cs,
  fieldRequired: ds,
  invalidInputFormat: fs,
  createBookingErrorTitle: hs,
  getAvailabilityErrorTitle: ps,
  cancelBookingErrorTitle: gs,
  rescheduleBookingErrorTitle: ms,
  getUISettingErrorTitle: bs,
  rejectBookingErrorTitle: ys,
  confirmBookingErrorTitle: vs,
  genericErrorTitle: xs,
  schedulingComponentErrorTitle: ks,
  sessionIdRequiredErrorMessage: ws,
  publicConfigErrorMessage: Es,
  invalidTimeslotErrorTitle: $s,
  invalidTimeslotErrorMessage: Ts,
  cancellationErrorTitle: Ss,
  cancellationErrorMessage: Cs,
  minimumCancellationErrorMessage: Bs,
  cancelBokingFormError: As
}, Ig = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  noDateSelected: To,
  rescheduleTitle: So,
  days: Co,
  ...
  cancelBokingFormError: As,
  default: Pg
}), Os = "No has seleccionado ninguna fecha", Rs = "Elige otro horario para reprogramar tu reunión", Ds = {
  sunday: "DOM",
  monday: "LUN",
  tuesday: "MAR",
  wednesday: "MIÉ",
  ...
  november: "Noviembre",
  december: "Diciembre"
}, Is = "Siguiente", Ls = "{{date}}", Ns = "{{time}}", _s = "Nombre", Us = "Introduce tu nombre", Fs = "Correo electrónico", js = "Introduce tu correo electrónico", Ys = "Correo electrónico del invitado", Hs = "Introduce el correo electrónico del invitado", qs = "Añadir invitado", zs = "Añadir otro invitado", Ws = "Atrás", Gs = "Reservar ahora", Ks = "Reserva confirmada", Vs = "Recibirás una confirmación por correo electrónico pronto.", Js = "Reserva enviada", Zs = "Recibirás un correo electrónico una vez que se confirme la reserva.", Qs = "Reserva reprogramada", Xs = "Fecha y hora de la reserva", ea = "Cancelar reserva", ta = "Reprogramar", ra = "Rechazar reserva", na = "Confirmar reserva", ia = "Reserva pendiente", ua = "Gestiona tu reserva a continuación. El invitado recibirá un correo electrónico informándole del estado de la solicitud.", oa = "Tu reserva ha sido confirmada con éxito", sa = "Se ha enviado un correo de confirmación a", aa = "¿Cancelar reserva?", la = "Su horario actual estará disponible para otros.", ca = "Motivo de la cancelación", da = "Regresar", fa = "Su reserva ha sido cancelada con éxito", ha = "Se ha enviado un correo electrónico de cancelación a", pa = "Cerrar", ga = "Cerrando", ma = "{{field}} es obligatorio.", ba = "{{field}} tiene un formato no válido.", ya = "Crear Reserva", va = "Obtener Disponibilidad", xa = "Cancelar Reserva", ka = "Reprogramar Reserva", wa = "Obtener Configuraciones de UI", Ea = "Rechazar Reserva", $a = "Confirmar Reserva", Ta = "Algo salió mal...", Sa = "Error en el componente de programación", Ca = "'sessionId' es necesario para configuraciones privadas.", Ba = "Si se usa una configuración pública, pase una configurationId o una combinación de 'slug' y 'clientId'.", Aa = "¡Intervalo de tiempo no válido!", Oa = "El intervalo de tiempo seleccionado no es válido", Ra = "Error de Cancelación", Da = "Por favor, indique el motivo de la cancelación.", Ma = "No puede cancelar la reserva dentro de los {{minCancellationNotice}} minutos del evento", Pa = "Error en el formulario de cancelación de la reserva", Lg = {
  noDateSelected: Os,
  rescheduleTitle: Rs,
  days: Ds,
  time: Ms,
  ...
  emailPlaceholder: js,
  guestEmail: Ys,
  guestEmailPlaceholder: Hs,
  addGuest: qs,
  addAnotherGuest: zs,
  backButton: Ws,
  bookNowButton: Gs,
  bookingConfirmed: Ks,
  bookingConfirmedDescription: Vs,
  bookingSent: Js,
  bookingSentDescription: Zs,
  bookingRescheduled: Qs,
  bookingDateAndTimeHeader: Xs,
  cancelBookingButton: ea,
  rescheduleBookingButton: ta,
  rejectBookingButton: ra,
  confirmBookingButton: na,
  bookingPendingTitle: ia,
  bookingPendingnDescription: ua,
  confirmedEventCardTitle: oa,
  confirmedEventCardDescription: sa,
  cancelBookingTitle: aa,
  cancelBookingMessage: la,
  reasonForCancellation: ca,
  goBackButton: da,
  bookingCancelledTitle: fa,
  bookingCancelledMessage: ha,
  closeButton: pa,
  closingButton: ga,
  fieldRequired: ma,
  invalidInputFormat: ba,
  createBookingErrorTitle: ya,
  getAvailabilityErrorTitle: va,
  cancelBookingErrorTitle: xa,
  rescheduleBookingErrorTitle: ka,
  getUISettingErrorTitle: wa,
  rejectBookingErrorTitle: Ea,
  confirmBookingErrorTitle: $a,
  genericErrorTitle: Ta,
  schedulingComponentErrorTitle: Sa,
  sessionIdRequiredErrorMessage: Ca,
  publicConfigErrorMessage: Ba,
  invalidTimeslotErrorTitle: Aa,
  invalidTimeslotErrorMessage: Oa,
  cancellationErrorTitle: Ra,
  cancellationErrorMessage: Da,
  minimumCancellationErrorMessage: Ma,
  cancelBokingFormError: Pa
  ...
  cancelBokingFormError: Pa,
  default: Lg
}), Ia = "日付が選択されていません", La = "別の時間を選択してください", Na = {
  sunday: "日",
  monday: "月",
  tuesday: "火",
  wednesday: "水",
  ...
  november: "11月",
  december: "12月"
}, Fa = "次", ja = "{{date}}", Ya = "{{time}}", Ha = "名前", qa = "名前を入力してください", za = "メールアドレス", Wa = "メールアドレスを入力してください", Ga = "ゲストのメールアドレス", Ka = "ゲストのメールアドレスを入力してください", Va = "ゲストを追加", Ja = "他のゲストを追加", Za = "戻る", Qa = "今すぐ予約", Xa = "予約が確認されました", el = "間もなくメールで確認が届きます。", tl = "予約が送信されました", rl = "予約が確認され次第、メールをお送りします。", nl = "予約が再予定されました", il = "予約の日付と時間", ul = "予約をキャンセル", ol = "再調整", sl = "予約を拒否", al = "予約を確認", ll = "予約保留中", cl = "以下で予約を管理します。招待者にはリクエストステータスを知らせるメールが届きます。", dl = "予約が正常に確認されました", fl = "確認メールが送信されました", hl = "予約をキャンセルしますか？", pl = "現在の時間枠は他の人に利用可能になります。", gl = "キャンセルの理由", ml = "戻る", bl = "予約が正常にキャンセルされました", yl = "キャンセルメールが送信されました", vl = "閉じる", xl = "閉じる", kl = "{{field}} は必須です.", wl = "{{field}} の形式が無効です.", El = "予約作成", $l = "空き状況を取得", Tl = "予約をキャンセル", Sl = "予約の再スケジュール", Cl = "UI設定を取得", Bl = "予約を拒否", Al = "予約を確認", Ol = "何かがうまくいかなかった...", Rl = "スケジューリングコンポーネントエラー", Dl = "プライベート構成には 'sessionId' が必要です。", Ml = "公開設定を使用する場合は、configurationId または 'slug' と 'clientId' の組み合わせを渡します。", Pl = "無効な時間帯！", Il = "選択された時間帯は無効です", Ll = "キャンセルエラー", Nl = "キャンセルの理由を入力してください。", _l = "イベントの{{minCancellationNotice}}分前には予約をキャンセルできません", Ul = "予約キャンセルフォームエラー", _g = {
  noDateSelected: Ia,
  rescheduleTitle: La,
  days: Na,
  time: _a,
  ...
  emailPlaceholder: Wa,
  guestEmail: Ga,
  guestEmailPlaceholder: Ka,
  addGuest: Va,
  addAnotherGuest: Ja,
  backButton: Za,
  bookNowButton: Qa,
  bookingConfirmed: Xa,
  bookingConfirmedDescription: el,
  bookingSent: tl,
  bookingSentDescription: rl,
  bookingRescheduled: nl,
  bookingDateAndTimeHeader: il,
  cancelBookingButton: ul,
  rescheduleBookingButton: ol,
  rejectBookingButton: sl,
  confirmBookingButton: al,
  bookingPendingTitle: ll,
  bookingPendingnDescription: cl,
  confirmedEventCardTitle: dl,
  confirmedEventCardDescription: fl,
  cancelBookingTitle: hl,
  cancelBookingMessage: pl,
  reasonForCancellation: gl,
  goBackButton: ml,
  bookingCancelledTitle: bl,
  bookingCancelledMessage: yl,
  closeButton: vl,
  closingButton: xl,
  fieldRequired: kl,
  invalidInputFormat: wl,
  createBookingErrorTitle: El,
  getAvailabilityErrorTitle: $l,
  cancelBookingErrorTitle: Tl,
  rescheduleBookingErrorTitle: Sl,
  getUISettingErrorTitle: Cl,
  rejectBookingErrorTitle: Bl,
  confirmBookingErrorTitle: Al,
  genericErrorTitle: Ol,
  schedulingComponentErrorTitle: Rl,
  sessionIdRequiredErrorMessage: Dl,
  publicConfigErrorMessage: Ml,
  invalidTimeslotErrorTitle: Pl,
  invalidTimeslotErrorMessage: Il,
  cancellationErrorTitle: Ll,
  cancellationErrorMessage: Nl,
  minimumCancellationErrorMessage: _l,
  cancelBokingFormError: Ul
  ...
  cancelBokingFormError: Ul,
  default: _g
}), Fl = "Kein Datum ausgewählt", jl = "Wählen Sie einen anderen Zeitpunkt, um Ihr Meeting neu zu planen", Yl = {
  sunday: "SO",
  monday: "MO",
  tuesday: "DI",
  wednesday: "MI",
  ...
  november: "November",
  december: "Dezember"
}, zl = "Weiter", Wl = "{{date}}", Gl = "{{time}}", Kl = "Name", Vl = "Geben Sie Ihren Namen ein", Jl = "E-Mail", Zl = "Geben Sie Ihre E-Mail-Adresse ein", Ql = "Gast E-Mail", Xl = "Geben Sie die E-Mail-Adresse des Gastes ein", ec = "Gast hinzufügen", tc = "Weiteren Gast hinzufügen", rc = "Zurück", nc = "Jetzt buchen", ic = "Buchung bestätigt", uc = "Sie erhalten in Kürze eine E-Mail-Bestätigung.", oc = "Buchung gesendet", sc = "Sie erhalten eine E-Mail, sobald die Buchung bestätigt ist.", ac = "Buchung umgebucht", lc = "Buchungsdatum und -zeit", cc = "Buchung stornieren", dc = "Umplanen", fc = "Buchung ablehnen", hc = "Buchung bestätigen", pc = "Buchung ausstehend", gc = "Verwalten Sie Ihre Buchung unten. Der Eingeladene erhält eine E-Mail mit dem Status der Anfrage.", mc = "Ihre Buchung wurde erfolgreich bestätigt", bc = "Eine Bestätigungs-E-Mail wurde gesendet an", yc = "Buchung stornieren?", vc = "Ihr aktueller Zeitraum wird für andere verfügbar.", xc = "Grund für die Stornierung", kc = "Zurück", wc = "Ihre Buchung wurde erfolgreich storniert", Ec = "Eine Stornierungs-E-Mail wurde gesendet an", $c = "Schließen", Tc = "Schließen", Sc = "{{field}} ist erforderlich.", Cc = "{{field}} hat ein ungültiges Format.", Bc = "Buchung Erstellen", Ac = "Verfügbarkeit Ermitteln", Oc = "Buchung Stornieren", Rc = "Buchung Verschieben", Dc = "UI-Einstellungen Abrufen", Mc = "Buchung Ablehnen", Pc = "Buchung Bestätigen", Ic = "Etwas ist schief gelaufen...", Lc = "Fehler im Planungskomponent", Nc = "'sessionId' ist für private Konfigurationen erforderlich.", _c = "Bei Verwendung einer öffentlichen Konfiguration geben Sie entweder eine Konfigurations-ID oder eine Kombination aus 'slug' und 'clientId' an.", Uc = "Ungültiges Zeitfenster!", Fc = "Das ausgewählte Zeitfenster ist ungültig", jc = "Stornierungsfehler", Yc = "Bitte geben Sie einen Grund für die Stornierung an.", Hc = "Sie können die Buchung nicht innerhalb von {{minCancellationNotice}} Minuten vor der Veranstaltung stornieren", qc = "Fehler im Stornierungsformular", Fg = {
  noDateSelected: Fl,
  rescheduleTitle: jl,
  days: Yl,
  time: Hl,
  ...
  emailPlaceholder: Zl,
  guestEmail: Ql,
  guestEmailPlaceholder: Xl,
  addGuest: ec,
  addAnotherGuest: tc,
  backButton: rc,
  bookNowButton: nc,
  bookingConfirmed: ic,
  bookingConfirmedDescription: uc,
  bookingSent: oc,
  bookingSentDescription: sc,
  bookingRescheduled: ac,
  bookingDateAndTimeHeader: lc,
  cancelBookingButton: cc,
  rescheduleBookingButton: dc,
  rejectBookingButton: fc,
  confirmBookingButton: hc,
  bookingPendingTitle: pc,
  bookingPendingnDescription: gc,
  confirmedEventCardTitle: mc,
  confirmedEventCardDescription: bc,
  cancelBookingTitle: yc,
  cancelBookingMessage: vc,
  reasonForCancellation: xc,
  goBackButton: kc,
  bookingCancelledTitle: wc,
  bookingCancelledMessage: Ec,
  closeButton: $c,
  closingButton: Tc,
  fieldRequired: Sc,
  invalidInputFormat: Cc,
  createBookingErrorTitle: Bc,
  getAvailabilityErrorTitle: Ac,
  cancelBookingErrorTitle: Oc,
  rescheduleBookingErrorTitle: Rc,
  getUISettingErrorTitle: Dc,
  rejectBookingErrorTitle: Mc,
  confirmBookingErrorTitle: Pc,
  genericErrorTitle: Ic,
  schedulingComponentErrorTitle: Lc,
  sessionIdRequiredErrorMessage: Nc,
  publicConfigErrorMessage: _c,
  invalidTimeslotErrorTitle: Uc,
  invalidTimeslotErrorMessage: Fc,
  cancellationErrorTitle: jc,
  cancellationErrorMessage: Yc,
  minimumCancellationErrorMessage: Hc,
  cancelBokingFormError: qc
  ...
  cancelBokingFormError: qc,
  default: Fg
}), zc = "Ingen dag vald", Wc = "Välj en annan tid för att boka om din tid", Gc = {
  sunday: "SÖN",
  monday: "MÅN",
  tuesday: "TIS",
  wednesday: "ONS",
  ...
  november: "November",
  december: "December"
}, Jc = "Nästa", Zc = "{{date}}", Qc = "{{time}}", Xc = "Namn", e0 = "Ange ditt namn", t0 = "E-post", r0 = "Ange din e-postadress", n0 = "Gästens e-post", i0 = "Ange gästens e-postadress", u0 = "Lägg till gäst", o0 = "Lägg till en gäst till", s0 = "Tillbaka", a0 = "Boka nu", l0 = "Bokning bekräftad", c0 = "Du kommer snart att få en bekräftelse via e-post.", d0 = "Bokning skickad", f0 = "Du kommer att få ett e-mail när bokningen är bekräftad.", h0 = "Bokning ombokad", p0 = "Bokningsdatum och tid", g0 = "Avboka bokning", m0 = "Omboka", b0 = "Avvisa bokning", y0 = "Bekräfta bokning", v0 = "Bokning pågår", x0 = "Hantera din bokning nedan. Inbjudna kommer att få ett e-postmeddelande om begärans status.", k0 = "Din bokning har bekräftats framgångsrikt", w0 = "Ett bekräftelsemail har skickats till", E0 = "Avboka bokning?", $0 = "Din nuvarande tidslucka kommer att bli tillgänglig för andra.", T0 = "Anledning till avbokning", S0 = "Gå tillbaka", C0 = "Din bokning har avbokats framgångsrikt", B0 = "Ett avbokningsmejl har skickats till", A0 = "Stäng", O0 = "Stänger", R0 = "{{field}} är obligatoriskt.", D0 = "{{field}} har ogiltigt format.", M0 = "Skapa Bokning", P0 = "Hämta Tillgänglighet", I0 = "Avboka Bokning", L0 = "Omboka Bokning", N0 = "Hämta UI-inställningar", _0 = "Avvisa Bokning", U0 = "Bekräfta Bokning", F0 = "Något gick fel...", j0 = "Schemaläggningskomponentfel", Y0 = "'sessionId' krävs för privata konfigurationer.", H0 = "Om du använder offentlig konfiguration anger du antingen en konfigurations-ID eller en kombination av 'slug' och 'clientId'.", q0 = "Ogiltig tidslucka!", z0 = "Den valda tidsluckan är ogiltig", W0 = "Avbokningsfel", G0 = "Vänligen ange en anledning till avbokningen.", K0 = "Du kan inte avboka bokningen inom {{minCancellationNotice}} minuter före evenemanget", V0 = "Fel i avbokningsformuläret", Yg = {
  noDateSelected: zc,
  rescheduleTitle: Wc,
  days: Gc,
  time: Kc,
  ...
  emailPlaceholder: r0,
  guestEmail: n0,
  guestEmailPlaceholder: i0,
  addGuest: u0,
  addAnotherGuest: o0,
  backButton: s0,
  bookNowButton: a0,
  bookingConfirmed: l0,
  bookingConfirmedDescription: c0,
  bookingSent: d0,
  bookingSentDescription: f0,
  bookingRescheduled: h0,
  bookingDateAndTimeHeader: p0,
  cancelBookingButton: g0,
  rescheduleBookingButton: m0,
  rejectBookingButton: b0,
  confirmBookingButton: y0,
  bookingPendingTitle: v0,
  bookingPendingnDescription: x0,
  confirmedEventCardTitle: k0,
  confirmedEventCardDescription: w0,
  cancelBookingTitle: E0,
  cancelBookingMessage: $0,
  ...
  getAvailabilityErrorTitle: P0,
  cancelBookingErrorTitle: I0,
  rescheduleBookingErrorTitle: L0,
  getUISettingErrorTitle: N0,
  rejectBookingErrorTitle: _0,
  confirmBookingErrorTitle: U0,
  genericErrorTitle: F0,
  schedulingComponentErrorTitle: j0,
  sessionIdRequiredErrorMessage: Y0,
  publicConfigErrorMessage: H0,
  invalidTimeslotErrorTitle: q0,
  invalidTimeslotErrorMessage: z0,
  cancellationErrorTitle: W0,
  cancellationErrorMessage: G0,
  minimumCancellationErrorMessage: K0,
  ...
  cancelBokingFormError: V0,
  default: Yg
}), J0 = "请选择日期", Z0 = "选择另一个时间段重新安排您的会议", Q0 = {
  sunday: "周日",
  monday: "周一",
  tuesday: "周二",
  wednesday: "周三",
  ...
  november: "十一月",
  december: "十二月"
}, td = "下一个", rd = "{{date}}", nd = "{{time}}", id = "姓名", ud = "输入你的名字", od = "电子邮件", sd = "输入你的电子邮件", ad = "客人的电子邮件", ld = "输入客人的电子邮件", cd = "添加客人", dd = "添加另一个客人", fd = "返回", hd = "立即预订", pd = "预订已确认", gd = "您将很快收到一封确认电子邮件。", md = "预订已发送", bd = "预订确认后，您将收到一封电子邮件。", yd = "预订已重新安排", vd = "预订日期和时间", xd = "取消预订", kd = "重新安排", wd = "拒绝预订", Ed = "确认预订", $d = "预订待处理", Td = "在下方管理您的预订。受邀者将收到一封电子邮件，通知他们请求状态。", Sd = "您的预订已成功确认", Cd = "确认邮件已发送至", Bd = "取消预订？", Ad = "您当前的时间段将对其他人开放。", Od = "取消原因", Rd = "返回", Dd = "您的预订已成功取消", Md = "取消邮件已发送至", Pd = "关闭", Id = "关闭", Ld = "{{field}} 是必需的.", Nd = "{{field}} 格式无效.", _d = "创建预订", Ud = "获取可用性", Fd = "取消预订", jd = "重新安排预订", Yd = "获取UI设置", Hd = "拒绝预订", qd = "确认预订", zd = "出了点问题...", Wd = "调度组件错误", Gd = "私有配置需要 'sessionId'。", Kd = "如果使用公共配置，请传递 configurationId 或 'slug' 和 'clientId' 的组合。", Vd = "无效的时间段！", Jd = "所选时间段无效", Zd = "取消错误", Qd = "请提供取消的原因。", Xd = "您不能在活动开始前的{{minCancellationNotice}}分钟内取消预订", ef = "取消预订表单错误", qg = {
  noDateSelected: J0,
  rescheduleTitle: Z0,
  days: Q0,
  time: X0,
  ...
  bookNowButton: hd,
  bookingConfirmed: pd,
  bookingConfirmedDescription: gd,
  bookingSent: md,
  ...
  cancelBokingFormError: ef,
  default: qg
}), tf = "Geen datum geselecteerd", rf = "Kies een ander tijdslot om je afspraak te verzetten", nf = {
  sunday: "ZO",
  monday: "MA",
  tuesday: "DI",
  wednesday: "WO",
  ...
  november: "November",
  december: "December"
}, sf = "Volgende", af = "{{date}}", lf = "{{time}}", cf = "Naam", df = "Voer je naam in", ff = "E-mail", hf = "Voer je e-mail in", pf = "E-mail van gast", gf = "Voer het e-mailadres van de gast in", mf = "Gast toevoegen", bf = "Nog een gast toevoegen", yf = "Terug", vf = "Boek nu", xf = "Boeking bevestigd", kf = "U ontvangt binnenkort een e-mailbevestiging.", wf = "Boeking verzonden", Ef = "U ontvangt een e-mail zodra de boeking is bevestigd.", $f = "Boeking verplaatst", Tf = "Boekingsdatum en -tijd", Sf = "Boeking annuleren", Cf = "Herplannen", Bf = "Boeking afwijzen", Af = "Boeking bevestigen", Of = "Boeking in afwachting", Rf = "Beheer uw boeking hieronder. De genodigde ontvangt een e-mail over de status van de aanvraag.", Df = "Uw boeking is succesvol bevestigd", Mf = "Een bevestigingsmail is verzonden naar", Pf = "Boeking annuleren?", If = "Uw huidige tijdslot zal beschikbaar worden voor anderen.", Lf = "Reden voor annulering", Nf = "Ga terug", _f = "Uw boeking is succesvol geannuleerd", Uf = "Er is een annuleringsmail verzonden naar", Ff = "Sluiten", jf = "Sluiten", Yf = "{{field}} is vereist.", Hf = "{{field}} heeft een ongeldig formaat.", qf = "Boeking Maken", zf = "Beschikbaarheid Opvragen", Wf = "Boeking Annuleren", Gf = "Boeking Wijzigen", Kf = "UI-instellingen Ophalen", Vf = "Boeking Afwijzen", Jf = "Boeking Bevestigen", Zf = "Er is iets misgegaan...", Qf = "Geen sessie-ID!", Xf = "Fout in planningscomponent", eh = "'sessionId' is vereist voor privéconfiguraties.", th = "Als u een openbare configuratie gebruikt, geeft u een configurationId of een combinatie van 'slug' en 'clientId' door.", rh = "Het geselecteerde tijdslot is ongeldig", nh = "Annuleringsfout", ih = "Geef een reden op voor de annulering.", uh = "U kunt de boeking niet annuleren binnen {{minCancellationNotice}} minuten voor het evenement", oh = "Fout in het annuleringsformulier", Wg = {
  noDateSelected: tf,
  rescheduleTitle: rf,
  days: nf,
  time: uf,
  ...
  bookingRescheduled: $f,
  bookingDateAndTimeHeader: Tf,
  cancelBookingButton: Sf,
  rescheduleBookingButton: Cf,
  rejectBookingButton: Bf,
  confirmBookingButton: Af,
  bookingPendingTitle: Of,
  bookingPendingnDescription: Rf,
  confirmedEventCardTitle: Df,
  confirmedEventCardDescription: Mf,
  cancelBookingTitle: Pf,
  cancelBookingMessage: If,
  reasonForCancellation: Lf,
  goBackButton: Nf,
  bookingCancelledTitle: _f,
  bookingCancelledMessage: Uf,
  closeButton: Ff,
  closingButton: jf,
  fieldRequired: Yf,
  invalidInputFormat: Hf,
  createBookingErrorTitle: qf,
  getAvailabilityErrorTitle: zf,
  cancelBookingErrorTitle: Wf,
  rescheduleBookingErrorTitle: Gf,
  getUISettingErrorTitle: Kf,
  rejectBookingErrorTitle: Vf,
  confirmBookingErrorTitle: Jf,
  genericErrorTitle: Zf,
  noSessionIdErrorTitle: Qf,
  schedulingComponentErrorTitle: Xf,
  sessionIdRequiredErrorMessage: eh,
  publicConfigErrorMessage: th,
  invalidTimeslotErrorMessage: rh,
  cancellationErrorTitle: nh,
  cancellationErrorMessage: ih,
  minimumCancellationErrorMessage: uh,
  cancelBokingFormError: oh
}, Gg = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  noDateSelected: tf,
  rescheduleTitle: rf,
  days: nf,
...
(function(n) {
  ...
  (e = String.fromCodePoint) !== null && e !== void 0 ? e : function(u) {
    var o = "";
    return u > 65535 && (u -= 65536, o += String.fromCharCode(u >>> 10 & 1023 | 55296), u = 56320 | u & 1023), o += String.fromCharCode(u), o;
  };
  function r(u) {
    var o;
    return u >= 55296 && u <= 57343 || u > 1114111 ? 65533 : (o = t.get(u)) !== null && o !== void 0 ? o : u;
  }
...
(function(n) {
  var e = ce && ce.__createBinding || (Object.create ? function(m, E, v, b) {
    ...
    return t(E, m), E;
  }, i = ce && ce.__importDefault || function(m) {
  ...
  function g(m) {
    return m >= l.UPPER_A && m <= l.UPPER_Z || m >= l.LOWER_A && m <= l.LOWER_Z || c(m);
  }
  function k(m) {
    return m === l.EQUALS || g(m);
  }
  var p;
  (function(m) {
  ...
  var A = (
    ...
    function() {
      function m(E, v, b) {
        this.decodeTree = E, this.emitCodePoint = v, this.errors = b, this.state = p.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = T.Strict;
      }
      return m.prototype.startEntity = function(E) {
        ...
        switch (this.state) {
          case p.EntityStart:
            return E.charCodeAt(v) === l.NUM ? (this.state = p.NumericStart, this.consumed += 1, this.stateNumericStart(E, v + 1)) : (this.state = p.NamedEntity, this.stateNamedEntity(E, v));
          case p.NumericStart:
        ...
        return v >= E.length ? -1 : (E.charCodeAt(v) | d) === l.LOWER_X ? (this.state = p.NumericHex, this.consumed += 1, this.stateNumericHex(E, v + 1)) : (this.state = p.NumericDecimal, this.stateNumericDecimal(E, v));
      }, m.prototype.addToNumericResult = function(E, v, b, y) {
        if (v !== b) {
          var C = b - v;
          this.result = this.result * Math.pow(y, C) + parseInt(E.substr(v, C), y), this.consumed += C;
        }
        ...
        for (var b = this.decodeTree, y = b[this.treeIndex], C = (y & f.VALUE_LENGTH) >> 14; v < E.length; v++, this.excess++) {
          var w = E.charCodeAt(v);
          if (this.treeIndex = R(b, y, this.treeIndex + Math.max(1, C), w), this.treeIndex < 0)
          ...
          if (y = b[this.treeIndex], C = (y & f.VALUE_LENGTH) >> 14, C !== 0) {
            if (w === l.SEMI)
        ...
        var E, v = this, b = v.result, y = v.decodeTree, C = (y[b] & f.VALUE_LENGTH) >> 14;
        return this.emitNamedEntityData(b, C, this.consumed), (E = this.errors) === null || E === void 0 || E.missingSemicolonAfterCharacterReference(), this.consumed;
      }, m.prototype.emitNamedEntityData = function(E, v, b) {
        var y = this.decodeTree;
        return this.emitCodePoint(v === 1 ? y[E] & ~f.VALUE_LENGTH : y[E + 1], b), v === 3 && this.emitCodePoint(y[E + 2], b), b;
  ...
  function R(m, E, v, b) {
    var y = (E & f.BRANCH_LENGTH) >> 7, C = E & f.JUMP_TABLE;
    if (y === 0)
      return C !== 0 && b === C ? v : -1;
    if (C) {
      var w = b - C;
  ...
  n.determineBranch = R;
  var L = j(u.default), P = j(o.default);
  function F(m, E) {
...
` || // new line
      ...
      function r(R) {
        var L, P = R.exec(e.substring(p));
        if (P)
          return L = P[0], p += L.length, L;
      }
      for (var i = e.length, u = /^[ \t\n\r\u000c]+/, o = /^[, \t\n\r\u000c]+/, s = /^[^ \t\n\r\u000c]+/, a = /[,]+$/, l = /^\d+$/, d = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, f, c, h, g, k, p = 0, T = []; ; ) {
        if (r(o), p >= i)
          return T;
        f = r(s), c = [], f.slice(-1) === "," ? (f = f.replace(a, ""), j()) : A();
      }
      function A() {
        for (r(u), h = "", g = "in descriptor"; ; ) {
          if (k = e.charAt(p), g === "in descriptor")
            if (t(k))
              h && (c.push(h), h = "", g = "after descriptor");
            else if (k === ",") {
              p += 1, h && c.push(h), j();
              return;
            } else if (k === "(")
            ...
            if (k === ")")
              h = h + k, g = "in descriptor";
            else if (k === "") {
              c.push(h), j();
              return;
            } else
              h = h + k;
          else if (g === "after descriptor" && !t(k))
            if (k === "") {
              j();
              return;
            } else
      ...
      function j() {
        var R = !1, L, P, F, G, N = {}, M, m, E, v, b;
        for (G = 0; G < c.length; G++)
          M = c[G], m = M[M.length - 1], E = M.substring(0, M.length - 1), v = parseInt(E, 10), b = parseFloat(E), l.test(E) && m === "w" ? ((L || P) && (R = !0), v === 0 ? R = !0 : L = v) : d.test(E) && m === "x" ? ((L || P || F) && (R = !0), b < 0 ? R = !0 : P = b) : l.test(E) && m === "h" ? ((F || P) && (R = !0), v === 0 ? R = !0 : F = v) : R = !0;
        R ? console && console.log && console.log("Invalid srcset descriptor found in '" + e + "' at '" + M + "'.") : (N.url = f, L && (N.w = L), P && (N.d = P), F && (N.h = F), T.push(N));
      }
    };
  });
})(Vg);
var gi = ce.process, an = { exports: {} }, W = String, sh = function() {
...
an.exports = sh();
an.exports.createColors = sh;
const Jg = {}, Zg = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: Jg
}), ge = /* @__PURE__ */ ou(Zg);
let mi = an.exports, bi = ge;
class ct extends Error {
  ...
  showSourceCode(e) {
    ...
    if (e) {
      let { bold: l, red: d, gray: f } = mi.createColors(!0);
      s = (c) => l(d(c)), a = (c) => f(c);
    } else
      s = a = (l) => l;
...
class Mr {
  ...
  body(e) {
    ...
    for (let i = 0; i < e.nodes.length; i++) {
      let u = e.nodes[i], o = this.raw(u, "before");
      o && this.builder(o), this.stringify(u, t !== i || r);
    }
  }
  block(e, t) {
  ...
  raw(e, t, r) {
    ...
    return typeof i > "u" && (i = yi[r]), o.rawCache[r] = i, i;
  }
  rawSemicolon(e) {
    let t;
    return e.walk((r) => {
...
let Xg = ah;
function Pr(n, e) {
  new Xg(e).stringify(n);
}
var ur = Pr;
Pr.default = Pr;
let { isClean: wt, my: em } = bt, tm = ln, rm = ah, nm = ur;
function Ir(n, e) {
...
var sr = Nr;
Nr.default = Nr;
let um = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", om = (n, e = 21) => (t = e) => {
  let r = "", i = t;
  for (; i--; )
  ...
  let e = "", t = n;
  for (; t--; )
    e += um[Math.random() * 64 | 0];
  return e;
};
const am = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  nanoid: sm,
  customAlphabet: om
}), lm = /* @__PURE__ */ ou(am);
let { SourceMapConsumer: vi, SourceMapGenerator: xi } = ge, { existsSync: cm, readFileSync: dm } = ge, { dirname: pr, join: fm } = ge;
function hm(n) {
...
class _r {
  ...
  consumer() {
    return this.consumerCache || (this.consumerCache = new vi(this.text)), this.consumerCache;
  }
  withContent() {
  ...
  decodeInline(e) {
    ...
    if (t.test(e) || r.test(e))
      return hm(e.substr(RegExp.lastMatch.length));
    let o = e.match(/data:application\/json;([^,]+),/)[1];
    throw new Error("Unsupported source map encoding " + o);
  }
  loadFile(e) {
    if (this.root = pr(e), cm(e))
      return this.mapFile = e, dm(e, "utf-8").toString().trim();
  }
  loadMap(e, t) {
    if (t === !1) return !1;
    if (t) {
      ...
      if (typeof t == "function") {
        ...
        if (t instanceof vi)
          return xi.fromSourceMap(t).toString();
        if (t instanceof xi)
          return t.toString();
        if (this.isMap(t))
      ...
      if (this.annotation) {
        ...
        return e && (r = fm(pr(e), r)), this.loadFile(r);
      }
    }
  }
  isMap(e) {
...
var lh = _r;
_r.default = _r;
let { SourceMapConsumer: pm, SourceMapGenerator: gm } = ge, { fileURLToPath: ki, pathToFileURL: Et } = ge, { resolve: Ur, isAbsolute: Fr } = ge, { nanoid: mm } = lm, gr = ge, wi = ln, bm = lh, mr = Symbol("fromOffsetCache"), ym = !!(pm && gm), Ei = !!(Ur && Fr);
class Kt {
  constructor(e, t = {}) {
    if (e === null || typeof e > "u" || typeof e == "object" && !e.toString)
      throw new Error(`PostCSS received ${e} instead of CSS string`);
    if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "￾" ? (this.hasBOM = !0, this.css = this.css.slice(1)) : this.hasBOM = !1, t.from && (!Ei || /^\w+:\/\//.test(t.from) || Fr(t.from) ? this.file = t.from : this.file = Ur(t.from)), Ei && ym) {
      let r = new bm(this.css, t);
      if (r.text) {
        this.map = r;
    ...
    this.file || (this.id = "<input css " + mm(6) + ">"), this.map && (this.map.file = this.from);
  }
  fromOffset(e) {
    let t, r;
    if (this[mr])
...
let { SourceMapConsumer: ch, SourceMapGenerator: Mt } = ge, { dirname: Pt, resolve: dh, relative: fh, sep: hh } = ge, { pathToFileURL: $i } = ge, vm = ar, xm = !!(ch && Mt), km = !!(Pt && dh && fh && hh);
class wm {
  constructor(e, t, r, i) {
  ...
  previous() {
    if (!this.previousMaps)
      if (this.previousMaps = [], this.root)
        ...
        let e = new vm(this.css, this.opts);
  ...
  applyPrevMaps() {
    for (let e of this.previous()) {
      ...
      this.mapOpts.sourcesContent === !1 ? (i = new ch(e.text), i.sourcesContent && (i.sourcesContent = i.sourcesContent.map(() => null))) : i = e.consumer(), this.map.applySourceMap(i, t, this.toUrl(this.path(r)));
    }
  }
  isAnnotation() {
...
`), this.css += t + "/*# sourceMappingURL=" + e + " */";
  ...
  path(e) {
    ...
    return typeof this.mapOpts.annotation == "string" && (t = Pt(dh(t, this.mapOpts.annotation))), e = fh(t, e), e;
  }
  toUrl(e) {
    return hh === "\\" && (e = e.replace(/\\/g, "/")), encodeURI(e).replace(/[#?]/g, encodeURIComponent);
  }
  toFileUrl(e) {
    if ($i)
      return $i(e).toString();
...
`), t = s.length - o) : t += s.length, a && l !== "start") {
  ...
  generate() {
    if (this.clearAnnotation(), km && xm && this.isMap())
...
var lr = jr;
jr.default = jr;
let { isClean: gh, my: mh } = bt, bh = sr, yh = lr, $m = or, vh, cn, dn, xh;
function kh(n) {
  return n.map((e) => (e.nodes && (e.nodes = kh(e.nodes)), delete e.source, e));
}
function wh(n) {
  if (n[gh] = !1, n.proxyOf.nodes)
...
class pe extends $m {
  ...
  normalize(e, t) {
    if (typeof e == "string")
      ...
      typeof e.value != "string" && (e.value = String(e.value)), e = [new bh(e)];
    } else if (e.selector)
      e = [new cn(e)];
    else if (e.name)
      e = [new dn(e)];
    ...
    return e.map((i) => (i[mh] || pe.rebuild(i), i = i.proxyOf, i.parent && i.parent.removeChild(i), i[gh] && wh(i), typeof i.raws.before > "u" && t && typeof t.raws.before < "u" && (i.raws.before = t.raws.before.replace(/\S/g, "")), i.parent = this.proxyOf, i));
  }
  getProxyProcessor() {
    return {
      set(e, t, r) {
      ...
      get(e, t) {
        return t === "proxyOf" ? e : e[t] ? t === "each" || typeof t == "string" && t.startsWith("walk") ? (...r) => e[t](
          ...r.map((i) => typeof i == "function" ? (u, o) => i(u.toProxy(), o) : i)
...
pe.default = pe;
pe.rebuild = (n) => {
  n.type === "atrule" ? Object.setPrototypeOf(n, dn.prototype) : n.type === "rule" ? Object.setPrototypeOf(n, cn.prototype) : n.type === "decl" ? Object.setPrototypeOf(n, bh.prototype) : n.type === "comment" ? Object.setPrototypeOf(n, yh.prototype) : n.type === "root" && Object.setPrototypeOf(n, xh.prototype), n[mh] = !0, n.nodes && n.nodes.forEach((e) => {
    pe.rebuild(e);
  });
};
let Tm = Ue, Eh, $h;
class dt extends Tm {
  ...
  toResult(e = {}) {
    return new Eh(new $h(), this, e).stringify();
  }
}
...
var hn = Hr;
Hr.default = Hr;
const br = 39, Ti = 34, $t = 92, Si = 47, Tt = 10, tt = 32, St = 12, Ct = 9, Bt = 13, Cm = 91, Bm = 93, Am = 40, Om = 41, Rm = 123, Dm = 125, Mm = 59, Pm = 42, Im = 58, Lm = 64, At = /[\t\n\f\r "#'()/;[\\\]{}]/g, Ot = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, Nm = /.[\n"'(/\\]/, Ci = /[\da-f]/i;
var _m = function(e, t = {}) {
  let r = e.css.valueOf(), i = t.ignoreErrors, u, o, s, a, l, d, f, c, h, g, k = r.length, p = 0, T = [], A = [];
  function j() {
    return p;
  }
  function R(G) {
  ...
  function L() {
    return A.length === 0 && p >= k;
  }
  function P(G) {
    if (A.length) return A.pop();
    if (p >= k) return;
    let N = G ? G.ignoreUnclosed : !1;
    switch (u = r.charCodeAt(p), u) {
      ...
      case St: {
        ...
        while (u === tt || u === Tt || u === Ct || u === Bt || u === St);
      ...
      case Am: {
        if (c = T.length ? T.pop()[1] : "", h = r.charCodeAt(p + 1), c === "url" && h !== br && h !== Ti && h !== tt && h !== Tt && h !== Ct && h !== St && h !== Bt) {
          o = p;
          do {
            if (d = !1, o = r.indexOf(")", o + 1), o === -1)
              if (i || N) {
                o = p;
                break;
              } else
          ...
          o = r.indexOf(")", p + 1), a = r.slice(p, o + 1), o === -1 || Nm.test(a) ? g = ["(", "(", p] : (g = ["brackets", a, p, o], p = o);
        break;
      }
      case br:
      case Ti: {
      ...
      case $t: {
        for (o = p, l = !0; r.charCodeAt(o + 1) === $t; )
          o += 1, l = !l;
        if (u = r.charCodeAt(o + 1), l && u !== Si && u !== tt && u !== Tt && u !== Ct && u !== Bt && u !== St && (o += 1, Ci.test(r.charAt(o)))) {
          for (; Ci.test(r.charAt(o + 1)); )
            o += 1;
      ...
      default: {
        u === Si && r.charCodeAt(p + 1) === Pm ? (o = r.indexOf("*/", p + 2) + 1, o === 0 && (i || N ? o = r.length : R("comment")), g = ["comment", r.slice(p, o + 1), p, o], p = o) : (Ot.lastIndex = p + 1, Ot.test(r), Ot.lastIndex === 0 ? o = r.length - 1 : o = Ot.lastIndex - 2, g = ["word", r.slice(p, o + 1), p, o], T.push(g), p = o);
        break;
      }
    }
    return p++, g;
...
class Ve extends Ch {
  ...
  toResult(e = {}) {
    return new Bh(new Ah(), this, e).stringify();
  }
}
...
Jt.default = Jt;
Rh.registerRule(Jt);
let Fm = sr, jm = _m, Ym = lr, Hm = pn, qm = yt, Bi = gn;
const Ai = {
  empty: !0,
  space: !0
};
...
class Wm {
  constructor(e) {
    this.input = e, this.root = new qm(), this.current = this.root, this.spaces = "", this.semicolon = !1, this.customProperty = !1, this.createTokenizer(), this.root.source = { input: e, start: { offset: 0, line: 1, column: 1 } };
  }
  createTokenizer() {
  ...
  decl(e, t) {
    ...
    for (let l = e.length - 1; l >= 0; l--) {
      if (u = e[l], u[1].toLowerCase() === "!important") {
        ...
        f.trim().indexOf("!") === 0 && (r.important = !0, r.raws.important = f, e = d);
      }
  ...
  raw(e, t, r, i) {
    ...
    for (let c = 0; c < s; c += 1)
      u = r[c], o = u[0], o === "space" && c === s - 1 && !i ? l = !1 : o === "comment" ? (f = r[c - 1] ? r[c - 1][0] : "empty", d = r[c + 1] ? r[c + 1][0] : "empty", !Ai[f] && !Ai[d] ? a.slice(-1) === "," ? l = !1 : a += u[1] : l = !1) : a += u[1];
    if (!l) {
      let c = r.reduce((h, g) => h + g[1], "");
...
var Gm = Wm;
let Km = Ue, Vm = Gm, Jm = ar;
function Zt(n, e) {
  let t = new Jm(n, e), r = new Vm(t);
  try {
    r.parse();
  } catch (i) {
    throw i;
...
Zt.default = Zt;
Km.registerParse(Zt);
let { isClean: me, my: Zm } = bt, Qm = ph, Xm = ur, eb = Ue, tb = fn, Oi = hn, rb = mn, nb = yt;
const ib = {
  document: "Document",
  root: "Root",
  atrule: "AtRule",
...
class Me {
  constructor(e, t, r) {
    ...
    if (typeof t == "object" && t !== null && (t.type === "root" || t.type === "document"))
      i = qr(t);
    else if (t instanceof Me || t instanceof Oi)
    ...
    this.result = new Oi(e, i, r), this.helpers = { ...zr, result: this.result, postcss: zr }, this.plugins = this.processor.plugins.map((u) => typeof u == "object" && u.prepare ? { ...u, ...u.prepare(this.result) } : u);
  }
  ...
  stringify() {
    ...
    let e = this.result.opts, t = Xm;
    e.syntax && (t = e.syntax.stringify), e.stringifier && (t = e.stringifier), t.stringify && (t = t.stringify);
    let i = new Qm(t, this.result.root, this.result.opts).generate();
...
var Mh = Me;
Me.default = Me;
nb.registerLazyResult(Me);
tb.registerLazyResult(Me);
let sb = ph, ab = ur, lb = mn;
const cb = hn;
class Wr {
  constructor(e, t, r) {
    t = t.toString(), this.stringified = !1, this._processor = e, this._css = t, this._opts = r, this._map = void 0;
    let i, u = ab;
    this.result = new cb(this._processor, i, this._opts), this.result.css = t;
    let o = this;
...
class ht {
  ...
  process(e, t = {}) {
    return this.plugins.length === 0 && typeof t.parser > "u" && typeof t.stringifier > "u" && typeof t.syntax > "u" ? new fb(this, e, t) : new hb(this, e, t);
  }
  normalize(e) {
    let t = [];
    for (let r of e)
...
var mb = ht;
ht.default = ht;
gb.registerProcessor(ht);
pb.registerProcessor(ht);
let bb = sr, yb = lh, vb = lr, xb = pn, kb = ar, wb = yt, Eb = gn;
function pt(n, e) {
  ...
  if (t) {
    e = [];
    for (let i of t) {
      let u = { ...i, __proto__: kb.prototype };
      u.map && (u.map = {
        ...u.map,
...
var $b = pt;
pt.default = pt;
let Tb = ln, Ph = sr, Sb = Mh, Cb = Ue, bn = mb, Bb = ur, Ab = $b, Ih = fn, Ob = Th, Lh = lr, Nh = pn, Rb = hn, Db = ar, Mb = mn, Pb = Oh, _h = gn, Uh = yt, Ib = or;
function Y(...n) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`
    ), gi.env.LANG && gi.env.LANG.startsWith("cn") && console.warn(
      e + `: 里面 postcss.plugin 被弃用. 迁移指南:
https://www.w3ctech.com/topic/2226`
    ));
    let s = t(...o);
    return s.postcssPlugin = e, s.postcssVersion = new bn().version, s;
  }
  let u;
...
Y.fromJSON = Ab;
Y.list = Pb;
Y.comment = (n) => new Lh(n);
Y.atRule = (n) => new Nh(n);
Y.decl = (n) => new Ph(n);
Y.rule = (n) => new _h(n);
Y.root = (n) => new Uh(n);
Y.document = (n) => new Ih(n);
Y.CssSyntaxError = Tb;
Y.Declaration = Ph;
Y.Container = Cb;
Y.Processor = bn;
...
function Lb(n, e, t = "registerComponent") {
...
function Nb(n, e, t = "unregisterComponent") {
  return new CustomEvent(t, {
    bubbles: !0,
    composed: !0,
    detail: e
...
function Fh(n) {
  return (e, t) => {
    const r = n.name;
    z(`[${r}] Registering component ${r} being called on ${t}`);
    ...
    if (n.storeToProps && n.stateToProps) {
      ...
      if (d.length > 0) {
        Rt(`[${r}] Overlapping prop keys detected in ${r} for storeToProps and stateToProps. Make sure to only define them once. Overlapping keys: ${d.join(", ")}`);
        return;
      }
    }
    ...
    n.eventToProps && Object.keys(n.eventToProps).forEach((a) => {
      ...
      z(`[~${r}] connectedCallback called`);
      const a = u == null ? void 0 : u.call(this), l = Dt(this);
      ...
      const a = i == null ? void 0 : i.call(this), l = Dt(this), d = {
        element: l,
        ...n,
        eventToProps: s
      }, f = Lb(e, d, n.registrationEventName);
      return l.dispatchEvent(f) && z(`[${r}] Component ${r} successfully fired registration event`), a;
    }, e.disconnectedCallback = function() {
      const a = o == null ? void 0 : o.call(this), l = Dt(this), d = {
        element: l,
        ...n,
        eventToProps: s
      }, f = Nb(e, d, n.unregistrationEventName);
      return l.dispatchEvent(f) && z(`[${r}] Component ${r} successfully fired unregistration event`), a;
    });
  };
}
const _b = ".sc-chevron-icon-h{display:flex}", Ub = _b, Fb = Ne(class extends _e {
  constructor() {
    super(), this.__registerHost(), this.width = "24", this.height = "24";
  }
  render() {
    return B("svg", { key: "90d483478e14f04ab2793f5c922ccb87a8b1f1cc", xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none" }, B("path", { key: "b50664e82487982f62f962fd7e6586d2a68e42e9", fill: "currentColor", d: "M15.53 4.22a.75.75 0 0 1 0 1.06L8.81 12l6.72 6.72a.75.75 0 1 1-1.06 1.06l-7.25-7.25a.75.75 0 0 1 0-1.06l7.25-7.25a.75.75 0 0 1 1.06 0Z" }));
  }
  static get style() {
    return Ub;
  }
...
const jb = ".sc-close-icon-h{display:flex}", Yb = jb, Hb = Ne(class extends _e {
  constructor() {
    super(), this.__registerHost(), this.width = "16", this.height = "16";
  }
  render() {
    return B("svg", { key: "781556b9f4b7e7601555738d269d42c865e1d39a", width: "21", height: "21", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, B("g", { key: "40e7787cbf60dc41c46e23571582d97b6ba95b6e", "clip-path": "url(#a)" }, B("path", { key: "991d9d4c71663288ebd4c5202c997624b8215678", d: "M5.73 4.574a.75.75 0 1 0-1.061 1.06l4.419 4.42-4.42 4.42a.75.75 0 1 0 1.061 1.06l4.42-4.42 4.419 4.42a.75.75 0 0 0 1.06-1.06l-4.419-4.42 4.42-4.42a.75.75 0 1 0-1.061-1.06l-4.42 4.42-4.419-4.42Z", fill: "currentColor" })), B("defs", { key: "f8d0c70fc77f5be3791251e0f03208ece6af517f" }, B("clipPath", { key: "1c88efda98af5a21f7efbfa60d68ddad75e73893", id: "a" }, B("path", { key: "8d66c6f7b956df6d1db19ab1c7282ffaebc2406a", fill: "#fff", transform: "translate(.148 .054)", d: "M0 0h20v20H0z" }))));
  }
  static get style() {
    return Yb;
  }
...
const Gb = ':host{display:block;width:inherit;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif}.dropdown{display:inline-block;width:100%;position:relative}.dropdown .dropdown-label{display:flex;align-items:center;gap:0.25rem;color:var(--nylas-base-800)}.dropdown span.error{color:var(--nylas-error);font-size:14px}.dropbtn{width:inherit;height:48px;color:black;padding:0.5rem;font-size:1rem;cursor:pointer;display:flex;gap:0.5rem;justify-content:space-between;align-items:center;background:transparent;border:1px solid var(--nylas-base-200);border-radius:var(--nylas-border-radius-2x)}.dropbtn.focus{background:transparent}.dropbtn.error{border:1px solid var(--nylas-error)}.dropbtn:hover,.dropbtn:active{border:1px solid var(--nylas-primary)}.dropbtn:active{outline:2px solid var(--nylas-primary)}.dropbtn span.open{transform:rotate(90deg)}.dropbtn span.closed{transform:rotate(270deg)}.dropdown-content{display:block;margin-top:0.5rem;background-color:var(--nylas-base-0);width:100%;max-height:336px;overflow:auto;z-index:1;border-radius:4px;position:absolute;top:72px;box-shadow:0px 4px 6px -2px rgba(0, 0, 0, 0.0509803922);box-shadow:0px 10px 15px -3px rgba(0, 0, 0, 0.1019607843)}.dropdown-content ul{padding:0;list-style-type:none;color:var(--nylas-base-900);max-height:336px}.dropdown-content ul li{padding:16px, 12px, 16px, 12px;color:black;padding:12px 16px;text-decoration:none;display:block;font-family:inherit;font-size:14px;font-weight:400;line-height:20px;letter-spacing:0px;text-align:left;cursor:pointer}.dropdown-content ul li:hover,.dropdown-content ul li:focus{background-color:var(--nylas-base-100)}.dropdown-content ul li label{display:flex;align-items:center;gap:0.5rem}.dropdown-content ul li label input{margin:0}.selected-options{display:flex;flex-wrap:wrap;gap:0.5rem;padding:0.5rem 0;margin-top:0.25rem;background:var(--nylas-base-0)}.selected-options .selected-option{display:flex;align-items:center;gap:0.5rem;padding:4px 8px;border-radius:var(--nylas-border-radius-2x);background:var(--nylas-base-100);color:var(--nylas-base-800);font-size:16px;font-weight:500;line-height:1.5rem;letter-spacing:0.5px}.selected-options .selected-option button{background:transparent;border:none;cursor:pointer;padding:0}.selected-options .selected-option button:hover{color:var(--nylas-primary)}', Kb = Gb, Vb = Ne(class extends _e {
  ...
  handleListboxKeydown(e) {
    const t = this.availableOptions, r = t.findIndex((i) => i.value === this.ariaActivedescendant);
    switch (e.key) {
      case "ArrowDown":
      case "Tab":
        if (e.shiftKey) {
          e.preventDefault();
          const u = r - 1 >= 0 ? r - 1 : t.length - 1;
          this.ariaActivedescendant = t[u].value, this.focusOption(u);
        } else {
          e.preventDefault();
          const u = r + 1 < t.length ? r + 1 : 0;
          this.ariaActivedescendant = t[u].value, this.focusOption(u);
        }
        break;
      case "ArrowUp":
        e.preventDefault();
        const i = r - 1 >= 0 ? r - 1 : t.length - 1;
        this.ariaActivedescendant = t[i].value, this.focusOption(i);
        break;
      case "Enter":
        e.preventDefault(), this.ariaActivedescendant && this.selectOption(t[r]);
        break;
      case "Escape":
        this.isOpen = !1;
        break;
  ...
  focusOption(e) {
    ...
    if (!t)
      return;
    const r = t.value, i = (u = this.el.shadowRoot) == null ? void 0 : u.getElementById(r);
  ...
  renderOption(e) {
    return B("li", { key: e.value, id: e.value, role: "option", tabindex: "0", "aria-selected": e.selected ? "true" : "false", onClick: (t) => {
      t.stopImmediatePropagation(), this.selectOption(e);
    }, class: { selected: !!e.selected } }, B("label", { htmlFor: e.value }, B("input", { "aria-hidden": "true", id: e.value, type: "checkbox", checked: e.selected }), B("span", null, e.label)));
  }
  render() {
    var e, t;
    return B(Qt, { key: "cecb77880fd937e5845868c7cae0d9e341991088" }, B("div", { key: "3d6acf55e72e25e411812f2fd887678bb332ef16", class: "dropdown", part: "msd_dropdown" }, B("label", { key: "c509b2157684148c0ee0d33f9a2de999d4e05945", class: "dropdown-label" }, this.label, B("slot", { key: "568acd93a920e4538350a56c2cef04a67fa07dc7", name: "label-icon", "aria-hidden": "true" })), B("button", { key: "036bf6146c9071cb369f95ec3e60ea6d8cf12d1a", name: this.name, part: `msd_dropdown-button ${this.error ? "msd_dropdown-button--error" : ""}`, class: { dropbtn: !0, open: this.isOpen, error: !!this.error }, onClick: () => this.toggleDropdown(), "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? "true" : "false", "aria-label": this.name, onKeyDown: (r) => this.handleSelectButtonKeyDown(r) }, B("slot", { key: "4760a3c065fa4f0af09cf11326423aacf5511066", name: "select-icon", "aria-hidden": "true" }), B("span", { key: "4edd567dc3f25451a4f0cbddb02391bde5fc56fd", class: "selected-option", part: "msd_dropdown-button-selected-label" }, this.getSelectedOptions().length > 1 ? "Multiple options selected" : ((e = this.availableOptions.filter((r) => r.selected)[0]) == null ? void 0 : e.label) ?? ((t = this.availableOptions[0]) == null ? void 0 : t.label)), B("span", { key: "6ae9028141f44f16dc56ecd294a2acc3db9a01d5", class: this.isOpen ? "open" : "closed", "aria-hidden": "true" }, B("chevron-icon", { key: "7381625a3b7a961a125d91a27e7b96e4754fb0a1", width: "16", height: "16" }))), this.error ? B("span", { class: "error" }, this.error) : null, this.isOpen ? null : B("div", { class: "selected-options" }, this.getSelectedOptions().map((r) => B("span", { class: "selected-option" }, r.label, B("button", { key: r.label, onClick: () => this.selectOption(r) }, B("close-icon", null))))), this.isOpen ? B("div", { class: "dropdown-content", part: "msd_dropdown-content" }, B("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-multiselectable": !0, "aria-activedescendant": this.ariaActivedescendant, onKeyDown: (r) => this.handleListboxKeydown(r) }, this.availableOptions.map((r) => this.renderOption(r)))) : null));
  }
  get el() {
    return this;
  }
  ...
  ["multi-select-dropdown", "chevron-icon", "close-icon"].forEach((e) => {
    switch (e) {
      case "multi-select-dropdown":
        customElements.get(e) || customElements.define(e, Vb);
        break;
      case "chevron-icon":
...
const Hh = Ne(class extends _e {
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.valueChanged = Vr(this, "valueChanged", 7), this.internals = this.attachInternals(), this.calendars = void 0, this.currentUser = void 0, this.name = "calendar", this.defaultSelectedCalendars = [], this.selectedCalendars = [], this.error = "";
  }
  elementNameChangedHandler(e) {
    z("nylas-calendar-picker", "elementNameChangedHandler", e), this.host.setAttribute("name", e);
  }
  connectedCallback() {
    z("nylas-calendar-picker", "connectedCallback");
  }
  disconnectedCallback() {
    z("nylas-calendar-picker", "disconnectedCallback");
  }
  componentWillLoad() {
    z("nylas-calendar-picker", "componentWillLoad"), this.host.setAttribute("name", this.name);
  }
  componentDidLoad() {
    z("nylas-calendar-picker", "componentDidLoad"), typeof this.internals.setFormValue == "function" && (this.internals.setFormValue(this.defaultSelectedCalendars.toString(), "calendar"), this.valueChanged.emit({ value: this.defaultSelectedCalendars, name: this.name }));
  }
  componentWillUpdate() {
    z("nylas-calendar-picker", "componentWillUpdate");
  }
  componentDidUpdate() {
    z("nylas-calendar-picker", "componentDidUpdate");
  }
  componentWillRender() {
    z("nylas-calendar-picker", "componentWillRender");
  }
  componentDidRender() {
    z("nylas-calendar-picker", "componentDidRender");
  }
  selectedOptionsChangedHandler(e) {
    z("nylas-calendar-picker", "nylasFormDropdownChangedHandler", e.detail);
    const t = (r) => {
      const { value: i } = r.detail;
      this.selectedCalendars = [...i], this.selectedCalendars.length === 0 ? (this.error = "Select at least one calendar.", this.internals.setValidity({ customError: !0 }, "Select at least one calendar.")) : (this.error = "", this.internals.setValidity({})), this.internals.setFormValue(i.toString(), this.name);
    };
  ...
  render() {
    ...
    return B(Qt, null, B("div", { class: "nylas-calendar-picker", part: "ncp" }, e.length > 0 ? B("div", { class: "nylas-calendar-picker__dropdown" }, B("multi-select-dropdown", { name: this.name, options: e, error: this.error, exportparts: "msd_dropdown: ncp__dropdown, msd_dropdown-button: ncp__dropdown-button, msd_dropdown-content: ncp__dropdown-content" })) : B("div", { class: "nylas-calendar-picker__loading" }, B("span", { class: "label" }, "Select calendars that will be checked for availability ", B("info-icon", null)), B("div", { class: "loading-button" }, B("span", null, "Loading...")))));
  }
...
Qb([
  Fh({
    ...
    stateToProps: /* @__PURE__ */ new Map([["schedulerConfig.currentUser", "currentUser"]]),
    eventToProps: {
      valueChanged: async (n, e) => {
        const { valueChangedHandler: t } = n.detail;
        t && t(n);
      }
    },
    fireRegisterEvent: !0
  ...
  ["nylas-calendar-picker", "chevron-icon", "close-icon", "info-icon", "multi-select-dropdown"].forEach((e) => {
    switch (e) {
      case "nylas-calendar-picker":
        customElements.get(e) || customElements.define(e, Hh);
        break;
      case "chevron-icon":
        customElements.get(e) || yn();
        break;
...
const e2 = '.tooltip-container{position:relative;display:flex;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif}.tooltip-content{visibility:hidden;background-color:var(--nylas-base-800);color:var(--nylas-base-0);text-align:left;border-radius:6px;padding:5px 0;position:absolute;z-index:1;opacity:0;transition:opacity 0.3s;padding:0.5rem 1rem;max-width:200px;width:max-content}.tooltip-content.top{bottom:0;left:0;margin-bottom:1.25rem;transform:translateX(-50%)}.tooltip-content.right{top:50%;left:0%;margin-left:1.25rem;transform:translateY(-50%)}.tooltip-content.bottom{top:0;left:0;margin-top:1.25rem;transform:translateX(-50%)}.tooltip-content.left{top:50%;right:0%;margin-right:1.25rem;transform:translateY(-50%)}.tooltip-container:hover .tooltip-content,.tooltip-container:focus-within .tooltip-content{visibility:visible;opacity:1}.tooltip-content::after{content:"";position:absolute;top:-0.75rem;left:50%;transform:rotate(180deg);border-width:6px;border-style:solid;border-color:black transparent transparent transparent}.tooltip-content.top::after{top:100%;left:50%;transform:rotate(0deg)}.tooltip-content.bottom::after{top:-0.75rem;left:50%;transform:rotate(180deg)}.tooltip-content.left::after{top:47.5%;left:100%;transform:rotate(270deg)}.tooltip-content.right::after{top:47.5%;left:-0.75rem;transform:rotate(90deg)}', t2 = e2, r2 = Ne(class extends _e {
  ...
  render() {
    return B("div", { key: "39014243f733656bf550b9141eabd5c13e3c43d9", class: "tooltip-container", part: "tc__container" }, B("span", { key: "8b331b143065287a337e26a4680b3744ca8e2bc7", class: "info-icon", tabindex: "0", onFocus: this.showTooltip.bind(this), onBlur: this.hideTooltip.bind(this) }, B("slot", { key: "cf584033435cee5ca7143f5ee5fb983e3e9ab550", name: "tooltip-icon" }, "i")), B("span", { key: "409b87ee03bc5aa39fcaf965eca18d03f0ef1a44", class: `tooltip-content ${this.position}`, part: "tc__content" }, B("slot", { key: "00f5fa51bcf2cd31fac498f94a97ac67d5b7de3f", name: "tooltip-content" }, "This is a help text.")));
  }
  get el() {
    return this;
  }
...
const xn = Ne(class extends _e {
  constructor() {
    var e;
    super(), this.__registerHost(), this.__attachShadow(), this.valueChanged = Vr(this, "valueChanged", 7), this.internals = this.attachInternals(), this.name = "connected-calendars", this.selectedConfiguration = void 0, this.participants = ((e = this.selectedConfiguration) == null ? void 0 : e.participants) || [], this.calendars = void 0, this.participantOptions = void 0, this.selectedCalendars = this.setParticipants(this.participants), this.participantCalendars = {}, this.participantDefaultSelectedCalendars = {};
  }
  elementNameChangedHandler(e) {
    z("nylas-connected-calendars", "elementNameChangedHandler", e), this.host.setAttribute("name", e);
  }
  calendarsChangedHandler(e) {
    z("nylas-connected-calendars", "calendarsChangedHandler", e), this.selectedCalendars = this.setParticipants(this.participants), this.participantCalendars = this.getParticipantCalendarOptions(this.participants, this.participantOptions);
  }
  participantsChangedHandler(e) {
    z("nylas-connected-calendars", "participantsChangedHandler", e), this.selectedCalendars = this.setParticipants(e), this.participantCalendars = this.getParticipantCalendarOptions(e, this.participantOptions);
  }
  participantOptionsChangedHandler(e) {
    z("nylas-calendar-picker", "participantOptionsChangedHandler", e), this.selectedCalendars = this.setParticipants(this.participants), this.participantCalendars = this.getParticipantCalendarOptions(this.participants, e);
  }
  selectedConfigurationChangedHandler(e) {
    z("nylas-calendar-picker", "selectedConfigurationChangedHandler", e);
  ...
  getParticipantCalendarOptions(e, t) {
    var o, s, a, l;
    const r = e == null ? void 0 : e.find((d) => d.is_organizer), i = ((a = (s = (o = this.selectedConfiguration) == null ? void 0 : o.availability) == null ? void 0 : s.availability_rules) == null ? void 0 : a.availability_method) !== "collective", u = {};
    if (t) {
      const d = e == null ? void 0 : e.filter((c) => t.some((h) => h.email === c.email)), f = e == null ? void 0 : e.filter((c) => !t.some((h) => h.email === c.email));
      d == null || d.forEach((c) => {
        var k, p, T;
        const h = t == null ? void 0 : t.find((A) => A.email === c.email);
        if (!h)
          return;
        this.participantDefaultSelectedCalendars[c.email] = ((k = c.availability) == null ? void 0 : k.calendar_ids) || [];
        const g = h.calendars ?? [];
        (T = (p = c.availability) == null ? void 0 : p.calendar_ids) == null || T.forEach((A) => {
          !(g != null && g.some((j) => j.id === A)) && A !== "primary" && g.push({ id: A, name: A });
        }), u[c.email] = g;
      }), i && (f == null || f.forEach((c) => {
        var h, g, k, p;
        (h = c == null ? void 0 : c.availability) != null && h.calendar_ids && ((k = (g = c == null ? void 0 : c.availability) == null ? void 0 : g.calendar_ids) == null ? void 0 : k.length) > 0 && !c.is_organizer && (u[c.email] = this.calendars ?? [{ id: "primary", name: c.email }], this.participantDefaultSelectedCalendars[c.email] = ((p = c.availability) == null ? void 0 : p.calendar_ids) || []);
      }));
    }
    return r && (u[r.email] = this.calendars ?? [{ id: "primary", name: r.email }], this.participantDefaultSelectedCalendars[r.email] = ((l = r.availability) == null ? void 0 : l.calendar_ids) || []), u;
  }
  connectedCallback() {
    z("nylas-connected-calendars", "connectedCallback");
  }
  disconnectedCallback() {
    z("nylas-connected-calendars", "disconnectedCallback");
  }
  componentWillLoad() {
    z("nylas-connected-calendars", "componentWillLoad");
  }
  componentDidLoad() {
    var e, t;
    z("nylas-connected-calendars", "componentDidLoad"), this.selectedConfiguration && (this.selectedCalendars = this.setParticipants((e = this.selectedConfiguration) == null ? void 0 : e.participants), this.participantCalendars = this.getParticipantCalendarOptions((t = this.selectedConfiguration) == null ? void 0 : t.participants, this.participantOptions));
  }
  handleValueChanged(e) {
    z("[nylas-editor-tabs]", "handleValueChanged", e);
    ...
    const i = t.split("participant-")[1];
    if (!this.selectedCalendars[i])
      return;
    this.selectedCalendars[i].calendars = r, this.selectedCalendars = { ...this.selectedCalendars };
    const u = {};
    Object.keys(this.selectedCalendars).forEach((o) => {
      u[o] = this.selectedCalendars[o].calendars;
    }), this.internals.setFormValue(JSON.stringify(u), this.name), this.valueChanged.emit({ value: JSON.stringify(u), name: this.name });
  }
  setParticipants(e) {
    const t = {};
    return e == null || e.forEach((r) => {
      var i, u, o;
      if ((i = r == null ? void 0 : r.availability) != null && i.calendar_ids && ((o = (u = r == null ? void 0 : r.availability) == null ? void 0 : u.calendar_ids) == null ? void 0 : o.length) > 0) {
        const s = !!r.is_organizer;
        t[r.email] = {
          isOpen: s,
          name: r.name || r.email,
  ...
  render() {
    return B(Qt, { key: "93c9e0b22219deb57d1eb08f1ffa3057c1f11e2d" }, B("div", { key: "fbd05348502ca5f1bf16cdcabe57486afed5ff08", class: "nylas-connected-calendars", part: "npca" }, B("div", { key: "c83d17fa00cca611b100cb17f327af5a4841fec6", class: "header", part: "npca__header" }, B("h3", { key: "563228be14edc1cfd8c9cb2c4da74f7384b6824c" }, "Connected Calendars"), B("p", { key: "f9349bbbd8769616744fc125b22f0d50ff340c48" }, "Select the calendars to use for checking your availability.", B("tooltip-component", { key: "b119f309472799d0d7b882cdcf079e0e5fad63ce" }, B("info-icon", { key: "f065051277ec70042dcebc59b0baaf0b7c8a7fc3", slot: "tooltip-icon" }), B("span", { key: "3dcad6fcad23ba112d4167fee874a41363ed79ea", slot: "tooltip-content" }, "Check availability across one or more calendars. If you select multiple calendars for a participant, the participant must be available across all of their calendars to be considered available.")))), B("div", { key: "d313e98a65f0dc8a5c8ad12d3d2a301263fe6121", class: "content", part: "npca__content" }, B("form", { key: "0e71e357eefb86c6d60e932793a779e7f4d48ead", ref: (e) => this.connectedCalendarsFormRef = e }, Object.keys(this.participantCalendars).map((e, t) => {
      const r = this.selectedCalendars[e], i = this.participantCalendars[e];
      if (!(!r || !r.name))
        return B("div", { class: "participant-container", part: "npca__participant-container", key: `participant-conatiner-${t}` }, B("div", { class: "participant-title", part: "npca__participant-title" }, B("p", null, r.name, "'s connected calendars"), B("div", { class: "participant-toggle", part: "npca__participant-toggle--container" }, B("span", { class: `chevron ${r.isOpen ? "open" : "closed"}`, onClick: () => {
          this.selectedCalendars[e].isOpen = !r.isOpen, this.selectedCalendars = { ...this.selectedCalendars };
        } }, B("chevron-icon", { width: "24", height: "24" })))), r.isOpen && B("nylas-calendar-picker", { key: e, name: `participant-${e}`, calendars: i, defaultSelectedCalendars: this.participantDefaultSelectedCalendars[e] }));
    })))));
  }
  static get formAssociated() {
    return !0;
  ...
  ["nylas-connected-calendars", "chevron-icon", "close-icon", "info-icon", "multi-select-dropdown", "nylas-calendar-picker", "tooltip-component"].forEach((e) => {
    switch (e) {
      ...
      case "multi-select-dropdown":
        ...
        break;
      case "nylas-calendar-picker":
        customElements.get(e) || Xb();
        break;
      case "tooltip-component":
        customElements.get(e) || n2();
        break;
    }
  });
}
const g2 = xn, m2 = s2;
export {
  g2 as NylasConnectedCalendars,
  m2 as defineCustomElement
};
