...
const P = (n, e, ...t) => {
  ...
  if (n = n.nodeType === 11 ? n : fe, u)
    if (typeof u == "string") {
      ...
      if (o || wn.set(n, o = /* @__PURE__ */ new Set()), !o.has(i)) {
        ...
        e.$flags$ & 4 && (s.innerHTML += Uh), o && o.add(i);
      }
    } else n.adoptedStyleSheets.includes(u) || (n.adoptedStyleSheets = [...n.adoptedStyleSheets, u]);
  return i;
}, Qh = (n) => {
  const e = n.$cmpMeta$, t = n.$hostElement$, r = e.$flags$, i = Le("attachStyles", e.$tagName$), u = Zh(t.shadowRoot ? t.shadowRoot : t.getRootNode(), e, n.$modeName$);
...
}, Xh = /\s/, En = (n) => n ? n.split(Xh) : [], Di = "Capture", e1 = new RegExp(Di + "$"), Ri = (n, e, t, r) => {
  ...
  for (let r = e; r <= t; ++r) {
    ...
    if (i) {
      const u = i.$elm$;
      _i(i), u && (Lt = !0, u["s-ol"] ? u["s-ol"].remove() : ut(u, !0), u.remove());
    }
  }
}, t1 = (n, e, t, r, i = !1) => {
  ...
  for (; u <= l && o <= d; )
    if (c == null)
      ...
      (c.$tag$ === "slot" || g.$tag$ === "slot") && ut(c.$elm$.parentNode, !1), qe(c, g, i), n.insertBefore(c.$elm$, f.$elm$.nextSibling), c = e[++u], g = r[--d];
    else if (xt(f, h, i))
      (c.$tag$ === "slot" || g.$tag$ === "slot") && ut(f.$elm$.parentNode, !1), qe(f, h, i), n.insertBefore(f.$elm$, c.$elm$), f = e[--l], h = r[++o];
    else {
      for (s = -1, a = u; a <= l; ++a)
  ...
  let a;
  s === null ? (ie = o === "svg" ? !0 : o === "foreignObject" ? !1 : ie, o === "slot" || Ri(n, e, ie), i !== null && u !== null ? t1(r, i, e, u, t) : u !== null ? (n.$text$ !== null && (r.textContent = ""), Mi(r, null, e, u, 0, u.length - 1)) : i !== null && Ii(i, 0, i.length - 1), ie && o === "svg" && (ie = !1)) : (a = r["s-cr"]) ? a.parentNode.textContent = s : n.$text$ !== s && (r.data = s);
}, Pi = (n) => {
  ...
  var r, i, u, o, s;
  const a = n.$hostElement$, l = n.$cmpMeta$, c = n.$vnode$ || Pt(null, null), f = Hh(e) ? e : P(null, null, e);
  ...
  f.$tag$ = null, f.$flags$ |= 4, n.$vnode$ = f, f.$elm$ = c.$elm$ = a.shadowRoot || a, Ye = a["s-sc"], vr = a["s-cr"], Ci = (l.$flags$ & 1) !== 0, Lt = !1, qe(c, f, t);
  {
    ...
    Lt && Pi(f.$elm$), ee.$flags$ &= -2, Te.length = 0;
  }
  ...
  const r = n.$hostElement$, i = Le("update", n.$cmpMeta$.$tagName$);
  r["s-rc"], t && Qh(n);
  const u = Le("render", n.$cmpMeta$.$tagName$);
  s1(n, e, r, t), u(), i(), a1(n);
}, s1 = (n, e, t, r) => {
  try {
    bn = e, e = e.render && e.render(), n.$flags$ &= -17, n.$flags$ |= 2, (Oe.hasRenderFn || Oe.reflect) && (Oe.vdomRender || Oe.reflect) && (Oe.hydrateServerSide || r1(n, e, r));
  } catch (a) {
    gt(a, n.$hostElement$);
  }
  return bn = null, null;
}, a1 = (n) => {
  const e = n.$cmpMeta$.$tagName$, t = n.$hostElement$, r = Le("postUpdate", e), i = t;
...
}, l1 = (n, e) => pt(n).$instanceValues$.get(e), c1 = (n, e, t, r) => {
  const i = pt(n), u = n, o = i.$instanceValues$.get(e), s = i.$flags$, a = u;
        ...
        ee.jmp(() => {
          ...
          if (this.hasOwnProperty(f))
            ...
            if (i.hasOwnProperty(f) && typeof this[f] == "number" && this[f] == l)
              return;
            if (f == null) {
              const d = pt(this), h = d == null ? void 0 : d.$flags$;
              if (h && !(h & 8) && h & 128 && l !== a) {
  ...
  if (!(ee.$flags$ & 1)) {
    const e = pt(n), t = e.$cmpMeta$, r = Le("connectedCallback", t.$tagName$);
  ...
  return n;
})(), k1 = (n) => Promise.resolve(n), E1 = /* @__PURE__ */ (() => {
  try {
...
var D1 = {}.toString, zi = Array.isArray || function(n) {
...
function Wi(n, e, t, r) {
  ...
  return typeof ArrayBuffer < "u" && e instanceof ArrayBuffer ? L1(n, e, t, r) : typeof e == "string" ? I1(n, e, t) : P1(n, e);
}
    ...
    var m = function() {
      ...
      return b.parse = function(y) {
        this.$d = function(B) {
          ...
          if (R.u(k)) return /* @__PURE__ */ new Date();
        ...
        return R.u(y) ? this[B] : this.set(k, y);
      }, b.unix = function() {
        return Math.floor(this.valueOf() / 1e3);
      }, b.valueOf = function() {
        return this.$d.getTime();
      }, b.startOf = function(y, B) {
        var k = this, S = !!R.u(B) || B, C = R.p(y), I = function(_e, re) {
          var Ae = R.w(k.$u ? Date.UTC(k.$y, re, _e) : new Date(k.$y, re, _e), k);
          return S ? Ae : Ae.endOf(l);
        }, H = function(_e, re) {
          return R.w(k.toDate()[_e].apply(k.toDate("s"), (S ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(re)), k);
        ...
        var k, S = R.p(y), C = "set" + (this.$u ? "UTC" : ""), I = (k = {}, k[l] = C + "Date", k[g] = C + "Date", k[f] = C + "Month", k[h] = C + "FullYear", k[a] = C + "Hours", k[s] = C + "Minutes", k[o] = C + "Seconds", k[u] = C + "Milliseconds", k)[S], H = S === l ? this.$D + (B - this.$W) : B;
        if (S === f || S === h) {
        ...
        var S, C = R.p(B), I = N(y), H = (I.utcOffset() - this.utcOffset()) * r, G = this - I, Z = R.m(this, I);
        return Z = (S = {}, S[h] = Z / 12, S[f] = Z, S[d] = Z / 3, S[c] = (G - H) / 6048e5, S[l] = (G - H) / 864e5, S[a] = G / i, S[s] = G / r, S[o] = G / t, S)[C] || G, k ? Z : R.a(Z);
...
var op = function(n, e, t) {
  ...
  var e = n.getUTCMonth();
  return e === 1 && rt(n.getUTCFullYear()) ? 29 : sp[e];
}, We = function(n) {
...
function du(n) {
  for (var e = [], t = Object.keys(n), r = 0, i = t; r < i.length; r++) {
    var u = i[r];
    Y(Kp, u) || e.push(u), su(n[u]) && !tt(n[u]) && e.push(u);
  }
  if (e.length)
...
function Up(n, e) {
  ...
  if (c) {
    ...
    if (Y(e.byweekno, -1))
      ...
      var q = We(Pe(n - 1, 1, 1)), A = le(7 - q.valueOf() + e.wkst, 7), L = rt(n - 1) ? 366 : 365, M = void 0;
      A >= 4 ? (A = 0, M = L + le(q - e.wkst, 7)) : M = r - c, O = Math.floor(52 + le(M, 7) / 4);
    }
    if (Y(e.byweekno, O))
      for (var p = 0; p < c; p++)
        s.wnomask[p] = 1;
...
function Fp(n) {
  var e = rt(n) ? 366 : 365, t = Pe(n, 1, 1), r = We(t);
  return e === 365 ? {
    mmask: Bp,
    mdaymask: Rp,
    nmdaymask: Pp,
...
function jp(n, e, t, r, i, u) {
  ...
  for (var a = 0; a < s.length; a++)
    for (var l = s[a], c = l[0], f = l[1] - 1, d = 0; d < u.bynweekday.length; d++) {
      ...
      p < 0 ? (h = f + (p + 1) * 7, h -= le(i[h] - w, 7)) : (h = c + (p - 1) * 7, h += le(7 - i[h] + w, 7)), c <= h && h <= f && (o.nwdaymask[h] = 1);
    }
  return o;
}
function Yp(n, e) {
...
function Hp(n, e, t, r, i, u) {
  for (var o = [], s = 0; s < n.length; s++) {
    ...
    var w = e[l], p = au(i.yearordinal + g), T = lu(p, w);
    Y(o, T) || o.push(T);
  }
  return ot(o), o;
}
  ...
  for (var c = Gp(l, a, e); ; ) {
    ...
    if (J(o))
      ...
      for (var T = h; T < g; T++) {
        var A = d[T];
        if (K(A))
          for (var L = au(l.yearordinal + A), M = 0; M < c.length; M++) {
            var F = c[M], O = lu(L, F);
            if (u && O > u)
              return $e(n);
            if (O >= t) {
...
function Vp(n, e) {
  ...
  return l.forEach(function(c) {
    var f;
    if (c) {
      var d = eg(c), h = d.name, g = d.parms, w = d.value;
...
class Kt extends ir {
  ...
  translate(e, t, r) {
    ...
    if (O && d && (typeof d != "string" && typeof d != "boolean" && typeof d != "number") && p.indexOf(w) < 0 && !(typeof T == "string" && Array.isArray(d))) {
      ...
      if (u) {
        const A = Array.isArray(d), L = A ? [] : {}, M = A ? g : h;
        for (const F in d)
      ...
      if (L || A || b) {
        ...
        this.options.saveMissing && (this.options.saveMissingPlurals && M ? y.forEach((S) => {
          ...
          R && t[`defaultValue${this.options.pluralSeparator}zero`] && C.indexOf(`${this.options.pluralSeparator}zero`) < 0 && C.push(`${this.options.pluralSeparator}zero`), C.forEach((I) => {
      ...
      f.forEach((p) => {
        this.isValidLookup(r) || (s = p, !ti[`${w[0]}-${p}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(s) && (ti[`${w[0]}-${p}`] = !0, this.logger.warn(`key "${i}" for languages "${w.join(", ")}" won't get resolved as namespace "${s}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), w.forEach((T) => {
          ...
          if (this.i18nFormat && this.i18nFormat.addLookupKeys)
            ...
            if (d && (O.push(c + A), t.ordinal && A.indexOf(M) === 0 && O.push(c + A.replace(M, this.options.pluralSeparator)), h && O.push(c + L)), g) {
              const F = `${c}${this.options.contextSeparator}${t.context}`;
              O.push(F), d && (O.push(F + A), t.ordinal && A.indexOf(M) === 0 && O.push(F + A.replace(M, this.options.pluralSeparator)), h && O.push(F + L));
            }
          }
          let q;
          for (; q = O.pop(); )
...
class st extends ir {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      }), c && (!this.options.interpolation.format || this.options.interpolation.format === i.interpolation.format) && (d.formatter = u(c), d.formatter.init(d, this.options), this.options.interpolation.format = d.formatter.format.bind(d.formatter)), d.interpolator = new wg(this.options), d.utils = {
...
const gu = st.createInstance();
gu.createInstance = st.createInstance;
const mu = "No date selected", bu = "Choose another time slot to reschedule your meeting", yu = {
  ...
  bookingRescheduled: _u,
  bookingDateAndTimeHeader: Uu,
  ...
  cancelBokingFormError: wo,
  default: Bg
}), ko = "Aucune date sélectionnée", Eo = "Choisissez un autre créneau horaire pour reprogrammer votre réunion", $o = {
  sunday: "DIM",
  monday: "LUN",
  tuesday: "MAR",
  wednesday: "MER",
  ...
  cancelBokingFormError: Da,
  default: Dg
}), Ra = "日付が選択されていません", Ma = "別の時間を選択してください", Ia = {
  sunday: "日",
  monday: "月",
  tuesday: "火",
  wednesday: "水",
  ...
  cancellationErrorMessage: Il,
  minimumCancellationErrorMessage: Ll,
  cancelBokingFormError: Pl
  ...
  cancelBokingFormError: Pl,
  default: Mg
}), Nl = "Kein Datum ausgewählt", _l = "Wählen Sie einen anderen Zeitpunkt, um Ihr Meeting neu zu planen", Ul = {
  sunday: "SO",
  monday: "MO",
  tuesday: "DI",
  wednesday: "MI",
  ...
  sessionIdRequiredErrorMessage: Ic,
  publicConfigErrorMessage: Lc,
  invalidTimeslotErrorTitle: Pc,
  invalidTimeslotErrorMessage: Nc,
  cancellationErrorTitle: _c,
  ...
  confirmBookingErrorTitle: P0,
  genericErrorTitle: N0,
  schedulingComponentErrorTitle: _0,
  ...
  bookingRescheduled: wf,
  bookingDateAndTimeHeader: kf,
  ...
  goBackButton: If,
  bookingCancelledTitle: Lf,
  bookingCancelledMessage: Pf,
  closeButton: Nf,
  closingButton: _f,
  fieldRequired: Uf,
...
(function(n) {
  ...
  n.determineBranch = A;
  var L = q(u.default), M = q(o.default);
  function F(m, E) {
...
` || // new line
      ...
      function r(A) {
        var L, M = A.exec(e.substring(p));
        if (M)
          return L = M[0], p += L.length, L;
      }
      ...
      function q() {
        var A = !1, L, M, F, W, N = {}, R, m, E, v, b;
        for (W = 0; W < d.length; W++)
          R = d[W], m = R[R.length - 1], E = R.substring(0, R.length - 1), v = parseInt(E, 10), b = parseFloat(E), l.test(E) && m === "w" ? ((L || M) && (A = !0), v === 0 ? A = !0 : L = v) : c.test(E) && m === "x" ? ((L || M || F) && (A = !0), b < 0 ? A = !0 : M = b) : l.test(E) && m === "h" ? ((F || M) && (A = !0), v === 0 ? A = !0 : F = v) : A = !0;
        A ? console && console.log && console.log("Invalid srcset descriptor found in '" + e + "' at '" + R + "'.") : (N.url = f, L && (N.w = L), M && (N.d = M), F && (N.h = F), T.push(N));
      }
    };
  });
})(Hg);
...
`), this.css += t + "/*# sourceMappingURL=" + e + " */";
  ...
  path(e) {
    ...
    return typeof this.mapOpts.annotation == "string" && (t = It(ah(t, this.mapOpts.annotation))), e = lh(t, e), e;
  }
  toUrl(e) {
...
class lt extends xm {
  ...
  toResult(e = {}) {
    return new xh(new wh(), this, e).stringify();
  }
}
  ...
  function M(W) {
    ...
    switch (u = r.charCodeAt(p), u) {
      ...
      case St: {
        ...
        while (u === Xe || u === Tt || u === Bt || u === Ct || u === St);
      ...
      case $t: {
        for (o = p, l = !0; r.charCodeAt(o + 1) === $t; )
          o += 1, l = !l;
        if (u = r.charCodeAt(o + 1), l && u !== ki && u !== Xe && u !== Tt && u !== Bt && u !== Ct && u !== St && (o += 1, Ei.test(r.charAt(o)))) {
      ...
      default: {
        u === ki && r.charCodeAt(p + 1) === Am ? (o = r.indexOf("*/", p + 2) + 1, o === 0 && (i || N ? o = r.length : A("comment")), g = ["comment", r.slice(p, o + 1), p, o], p = o) : (Ot.lastIndex = p + 1, Ot.test(r), Ot.lastIndex === 0 ? o = r.length - 1 : o = Ot.lastIndex - 2, g = ["word", r.slice(p, o + 1), p, o], T.push(g), p = o);
        break;
      }
    }
    return p++, g;
...
function ft(n, e) {
  ...
  if (r.nodes && (r.nodes = n.nodes.map((i) => ft(i, e))), r.source) {
...
function Mb(n) {
  return (e, t) => {
    const r = n.name;
    ae(`[${r}] Registering component ${r} being called on ${t}`);
    ...
    n.eventToProps && Object.keys(n.eventToProps).forEach((a) => {
      ...
      const a = i == null ? void 0 : i.call(this), l = Rt(this), c = {
        ...
        ...n,
        eventToProps: s
      }, f = Db(e, c, n.registrationEventName);
      return l.dispatchEvent(f) && ae(`[${r}] Component ${r} successfully fired registration event`), a;
      ...
      return l.dispatchEvent(f) && ae(`[${r}] Component ${r} successfully fired unregistration event`), a;
    });
  };
}
const Ib = ".sc-chevron-icon-h{display:flex}", Lb = Ib, Pb = ht(class extends mt {
  constructor() {
...
function Nh() {
  ...
  ["chevron-icon"].forEach((e) => {
    switch (e) {
      case "chevron-icon":
        customElements.get(e) || customElements.define(e, Pb);
        break;
    }
  });
}
const Nb = ':host{display:block;position:relative;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif}@media screen and (max-width: 768px){:host{position:unset}}.dropdown{display:inline-block}.dropbtn{color:var(--nylas-base-800);padding:10px;font-size:1rem;font-family:var(--nylas-font-family);cursor:pointer;display:flex;gap:0.5rem;background:transparent;border:none;border-radius:var(--nylas-border-radius-2x);width:50px;padding:14px 16px;border-radius:var(--nylas-border-radius-2x)}.dropbtn.focus{background:transparent}.dropbtn:hover,.dropbtn:active{outline:1px solid var(--nylas-primary)}.dropbtn:active{outline:2px solid var(--nylas-primary)}.dropbtn span.chevron{display:flex;align-self:center}.dropbtn span.open{transform:rotate(90deg)}.dropbtn span.closed{transform:rotate(270deg)}.dropbtn span.selected-option{text-overflow:ellipsis;overflow:hidden;white-space:nowrap;max-width:144px;font-size:14px;line-height:20px}@media screen and (max-width: 768px){.dropbtn span.selected-option{max-width:124px;font-size:16px}}.dropdown-content{display:block;margin-top:0.5rem;background-color:var(--nylas-base-0);max-width:306px;width:max-content;max-height:336px;overflow:auto;z-index:1;border-radius:4px;position:absolute;box-shadow:0px 4px 6px -2px rgba(0, 0, 0, 0.05);box-shadow:0px 10px 15px -3px rgba(0, 0, 0, 0.1)}@media screen and (max-width: 768px){.dropdown-content{right:0;width:325px;max-width:unset}}.search-box{border-bottom:1px solid var(--nylas-base-200);padding:10px;position:sticky;top:0;background:var(--nylas-base-0)}.search-box .icon{position:absolute;top:1.25rem;left:1.25rem;color:var(--nylas-base-300)}.dropdown-content ul{padding:0;list-style-type:none;color:var(--nylas-base-900);max-height:336px}.dropdown-content ul li{padding:16px, 12px, 16px, 12px;color:black;padding:12px 16px;text-decoration:none;display:block;font-family:inherit;font-size:14px;font-weight:400;line-height:20px;letter-spacing:0px;text-align:left;cursor:pointer}.dropdown-content ul li:hover,.dropdown-content ul li:focus{background-color:var(--nylas-base-100)}.dropdown-content .selected{background-color:#e7e7e7}input[type=text]{width:-webkit-fill-available;padding:inherit;border:1px solid #ccc;border-radius:4px;position:sticky;background:no-repeat scroll 7px 7px;padding-left:30px;background-size:16px 16px}', _b = Nb, Ub = ht(class extends mt {
  ...
  render() {
    return P("div", { key: "fa0347bf09ec791976c3628837a400ffce06f785", class: "dropdown", part: "id_dropdown" }, P("input", { key: "d18704609aa859f705397ca57a0d491a8f09ed99", type: "text", name: this.name, id: this.name, part: "id_dropdown-input", class: { dropbtn: !0, open: this.isOpen }, value: this.inputValue, onClick: (e) => {
      this.toggleDropdown(), this.shouldAutoScroll = !0, this.handleClick(e);
    }, "aria-haspopup": "listbox", "aria-label": this.name, "aria-expanded": this.isOpen ? "true" : "false", onKeyDown: (e) => this.handleComboboxKeyDown(e), onInput: (e) => this.handleOnInput(e) }), this.isOpen ? P("div", { class: "dropdown-content", part: "id_dropdown-content", ref: (e) => this.optionsRef = e }, P("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-activedescendant": this.ariaActivedescendant, onKeyDown: (e) => this.handleListboxKeydown(e) }, this.filteredOptions.map((e) => P("li", { tabindex: "0", key: e.value, id: e.value, onClick: () => this.selectOption(e), role: "option", class: {
...
const jb = ".sc-search-icon-h{display:flex}", Yb = jb, qb = ht(class extends mt {
  constructor() {
...
const mn = ht(class extends mt {
  ...
  elementNameChangedHandler(e) {
    ae("nylas-event-duration", "elementNameChangedHandler", e), this.host.setAttribute("name", e);
  }
  selectedConfigurationChangedHandler(e) {
    var r;
    const t = (r = e == null ? void 0 : e.availability) == null ? void 0 : r.duration_minutes;
    t && (this.duration = t >= 60 ? t / 60 : t, this.durationMinutes = t || 30, this.durationIncrement = t >= 60 ? 60 : 1);
  }
  durationMinutesChangedHandler(e, t) {
    ae("nylas-event-duration", "durationMinutesChangedHandler", e), e !== t && this.valueChanged.emit({ value: e.toString(), name: this.name });
  }
  connectedCallback() {
    ae("nylas-event-duration", "connectedCallback");
  }
  componentWillLoad() {
    ae("nylas-event-duration", "componentWillLoad"), this.host.setAttribute("name", this.name), this.setDurationMintueOptions();
  }
  componentDidLoad() {
    ae("nylas-event-duration", "componentDidLoad"), this.selectedConfiguration && this.selectedConfigurationChangedHandler(this.selectedConfiguration), this.duration = this.duration ? this.duration : this.eventDurationMinutes ? this.eventDurationMinutes >= 60 ? this.eventDurationMinutes / 60 : this.eventDurationMinutes : 30, this.durationMinutes = this.durationMinutes ? this.durationMinutes : this.duration ? this.duration : 30, this.durationIncrement = this.durationIncrement ? this.durationIncrement : this.duration >= 60 ? 60 : 1, this.internals.setFormValue(this.durationMinutes.toString(), "duration");
  }
  disconnectedCallback() {
    ae("nylas-event-duration", "disconnectedCallback");
  }
  setDurationMintueOptions() {
    return this.durationIncrement === 1 ? this.durationMinutesOptions = [
      ...
      { value: 45, label: "45" },
      { value: 60, label: "60" }
    ] : this.durationMinutesOptions = Array.from({ length: 23 }, (e, t) => ({ value: t + 1, label: (t + 1).toString() })), this.durationMinutesOptions;
  }
  handleChange(e) {
    this.duration = e.target.value, this.durationMinutes = this.duration * this.durationIncrement, this.internals.setFormValue(this.durationMinutes.toString(), this.name);
  }
  nylasFormDropdownChangedHandler(e) {
    ae("nylas-calendar-picker", "nylasFormDropdownChangedHandler", e.detail);
    const { value: t } = e.detail;
    this.durationIncrement = parseInt(t), this.durationIncrement === 1 ? this.duration = 60 : this.duration = 1, this.setDurationMintueOptions(), this.durationMinutes = this.duration * this.durationIncrement, this.internals.setFormValue(this.durationMinutes.toString(), "duration");
  }
  inputOptionChangedHandler(e) {
    ae("nylas-calendar-picker", "inputOptionChangedHandler", e.detail);
    const { value: t } = e.detail;
    this.duration = t, this.durationMinutes = this.duration * this.durationIncrement, this.internals.setFormValue(this.durationMinutes.toString(), this.name);
  }
  render() {
    const e = [
    ...
    return P(Ai, { key: "3aeec3a1b528f5e1d6c0470122a31fd5e7470fa9" }, P("div", { key: "1c1efed9fdecbde574461154cc3b60f29bafe657", class: "nylas-event-duration", part: "ned" }, P("label", { key: "cd8cb2b52038a897b03021e90b4ec335b2390db5", htmlFor: "duration" }, "Event duration", P("span", { key: "8a09d363737a793078e2c7a7f7764b28851569c9", class: "required" }, "*")), P("div", { key: "970ef2ffc2a7d718346e6654c99cc24b34e44ec9", class: "nylas-event-duration__wrapper" }, P("input-dropdown", { key: "bb614ca89f742a55e86d1cdf6a8a779f0631bb7f", name: "event-duration", options: this.durationMinutesOptions, inputValue: this.duration.toString(), exportparts: "id_dropdown: ned__input_dropdown, id_dropdown-input: ned__input_dropdown-input, id_dropdown-content: ned__input_dropdown-content", defaultInputOption: this.durationMinutesOptions.find((t) => t.value == this.duration) }), this.durationIncrement && P("select-dropdown", { name: "event-duration", options: e, pluralizedLabel: this.duration > 1 ? "s" : "", exportparts: "sd_dropdown: ned__dropdown, sd_dropdown-button: ned__dropdown-button, sd_dropdown-content: ned__dropdown-content", defaultSelectedOption: e.find((t) => t.value == this.durationIncrement), withSearch: !1 }))));
  }
...
function Zb() {
  if (typeof customElements > "u")
    return;
  ["nylas-event-duration", "chevron-icon", "input-dropdown", "search-icon", "select-dropdown"].forEach((e) => {
    switch (e) {
...
const n2 = mn, i2 = Zb;
export {
  n2 as NylasEventDuration,
  i2 as defineCustomElement
};
