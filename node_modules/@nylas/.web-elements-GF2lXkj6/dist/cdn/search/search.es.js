...
let x, M, _, le = !1, U = !1, W = !1, v = !1, I = null, H = !1;
const L = (e, t = "") => () => {
...
const P = (e, t, ...n) => {
  ...
  $.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], M = i["s-cr"], le = (u.$flags$ & 1) !== 0, U = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      de($.$elm$);
      for (const d of m) {
...
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ ot(ye, !0), ct = ".sc-search-icon-h{display:flex}", $t = ct, at = Ke(class extends tt {
  constructor() {
