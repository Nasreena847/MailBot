...
const A = (n, e, ...t) => {
  ...
  if (typeof n.vtag == "function") {
    ...
    return n.vkey && (t.key = n.vkey), n.vname && (t.name = n.vname), A(n.vtag, t, ...n.vchildren || []);
  }
  ...
  if (Ci || (Wr = !0, i.$tag$ === "slot" && (Ye && r.classList.add(Ye + "-s"), i.$flags$ |= i.$children$ ? (
    ...
    o = i.$elm$ = de.createTextNode(i.$text$);
  else if (i.$flags$ & 1)
    o = i.$elm$ = de.createTextNode("");
  else {
    if (ue || (ue = i.$tag$ === "svg"), o = i.$elm$ = de.createElementNS(ue ? Fh : jh, i.$flags$ & 2 ? "slot-fb" : i.$tag$), ue && i.$tag$ === "foreignObject" && (ue = !1), Ri(null, i, ue), Yh(Ye) && o["s-si"] !== Ye && o.classList.add(o["s-si"] = Ye), i.$children$)
  ...
  for (let r = e; r <= t; ++r) {
    ...
    if (i) {
      const u = i.$elm$;
      Ni(i), u && (It = !0, u["s-ol"] ? u["s-ol"].remove() : st(u, !0), u.remove());
    }
  }
}, t1 = (n, e, t, r, i = !1) => {
  let u = 0, o = 0, s = 0, a = 0, l = e.length - 1, c = e[0], d = e[l], f = r.length - 1, h = r[0], g = r[f], w, p;
  for (; u <= l && o <= f; )
    if (c == null)
      c = e[++u];
    else if (d == null)
      ...
      qe(d, g, i), d = e[--l], g = r[--f];
    else if (xt(c, g, i))
      (c.$tag$ === "slot" || g.$tag$ === "slot") && st(c.$elm$.parentNode, !1), qe(c, g, i), n.insertBefore(c.$elm$, d.$elm$.nextSibling), c = e[++u], g = r[--f];
    else if (xt(d, h, i))
      (c.$tag$ === "slot" || g.$tag$ === "slot") && st(d.$elm$.parentNode, !1), qe(d, h, i), n.insertBefore(d.$elm$, c.$elm$), d = e[--l], h = r[++o];
    else {
      for (s = -1, a = u; a <= l; ++a)
  ...
  var r, i, u, o, s;
  const a = n.$hostElement$, l = n.$cmpMeta$, c = n.$vnode$ || Lt(null, null), d = Hh(e) ? e : A(null, null, e);
...
}, b1 = (n, e) => e & 4 ? de : e & 8 ? Qt : e & 16 ? de.body : n, y1 = (n) => w1 ? {
  passive: (n & 1) !== 0,
  capture: (n & 2) !== 0
...
function Xt(n, e, t, r, i) {
  var u, o, s = i * 8 - r - 1, a = (1 << s) - 1, l = a >> 1, c = -7, d = t ? i - 1 : 0, f = t ? -1 : 1, h = n[e + d];
  for (d += f, u = h & (1 << -c) - 1, h >>= -c, c += s; c > 0; u = u * 256 + n[e + d], d += f, c -= 8)
    ;
  for (o = u & (1 << -c) - 1, u >>= -c, c += r; c > 0; o = o * 256 + n[e + d], d += f, c -= 8)
    ;
  if (u === 0)
    u = 1 - l;
  else {
...
function Hi(n, e, t, r, i, u) {
  var o, s, a, l = u * 8 - i - 1, c = (1 << l) - 1, d = c >> 1, f = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = r ? 0 : u - 1, g = r ? 1 : -1, w = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, o = c) : (o = Math.floor(Math.log(e) / Math.LN2), e * (a = Math.pow(2, -o)) < 1 && (o--, a *= 2), o + d >= 1 ? e += f / a : e += f * Math.pow(2, 1 - d), e * a >= 2 && (o++, a /= 2), o + d >= c ? (s = 0, o = c) : o + d >= 1 ? (s = (e * a - 1) * Math.pow(2, i), o = o + d) : (s = e * Math.pow(2, d - 1) * Math.pow(2, i), o = 0)); i >= 8; n[t + h] = s & 255, h += g, s /= 256, i -= 8)
    ;
...
x.prototype.toString = function() {
  var e = this.length | 0;
  return e === 0 ? "" : arguments.length === 0 ? Zi(this, 0, e) : _1.apply(this, arguments);
};
...
x.prototype.compare = function(e, t, r, i, u) {
  ...
  for (var o = u - i, s = r - t, a = Math.min(o, s), l = this.slice(i, u), c = e.slice(t, r), d = 0; d < a; ++d)
    if (l[d] !== c[d]) {
      o = l[d], s = c[d];
      break;
    }
...
function U1(n, e, t, r) {
  return rr(Ut(e, n.length - t), n, t, r);
}
function Vi(n, e, t, r) {
    ...
    if (i + s <= t) {
      ...
      switch (s) {
        case 1:
          ...
          break;
        case 2:
          a = n[i + 1], (a & 192) === 128 && (d = (u & 31) << 6 | a & 63, d > 127 && (o = d));
          break;
        case 3:
          a = n[i + 1], l = n[i + 2], (a & 192) === 128 && (l & 192) === 128 && (d = (u & 15) << 12 | (a & 63) << 6 | l & 63, d > 2047 && (d < 55296 || d > 57343) && (o = d));
          break;
        case 4:
          a = n[i + 1], l = n[i + 2], c = n[i + 3], (a & 192) === 128 && (l & 192) === 128 && (c & 192) === 128 && (d = (u & 15) << 18 | (a & 63) << 12 | (l & 63) << 6 | c & 63, d > 65535 && d < 1114112 && (o = d));
      }
    }
...
(function(n, e) {
  (function(t, r) {
    ...
    var t = 1e3, r = 6e4, i = 36e5, u = "millisecond", o = "second", s = "minute", a = "hour", l = "day", c = "week", d = "month", f = "quarter", h = "year", g = "date", w = "Invalid Date", p = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, T = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, O = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(v) {
      ...
      return { M: d, y: h, w: c, d: l, D: g, h: a, m: s, s: o, ms: u, Q: f }[v] || String(v || "").toLowerCase().replace(/s$/, "");
    }, u: function(v) {
      return v === void 0;
    } }, L = "en", P = {};
    P[L] = O;
    ...
    var m = function() {
      ...
      return b.parse = function(y) {
        ...
        return _(y) < this.startOf(B);
      }, b.isBefore = function(y, B) {
        return this.endOf(B) < _(y);
      }, b.$g = function(y, B, k) {
        ...
        var k = this, S = !!M.u(B) || B, C = M.p(y), I = function(Ne, ne) {
          var Ae = M.w(k.$u ? Date.UTC(k.$y, ne, Ne) : new Date(k.$y, ne, Ne), k);
          return S ? Ae : Ae.endOf(l);
        }, H = function(Ne, ne) {
          return M.w(k.toDate()[Ne].apply(k.toDate("s"), (S ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(ne)), k);
        ...
        var k, S = M.p(y), C = "set" + (this.$u ? "UTC" : ""), I = (k = {}, k[l] = C + "Date", k[g] = C + "Date", k[d] = C + "Month", k[h] = C + "FullYear", k[a] = C + "Hours", k[s] = C + "Minutes", k[o] = C + "Seconds", k[u] = C + "Milliseconds", k)[S], H = S === l ? this.$D + (B - this.$W) : B;
        if (S === d || S === h) {
        ...
        var S = y || "YYYY-MM-DDTHH:mm:ssZ", C = M.z(this), I = this.$H, H = this.$m, G = this.$M, Z = k.weekdays, Ce = k.months, Ee = function(ne, Ae, lr, vt) {
          return ne && (ne[Ae] || ne(B, S)) || lr[Ae].slice(0, vt);
        }, Qe = function(ne) {
          return M.s(I % 12 || 12, ne, "0");
        }, Xe = k.meridiem || function(ne, Ae, lr) {
          var vt = ne < 12 ? "AM" : "PM";
          return lr ? vt.toLowerCase() : vt;
        }, Ne = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: G + 1, MM: M.s(G + 1, 2, "0"), MMM: Ee(k.monthsShort, G, Ce, 3), MMMM: Ee(Ce, G), D: this.$D, DD: M.s(this.$D, 2, "0"), d: String(this.$W), dd: Ee(k.weekdaysMin, this.$W, Z, 2), ddd: Ee(k.weekdaysShort, this.$W, Z, 3), dddd: Z[this.$W], H: String(I), HH: M.s(I, 2, "0"), h: Qe(1), hh: Qe(2), a: Xe(I, H, !0), A: Xe(I, H, !1), m: String(H), mm: M.s(H, 2, "0"), s: String(this.$s), ss: M.s(this.$s, 2, "0"), SSS: M.s(this.$ms, 3, "0"), Z: C };
        return S.replace(T, function(ne, Ae) {
          return Ae || Ne[ne] || C.replace(":", "");
        });
      }, b.utcOffset = function() {
        return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
      }, b.diff = function(y, B, k) {
        var S, C = M.p(B), I = _(y), H = (I.utcOffset() - this.utcOffset()) * r, G = this - I, Z = M.m(this, I);
        return Z = (S = {}, S[h] = Z / 12, S[d] = Z, S[f] = Z / 3, S[c] = (G - H) / 6048e5, S[l] = (G - H) / 864e5, S[a] = G / i, S[s] = G / r, S[o] = G / t, S)[C] || G, k ? Z : M.a(Z);
    ...
    return _.prototype = E, [["$ms", u], ["$s", o], ["$m", s], ["$H", a], ["$W", l], ["$M", d], ["$y", h], ["$D", g]].forEach(function(v) {
      E[v[1]] = function(b) {
        return this.$g(b, v[0], v[1]);
      };
    }), _.extend = function(v, b) {
      return v.$i || (v(b, m, _), v.$i = !0), _;
    }, _.locale = W, _.isDayjs = F, _.unix = function(v) {
      return _(1e3 * v);
...
var Un = (
  ...
  function() {
    function n(e, t, r, i) {
      if (t === void 0 && (t = dp), r === void 0 && (r = Ft), i === void 0 && (i = hp), this.text = [], this.language = r || Ft, this.gettext = t, this.dateFormatter = i, this.rrule = e, this.options = e.options, this.origOptions = e.origOptions, this.origOptions.bymonthday) {
...
function cu(n, e) {
  ...
  function i() {
    ...
    switch (r.symbol) {
      case "day(s)":
        t.freq = R.DAILY, r.nextSymbol() && (o(), d());
        break;
      case "weekday(s)":
        t.freq = R.WEEKLY, t.byweekday = [R.MO, R.TU, R.WE, R.TH, R.FR], r.nextSymbol(), d();
        break;
      case "week(s)":
        t.freq = R.WEEKLY, r.nextSymbol() && (u(), d());
        break;
      case "hour(s)":
        t.freq = R.HOURLY, r.nextSymbol() && (u(), d());
        break;
      case "minute(s)":
        t.freq = R.MINUTELY, r.nextSymbol() && (u(), d());
        break;
      case "month(s)":
        t.freq = R.MONTHLY, r.nextSymbol() && (u(), d());
        break;
      case "year(s)":
        t.freq = R.YEARLY, r.nextSymbol() && (u(), d());
        break;
      case "monday":
      case "tuesday":
      case "wednesday":
      ...
      case "sunday":
        ...
        if (t.byweekday = [R[h]], !r.nextSymbol())
          return;
        for (; r.accept("comma"); ) {
          if (r.isDone())
            throw new Error("Unexpected end");
          ...
          t.byweekday.push(R[g]), r.nextSymbol();
        }
        c(), d();
        break;
      case "january":
  ...
  function u() {
    ...
    if (f || h)
      do {
        var g = l(), w = a(), p = s();
        if (g)
          w ? (r.nextSymbol(), t.byweekday || (t.byweekday = []), t.byweekday.push(R[w].nth(g))) : (t.bymonthday || (t.bymonthday = []), t.bymonthday.push(g), r.accept("day(s)"));
        else if (w)
          r.nextSymbol(), t.byweekday || (t.byweekday = []), t.byweekday.push(R[w]);
        else if (r.symbol === "weekday(s)")
          r.nextSymbol(), t.byweekday || (t.byweekday = [R.MO, R.TU, R.WE, R.TH, R.FR]);
...
var gp = function(n, e) {
  return e === void 0 && (e = Ft), new R(cu(n, e) || void 0);
}, Ze = [
  "count",
  "until",
  "interval",
...
function Ep(n) {
  ...
  return e.map(function(t) {
    ...
    var i = Number(r[1]), u = r[2], o = fe[u].weekday;
    return new re(o, i);
  });
}
var qt = (
...
function Up(n, e) {
  ...
  for (var d = Math.floor(l / 7), f = le(l, 7), h = Math.floor(d + f / 4), g = 0; g < e.byweekno.length; g++) {
    var w = e.byweekno[g];
...
function jp(n, e, t, r, i, u) {
  ...
  for (var a = 0; a < s.length; a++)
    for (var l = s[a], c = l[0], d = l[1] - 1, f = 0; f < u.bynweekday.length; f++) {
      var h = void 0, g = u.bynweekday[f], w = g[0], p = g[1];
      p < 0 ? (h = d + (p + 1) * 7, h -= le(i[h] - w, 7)) : (h = c + (p - 1) * 7, h += le(7 - i[h] + w, 7)), c <= h && h <= d && (o.nwdaymask[h] = 1);
    }
  return o;
}
function Yp(n, e) {
  e === void 0 && (e = 0);
  var t = n % 19, r = Math.floor(n / 100), i = n % 100, u = Math.floor(r / 4), o = r % 4, s = Math.floor((r + 8) / 25), a = Math.floor((r - s + 1) / 3), l = Math.floor(19 * t + r - u - a + 15) % 30, c = Math.floor(i / 4), d = i % 4, f = Math.floor(32 + 2 * o + 2 * c - l - d) % 7, h = Math.floor((t + 11 * l + 22 * f) / 451), g = Math.floor((l + f - 7 * h + 114) / 31), w = (l + f - 7 * h + 114) % 31 + 1, p = Date.UTC(n, g - 1, w + e), T = Date.UTC(n, 0, 1);
...
var qp = (
  ...
  function() {
    ...
    return n.prototype.rebuild = function(e, t) {
      ...
      for (var r = this.mrange[t - 1], i = this.mrange[t], u = N(null, this.yearlen), o = r; o < i; o++)
        u[o] = o;
      return [u, r, i];
...
var fe = {
  ...
  function() {
    function n(e, t) {
      e === void 0 && (e = {}), t === void 0 && (t = !1), this._cache = t ? null : new Sp(), this.origOptions = fu(e);
...
function Jp(n, e, t, r, i, u) {
  ...
  function a(f, h) {
    t.forEach(function(g) {
      g.between(f, h, !0).forEach(function(w) {
        o[Number(w)] = !0;
      });
    });
  }
  i.forEach(function(f) {
    var h = new qt(f, u).rezonedDate();
    o[Number(h)] = !0;
  }), n.accept = function(f) {
    var h = Number(f);
...
function Vp(n, e) {
  ...
  return l.forEach(function(c) {
    var d;
    if (c) {
      var f = eg(c), h = f.name, g = f.parms, w = f.value;
...
function Zp(n, e) {
  ...
  if (e.compatible && (e.forceset = !0, e.unfold = !0), e.forceset || r.length > 1 || i.length || u.length || o.length) {
    ...
    return c.dtstart(s), c.tzid(a || void 0), r.forEach(function(f) {
      c.rrule(new R(fr(f, s, a), l));
    }), i.forEach(function(f) {
      c.rdate(f);
    }), u.forEach(function(f) {
      c.exrule(new R(fr(f, s, a), l));
...
const dg = [" ", ",", "?", "!", ";"], hg = new fg(20);
function pg(n, e, t) {
  e = e || "", t = t || "";
  const r = dg.filter((o) => e.indexOf(o) < 0 && t.indexOf(o) < 0);
...
class ri {
  ...
  formatLanguageCode(e) {
    if (typeof e == "string" && e.indexOf("-") > -1) {
      ...
      let r = e.split("-");
      return this.options.lowerCaseLng ? r = r.map((i) => i.toLowerCase()) : r.length === 2 ? (r[0] = r[0].toLowerCase(), r[1] = r[1].toUpperCase(), t.indexOf(r[1].toLowerCase()) > -1 && (r[1] = dr(r[1].toLowerCase()))) : r.length === 3 && (r[0] = r[0].toLowerCase(), r[1].length === 2 && (r[1] = r[1].toUpperCase()), r[0] !== "sgn" && r[2].length === 2 && (r[2] = r[2].toUpperCase()), t.indexOf(r[1].toLowerCase()) > -1 && (r[1] = dr(r[1].toLowerCase())), t.indexOf(r[2].toLowerCase()) > -1 && (r[2] = dr(r[2].toLowerCase()))), r.join("-");
    }
  ...
  nest(e, t) {
    ...
    function s(a, l) {
      ...
      try {
        ...
        return this.logger.warn(`failed parsing options string in nesting for key ${a}`, w), `${a}${c}${f}`;
      }
...
class Tg extends nr {
  ...
  queueLoad(e, t, r, i) {
    ...
    return e.forEach((l) => {
      ...
      t.forEach((d) => {
        const f = `${l}|${d}`;
        !r.reload && this.store.hasResourceBundle(l, d) ? this.state[f] = 2 : this.state[f] < 0 || (this.state[f] === 1 ? o[f] === void 0 && (o[f] = !0) : (this.state[f] = 1, c = !1, o[f] === void 0 && (o[f] = !0), u[f] === void 0 && (u[f] = !0), a[d] === void 0 && (a[d] = !0)));
      }), c || (s[l] = !0);
    ...
    if (!(r == null || r === "")) {
      if (this.backend && this.backend.create) {
        ...
        if (l.length < 6)
          try {
            let c;
            l.length === 5 ? c = l(e, t, r, i, a) : c = l(e, t, r, i), c && typeof c.then == "function" ? c.then((d) => s(null, d)).catch(s) : s(null, c);
          } catch (c) {
            s(c);
          }
        else
...
class lt extends nr {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      }), c && (!this.options.interpolation.format || this.options.interpolation.format === i.interpolation.format) && (f.formatter = u(c), f.formatter.init(f, this.options), this.options.interpolation.format = f.formatter.format.bind(f.formatter)), f.interpolator = new wg(this.options), f.utils = {
        hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
      }, f.backendConnector = new Tg(u(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", function(h) {
...
const mu = "No date selected", bu = "Choose another time slot to reschedule your meeting", yu = {
  ...
  cancelBokingFormError: Ll,
  default: Mg
}), _l = "Kein Datum ausgewählt", Nl = "Wählen Sie einen anderen Zeitpunkt, um Ihr Meeting neu zu planen", Ul = {
  sunday: "SO",
  monday: "MO",
  tuesday: "DI",
  wednesday: "MI",
  ...
  invalidTimeslotErrorMessage: _c,
  ...
  confirmBookingButton: wf,
  bookingPendingTitle: kf,
  bookingPendingnDescription: Ef,
  ...
  bookingRescheduled: wd,
  bookingDateAndTimeHeader: kd,
  cancelBookingButton: Ed,
...
class pe extends vm {
  ...
  normalize(e, t) {
    ...
    return e.map((i) => (i[hh] || pe.rebuild(i), i = i.proxyOf, i.parent && i.parent.removeChild(i), i[dh] && vh(i), typeof i.raws.before > "u" && t && typeof t.raws.before < "u" && (i.raws.before = t.raws.before.replace(/\S/g, "")), i.parent = this.proxyOf, i));
  }
  getProxyProcessor() {
    return {
      set(e, t, r) {
  ...
  return (e, t) => {
    ...
    n.eventToProps && Object.keys(n.eventToProps).forEach((a) => {
      ...
      const a = o == null ? void 0 : o.call(this), l = Rt(this), c = {
        ...
        ...n,
        eventToProps: s
      }, d = Rb(e, c, n.unregistrationEventName);
      return l.dispatchEvent(d) && te(`[${r}] Component ${r} successfully fired unregistration event`), a;
    });
  };
}
const Pb = ".sc-chevron-icon-h{display:flex}", Ib = Pb, Lb = Je(class extends Ve {
  ...
  render() {
    return A("svg", { key: "90d483478e14f04ab2793f5c922ccb87a8b1f1cc", xmlns: "http://www.w3.org/2000/svg", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none" }, A("path", { key: "b50664e82487982f62f962fd7e6586d2a68e42e9", fill: "currentColor", d: "M15.53 4.22a.75.75 0 0 1 0 1.06L8.81 12l6.72 6.72a.75.75 0 1 1-1.06 1.06l-7.25-7.25a.75.75 0 0 1 0-1.06l7.25-7.25a.75.75 0 0 1 1.06 0Z" }));
  }
  static get style() {
    return Ib;
  }
...
const Kb = '.tooltip-container{position:relative;display:flex;--nylas-primary:#2563eb;--nylas-error:#cc4841;--nylas-error-pressed:#992222;--nylas-wraning:#f06c00;--nylas-success:#16a392;--nylas-info:#2b8fc2;--nylas-base-0:#ffffff;--nylas-base-25:#fcfcfd;--nylas-base-50:#f8f9fc;--nylas-base-100:#eaecf5;--nylas-base-200:#d5d9eb;--nylas-base-300:#b3b8d8;--nylas-base-400:#717bbc;--nylas-base-500:#4e5ba6;--nylas-base-600:#3e4784;--nylas-base-700:#263f72;--nylas-base-800:#293056;--nylas-base-900:#101323;--nylas-base-950:#0e101b;--nylas-border-radius:0.25rem;--nylas-border-radius-2x:0.5rem;--nylas-border-radius-3x:0.75rem;--nylas-font-family:"Inter", sans-serif}.tooltip-content{visibility:hidden;background-color:var(--nylas-base-800);color:var(--nylas-base-0);text-align:left;border-radius:6px;padding:5px 0;position:absolute;z-index:1;opacity:0;transition:opacity 0.3s;padding:0.5rem 1rem;max-width:200px;width:max-content}.tooltip-content.top{bottom:0;left:0;margin-bottom:1.25rem;transform:translateX(-50%)}.tooltip-content.right{top:50%;left:0%;margin-left:1.25rem;transform:translateY(-50%)}.tooltip-content.bottom{top:0;left:0;margin-top:1.25rem;transform:translateX(-50%)}.tooltip-content.left{top:50%;right:0%;margin-right:1.25rem;transform:translateY(-50%)}.tooltip-container:hover .tooltip-content,.tooltip-container:focus-within .tooltip-content{visibility:visible;opacity:1}.tooltip-content::after{content:"";position:absolute;top:-0.75rem;left:50%;transform:rotate(180deg);border-width:6px;border-style:solid;border-color:black transparent transparent transparent}.tooltip-content.top::after{top:100%;left:50%;transform:rotate(0deg)}.tooltip-content.bottom::after{top:-0.75rem;left:50%;transform:rotate(180deg)}.tooltip-content.left::after{top:47.5%;left:100%;transform:rotate(270deg)}.tooltip-content.right::after{top:47.5%;left:-0.75rem;transform:rotate(90deg)}', Jb = Kb, Vb = Je(class extends Ve {
  ...
  render() {
    return A("div", { key: "39014243f733656bf550b9141eabd5c13e3c43d9", class: "tooltip-container", part: "tc__container" }, A("span", { key: "8b331b143065287a337e26a4680b3744ca8e2bc7", class: "info-icon", tabindex: "0", onFocus: this.showTooltip.bind(this), onBlur: this.hideTooltip.bind(this) }, A("slot", { key: "cf584033435cee5ca7143f5ee5fb983e3e9ab550", name: "tooltip-icon" }, "i")), A("span", { key: "409b87ee03bc5aa39fcaf965eca18d03f0ef1a44", class: `tooltip-content ${this.position}`, part: "tc__content" }, A("slot", { key: "00f5fa51bcf2cd31fac498f94a97ac67d5b7de3f", name: "tooltip-content" }, "This is a help text.")));
  }
  get el() {
    return this;
  }
...
const mn = Je(class extends Ve {
  ...
  componentDidLoad() {
    if (te("nylas-buffer-time", "componentDidLoad"), this.selectedConfiguration ? this.selectedConfigurationChangedHandler(this.selectedConfiguration) : (this.selectedBeforeBufferTime = this.buffer.before, this.selectedAfterBufferTime = this.buffer.after), this.componentLoaded = !0, typeof this.internals.setFormValue == "function") {
      const e = {
        before: this.selectedBeforeBufferTime,
        after: this.selectedAfterBufferTime
      };
      this.internals.setFormValue(JSON.stringify(e), this.name);
    }
  }
  componentWillUpdate() {
  ...
  selectedConfigurationChangedHandler(e) {
    ...
    const t = (i = (r = e == null ? void 0 : e.availability) == null ? void 0 : r.availability_rules) == null ? void 0 : i.buffer;
    this.selectedAfterBufferTime = t != null && t.after ? t.after : this.buffer.after, this.selectedBeforeBufferTime = t != null && t.before ? t.before : this.buffer.before;
  }
  nylasFormDropdownChangedHandler(e) {
    te("nylas-buffer-time", "nylasFormDropdownChangedHandler", e.detail);
    const t = (r) => {
      const { value: i, name: u } = r.detail;
      u === "before-buffer-time" ? this.selectedBeforeBufferTime = parseInt(i) : u === "after-buffer-time" && (this.selectedAfterBufferTime = parseInt(i));
      const o = {
        before: this.selectedBeforeBufferTime,
        after: this.selectedAfterBufferTime
      };
      this.internals.setFormValue(JSON.stringify(o), "booking-calendar");
    };
    this.valueChanged.emit({ ...e.detail, valueChanged: t });
  }
  renderPreview() {
    const i = (s) => {
      const a = Math.floor(s / 30), l = s % 30 / 30 * 10;
      return {
        fullSlots: a,
        partialFillHeight: l
      };
    }, u = () => {
      const { fullSlots: s, partialFillHeight: a } = i(this.selectedBeforeBufferTime);
      return Array.from({ length: 4 }, (l, c) => {
        const d = this.selectedBeforeBufferTime > 0 && c > 4 - s - 1, f = this.selectedBeforeBufferTime > 0 && c === 4 - s - 1 && a > 0;
        let h = {};
        return d && !f ? h.backgroundColor = "var(--nylas-base-100)" : f && (h.background = `linear-gradient(to top, var(--nylas-base-100) ${a}px, transparent 0)`), A("div", { key: c, class: `slot ${d ? "active" : ""}`, style: {
          height: "10px",
          ...h
        } });
      });
    }, o = () => {
      const { fullSlots: s, partialFillHeight: a } = i(this.selectedAfterBufferTime);
      return Array.from({ length: 4 }, (l, c) => {
        const d = this.selectedAfterBufferTime > 0 && c < s, f = c === s && a > 0;
        let h = {};
        return d && !f ? h.backgroundColor = "var(--nylas-base-100)" : f && (h.background = `linear-gradient(to bottom, var(--nylas-base-100) ${a}px, transparent 0)`), A("div", { key: c, class: `slot ${d ? "active" : ""}`, style: {
          height: "10px",
          ...h
        } });
      });
    };
    return A("div", { class: "preview-container" }, u(), A("div", { class: "event-slot", style: { height: "20px" } }), o());
  }
  render() {
    const e = Array.from({ length: 25 }, (t, r) => {
      const i = r * 5;
      return {
        label: i.toString(),
        value: i
