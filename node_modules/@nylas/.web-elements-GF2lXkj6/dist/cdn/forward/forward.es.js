...
const U = (e, t, ...n) => {
    ...
    if (t === "class") {
      ...
      if (t === "ref")
        ...
        if (t[2] === "-" ? t = t.slice(3) : te(D, c) ? t = c.slice(2) : t = c[2] + t.slice(3), n || s) {
          ...
          t = t.replace(Ce, ""), n && p.rel(e, t, n, i), s && p.ael(e, t, s, i);
        }
      } else {
        const i = z(s);
        if ((o || i && s !== null) && !l)
...
}, Fe = /\s/, Y = (e) => e ? e.split(Fe) : [], ie = "Capture", Ce = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  for (let s = t; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      ue(l), r && (C = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, Ue = (e, t, n, s, l = !1) => {
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (t = n[s], !t["s-cn"] && !t["s-nr"] && t["s-hn"] !== l["s-hn"] && !T.experimentalSlotFixes)
          if (Z(t, r)) {
            ...
            C = !0, t["s-sn"] = t["s-sn"] || r, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (t["s-sh"] = l["s-hn"], m.push({
              $slotRefNode$: l,
              $nodeToRelocate$: t
            })), t["s-sr"] && m.map((c) => {
  ...
  const l = w(e), r = e, o = l.$instanceValues$.get(t), c = l.$flags$, i = r;
...
}, it = (e) => nt().then(e), rt = /* @__PURE__ */ ot(ye, !0), ct = ".sc-forward-icon-h{display:flex}", $t = ct, at = Ke(class extends tt {
  constructor() {
    super(), this.__registerHost(), this.width = "15", this.height = "15";
  }
  render() {
    return U("svg", { key: "c8b018ea9d3c7e33125a3cab408be079b8091071", fill: "auto", width: this.width, height: this.height, viewBox: "0 0 1920 1920", xmlns: "http://www.w3.org/2000/svg" }, U("path", { key: "b1af6cc12e320cc77734d7ad77ac4d5149f7000d", d: "m1246.246 64-90.496 90.496 477.952 477.952h-590.848C467.878 632.448.038 1100.416.038 1675.392v109.056h128v-109.056c0-504.576 410.368-914.944 914.816-914.944h590.848l-477.952 478.08 90.496 90.496 632.448-632.576L1246.246 64Z", "fill-rule": "evenodd" }));
  }
  static get style() {
    return $t;
  }
