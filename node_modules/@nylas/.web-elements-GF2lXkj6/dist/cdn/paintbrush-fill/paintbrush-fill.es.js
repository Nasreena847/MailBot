...
let L, D, C, lt = !1, P = !1, W = !1, v = !1, I = null, M = !1;
const x = (t, e = "") => () => {
...
const H = (t, e, ...n) => {
...
}, _t = (t) => te.map((e) => e(t)).find((e) => !!e), Ct = (t, e) => t != null && !z(t) ? e & 4 ? t === "false" ? !1 : t === "" || !!t : e & 2 ? parseFloat(t) : e & 1 ? String(t) : t : t, K = /* @__PURE__ */ new WeakMap(), At = (t, e, n) => {
  let s = B.get(t);
  ...
  const e = t.$cmpMeta$, n = t.$hostElement$, s = e.$flags$, l = x("attachStyles", e.$tagName$), r = Rt(n.shadowRoot ? n.shadowRoot : n.getRootNode(), e, t.$modeName$);
  s & 10 && (n["s-sc"] = r, n.classList.add(r + "-h"), s & 2 && n.classList.add(r + "-s")), l();
}, ot = (t, e) => "sc-" + (e && t.$flags$ & 32 ? t.$tagName$ + "-" + e : t.$tagName$), Z = (t, e, n, s, l, r) => {
  if (n !== s) {
    ...
    if (e === "class") {
      ...
      if (e === "ref")
        ...
        if (e[2] === "-" ? e = e.slice(3) : et(w, c) ? e = c.slice(2) : e = c[2] + e.slice(3), n || s) {
...
}, Ft = /\s/, J = (t) => t ? t.split(Ft) : [], it = "Capture", Pt = new RegExp(it + "$"), rt = (t, e, n, s) => {
  ...
  if (lt || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? St : mt, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), rt(null, l, v), kt(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== C && l["s-ol"] && (at(l).insertBefore(l, q(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), e && A(l, e);
  }
  p.$flags$ &= -2;
}, ct = (t, e, n, s, l, r) => {
  ...
  for (let s = e; s <= n; ++s) {
    ...
    if (l) {
      const r = l.$elm$;
      ut(l), r && (P = !0, r["s-ol"] ? r["s-ol"].remove() : A(r, !0), r.remove());
    }
  }
}, Ht = (t, e, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = e[c], g.$tag$ !== a.$tag$ ? y = j(e && e[o], n, c, t) : (E(g, a, l), e[c] = void 0, y = g.$elm$), a = s[++o]) : (y = j(e && e[o], n, o, t), a = s[++o]), y && at(f.$elm$).insertBefore(y, q(f.$elm$));
    }
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || rt(t, e, v), l !== null && r !== null ? Ht(s, l, e, r, n) : r !== null ? (t.$text$ !== null && (s.textContent = ""), ct(s, null, e, r, 0, r.length - 1)) : l !== null && $t(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : t.$text$ !== c && (s.data = c);
}, ft = (t) => {
  ...
  var s, l, r, o, c;
  const i = t.$hostElement$, u = t.$cmpMeta$, f = t.$vnode$ || U(null, null), $ = xt(e) ? e : H(null, null, e);
  ...
  $.$tag$ = null, $.$flags$ |= 4, t.$vnode$ = $, $.$elm$ = f.$elm$ = i.shadowRoot || i, L = i["s-sc"], D = i["s-cr"], lt = (u.$flags$ & 1) !== 0, P = !1, E(f, $, n);
  {
    if (p.$flags$ |= 1, W) {
      dt($.$elm$);
      for (const d of m) {
...
}, ht = (t, e) => (t.$flags$ |= 16, jt(t, t.$ancestorComponent$), re(() => Bt(t, e))), Bt = (t, e) => {
  const n = t.$hostElement$, s = x("scheduleUpdate", t.$cmpMeta$.$tagName$), l = n;
  let r;
  return e ? r = _(l, "componentWillLoad") : r = _(l, "componentWillUpdate"), r = V(r, () => _(l, "componentWillRender")), s(), V(r, () => Dt(t, l, e));
  ...
  n && n.map(([l, r, o]) => {
    const c = Jt(t, l), i = Zt(e, o), u = Yt(l);
...
}, Jt = (t, e) => e & 4 ? S : e & 8 ? w : e & 16 ? S.body : t, Yt = (t) => se ? {
  passive: (t & 1) !== 0,
  capture: (t & 2) !== 0
...
}, et = (t, e) => e in t, O = (t, e) => (0, console.error)(t, e), B = /* @__PURE__ */ new Map(), te = [], w = typeof window < "u" ? window : {}, S = w.document || { head: {} }, ee = w.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (t) => t(),
...
}, ie = (t) => ne().then(t), re = /* @__PURE__ */ oe(yt, !0), ce = ".sc-paintbrush-fill-icon-h{display:flex}", $e = ce, ae = Kt(class extends ee {
  constructor() {
