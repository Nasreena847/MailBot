...
let L, H, A, lt = !1, U = !1, W = !1, v = !1, q = null, M = !1;
const x = (t, e = "") => () => {
...
const j = (t, e, ...n) => {
  ...
  if (t = t.nodeType === 11 ? t : S, r)
    if (typeof r == "string") {
      ...
      if (o || K.set(t, o = /* @__PURE__ */ new Set()), !o.has(l)) {
        ...
        e.$flags$ & 4 && (c.innerHTML += vt), o && o.add(l);
      }
  ...
  if (lt || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? St : kt, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), rt(null, l, v), mt(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== A && l["s-ol"] && (at(l).insertBefore(l, I(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), e && R(l, e);
  }
  p.$flags$ &= -2;
}, ct = (t, e, n, s, l, r) => {
  let o = t["s-cr"] && t["s-cr"].parentNode || t, c;
  for (o.shadowRoot && o.tagName === A && (o = o.shadowRoot); l <= r; ++l)
    s[l] && (c = P(null, n, l, t), c && (s[l].$elm$ = c, o.insertBefore(c, I(e))));
}, $t = (t, e, n) => {
  for (let s = e; s <= n; ++s) {
    const l = t[s];
    if (l) {
      const r = l.$elm$;
      ut(l), r && (U = !0, r["s-ol"] ? r["s-ol"].remove() : R(r, !0), r.remove());
    }
  }
}, jt = (t, e, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = e[c], g.$tag$ !== a.$tag$ ? y = P(e && e[o], n, c, t) : (E(g, a, l), e[c] = void 0, y = g.$elm$), a = s[++o]) : (y = P(e && e[o], n, o, t), a = s[++o]), y && at(f.$elm$).insertBefore(y, I(f.$elm$));
    }
  r > u ? ct(t, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && $t(e, r, u);
}, F = (t, e, n = !1) => t.$tag$ === e.$tag$ ? t.$tag$ === "slot" ? t.$name$ === e.$name$ : n ? !0 : t.$key$ === e.$key$ : !1, I = (t) => t && t["s-ol"] || t, at = (t) => (t["s-ol"] ? t["s-ol"] : t).parentNode, E = (t, e, n = !1) => {
  const s = e.$elm$ = t.$elm$, l = t.$children$, r = e.$children$, o = e.$tag$, c = e.$text$;
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || rt(t, e, v), l !== null && r !== null ? jt(s, l, e, r, n) : r !== null ? (t.$text$ !== null && (s.textContent = ""), ct(s, null, e, r, 0, r.length - 1)) : l !== null && $t(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : t.$text$ !== c && (s.data = c);
}, ft = (t) => {
      ...
      for (s = n.length - 1; s >= 0; s--)
        if (e = n[s], !e["s-cn"] && !e["s-nr"] && e["s-hn"] !== l["s-hn"] && !b.experimentalSlotFixes)
          if (Z(e, r)) {
            ...
            U = !0, e["s-sn"] = e["s-sn"] || r, o ? (o.$nodeToRelocate$["s-sh"] = l["s-hn"], o.$slotRefNode$ = l) : (e["s-sh"] = l["s-hn"], k.push({
              $slotRefNode$: l,
              $nodeToRelocate$: e
            })), e["s-sr"] && k.map((c) => {
  ...
  try {
    q = e, e = e.render && e.render(), t.$flags$ &= -17, t.$flags$ |= 2, (b.hasRenderFn || b.reflect) && (b.vdomRender || b.reflect) && (b.hydrateServerSide || wt(t, e, s));
  } catch (i) {
    C(i, t.$hostElement$);
  }
  return q = null, null;
  ...
  n && n.map(([l, r, o]) => {
    const c = Yt(t, l), i = Jt(e, o), u = Zt(l);
  ...
  return t;
})(), ne = (t) => Promise.resolve(t), le = /* @__PURE__ */ (() => {
  try {
...
}, ie = (t) => ne().then(t), re = /* @__PURE__ */ oe(yt, !0), ce = ".sc-italic-icon-h{display:flex}", $e = ce, ae = Kt(class extends ee {
  constructor() {
    super(), this.__registerHost(), this.width = "15", this.height = "15";
  }
  render() {
    return j("svg", { key: "42e08d459b503b00404ed6d853200439939d31c3", width: this.width, height: this.height, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, j("path", { key: "bf3ebd40f6ba15c02f132fcd0757b09d82ef031d", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "m10 20 4-16m2 0h-4m0 16H8" }));
  }
  static get style() {
    return $e;
  }
