...
let x, B, _, le = !1, H = !1, W = !1, v = !1, q = null, D = !1;
const b = (e, t = "") => () => {
...
const F = (e, t, ...n) => {
...
}, Me = /\s/, J = (e) => e ? e.split(Me) : [], ie = "Capture", He = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  for (let s = n.length - 1; s >= 0; s--) {
    const l = n[s];
    l["s-hn"] !== _ && l["s-ol"] && ($e(l).insertBefore(l, Z(l)), l["s-ol"].remove(), l["s-ol"] = void 0, l["s-sh"] = void 0, W = !0), t && A(l, t);
  }
  p.$flags$ &= -2;
}, ce = (e, t, n, s, l, r) => {
  let o = e["s-cr"] && e["s-cr"].parentNode || e, c;
  for (o.shadowRoot && o.tagName === _ && (o = o.shadowRoot); l <= r; ++l)
    s[l] && (c = P(null, n, l, e), c && (s[l].$elm$ = c, o.insertBefore(c, Z(t))));
}, ae = (e, t, n) => {
  for (let s = t; s <= n; ++s) {
    const l = e[s];
    if (l) {
      const r = l.$elm$;
      ue(l), r && (H = !0, r["s-ol"] ? r["s-ol"].remove() : A(r, !0), r.remove());
    }
  }
}, Fe = (e, t, n, s, l = !1) => {
  ...
  for (; r <= u && o <= d; )
    if (f == null)
      ...
      c >= 0 ? (g = t[c], g.$tag$ !== $.$tag$ ? y = P(t && t[o], n, c, e) : (L(g, $, l), t[c] = void 0, y = g.$elm$), $ = s[++o]) : (y = P(t && t[o], n, o, e), $ = s[++o]), y && $e(f.$elm$).insertBefore(y, Z(f.$elm$));
    }
  r > u ? ce(e, s[d + 1] == null ? null : s[d + 1].$elm$, n, s, o, d) : o > d && ae(t, r, u);
}, M = (e, t, n = !1) => e.$tag$ === t.$tag$ ? e.$tag$ === "slot" ? e.$name$ === t.$name$ : n ? !0 : e.$key$ === t.$key$ : !1, Z = (e) => e && e["s-ol"] || e, $e = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode, L = (e, t, n = !1) => {
  const s = t.$elm$ = e.$elm$, l = e.$children$, r = t.$children$, o = t.$tag$, c = t.$text$;
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || re(e, t, v), l !== null && r !== null ? Fe(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), ce(s, null, t, r, 0, r.length - 1)) : l !== null && ae(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, fe = (e) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || U(null, null), a = be(t) ? t : F(null, null, t);
  ...
  a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = f.$elm$ = i.shadowRoot || i, x = i["s-sc"], B = i["s-cr"], le = (u.$flags$ & 1) !== 0, H = !1, L(f, a, n);
  {
    if (p.$flags$ |= 1, W) {
      de(a.$elm$);
      for (const d of m) {
    ...
    H && fe(a.$elm$), p.$flags$ &= -2, m.length = 0;
  }
