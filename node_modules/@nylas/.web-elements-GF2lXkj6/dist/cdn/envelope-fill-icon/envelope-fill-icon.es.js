...
}, pe = (e, t) => (e.$flags$ |= 16, we(e, e.$ancestorComponent$), ct(() => De(e, t))), De = (e, t) => {
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), w = /* @__PURE__ */ new Map(), tt = [], D = typeof window < "u" ? window : {}, S = D.document || { head: {} }, st = D.HTMLElement || class {
}, h = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-envelope-fill-icon-h{display:flex}", at = $t, ve = Ze(class extends st {
  constructor() {
