...
const j = (e, t, ...n) => {
...
}, Fe = /\s/, Y = (e) => e ? e.split(Fe) : [], ie = "Capture", je = new RegExp(ie + "$"), re = (e, t, n, s) => {
  ...
  if (le || (W = !0, l.$tag$ === "slot" && (L && s.classList.add(L + "-s"), l.$flags$ |= l.$children$ ? (
    ...
    if (v || (v = l.$tag$ === "svg"), o = l.$elm$ = S.createElementNS(v ? ke : me, l.$flags$ & 2 ? "slot-fb" : l.$tag$), v && l.$tag$ === "foreignObject" && (v = !1), re(null, l, v), Te(L) && o["s-si"] !== L && o.classList.add(o["s-si"] = L), l.$children$)
  ...
  let i;
  c === null ? (v = o === "svg" ? !0 : o === "foreignObject" ? !1 : v, o === "slot" || re(e, t, v), l !== null && r !== null ? we(s, l, t, r, n) : r !== null ? (e.$text$ !== null && (s.textContent = ""), ce(s, null, t, r, 0, r.length - 1)) : l !== null && $e(l, 0, l.length - 1), v && o === "svg" && (v = !1)) : (i = s["s-cr"]) ? i.parentNode.textContent = c : e.$text$ !== c && (s.data = c);
}, fe = (e) => {
  ...
  var s, l, r, o, c;
  const i = e.$hostElement$, u = e.$cmpMeta$, f = e.$vnode$ || w(null, null), $ = Le(t) ? t : j(null, null, t);
...
}, he = (e, t) => (e.$flags$ |= 16, Pe(e, e.$ancestorComponent$), ct(() => Be(e, t))), Be = (e, t) => {
...
}, te = (e, t) => t in e, O = (e, t) => (0, console.error)(e, t), P = /* @__PURE__ */ new Map(), tt = [], B = typeof window < "u" ? window : {}, S = B.document || { head: {} }, st = B.HTMLElement || class {
}, p = {
  $flags$: 0,
  $resourcesUrl$: "",
  jmp: (e) => e(),
...
}, rt = (e) => lt().then(e), ct = /* @__PURE__ */ it(ye, !0), $t = ".sc-underline-icon-h{display:flex}", at = $t, ve = Je(class extends st {
  constructor() {
