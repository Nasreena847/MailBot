...
.nylas-event-duration label span.required {
  color: var(--nylas-error, #cc4841);
}
.nylas-event-duration label span.label-icon {
  margin-left: 4px;
}
.nylas-event-duration label span.label-icon tooltip-component {
  display: flex;
}
...
.nylas-event-duration__wrapper input {
  padding: 12px 16px;
  border-width: 1;
  border-radius: 8px;
...
.nylas-event-duration__wrapper input-dropdown::part(id_dropdown-input) {
  border: 1px solid var(--nylas-base-200);
  border-radius: var(--nylas-border-radius-2x);
  padding: 14px 16px;
  width: 50px;
}
.nylas-event-duration__wrapper input-dropdown::part(id_dropdown-content) {
  width: 100%;
  min-width: unset;
  height: 200px;
}
.nylas-event-duration__wrapper select-dropdown {
  width: 120px;
}
...
.nylas-event-duration__wrapper select-dropdown::part(sd_dropdown-button) {
  border: 1px solid var(--nylas-base-200);
}