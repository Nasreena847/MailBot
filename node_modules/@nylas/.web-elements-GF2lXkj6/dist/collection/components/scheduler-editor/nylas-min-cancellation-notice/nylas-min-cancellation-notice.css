...
.nylas-min-cancellation-notice label {
  display: flex;
  align-items: center;
...
.nylas-min-cancellation-notice label span.label-icon {
  margin-left: 4px;
}
.nylas-min-cancellation-notice label span.label-icon tooltip-component {
  display: flex;
}
