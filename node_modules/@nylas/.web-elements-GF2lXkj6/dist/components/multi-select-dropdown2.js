...
const MultiSelectDropdown = proxyCustomElement(class MultiSelectDropdown extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'cecb77880fd937e5845868c7cae0d9e341991088' }, h("div", { key: '3d6acf55e72e25e411812f2fd887678bb332ef16', class: "dropdown", part: "msd_dropdown" }, h("label", { key: 'c509b2157684148c0ee0d33f9a2de999d4e05945', class: "dropdown-label" }, this.label, h("slot", { key: '568acd93a920e4538350a56c2cef04a67fa07dc7', name: "label-icon", "aria-hidden": "true" })), h("button", { key: '036bf6146c9071cb369f95ec3e60ea6d8cf12d1a', name: this.name, part: `msd_dropdown-button ${this.error ? 'msd_dropdown-button--error' : ''}`, class: { dropbtn: true, open: this.isOpen, error: !!this.error }, onClick: () => this.toggleDropdown(), "aria-haspopup": "listbox", "aria-expanded": this.isOpen ? 'true' : 'false', "aria-label": this.name, onKeyDown: e => this.handleSelectButtonKeyDown(e) }, h("slot", { key: '4760a3c065fa4f0af09cf11326423aacf5511066', name: "select-icon", "aria-hidden": "true" }), h("span", { key: '4edd567dc3f25451a4f0cbddb02391bde5fc56fd', class: "selected-option", part: "msd_dropdown-button-selected-label" }, this.getSelectedOptions().length > 1 ? `Multiple options selected` : this.availableOptions.filter(o => o.selected)[0]?.label ?? this.availableOptions[0]?.label), h("span", { key: '6ae9028141f44f16dc56ecd294a2acc3db9a01d5', class: this.isOpen ? 'open' : 'closed', "aria-hidden": "true" }, h("chevron-icon", { key: '7381625a3b7a961a125d91a27e7b96e4754fb0a1', width: "16", height: "16" }))), this.error ? h("span", { class: "error" }, this.error) : null, this.isOpen ? null : (h("div", { class: 'selected-options' }, this.getSelectedOptions().map(option => (h("span", { class: "selected-option" }, option.label, h("button", { key: option.label, onClick: () => this.selectOption(option) }, h("close-icon", null))))))), this.isOpen ? (h("div", { class: "dropdown-content", part: "msd_dropdown-content" }, h("ul", { tabindex: "-1", role: "listbox", "aria-label": this.name, "aria-multiselectable": true, "aria-activedescendant": this.ariaActivedescendant, onKeyDown: e => this.handleListboxKeydown(e) }, this.availableOptions.map(option => this.renderOption(option))))) : null)));
    }
    get el() { return this; }
