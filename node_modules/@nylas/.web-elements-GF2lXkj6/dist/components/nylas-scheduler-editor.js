...
import { d as dataResponse, a as debug, N as Buffer, O as process, h as commonjsGlobal } from './utils.js';
import { C as CreateNylasSchedulerConfigStore } from './scheduler-config-store.js';
import { d as defineCustomElement$1g } from './add-circle.js';
import { d as defineCustomElement$1f } from './button-component2.js';
import { d as defineCustomElement$1e } from './calendar-agenda-fill.js';
import { d as defineCustomElement$1d } from './calendar-agenda.js';
import { d as defineCustomElement$1c } from './calendar.js';
...
import { d as defineCustomElement$13 } from './delete.js';
import { d as defineCustomElement$12 } from './dragable.js';
import { d as defineCustomElement$11 } from './edit.js';
import { d as defineCustomElement$10 } from './envelope-fill.js';
import { d as defineCustomElement$$ } from './envelope.js';
import { d as defineCustomElement$_ } from './eye.js';
import { d as defineCustomElement$Z } from './flow.js';
import { d as defineCustomElement$Y } from './globe.js';
import { d as defineCustomElement$X } from './google-logo.js';
import { d as defineCustomElement$W } from './google-meet.js';
import { d as defineCustomElement$V } from './info.js';
import { d as defineCustomElement$U } from './input-component2.js';
import { d as defineCustomElement$T } from './input-dropdown2.js';
import { d as defineCustomElement$S } from './input-image-url2.js';
import { d as defineCustomElement$R } from './loading.js';
import { d as defineCustomElement$Q } from './location.js';
import { d as defineCustomElement$P } from './location-off.js';
import { d as defineCustomElement$O } from './microsoft-logo.js';
import { d as defineCustomElement$N } from './microsof-teams.js';
import { d as defineCustomElement$M } from './multi-select-dropdown2.js';
import { d as defineCustomElement$L } from './nylas-additional-participants2.js';
import { d as defineCustomElement$K } from './nylas-availability-picker2.js';
import { d as defineCustomElement$J } from './nylas-booking-calendar-picker2.js';
import { d as defineCustomElement$I } from './nylas-booking-confirmation-redirect2.js';
import { d as defineCustomElement$H } from './nylas-booking-confirmation-type2.js';
import { d as defineCustomElement$G } from './nylas-booking-form-config2.js';
import { d as defineCustomElement$F } from './nylas-buffer-time2.js';
import { d as defineCustomElement$E } from './nylas-calendar-picker2.js';
import { d as defineCustomElement$D } from './nylas-cancellation-policy2.js';
import { d as defineCustomElement$C } from './nylas-confirmation-email2.js';
import { d as defineCustomElement$B } from './nylas-connected-calendars2.js';
import { d as defineCustomElement$A } from './nylas-custom-booking-flow2.js';
import { d as defineCustomElement$z } from './nylas-custom-event-slug2.js';
import { d as defineCustomElement$y } from './nylas-customize-booking-settings2.js';
import { d as defineCustomElement$x } from './nylas-editor-tabs2.js';
import { d as defineCustomElement$w } from './nylas-event-description2.js';
import { d as defineCustomElement$v } from './nylas-event-duration2.js';
import { d as defineCustomElement$u } from './nylas-event-info2.js';
import { d as defineCustomElement$t } from './nylas-event-limits2.js';
import { d as defineCustomElement$s } from './nylas-event-location2.js';
import { d as defineCustomElement$r } from './nylas-event-title2.js';
import { d as defineCustomElement$q } from './nylas-form-card2.js';
import { d as defineCustomElement$p } from './nylas-limit-future-bookings2.js';
import { d as defineCustomElement$o } from './nylas-list-configurations2.js';
import { d as defineCustomElement$n } from './nylas-min-booking-notice2.js';
import { d as defineCustomElement$m } from './nylas-min-cancellation-notice2.js';
import { d as defineCustomElement$l } from './nylas-page-name2.js';
import { d as defineCustomElement$k } from './nylas-page-styling2.js';
import { d as defineCustomElement$j } from './nylas-participant-booking-calendars2.js';
import { d as defineCustomElement$i } from './nylas-participants-custom-availability2.js';
...
function defineCustomElement$1() {
    ...
    const components = ["nylas-scheduler-editor", "add-circle-icon", "button-component", "calendar-agenda-fill-icon", "calendar-agenda-icon", "calendar-icon", "calendar-info-icon", "calendar-patterns-icon", "checkbox-component", "checkmark-icon", "chevron-icon", "clock-icon", "close-icon", "copy-icon", "delete-icon", "dragable-icon", "edit-icon", "envelope-fill-icon", "envelope-icon", "eye-icon", "flow-icon", "globe-icon", "google-logo-icon", "google-meet-icon", "info-icon", "input-component", "input-dropdown", "input-image-url", "loading-icon", "location-icon", "location-off-icon", "microsoft-logo-icon", "microsoft-teams-icon", "multi-select-dropdown", "nylas-additional-participants", "nylas-availability-picker", "nylas-booking-calendar-picker", "nylas-booking-confirmation-redirect", "nylas-booking-confirmation-type", "nylas-booking-form-config", "nylas-buffer-time", "nylas-calendar-picker", "nylas-cancellation-policy", "nylas-confirmation-email", "nylas-connected-calendars", "nylas-custom-booking-flow", "nylas-custom-event-slug", "nylas-customize-booking-settings", "nylas-editor-tabs", "nylas-event-description", "nylas-event-duration", "nylas-event-info", "nylas-event-limits", "nylas-event-location", "nylas-event-title", "nylas-form-card", "nylas-limit-future-bookings", "nylas-list-configurations", "nylas-min-booking-notice", "nylas-min-cancellation-notice", "nylas-page-name", "nylas-page-styling", "nylas-participant-booking-calendars", "nylas-participants-custom-availability", "nylas-scheduling-method", "nylas-time-window-picker", "nylas-timeslot-interval", "paintbrush-fill-icon", "paintbrush-icon", "people-icon", "person-clipboard-icon", "plus-icon", "radio-button-group", "search-icon", "select-dropdown", "textarea-component", "time-period-selector", "toggle-switch", "tooltip-component", "zoom-icon"];
