...
import { d as defineCustomElement$8 } from './add-circle.js';
import { d as defineCustomElement$7 } from './chevron.js';
import { d as defineCustomElement$6 } from './close.js';
import { d as defineCustomElement$5 } from './dragable.js';
...
function defineCustomElement() {
    ...
    const components = ["nylas-booking-form-config", "add-circle-icon", "chevron-icon", "close-icon", "dragable-icon", "input-component", "plus-icon", "search-icon", "select-dropdown"];
