...
import { a as debug, n as instance, P as compactStringToUUIDs, u as addDaysToCurrentDate, o as capitalizeFirstLetter } from './utils.js';
import { N as NylaSchedulerAPIConnector, E as ErrorCategory, C as CreateNylasSchedulerStore } from './scheduler-store.js';
import { e as LANGUAGE_CODE, L as LANGUAGE_CODE_MAP } from './constants.js';
import { d as defineCustomElement$z } from './add-circle.js';
import { d as defineCustomElement$y } from './button-component2.js';
import { d as defineCustomElement$x } from './calendar-cancel.js';
import { d as defineCustomElement$w } from './calendar-check.js';
import { d as defineCustomElement$v } from './calendar.js';
import { d as defineCustomElement$u } from './checkbox-component2.js';
import { d as defineCustomElement$t } from './checkmark-circle.js';
import { d as defineCustomElement$s } from './chevron.js';
import { d as defineCustomElement$r } from './clock.js';
import { d as defineCustomElement$q } from './close.js';
import { d as defineCustomElement$p } from './globe.js';
import { d as defineCustomElement$o } from './info.js';
import { d as defineCustomElement$n } from './input-component2.js';
import { d as defineCustomElement$m } from './loading.js';
import { d as defineCustomElement$l } from './nylas-booked-event-card2.js';
import { d as defineCustomElement$k } from './nylas-booking-form2.js';
import { d as defineCustomElement$j } from './nylas-cancel-booking-form2.js';
import { d as defineCustomElement$i } from './nylas-cancelled-event-card2.js';
import { d as defineCustomElement$h } from './nylas-confirmed-event-card2.js';
import { d as defineCustomElement$g } from './nylas-date-picker2.js';
...
const NylasScheduling$1 = proxyCustomElement(class NylasScheduling extends HTMLElement {
    ...
    static get style() { return nylasSchedulingCss; }
        ...
        "getRef": [64]
    }, [[0, "languageChanged", "languageChanged"], [0, "registerComponent", "registerComponentHandler"], [0, "unregisterComponent", "unregisterComponentHandler"], [0, "monthChanged", "monthChangedHandler"], [0, "detailsConfirmed", "bookButtonClickedHandler"], [0, "dateSelected", "dateSelectedHandler"], [0, "cancelBookedEventError", "cancelBookedEventErrorHandler"], [0, "cancelBookedEventValidationError", "cancelBookedEventValidationErrorHandler"], [0, "rescheduleBookedEventError", "rescheduleBookedEventErrorHandler"], [0, "confirmBookingError", "confirmBookingErrorHandler"]], {
        "bookingInfo": ["bookingInfoChanged"],
        "rescheduleBookingRef": ["rescheduleBookingRefChanged"],
        "cancelBookingRef": ["cancelBookingRefChanged"],
        "organizerConfirmationBookingRef": ["organizerConfirmationBookingRefChanged"],
...
function defineCustomElement$1() {
    ...
    const components = ["nylas-scheduling", "add-circle-icon", "button-component", "calendar-cancel-icon", "calendar-check-icon", "calendar-icon", "checkbox-component", "checkmark-circle-icon", "chevron-icon", "clock-icon", "close-icon", "globe-icon", "info-icon", "input-component", "loading-icon", "nylas-booked-event-card", "nylas-booking-form", "nylas-cancel-booking-form", "nylas-cancelled-event-card", "nylas-confirmed-event-card", "nylas-date-picker", "nylas-locale-switch", "nylas-logo", "nylas-notification", "nylas-organizer-confirmation-card", "nylas-selected-event-card", "nylas-timeslot-picker", "person-icon", "radio-button-group", "search-icon", "select-dropdown", "textarea-component", "tooltip-component", "translate-icon", "warning-icon"];
