...
import { a as debug, D as parsePreviewLink } from './utils.js';
import { d as defineCustomElement$a } from './button-component2.js';
import { d as defineCustomElement$9 } from './calendar.js';
...
function defineCustomElement() {
    ...
    const components = ["nylas-list-configurations", "button-component", "calendar-icon", "chevron-icon", "copy-icon", "delete-icon", "edit-icon", "eye-icon", "loading-icon", "search-icon", "select-dropdown"];
