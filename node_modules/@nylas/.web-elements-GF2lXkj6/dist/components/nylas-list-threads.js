...
import { a as debug, I as formatParticipants, J as formatDateTime } from './utils.js';
...
const NylasListThreads$1 = proxyCustomElement(class NylasListThreads extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h(Host, { key: 'd816c7e52e789537b3dacded7568af8edc55187a' }, h("div", { key: '4416ef73829c085f716af0114a34c971914d1452', class: 'list-thread', part: "list-thread" }, this.state === 'loading' && new Array(10).fill(0).map((_, i) => h("div", { class: "thread loading", style: { animationDelay: `${i * 20}ms` } })), this.state === 'ready' &&
    ...
    static get style() { return nylasListThreadsCss; }
...
], NylasListThreads$1.prototype, "render", null);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["nylas-list-threads"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-list-threads":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasListThreads$1);
            }
            break;
    } });
}

const NylasListThreads = NylasListThreads$1;
const defineCustomElement = defineCustomElement$1;

export { NylasListThreads, defineCustomElement };
