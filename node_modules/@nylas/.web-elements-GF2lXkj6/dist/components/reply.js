...
const ReplyIcon = proxyCustomElement(class ReplyIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '15';
    ...
    components.forEach(tagName => { switch (tagName) {
        case "reply-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ReplyIcon);
            }
            break;
    } });
}

export { ReplyIcon as R, defineCustomElement as d };
