import { proxyCustomElement, HTMLElement as HTMLElement$1, h, Host, Fragment } from '@stencil/core/internal/client';
import { a as debug, h as commonjsGlobal, R as detectIfMessageIsHTML, S as detectHTMLOrPlainText, T as parsePlainTextToHTML } from './utils.js';
...
const NylasViewEmail = proxyCustomElement(class NylasViewEmail extends HTMLElement$1 {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasViewEmailCss; }
}, [1, "nylas-view-email", {
        "message": [16],
        "parent": [16],
        "attachments": [16],
        "detectDarkMode": [4, "detect-dark-mode"],
        "state": [32],
        "sanitizedBody": [32],
        "styles": [32],
        "viewEmailElement": [32],
        "hoistedFontURLs": [32]
    }, [[9, "resize", "handleScroll"]], {
        "message": ["messageChanged"],
        "viewEmailElement": ["viewEmailElementChanged"]
    }]);
function defineCustomElement() {
    ...
    const components = ["nylas-view-email"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-view-email":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasViewEmail);
            }
            break;
    } });
}

export { NylasViewEmail as N, defineCustomElement as d };

//# sourceMappingURL=nylas-view-email2.js.map