...
import { a as debug, G as toTitleCase, H as formatFolderName } from './utils.js';
...
import { d as defineCustomElement$2 } from './trash-fill.js';
...
function defineCustomElement$1() {
    ...
    const components = ["nylas-list-folders", "archive-icon", "folder-icon", "inbox-icon", "sent-icon", "spam-icon", "star-icon", "trash-fill-icon"];
