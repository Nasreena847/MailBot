...
import { R as REMINDER_MINUTE_OPTIONS, c as REMINDER_HOUR_OPTIONS, d as REMINDER_DAY_OPTIONS } from './constants.js';
...
const NylasReminderTime = proxyCustomElement(class NylasReminderTime extends HTMLElement {
    ...
    static get style() { return nylasReminderTimeCss; }
        ...
        "reminderTime": [32],
        "reminderTimeMinutes": [32],
        "reminderTimeincrement": [32],
...
function defineCustomElement() {
    ...
    const components = ["nylas-reminder-time", "chevron-icon", "input-dropdown", "search-icon", "select-dropdown"];
