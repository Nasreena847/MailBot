...
const RefreshIcon = proxyCustomElement(class RefreshIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.width = '15';
    ...
    components.forEach(tagName => { switch (tagName) {
        case "refresh-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RefreshIcon);
            }
            break;
    } });
}

export { RefreshIcon as R, defineCustomElement as d };
