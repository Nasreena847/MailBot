...
import { a as debug, C as mergeDeep, D as parsePreviewLink } from './utils.js';
import { D as DEFAULT_OPEN_HOURS } from './constants.js';
import { d as defineCustomElement$18 } from './add-circle.js';
import { d as defineCustomElement$17 } from './button-component2.js';
import { d as defineCustomElement$16 } from './calendar-agenda-fill.js';
import { d as defineCustomElement$15 } from './calendar-agenda.js';
import { d as defineCustomElement$14 } from './calendar-info.js';
import { d as defineCustomElement$13 } from './calendar-patterns.js';
import { d as defineCustomElement$12 } from './checkbox-component2.js';
import { d as defineCustomElement$11 } from './checkmark.js';
import { d as defineCustomElement$10 } from './chevron.js';
import { d as defineCustomElement$$ } from './clock.js';
import { d as defineCustomElement$_ } from './close.js';
import { d as defineCustomElement$Z } from './copy.js';
import { d as defineCustomElement$Y } from './dragable.js';
import { d as defineCustomElement$X } from './edit.js';
import { d as defineCustomElement$W } from './envelope-fill.js';
import { d as defineCustomElement$V } from './envelope.js';
import { d as defineCustomElement$U } from './flow.js';
import { d as defineCustomElement$T } from './globe.js';
import { d as defineCustomElement$S } from './google-meet.js';
import { d as defineCustomElement$R } from './info.js';
import { d as defineCustomElement$Q } from './input-component2.js';
import { d as defineCustomElement$P } from './input-dropdown2.js';
import { d as defineCustomElement$O } from './input-image-url2.js';
import { d as defineCustomElement$N } from './loading.js';
import { d as defineCustomElement$M } from './location.js';
import { d as defineCustomElement$L } from './location-off.js';
import { d as defineCustomElement$K } from './microsof-teams.js';
import { d as defineCustomElement$J } from './multi-select-dropdown2.js';
import { d as defineCustomElement$I } from './nylas-additional-participants2.js';
import { d as defineCustomElement$H } from './nylas-availability-picker2.js';
import { d as defineCustomElement$G } from './nylas-booking-calendar-picker2.js';
import { d as defineCustomElement$F } from './nylas-booking-confirmation-redirect2.js';
import { d as defineCustomElement$E } from './nylas-booking-confirmation-type2.js';
import { d as defineCustomElement$D } from './nylas-booking-form-config2.js';
import { d as defineCustomElement$C } from './nylas-buffer-time2.js';
import { d as defineCustomElement$B } from './nylas-calendar-picker2.js';
import { d as defineCustomElement$A } from './nylas-cancellation-policy2.js';
import { d as defineCustomElement$z } from './nylas-confirmation-email2.js';
import { d as defineCustomElement$y } from './nylas-connected-calendars2.js';
import { d as defineCustomElement$x } from './nylas-custom-booking-flow2.js';
import { d as defineCustomElement$w } from './nylas-custom-event-slug2.js';
import { d as defineCustomElement$v } from './nylas-customize-booking-settings2.js';
import { d as defineCustomElement$u } from './nylas-event-description2.js';
import { d as defineCustomElement$t } from './nylas-event-duration2.js';
import { d as defineCustomElement$s } from './nylas-event-info2.js';
import { d as defineCustomElement$r } from './nylas-event-limits2.js';
import { d as defineCustomElement$q } from './nylas-event-location2.js';
import { d as defineCustomElement$p } from './nylas-event-title2.js';
import { d as defineCustomElement$o } from './nylas-form-card2.js';
import { d as defineCustomElement$n } from './nylas-limit-future-bookings2.js';
import { d as defineCustomElement$m } from './nylas-min-booking-notice2.js';
import { d as defineCustomElement$l } from './nylas-min-cancellation-notice2.js';
import { d as defineCustomElement$k } from './nylas-page-name2.js';
import { d as defineCustomElement$j } from './nylas-page-styling2.js';
import { d as defineCustomElement$i } from './nylas-participant-booking-calendars2.js';
import { d as defineCustomElement$h } from './nylas-participants-custom-availability2.js';
import { d as defineCustomElement$g } from './nylas-scheduling-method2.js';
import { d as defineCustomElement$f } from './nylas-time-window-picker2.js';
import { d as defineCustomElement$e } from './nylas-timeslot-interval2.js';
import { d as defineCustomElement$d } from './paintbrush-fill.js';
import { d as defineCustomElement$c } from './paintbrush.js';
import { d as defineCustomElement$b } from './people.js';
import { d as defineCustomElement$a } from './person-clipboard.js';
import { d as defineCustomElement$9 } from './plus.js';
...
import { d as defineCustomElement$4 } from './time-period-selector2.js';
import { d as defineCustomElement$3 } from './toggle-switch2.js';
...
function TabContents({ id, formState, activeTab }, children) {
    return (h(Fragment, null,
        ...
        h("div", { key: `availability-${id}`, class: { hide: activeTab !== Tab.Availability } },
            h("nylas-participant-booking-calendars", { participants: formState.participants, name: "participant-booking-calendars" }),
            h("nylas-connected-calendars", { participants: formState.participants, name: "connected-calendars" }),
            h("nylas-availability-picker", { name: "availability", exportparts: 'nap__header, nap__select-timezone, nap__select-timezone-button, nap__select-timezone-dropdown-content, nap__availability, nap__day, nap__time-ranges, nap__time-range, nap__add-time-range, nap__time-picker-container, nap__time-picker-input, nap__time-picker-times' })),
        h("div", { key: `booking-options-${id}`, class: { hide: activeTab !== Tab.BookingOptions } },
            ...
            h("nylas-custom-booking-flow", null,
                h("div", { slot: "inputs" },
        ...
        h("div", { key: `communications-${id}`, class: { hide: activeTab !== Tab.Communications } },
            h("div", { class: "tab-header" },
                h("h3", null, "Event communications"),
                h("p", null, "Set up automatic confirmation emails.")),
        ...
        h("div", { key: `participants-${id}`, class: { hide: activeTab !== Tab.Participants } },
            h("nylas-additional-participants", { name: "participants", exportparts: "nap__title, nap__subtitle, nap__content, nap__input_group, nap__input_wrapper, nap__input, nap__remove-participant" }),
...
function defineCustomElement() {
    ...
    const components = ["nylas-editor-tabs", "add-circle-icon", "button-component", "calendar-agenda-fill-icon", "calendar-agenda-icon", "calendar-info-icon", "calendar-patterns-icon", "checkbox-component", "checkmark-icon", "chevron-icon", "clock-icon", "close-icon", "copy-icon", "dragable-icon", "edit-icon", "envelope-fill-icon", "envelope-icon", "flow-icon", "globe-icon", "google-meet-icon", "info-icon", "input-component", "input-dropdown", "input-image-url", "loading-icon", "location-icon", "location-off-icon", "microsoft-teams-icon", "multi-select-dropdown", "nylas-additional-participants", "nylas-availability-picker", "nylas-booking-calendar-picker", "nylas-booking-confirmation-redirect", "nylas-booking-confirmation-type", "nylas-booking-form-config", "nylas-buffer-time", "nylas-calendar-picker", "nylas-cancellation-policy", "nylas-confirmation-email", "nylas-connected-calendars", "nylas-custom-booking-flow", "nylas-custom-event-slug", "nylas-customize-booking-settings", "nylas-event-description", "nylas-event-duration", "nylas-event-info", "nylas-event-limits", "nylas-event-location", "nylas-event-title", "nylas-form-card", "nylas-limit-future-bookings", "nylas-min-booking-notice", "nylas-min-cancellation-notice", "nylas-page-name", "nylas-page-styling", "nylas-participant-booking-calendars", "nylas-participants-custom-availability", "nylas-scheduling-method", "nylas-time-window-picker", "nylas-timeslot-interval", "paintbrush-fill-icon", "paintbrush-icon", "people-icon", "person-clipboard-icon", "plus-icon", "radio-button-group", "search-icon", "select-dropdown", "textarea-component", "time-period-selector", "toggle-switch", "tooltip-component", "zoom-icon"];
