...
import { d as defineCustomElement$9 } from './close.js';
import { d as defineCustomElement$8 } from './globe.js';
import { d as defineCustomElement$7 } from './info.js';
import { d as defineCustomElement$6 } from './nylas-availability-picker2.js';
...
const NylasParticipantsCustomAvailability = proxyCustomElement(class NylasParticipantsCustomAvailability extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return nylasParticipantsCustomAvailabilityCss; }
}, [65, "nylas-participants-custom-availability", {
        "selectedConfiguration": [16],
        "name": [1],
        "participants": [16],
        "selectedParticipants": [32]
    }, [[0, "nylasFormSwitchToggled", "nylasFormSwitchToggledHandler"], [0, "valueChanged", "handleValueChanged"]], {
        "name": ["elementNameChangedHandler"],
        "participants": ["participantsChangedHandler"],
        "selectedConfiguration": ["selectedConfigurationChangedHandler"]
    }]);
...
function defineCustomElement() {
    ...
    const components = ["nylas-participants-custom-availability", "add-circle-icon", "chevron-icon", "close-icon", "globe-icon", "info-icon", "nylas-availability-picker", "nylas-time-window-picker", "search-icon", "select-dropdown", "toggle-switch", "tooltip-component"];
    components.forEach(tagName => { switch (tagName) {
        case "nylas-participants-custom-availability":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, NylasParticipantsCustomAvailability);
            }
            break;
...
//# sourceMappingURL=nylas-participants-custom-availability2.js.map